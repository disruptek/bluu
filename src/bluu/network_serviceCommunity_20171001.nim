...
proc call*(call_563962: Call_BgpServiceCommunitiesList_563761; path: JsonNode;
...
proc call*(call_564033: Call_BgpServiceCommunitiesList_563761; apiVersion: string;
