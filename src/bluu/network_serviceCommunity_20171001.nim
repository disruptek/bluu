...
proc call*(call_593829: Call_BgpServiceCommunitiesList_593630; path: JsonNode;
...
proc call*(call_593900: Call_BgpServiceCommunitiesList_593630; apiVersion: string;
