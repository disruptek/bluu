...
proc call*(call_593864: Call_VolumesList_593646; path: JsonNode; query: JsonNode;
...
proc call*(call_593935: Call_VolumesList_593646; resourceGroupName: string;
...
type
  Call_VolumesGet_593977 = ref object of OpenApiRestCall_593424
proc url_VolumesGet_593979(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VolumesGet_593978(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593983 = path.getOrDefault("volume")
  valid_593983 = validateParameter(valid_593983, JString, required = true,
                                 default = nil)
  if valid_593983 != nil:
    section.add "volume", valid_593983
  var valid_593984 = path.getOrDefault("storageSubSystem")
  valid_593984 = validateParameter(valid_593984, JString, required = true,
                                 default = nil)
  if valid_593984 != nil:
    section.add "storageSubSystem", valid_593984
...
proc call*(call_593987: Call_VolumesGet_593977; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Return the requested a storage volume.
  ## 
...
proc call*(call_593988: Call_VolumesGet_593977; resourceGroupName: string;
...
var volumesGet* = Call_VolumesGet_593977(name: "volumesGet",
                                      ...
                                      validator: validate_VolumesGet_593978,
                                      base: "", url: url_VolumesGet_593979,
                                      schemes: {Scheme.Https})
export
  rest
