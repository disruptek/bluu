...
proc call*(call_593820: Call_RouteTablesListAll_593630; path: JsonNode;
...
proc call*(call_593891: Call_RouteTablesListAll_593630; apiVersion: string;
...
type
  Call_RouteTablesList_593933 = ref object of OpenApiRestCall_593408
proc url_RouteTablesList_593935(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RouteTablesList_593934(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
...
proc call*(call_593939: Call_RouteTablesList_593933; path: JsonNode; query: JsonNode;
...
proc call*(call_593940: Call_RouteTablesList_593933; resourceGroupName: string;
...
var routeTablesList* = Call_RouteTablesList_593933(name: "routeTablesList",
    ...
    validator: validate_RouteTablesList_593934, base: "", url: url_RouteTablesList_593935,
    schemes: {Scheme.Https})
type
  Call_RouteTablesCreateOrUpdate_593956 = ref object of OpenApiRestCall_593408
proc url_RouteTablesCreateOrUpdate_593958(protocol: Scheme; host: string;
...
proc validate_RouteTablesCreateOrUpdate_593957(path: JsonNode; query: JsonNode;
...
proc call*(call_593990: Call_RouteTablesCreateOrUpdate_593956; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or updates a route table in a specified resource group.
  ## 
...
proc call*(call_593991: Call_RouteTablesCreateOrUpdate_593956;
...
var routeTablesCreateOrUpdate* = Call_RouteTablesCreateOrUpdate_593956(
    ...
    validator: validate_RouteTablesCreateOrUpdate_593957, base: "",
    url: url_RouteTablesCreateOrUpdate_593958, schemes: {Scheme.Https})
type
  Call_RouteTablesGet_593943 = ref object of OpenApiRestCall_593408
proc url_RouteTablesGet_593945(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RouteTablesGet_593944(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  var valid_593948 = path.getOrDefault("routeTableName")
  valid_593948 = validateParameter(valid_593948, JString, required = true,
                                 default = nil)
  if valid_593948 != nil:
    section.add "routeTableName", valid_593948
...
proc call*(call_593952: Call_RouteTablesGet_593943; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified route table.
  ## 
...
proc call*(call_593953: Call_RouteTablesGet_593943; resourceGroupName: string;
  ...
  add(path_593954, "routeTableName", newJString(routeTableName))
...
var routeTablesGet* = Call_RouteTablesGet_593943(name: "routeTablesGet",
    ...
    validator: validate_RouteTablesGet_593944, base: "", url: url_RouteTablesGet_593945,
    schemes: {Scheme.Https})
type
  Call_RouteTablesUpdateTags_594006 = ref object of OpenApiRestCall_593408
proc url_RouteTablesUpdateTags_594008(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RouteTablesUpdateTags_594007(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594014: Call_RouteTablesUpdateTags_594006; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a route table tags.
  ## 
...
proc call*(call_594015: Call_RouteTablesUpdateTags_594006;
          resourceGroupName: string; routeTableName: string; apiVersion: string;
          subscriptionId: string; parameters: JsonNode): Recallable =
  ...
  add(path_594016, "routeTableName", newJString(routeTableName))
...
var routeTablesUpdateTags* = Call_RouteTablesUpdateTags_594006(
    name: "routeTablesUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}",
    validator: validate_RouteTablesUpdateTags_594007, base: "",
    url: url_RouteTablesUpdateTags_594008, schemes: {Scheme.Https})
type
...
type
  Call_RoutesList_594019 = ref object of OpenApiRestCall_593408
proc url_RoutesList_594021(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RoutesList_594020(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_594023 = path.getOrDefault("routeTableName")
  valid_594023 = validateParameter(valid_594023, JString, required = true,
                                 default = nil)
  if valid_594023 != nil:
    section.add "routeTableName", valid_594023
...
proc call*(call_594026: Call_RoutesList_594019; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all routes in a route table.
  ## 
...
proc call*(call_594027: Call_RoutesList_594019; resourceGroupName: string;
          routeTableName: string; apiVersion: string; subscriptionId: string): Recallable =
  ## routesList
  ## Gets all routes in a route table.
  ##   resourceGroupName: string (required)
  ...
  add(path_594028, "routeTableName", newJString(routeTableName))
...
var routesList* = Call_RoutesList_594019(name: "routesList",
                                      ...
                                      validator: validate_RoutesList_594020,
                                      base: "", url: url_RoutesList_594021,
                                      schemes: {Scheme.Https})
type
  Call_RoutesCreateOrUpdate_594042 = ref object of OpenApiRestCall_593408
proc url_RoutesCreateOrUpdate_594044(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RoutesCreateOrUpdate_594043(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594046 = path.getOrDefault("routeTableName")
  valid_594046 = validateParameter(valid_594046, JString, required = true,
                                 default = nil)
  if valid_594046 != nil:
    section.add "routeTableName", valid_594046
  var valid_594047 = path.getOrDefault("subscriptionId")
  valid_594047 = validateParameter(valid_594047, JString, required = true,
                                 default = nil)
  if valid_594047 != nil:
    section.add "subscriptionId", valid_594047
  var valid_594048 = path.getOrDefault("routeName")
  valid_594048 = validateParameter(valid_594048, JString, required = true,
                                 default = nil)
  if valid_594048 != nil:
    section.add "routeName", valid_594048
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594051: Call_RoutesCreateOrUpdate_594042; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a route in the specified route table.
  ## 
...
proc call*(call_594052: Call_RoutesCreateOrUpdate_594042;
          resourceGroupName: string; routeTableName: string; apiVersion: string;
  ...
  if routeParameters != nil:
    body_594055 = routeParameters
  result = call_594052.call(path_594053, query_594054, nil, nil, body_594055)

var routesCreateOrUpdate* = Call_RoutesCreateOrUpdate_594042(
    ...
    validator: validate_RoutesCreateOrUpdate_594043, base: "",
    url: url_RoutesCreateOrUpdate_594044, schemes: {Scheme.Https})
type
  Call_RoutesGet_594030 = ref object of OpenApiRestCall_593408
proc url_RoutesGet_594032(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RoutesGet_594031(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594034 = path.getOrDefault("routeTableName")
  valid_594034 = validateParameter(valid_594034, JString, required = true,
                                 default = nil)
  if valid_594034 != nil:
    section.add "routeTableName", valid_594034
  var valid_594035 = path.getOrDefault("subscriptionId")
  valid_594035 = validateParameter(valid_594035, JString, required = true,
                                 default = nil)
  if valid_594035 != nil:
    section.add "subscriptionId", valid_594035
  var valid_594036 = path.getOrDefault("routeName")
  valid_594036 = validateParameter(valid_594036, JString, required = true,
                                 default = nil)
  if valid_594036 != nil:
    section.add "routeName", valid_594036
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594038: Call_RoutesGet_594030; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified route from a route table.
  ## 
...
proc call*(call_594039: Call_RoutesGet_594030; resourceGroupName: string;
          routeTableName: string; apiVersion: string; subscriptionId: string;
...
var routesGet* = Call_RoutesGet_594030(name: "routesGet", meth: HttpMethod.HttpGet,
                                    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}/routes/{routeName}",
                                    validator: validate_RoutesGet_594031,
                                    base: "", url: url_RoutesGet_594032,
                                    schemes: {Scheme.Https})
type
  Call_RoutesDelete_594056 = ref object of OpenApiRestCall_593408
proc url_RoutesDelete_594058(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RoutesDelete_594057(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594060 = path.getOrDefault("routeTableName")
  valid_594060 = validateParameter(valid_594060, JString, required = true,
                                 default = nil)
  if valid_594060 != nil:
    section.add "routeTableName", valid_594060
  var valid_594061 = path.getOrDefault("subscriptionId")
  valid_594061 = validateParameter(valid_594061, JString, required = true,
                                 default = nil)
  if valid_594061 != nil:
    section.add "subscriptionId", valid_594061
  var valid_594062 = path.getOrDefault("routeName")
  valid_594062 = validateParameter(valid_594062, JString, required = true,
                                 default = nil)
  if valid_594062 != nil:
    section.add "routeName", valid_594062
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594064: Call_RoutesDelete_594056; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified route from a route table.
  ## 
...
proc call*(call_594065: Call_RoutesDelete_594056; resourceGroupName: string;
          routeTableName: string; apiVersion: string; subscriptionId: string;
          routeName: string): Recallable =
  ## routesDelete
  ## Deletes the specified route from a route table.
...
var routesDelete* = Call_RoutesDelete_594056(name: "routesDelete",
    ...
    validator: validate_RoutesDelete_594057, base: "", url: url_RoutesDelete_594058,
    schemes: {Scheme.Https})
export
  rest
