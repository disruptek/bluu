...
proc call*(call_563981: Call_NetworkStatusListByLocation_563777; path: JsonNode;
...
proc call*(call_564052: Call_NetworkStatusListByLocation_563777;
  ...
  add(path_564053, "locationName", newJString(locationName))
...
type
  Call_NetworkStatusListByService_564094 = ref object of OpenApiRestCall_563555
proc url_NetworkStatusListByService_564096(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkStatusListByService_564095(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets the Connectivity Status to the external resources on which the Api Management service depends from inside the Cloud Service. This also returns the DNS Servers as visible to the CloudService.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564097 = path.getOrDefault("serviceName")
  valid_564097 = validateParameter(valid_564097, JString, required = true,
                                 default = nil)
  if valid_564097 != nil:
    section.add "serviceName", valid_564097
...
proc call*(call_564101: Call_NetworkStatusListByService_564094; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the Connectivity Status to the external resources on which the Api Management service depends from inside the Cloud Service. This also returns the DNS Servers as visible to the CloudService.
  ## 
...
proc call*(call_564102: Call_NetworkStatusListByService_564094;
...
var networkStatusListByService* = Call_NetworkStatusListByService_564094(
    ...
    validator: validate_NetworkStatusListByService_564095, base: "",
    url: url_NetworkStatusListByService_564096, schemes: {Scheme.Https})
export
  rest
