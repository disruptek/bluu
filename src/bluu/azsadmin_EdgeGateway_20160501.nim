...
const
  macServiceName = "azsadmin-EdgeGateway"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_EdgeGatewaysList_593646 = ref object of OpenApiRestCall_593424
proc url_EdgeGatewaysList_593648(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.Fabric.Admin/fabricLocations/"),
               ...
               (kind: ConstantSegment, value: "/edgeGateways")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_EdgeGatewaysList_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593853: Call_EdgeGatewaysList_593646; path: JsonNode;
...
proc call*(call_593924: Call_EdgeGatewaysList_593646; resourceGroupName: string;
...
var edgeGatewaysList* = Call_EdgeGatewaysList_593646(name: "edgeGatewaysList",
    meth: HttpMethod.HttpGet, host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGateways",
    validator: validate_EdgeGatewaysList_593647, base: "",
    url: url_EdgeGatewaysList_593648, schemes: {Scheme.Https})
type
  Call_EdgeGatewaysGet_593966 = ref object of OpenApiRestCall_593424
proc url_EdgeGatewaysGet_593968(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
  ...
  assert "resourceGroupName" in path,
        "`resourceGroupName` is a required path parameter"
  assert "location" in path, "`location` is a required path parameter"
  assert "edgeGateway" in path, "`edgeGateway` is a required path parameter"
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
               (kind: VariableSegment, value: "subscriptionId"),
               (kind: ConstantSegment, value: "/resourceGroups/"),
        ...
        value: "/providers/Microsoft.Fabric.Admin/fabricLocations/"),
               (kind: VariableSegment, value: "location"),
               (kind: ConstantSegment, value: "/edgeGateways/"),
               (kind: VariableSegment, value: "edgeGateway")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_EdgeGatewaysGet_593967(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  var valid_593980 = path.getOrDefault("edgeGateway")
  valid_593980 = validateParameter(valid_593980, JString, required = true,
                                 default = nil)
  if valid_593980 != nil:
    section.add "edgeGateway", valid_593980
...
proc call*(call_593983: Call_EdgeGatewaysGet_593966; path: JsonNode; query: JsonNode;
...
proc call*(call_593984: Call_EdgeGatewaysGet_593966; resourceGroupName: string;
          subscriptionId: string; edgeGateway: string; location: string;
  ...
  add(path_593985, "edgeGateway", newJString(edgeGateway))
  add(path_593985, "location", newJString(location))
  result = call_593984.call(path_593985, query_593986, nil, nil, nil)

var edgeGatewaysGet* = Call_EdgeGatewaysGet_593966(name: "edgeGatewaysGet",
    meth: HttpMethod.HttpGet, host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/edgeGateways/{edgeGateway}",
    validator: validate_EdgeGatewaysGet_593967, base: "", url: url_EdgeGatewaysGet_593968,
