...
type
  Call_EdgeGatewaysList_563777 = ref object of OpenApiRestCall_563555
proc url_EdgeGatewaysList_563779(protocol: Scheme; host: string; base: string;
...
proc validate_EdgeGatewaysList_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563986: Call_EdgeGatewaysList_563777; path: JsonNode;
...
proc call*(call_564057: Call_EdgeGatewaysList_563777; subscriptionId: string;
...
var edgeGatewaysList* = Call_EdgeGatewaysList_563777(name: "edgeGatewaysList",
    ...
    validator: validate_EdgeGatewaysList_563778, base: "",
    url: url_EdgeGatewaysList_563779, schemes: {Scheme.Https})
type
  Call_EdgeGatewaysGet_564099 = ref object of OpenApiRestCall_563555
proc url_EdgeGatewaysGet_564101(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EdgeGatewaysGet_564100(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil,
        "path argument is necessary due to required `edgeGateway` field"
  var valid_564111 = path.getOrDefault("edgeGateway")
  valid_564111 = validateParameter(valid_564111, JString, required = true,
                                 default = nil)
  if valid_564111 != nil:
    section.add "edgeGateway", valid_564111
...
proc call*(call_564116: Call_EdgeGatewaysGet_564099; path: JsonNode; query: JsonNode;
...
proc call*(call_564117: Call_EdgeGatewaysGet_564099; edgeGateway: string;
  ...
  add(path_564118, "edgeGateway", newJString(edgeGateway))
...
var edgeGatewaysGet* = Call_EdgeGatewaysGet_564099(name: "edgeGatewaysGet",
    ...
    validator: validate_EdgeGatewaysGet_564100, base: "", url: url_EdgeGatewaysGet_564101,
