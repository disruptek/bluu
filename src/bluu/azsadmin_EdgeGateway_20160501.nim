...
type
  Call_EdgeGatewaysList_574679 = ref object of OpenApiRestCall_574457
proc url_EdgeGatewaysList_574681(protocol: Scheme; host: string; base: string;
...
proc validate_EdgeGatewaysList_574680(path: JsonNode; query: JsonNode;
...
proc call*(call_574886: Call_EdgeGatewaysList_574679; path: JsonNode;
...
proc call*(call_574957: Call_EdgeGatewaysList_574679; resourceGroupName: string;
...
var edgeGatewaysList* = Call_EdgeGatewaysList_574679(name: "edgeGatewaysList",
    ...
    validator: validate_EdgeGatewaysList_574680, base: "",
    url: url_EdgeGatewaysList_574681, schemes: {Scheme.Https})
type
  Call_EdgeGatewaysGet_574999 = ref object of OpenApiRestCall_574457
proc url_EdgeGatewaysGet_575001(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EdgeGatewaysGet_575000(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  var valid_575013 = path.getOrDefault("edgeGateway")
  valid_575013 = validateParameter(valid_575013, JString, required = true,
                                 default = nil)
  if valid_575013 != nil:
    section.add "edgeGateway", valid_575013
...
proc call*(call_575016: Call_EdgeGatewaysGet_574999; path: JsonNode; query: JsonNode;
...
proc call*(call_575017: Call_EdgeGatewaysGet_574999; resourceGroupName: string;
  ...
  add(path_575018, "edgeGateway", newJString(edgeGateway))
  add(path_575018, "location", newJString(location))
  result = call_575017.call(path_575018, query_575019, nil, nil, nil)

var edgeGatewaysGet* = Call_EdgeGatewaysGet_574999(name: "edgeGatewaysGet",
    ...
    validator: validate_EdgeGatewaysGet_575000, base: "", url: url_EdgeGatewaysGet_575001,
