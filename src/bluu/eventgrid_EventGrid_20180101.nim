...
type
  Call_PublishEvents_567863 = ref object of OpenApiRestCall_567641
proc url_PublishEvents_567865(protocol: Scheme; host: string; base: string;
...
proc validate_PublishEvents_567864(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_568048: Call_PublishEvents_567863; path: JsonNode; query: JsonNode;
...
proc call*(call_568119: Call_PublishEvents_567863; apiVersion: string;
  ...
  var body_568122 = newJObject()
  add(query_568120, "api-version", newJString(apiVersion))
  if events != nil:
    body_568122 = events
  result = call_568119.call(nil, query_568120, nil, nil, body_568122)

var publishEvents* = Call_PublishEvents_567863(name: "publishEvents",
    meth: HttpMethod.HttpPost, host: "azure.local", route: "/api/events",
    validator: validate_PublishEvents_567864, base: "", url: url_PublishEvents_567865,
