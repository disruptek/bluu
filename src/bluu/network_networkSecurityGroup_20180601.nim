...
proc call*(call_593836: Call_NetworkSecurityGroupsListAll_593646; path: JsonNode;
...
proc call*(call_593907: Call_NetworkSecurityGroupsListAll_593646;
...
type
  Call_NetworkSecurityGroupsList_593949 = ref object of OpenApiRestCall_593424
proc url_NetworkSecurityGroupsList_593951(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkSecurityGroupsList_593950(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593955: Call_NetworkSecurityGroupsList_593949; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all network security groups in a resource group.
  ## 
...
proc call*(call_593956: Call_NetworkSecurityGroupsList_593949;
...
var networkSecurityGroupsList* = Call_NetworkSecurityGroupsList_593949(
    ...
    validator: validate_NetworkSecurityGroupsList_593950, base: "",
    url: url_NetworkSecurityGroupsList_593951, schemes: {Scheme.Https})
type
  Call_NetworkSecurityGroupsCreateOrUpdate_593972 = ref object of OpenApiRestCall_593424
proc url_NetworkSecurityGroupsCreateOrUpdate_593974(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkSecurityGroupsCreateOrUpdate_593973(path: JsonNode;
...
proc call*(call_594006: Call_NetworkSecurityGroupsCreateOrUpdate_593972;
...
proc call*(call_594007: Call_NetworkSecurityGroupsCreateOrUpdate_593972;
...
var networkSecurityGroupsCreateOrUpdate* = Call_NetworkSecurityGroupsCreateOrUpdate_593972(
    ...
    validator: validate_NetworkSecurityGroupsCreateOrUpdate_593973, base: "",
    url: url_NetworkSecurityGroupsCreateOrUpdate_593974, schemes: {Scheme.Https})
type
  Call_NetworkSecurityGroupsGet_593959 = ref object of OpenApiRestCall_593424
proc url_NetworkSecurityGroupsGet_593961(protocol: Scheme; host: string;
...
proc validate_NetworkSecurityGroupsGet_593960(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593965 = path.getOrDefault("networkSecurityGroupName")
  valid_593965 = validateParameter(valid_593965, JString, required = true,
                                 default = nil)
  if valid_593965 != nil:
    section.add "networkSecurityGroupName", valid_593965
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_593968: Call_NetworkSecurityGroupsGet_593959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified network security group.
  ## 
...
proc call*(call_593969: Call_NetworkSecurityGroupsGet_593959;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_593970, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_593969.call(path_593970, query_593971, nil, nil, nil)

var networkSecurityGroupsGet* = Call_NetworkSecurityGroupsGet_593959(
    name: "networkSecurityGroupsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}",
    validator: validate_NetworkSecurityGroupsGet_593960, base: "",
    url: url_NetworkSecurityGroupsGet_593961, schemes: {Scheme.Https})
type
