...
type
  Call_QueueServicesGet_593647 = ref object of OpenApiRestCall_593425
proc url_QueueServicesGet_593649(protocol: Scheme; host: string; base: string;
...
proc validate_QueueServicesGet_593648(path: JsonNode; query: JsonNode;
...
proc call*(call_593853: Call_QueueServicesGet_593647; path: JsonNode;
...
proc call*(call_593924: Call_QueueServicesGet_593647; resourceGroupName: string;
...
var queueServicesGet* = Call_QueueServicesGet_593647(name: "queueServicesGet",
    ...
    validator: validate_QueueServicesGet_593648, base: "",
    url: url_QueueServicesGet_593649, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetricDefinitions_593966 = ref object of OpenApiRestCall_593425
proc url_QueueServicesListMetricDefinitions_593968(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetricDefinitions_593967(path: JsonNode;
...
proc call*(call_593974: Call_QueueServicesListMetricDefinitions_593966;
...
proc call*(call_593975: Call_QueueServicesListMetricDefinitions_593966;
...
var queueServicesListMetricDefinitions* = Call_QueueServicesListMetricDefinitions_593966(
    ...
    validator: validate_QueueServicesListMetricDefinitions_593967, base: "",
    url: url_QueueServicesListMetricDefinitions_593968, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetrics_593978 = ref object of OpenApiRestCall_593425
proc url_QueueServicesListMetrics_593980(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetrics_593979(path: JsonNode; query: JsonNode;
...
proc call*(call_593986: Call_QueueServicesListMetrics_593978; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of metrics for the queue service.
  ## 
...
proc call*(call_593987: Call_QueueServicesListMetrics_593978;
          resourceGroupName: string; apiVersion: string; farmId: string;
          subscriptionId: string; serviceType: string = "default"): Recallable =
...
var queueServicesListMetrics* = Call_QueueServicesListMetrics_593978(
    ...
    validator: validate_QueueServicesListMetrics_593979, base: "",
    url: url_QueueServicesListMetrics_593980, schemes: {Scheme.Https})
export
  rest
