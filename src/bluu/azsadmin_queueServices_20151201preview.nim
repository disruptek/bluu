...
type
  Call_QueueServicesGet_574680 = ref object of OpenApiRestCall_574458
proc url_QueueServicesGet_574682(protocol: Scheme; host: string; base: string;
...
proc validate_QueueServicesGet_574681(path: JsonNode; query: JsonNode;
...
proc call*(call_574886: Call_QueueServicesGet_574680; path: JsonNode;
...
proc call*(call_574957: Call_QueueServicesGet_574680; resourceGroupName: string;
...
var queueServicesGet* = Call_QueueServicesGet_574680(name: "queueServicesGet",
    ...
    validator: validate_QueueServicesGet_574681, base: "",
    url: url_QueueServicesGet_574682, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetricDefinitions_574999 = ref object of OpenApiRestCall_574458
proc url_QueueServicesListMetricDefinitions_575001(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetricDefinitions_575000(path: JsonNode;
...
proc call*(call_575007: Call_QueueServicesListMetricDefinitions_574999;
...
proc call*(call_575008: Call_QueueServicesListMetricDefinitions_574999;
...
var queueServicesListMetricDefinitions* = Call_QueueServicesListMetricDefinitions_574999(
    ...
    validator: validate_QueueServicesListMetricDefinitions_575000, base: "",
    url: url_QueueServicesListMetricDefinitions_575001, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetrics_575011 = ref object of OpenApiRestCall_574458
proc url_QueueServicesListMetrics_575013(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetrics_575012(path: JsonNode; query: JsonNode;
...
proc call*(call_575019: Call_QueueServicesListMetrics_575011; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of metrics for the queue service.
  ## 
...
proc call*(call_575020: Call_QueueServicesListMetrics_575011;
          resourceGroupName: string; apiVersion: string; farmId: string;
          subscriptionId: string; serviceType: string = "default"): Recallable =
...
var queueServicesListMetrics* = Call_QueueServicesListMetrics_575011(
    ...
    validator: validate_QueueServicesListMetrics_575012, base: "",
    url: url_QueueServicesListMetrics_575013, schemes: {Scheme.Https})
export
  rest
