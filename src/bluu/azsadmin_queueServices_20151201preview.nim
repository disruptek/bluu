...
const
  macServiceName = "azsadmin-queueServices"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_QueueServicesGet_563778 = ref object of OpenApiRestCall_563556
proc url_QueueServicesGet_563780(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        kind: ConstantSegment, value: "/providers/Microsoft.Storage.Admin/farms/"),
               ...
               (kind: ConstantSegment, value: "/queueservices/"),
...
proc validate_QueueServicesGet_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563986: Call_QueueServicesGet_563778; path: JsonNode;
...
proc call*(call_564057: Call_QueueServicesGet_563778; apiVersion: string;
...
var queueServicesGet* = Call_QueueServicesGet_563778(name: "queueServicesGet",
    meth: HttpMethod.HttpGet, host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/queueservices/{serviceType}",
    validator: validate_QueueServicesGet_563779, base: "",
    url: url_QueueServicesGet_563780, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetricDefinitions_564099 = ref object of OpenApiRestCall_563556
proc url_QueueServicesListMetricDefinitions_564101(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetricDefinitions_564100(path: JsonNode;
...
proc call*(call_564107: Call_QueueServicesListMetricDefinitions_564099;
...
proc call*(call_564108: Call_QueueServicesListMetricDefinitions_564099;
...
var queueServicesListMetricDefinitions* = Call_QueueServicesListMetricDefinitions_564099(
    name: "queueServicesListMetricDefinitions", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/queueservices/{serviceType}/metricdefinitions",
    validator: validate_QueueServicesListMetricDefinitions_564100, base: "",
    url: url_QueueServicesListMetricDefinitions_564101, schemes: {Scheme.Https})
type
  Call_QueueServicesListMetrics_564111 = ref object of OpenApiRestCall_563556
proc url_QueueServicesListMetrics_564113(protocol: Scheme; host: string;
...
proc validate_QueueServicesListMetrics_564112(path: JsonNode; query: JsonNode;
...
proc call*(call_564119: Call_QueueServicesListMetrics_564111; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a list of metrics for the queue service.
  ## 
...
proc call*(call_564120: Call_QueueServicesListMetrics_564111; apiVersion: string;
          farmId: string; subscriptionId: string; resourceGroupName: string;
          serviceType: string = "default"): Recallable =
...
var queueServicesListMetrics* = Call_QueueServicesListMetrics_564111(
    name: "queueServicesListMetrics", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage.Admin/farms/{farmId}/queueservices/{serviceType}/metrics",
    validator: validate_QueueServicesListMetrics_564112, base: "",
    url: url_QueueServicesListMetrics_564113, schemes: {Scheme.Https})
export
  rest
