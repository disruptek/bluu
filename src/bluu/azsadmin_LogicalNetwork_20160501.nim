...
type
  Call_LogicalNetworksList_563761 = ref object of OpenApiRestCall_563539
proc url_LogicalNetworksList_563763(protocol: Scheme; host: string; base: string;
...
proc validate_LogicalNetworksList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563970: Call_LogicalNetworksList_563761; path: JsonNode;
...
proc call*(call_564041: Call_LogicalNetworksList_563761; subscriptionId: string;
...
var logicalNetworksList* = Call_LogicalNetworksList_563761(
    ...
    validator: validate_LogicalNetworksList_563762, base: "",
    url: url_LogicalNetworksList_563763, schemes: {Scheme.Https})
type
  Call_LogicalNetworksGet_564083 = ref object of OpenApiRestCall_563539
proc url_LogicalNetworksGet_564085(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LogicalNetworksGet_564084(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_564098 = path.getOrDefault("logicalNetwork")
  valid_564098 = validateParameter(valid_564098, JString, required = true,
                                 default = nil)
  if valid_564098 != nil:
    section.add "logicalNetwork", valid_564098
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API Version.
...
proc call*(call_564100: Call_LogicalNetworksGet_564083; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the requested logical network.
  ## 
...
proc call*(call_564101: Call_LogicalNetworksGet_564083; subscriptionId: string;
  ...
  add(path_564102, "logicalNetwork", newJString(logicalNetwork))
  result = call_564101.call(path_564102, query_564103, nil, nil, nil)

var logicalNetworksGet* = Call_LogicalNetworksGet_564083(
    ...
    validator: validate_LogicalNetworksGet_564084, base: "",
    url: url_LogicalNetworksGet_564085, schemes: {Scheme.Https})
export
  rest
