...
type
  Call_LogicalNetworksList_574663 = ref object of OpenApiRestCall_574441
proc url_LogicalNetworksList_574665(protocol: Scheme; host: string; base: string;
...
proc validate_LogicalNetworksList_574664(path: JsonNode; query: JsonNode;
...
proc call*(call_574870: Call_LogicalNetworksList_574663; path: JsonNode;
...
proc call*(call_574941: Call_LogicalNetworksList_574663; resourceGroupName: string;
...
var logicalNetworksList* = Call_LogicalNetworksList_574663(
    ...
    validator: validate_LogicalNetworksList_574664, base: "",
    url: url_LogicalNetworksList_574665, schemes: {Scheme.Https})
type
  Call_LogicalNetworksGet_574983 = ref object of OpenApiRestCall_574441
proc url_LogicalNetworksGet_574985(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LogicalNetworksGet_574984(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_574996 = path.getOrDefault("logicalNetwork")
  valid_574996 = validateParameter(valid_574996, JString, required = true,
                                 default = nil)
  if valid_574996 != nil:
    section.add "logicalNetwork", valid_574996
...
proc call*(call_575000: Call_LogicalNetworksGet_574983; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the requested logical network.
  ## 
...
proc call*(call_575001: Call_LogicalNetworksGet_574983; resourceGroupName: string;
  ...
  add(path_575002, "logicalNetwork", newJString(logicalNetwork))
...
var logicalNetworksGet* = Call_LogicalNetworksGet_574983(
    ...
    validator: validate_LogicalNetworksGet_574984, base: "",
    url: url_LogicalNetworksGet_574985, schemes: {Scheme.Https})
export
  rest
