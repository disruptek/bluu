...
type
  Call_ComputeOperationResultsList_563761 = ref object of OpenApiRestCall_563539
proc url_ComputeOperationResultsList_563763(protocol: Scheme; host: string;
...
proc validate_ComputeOperationResultsList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563970: Call_ComputeOperationResultsList_563761; path: JsonNode;
...
proc call*(call_564041: Call_ComputeOperationResultsList_563761;
...
var computeOperationResultsList* = Call_ComputeOperationResultsList_563761(
    ...
    validator: validate_ComputeOperationResultsList_563762, base: "",
    url: url_ComputeOperationResultsList_563763, schemes: {Scheme.Https})
type
  Call_ComputeOperationResultsGet_564083 = ref object of OpenApiRestCall_563539
proc url_ComputeOperationResultsGet_564085(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ComputeOperationResultsGet_564084(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564100: Call_ComputeOperationResultsGet_564083; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of a compute operation.
  ## 
...
proc call*(call_564101: Call_ComputeOperationResultsGet_564083; operation: string;
          subscriptionId: string; location: string; resourceGroupName: string;
...
var computeOperationResultsGet* = Call_ComputeOperationResultsGet_564083(
    ...
    validator: validate_ComputeOperationResultsGet_564084, base: "",
    url: url_ComputeOperationResultsGet_564085, schemes: {Scheme.Https})
export
  rest
