...
type
  Call_DatabasesFailover_563761 = ref object of OpenApiRestCall_563539
proc url_DatabasesFailover_563763(protocol: Scheme; host: string; base: string;
...
proc validate_DatabasesFailover_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563965: Call_DatabasesFailover_563761; path: JsonNode;
...
proc call*(call_564036: Call_DatabasesFailover_563761; apiVersion: string;
...
var databasesFailover* = Call_DatabasesFailover_563761(name: "databasesFailover",
    ...
    validator: validate_DatabasesFailover_563762, base: "",
    url: url_DatabasesFailover_563763, schemes: {Scheme.Https})
export
  rest
