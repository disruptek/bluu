...
const
  macServiceName = "sql-FailoverDatabases"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_DatabasesFailover_567863 = ref object of OpenApiRestCall_567641
proc url_DatabasesFailover_567865(protocol: Scheme; host: string; base: string;
...
proc validate_DatabasesFailover_567864(path: JsonNode; query: JsonNode;
...
proc call*(call_568065: Call_DatabasesFailover_567863; path: JsonNode;
...
proc call*(call_568136: Call_DatabasesFailover_567863; resourceGroupName: string;
...
var databasesFailover* = Call_DatabasesFailover_567863(name: "databasesFailover",
    meth: HttpMethod.HttpPost, host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/failover",
    validator: validate_DatabasesFailover_567864, base: "",
    url: url_DatabasesFailover_567865, schemes: {Scheme.Https})
export
  rest
