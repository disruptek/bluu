...
type
  Call_DatabasesFailover_593630 = ref object of OpenApiRestCall_593408
proc url_DatabasesFailover_593632(protocol: Scheme; host: string; base: string;
...
proc validate_DatabasesFailover_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593832: Call_DatabasesFailover_593630; path: JsonNode;
...
proc call*(call_593903: Call_DatabasesFailover_593630; resourceGroupName: string;
...
var databasesFailover* = Call_DatabasesFailover_593630(name: "databasesFailover",
    ...
    validator: validate_DatabasesFailover_593631, base: "",
    url: url_DatabasesFailover_593632, schemes: {Scheme.Https})
export
  rest
