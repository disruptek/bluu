...
const
  macServiceName = "compute-skus"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_ResourceSkusList_563762 = ref object of OpenApiRestCall_563540
proc url_ResourceSkusList_563764(protocol: Scheme; host: string; base: string;
...
proc validate_ResourceSkusList_563763(path: JsonNode; query: JsonNode;
...
proc call*(call_563963: Call_ResourceSkusList_563762; path: JsonNode;
...
proc call*(call_564034: Call_ResourceSkusList_563762; apiVersion: string;
...
var resourceSkusList* = Call_ResourceSkusList_563762(name: "resourceSkusList",
    meth: HttpMethod.HttpGet, host: "management.azure.com",
    route: "/subscriptions/{subscriptionId}/providers/Microsoft.Compute/skus",
    validator: validate_ResourceSkusList_563763, base: "",
    url: url_ResourceSkusList_563764, schemes: {Scheme.Https})
export
  rest
