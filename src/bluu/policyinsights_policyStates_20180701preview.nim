...
proc validate_PolicyStatesListQueryResultsForResource_564344(path: JsonNode;
  ...
  var valid_564352 = query.getOrDefault("$to")
  valid_564352 = validateParameter(valid_564352, JString, required = false,
                                 default = nil)
  if valid_564352 != nil:
    section.add "$to", valid_564352
  var valid_564353 = query.getOrDefault("$orderby")
  valid_564353 = validateParameter(valid_564353, JString, required = false,
                                 default = nil)
  if valid_564353 != nil:
    section.add "$orderby", valid_564353
  var valid_564354 = query.getOrDefault("$apply")
  valid_564354 = validateParameter(valid_564354, JString, required = false,
                                 default = nil)
  if valid_564354 != nil:
    section.add "$apply", valid_564354
  ...
  var valid_564356 = query.getOrDefault("$from")
  valid_564356 = validateParameter(valid_564356, JString, required = false,
                                 default = nil)
  if valid_564356 != nil:
    section.add "$from", valid_564356
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564358: Call_PolicyStatesListQueryResultsForResource_564343;
          apiVersion: string; resourceId: string; Top: int = 0; Select: string = "";
          Expand: string = ""; policyStatesResource: string = "default";
          To: string = ""; Orderby: string = ""; Apply: string = ""; Filter: string = "";
          From: string = ""): Recallable =
  ...
  add(query_564360, "$select", newJString(Select))
  add(query_564360, "$expand", newJString(Expand))
  add(path_564359, "policyStatesResource", newJString(policyStatesResource))
  add(query_564360, "$to", newJString(To))
  add(query_564360, "$orderby", newJString(Orderby))
  add(query_564360, "$apply", newJString(Apply))
  add(query_564360, "$filter", newJString(Filter))
  add(query_564360, "$from", newJString(From))
  add(path_564359, "resourceId", newJString(resourceId))
...
var policyStatesListQueryResultsForResource* = Call_PolicyStatesListQueryResultsForResource_564343(
    ...
    schemes: {Scheme.Https})
type
  Call_PolicyStatesSummarizeForResource_564361 = ref object of OpenApiRestCall_563556
proc url_PolicyStatesSummarizeForResource_564363(protocol: Scheme; host: string;
...
proc validate_PolicyStatesSummarizeForResource_564362(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564364 = path.getOrDefault("policyStatesSummaryResource")
  valid_564364 = validateParameter(valid_564364, JString, required = true,
                                 default = newJString("latest"))
  if valid_564364 != nil:
    section.add "policyStatesSummaryResource", valid_564364
  var valid_564365 = path.getOrDefault("resourceId")
  valid_564365 = validateParameter(valid_564365, JString, required = true,
                                 default = nil)
  if valid_564365 != nil:
    section.add "resourceId", valid_564365
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
  ...
  var valid_564367 = query.getOrDefault("$top")
  valid_564367 = validateParameter(valid_564367, JInt, required = false, default = nil)
  if valid_564367 != nil:
    section.add "$top", valid_564367
  var valid_564368 = query.getOrDefault("$to")
  valid_564368 = validateParameter(valid_564368, JString, required = false,
                                 default = nil)
  if valid_564368 != nil:
    section.add "$to", valid_564368
  ...
  var valid_564370 = query.getOrDefault("$from")
  valid_564370 = validateParameter(valid_564370, JString, required = false,
                                 default = nil)
  if valid_564370 != nil:
    section.add "$from", valid_564370
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564371: Call_PolicyStatesSummarizeForResource_564361;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Summarizes policy states for the resource.
  ## 
...
proc call*(call_564372: Call_PolicyStatesSummarizeForResource_564361;
  ...
  add(query_564374, "$top", newJInt(Top))
  add(query_564374, "$to", newJString(To))
  add(query_564374, "$filter", newJString(Filter))
  add(query_564374, "$from", newJString(From))
  add(path_564373, "policyStatesSummaryResource",
      newJString(policyStatesSummaryResource))
  add(path_564373, "resourceId", newJString(resourceId))
  result = call_564372.call(path_564373, query_564374, nil, nil, nil)

var policyStatesSummarizeForResource* = Call_PolicyStatesSummarizeForResource_564361(
    ...
    validator: validate_PolicyStatesSummarizeForResource_564362, base: "",
    url: url_PolicyStatesSummarizeForResource_564363, schemes: {Scheme.Https})
type
  Call_PolicyStatesGetMetadata_564375 = ref object of OpenApiRestCall_563556
proc url_PolicyStatesGetMetadata_564377(protocol: Scheme; host: string; base: string;
...
proc validate_PolicyStatesGetMetadata_564376(path: JsonNode; query: JsonNode;
  ...
  var valid_564378 = path.getOrDefault("scope")
  valid_564378 = validateParameter(valid_564378, JString, required = true,
                                 default = nil)
  if valid_564378 != nil:
    section.add "scope", valid_564378
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_564380: Call_PolicyStatesGetMetadata_564375; path: JsonNode;
...
proc call*(call_564381: Call_PolicyStatesGetMetadata_564375; apiVersion: string;
  ...
  add(path_564382, "scope", newJString(scope))
  result = call_564381.call(path_564382, query_564383, nil, nil, nil)

var policyStatesGetMetadata* = Call_PolicyStatesGetMetadata_564375(
    ...
    validator: validate_PolicyStatesGetMetadata_564376, base: "",
    url: url_PolicyStatesGetMetadata_564377, schemes: {Scheme.Https})
export
  rest
