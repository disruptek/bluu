...
type
  Call_StorageOperationResultsList_563761 = ref object of OpenApiRestCall_563539
proc url_StorageOperationResultsList_563763(protocol: Scheme; host: string;
...
proc validate_StorageOperationResultsList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563970: Call_StorageOperationResultsList_563761; path: JsonNode;
...
proc call*(call_564041: Call_StorageOperationResultsList_563761;
...
var storageOperationResultsList* = Call_StorageOperationResultsList_563761(
    ...
    validator: validate_StorageOperationResultsList_563762, base: "",
    url: url_StorageOperationResultsList_563763, schemes: {Scheme.Https})
type
  Call_StorageOperationResultsGet_564083 = ref object of OpenApiRestCall_563539
proc url_StorageOperationResultsGet_564085(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageOperationResultsGet_564084(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564100: Call_StorageOperationResultsGet_564083; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of a storage operation.
  ## 
...
proc call*(call_564101: Call_StorageOperationResultsGet_564083; operation: string;
          subscriptionId: string; location: string; resourceGroupName: string;
...
var storageOperationResultsGet* = Call_StorageOperationResultsGet_564083(
    ...
    validator: validate_StorageOperationResultsGet_564084, base: "",
    url: url_StorageOperationResultsGet_564085, schemes: {Scheme.Https})
export
  rest
