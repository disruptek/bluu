...
type
  Call_DatabaseAutomaticTuningGet_563777 = ref object of OpenApiRestCall_563555
proc url_DatabaseAutomaticTuningGet_563779(protocol: Scheme; host: string;
...
proc validate_DatabaseAutomaticTuningGet_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563981: Call_DatabaseAutomaticTuningGet_563777; path: JsonNode;
...
proc call*(call_564052: Call_DatabaseAutomaticTuningGet_563777; apiVersion: string;
...
var databaseAutomaticTuningGet* = Call_DatabaseAutomaticTuningGet_563777(
    ...
    validator: validate_DatabaseAutomaticTuningGet_563778, base: "",
    url: url_DatabaseAutomaticTuningGet_563779, schemes: {Scheme.Https})
type
  Call_DatabaseAutomaticTuningUpdate_564094 = ref object of OpenApiRestCall_563555
proc url_DatabaseAutomaticTuningUpdate_564096(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseAutomaticTuningUpdate_564095(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564103: Call_DatabaseAutomaticTuningUpdate_564094; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update automatic tuning properties for target database.
  ## 
...
proc call*(call_564104: Call_DatabaseAutomaticTuningUpdate_564094;
...
var databaseAutomaticTuningUpdate* = Call_DatabaseAutomaticTuningUpdate_564094(
    name: "databaseAutomaticTuningUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/automaticTuning/current",
    validator: validate_DatabaseAutomaticTuningUpdate_564095, base: "",
    url: url_DatabaseAutomaticTuningUpdate_564096, schemes: {Scheme.Https})
export
  rest
