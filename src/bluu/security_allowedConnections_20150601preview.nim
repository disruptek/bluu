...
type
  Call_AllowedConnectionsList_593646 = ref object of OpenApiRestCall_593424
proc url_AllowedConnectionsList_593648(protocol: Scheme; host: string; base: string;
...
proc validate_AllowedConnectionsList_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593836: Call_AllowedConnectionsList_593646; path: JsonNode;
...
proc call*(call_593907: Call_AllowedConnectionsList_593646; apiVersion: string;
...
var allowedConnectionsList* = Call_AllowedConnectionsList_593646(
    ...
    validator: validate_AllowedConnectionsList_593647, base: "",
    url: url_AllowedConnectionsList_593648, schemes: {Scheme.Https})
type
  Call_AllowedConnectionsListByHomeRegion_593949 = ref object of OpenApiRestCall_593424
proc url_AllowedConnectionsListByHomeRegion_593951(protocol: Scheme; host: string;
...
proc validate_AllowedConnectionsListByHomeRegion_593950(path: JsonNode;
...
proc call*(call_593955: Call_AllowedConnectionsListByHomeRegion_593949;
...
proc call*(call_593956: Call_AllowedConnectionsListByHomeRegion_593949;
...
var allowedConnectionsListByHomeRegion* = Call_AllowedConnectionsListByHomeRegion_593949(
    ...
    validator: validate_AllowedConnectionsListByHomeRegion_593950, base: "",
    url: url_AllowedConnectionsListByHomeRegion_593951, schemes: {Scheme.Https})
type
  Call_AllowedConnectionsGet_593959 = ref object of OpenApiRestCall_593424
proc url_AllowedConnectionsGet_593961(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AllowedConnectionsGet_593960(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593987 = path.getOrDefault("connectionType")
  valid_593987 = validateParameter(valid_593987, JString, required = true,
                                 default = newJString("Internal"))
  if valid_593987 != nil:
    section.add "connectionType", valid_593987
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : API version for the operation
...
proc call*(call_593989: Call_AllowedConnectionsGet_593959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the list of all possible traffic between resources for the subscription and location, based on connection type.
  ## 
...
proc call*(call_593990: Call_AllowedConnectionsGet_593959;
  ...
  add(path_593991, "ascLocation", newJString(ascLocation))
  add(path_593991, "subscriptionId", newJString(subscriptionId))
  add(path_593991, "connectionType", newJString(connectionType))
  result = call_593990.call(path_593991, query_593992, nil, nil, nil)

var allowedConnectionsGet* = Call_AllowedConnectionsGet_593959(
    ...
    validator: validate_AllowedConnectionsGet_593960, base: "",
    url: url_AllowedConnectionsGet_593961, schemes: {Scheme.Https})
export
  rest
