...
type
  Call_QuotaByCounterKeysListByService_593646 = ref object of OpenApiRestCall_593424
proc url_QuotaByCounterKeysListByService_593648(protocol: Scheme; host: string;
...
proc validate_QuotaByCounterKeysListByService_593647(path: JsonNode;
  ...
  var valid_593821 = path.getOrDefault("quotaCounterKey")
  valid_593821 = validateParameter(valid_593821, JString, required = true,
                                 default = nil)
  if valid_593821 != nil:
    section.add "quotaCounterKey", valid_593821
...
proc call*(call_593848: Call_QuotaByCounterKeysListByService_593646;
...
proc call*(call_593919: Call_QuotaByCounterKeysListByService_593646;
  ...
  add(path_593920, "quotaCounterKey", newJString(quotaCounterKey))
...
var quotaByCounterKeysListByService* = Call_QuotaByCounterKeysListByService_593646(
    ...
    validator: validate_QuotaByCounterKeysListByService_593647, base: "",
    url: url_QuotaByCounterKeysListByService_593648, schemes: {Scheme.Https})
type
  Call_QuotaByCounterKeysUpdate_593961 = ref object of OpenApiRestCall_593424
proc url_QuotaByCounterKeysUpdate_593963(protocol: Scheme; host: string;
...
proc validate_QuotaByCounterKeysUpdate_593962(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `quotaCounterKey` field"
  var valid_593981 = path.getOrDefault("quotaCounterKey")
  valid_593981 = validateParameter(valid_593981, JString, required = true,
                                 default = nil)
  if valid_593981 != nil:
    section.add "quotaCounterKey", valid_593981
...
proc call*(call_593987: Call_QuotaByCounterKeysUpdate_593961; path: JsonNode;
...
proc call*(call_593988: Call_QuotaByCounterKeysUpdate_593961;
          quotaCounterKey: string; resourceGroupName: string; apiVersion: string;
  ...
  add(path_593989, "quotaCounterKey", newJString(quotaCounterKey))
...
var quotaByCounterKeysUpdate* = Call_QuotaByCounterKeysUpdate_593961(
    name: "quotaByCounterKeysUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}",
    validator: validate_QuotaByCounterKeysUpdate_593962, base: "",
    url: url_QuotaByCounterKeysUpdate_593963, schemes: {Scheme.Https})
type
  Call_QuotaByPeriodKeysGet_593992 = ref object of OpenApiRestCall_593424
proc url_QuotaByPeriodKeysGet_593994(protocol: Scheme; host: string; base: string;
...
proc validate_QuotaByPeriodKeysGet_593993(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `quotaCounterKey` field"
  var valid_593995 = path.getOrDefault("quotaCounterKey")
  valid_593995 = validateParameter(valid_593995, JString, required = true,
                                 default = nil)
  if valid_593995 != nil:
    section.add "quotaCounterKey", valid_593995
  var valid_593996 = path.getOrDefault("resourceGroupName")
  valid_593996 = validateParameter(valid_593996, JString, required = true,
                                 default = nil)
  if valid_593996 != nil:
    section.add "resourceGroupName", valid_593996
  var valid_593997 = path.getOrDefault("quotaPeriodKey")
  valid_593997 = validateParameter(valid_593997, JString, required = true,
                                 default = nil)
  if valid_593997 != nil:
    section.add "quotaPeriodKey", valid_593997
...
proc call*(call_594001: Call_QuotaByPeriodKeysGet_593992; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the value of the quota counter associated with the counter-key in the policy for the specific period in service instance.
  ## 
  ## Document describing how to configure the quota policies.
...
proc call*(call_594002: Call_QuotaByPeriodKeysGet_593992; quotaCounterKey: string;
  ...
  add(path_594003, "quotaCounterKey", newJString(quotaCounterKey))
  add(path_594003, "resourceGroupName", newJString(resourceGroupName))
  add(query_594004, "api-version", newJString(apiVersion))
  add(path_594003, "quotaPeriodKey", newJString(quotaPeriodKey))
...
var quotaByPeriodKeysGet* = Call_QuotaByPeriodKeysGet_593992(
    ...
    validator: validate_QuotaByPeriodKeysGet_593993, base: "",
    url: url_QuotaByPeriodKeysGet_593994, schemes: {Scheme.Https})
type
  Call_QuotaByPeriodKeysUpdate_594005 = ref object of OpenApiRestCall_593424
proc url_QuotaByPeriodKeysUpdate_594007(protocol: Scheme; host: string; base: string;
...
proc validate_QuotaByPeriodKeysUpdate_594006(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `quotaCounterKey` field"
  var valid_594008 = path.getOrDefault("quotaCounterKey")
  valid_594008 = validateParameter(valid_594008, JString, required = true,
                                 default = nil)
  if valid_594008 != nil:
    section.add "quotaCounterKey", valid_594008
  var valid_594009 = path.getOrDefault("resourceGroupName")
  valid_594009 = validateParameter(valid_594009, JString, required = true,
                                 default = nil)
  if valid_594009 != nil:
    section.add "resourceGroupName", valid_594009
  var valid_594010 = path.getOrDefault("quotaPeriodKey")
  valid_594010 = validateParameter(valid_594010, JString, required = true,
                                 default = nil)
  if valid_594010 != nil:
    section.add "quotaPeriodKey", valid_594010
...
proc call*(call_594015: Call_QuotaByPeriodKeysUpdate_594005; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing quota counter value in the specified service instance.
  ## 
...
proc call*(call_594016: Call_QuotaByPeriodKeysUpdate_594005;
          quotaCounterKey: string; resourceGroupName: string; apiVersion: string;
  ...
  add(path_594017, "quotaCounterKey", newJString(quotaCounterKey))
  add(path_594017, "resourceGroupName", newJString(resourceGroupName))
  add(query_594018, "api-version", newJString(apiVersion))
  add(path_594017, "quotaPeriodKey", newJString(quotaPeriodKey))
...
var quotaByPeriodKeysUpdate* = Call_QuotaByPeriodKeysUpdate_594005(
    name: "quotaByPeriodKeysUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}",
    validator: validate_QuotaByPeriodKeysUpdate_594006, base: "",
    url: url_QuotaByPeriodKeysUpdate_594007, schemes: {Scheme.Https})
export
  rest
