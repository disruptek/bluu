...
type
  Call_NetworkInterfacesListAll_563761 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesListAll_563763(protocol: Scheme; host: string;
...
proc validate_NetworkInterfacesListAll_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563962: Call_NetworkInterfacesListAll_563761; path: JsonNode;
...
proc call*(call_564033: Call_NetworkInterfacesListAll_563761; apiVersion: string;
...
var networkInterfacesListAll* = Call_NetworkInterfacesListAll_563761(
    ...
    validator: validate_NetworkInterfacesListAll_563762, base: "",
    url: url_NetworkInterfacesListAll_563763, schemes: {Scheme.Https})
type
  Call_NetworkInterfacesList_564075 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesList_564077(protocol: Scheme; host: string; base: string;
...
proc validate_NetworkInterfacesList_564076(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564081: Call_NetworkInterfacesList_564075; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all network interfaces in a resource group.
  ## 
...
proc call*(call_564082: Call_NetworkInterfacesList_564075; apiVersion: string;
...
var networkInterfacesList* = Call_NetworkInterfacesList_564075(
    ...
    validator: validate_NetworkInterfacesList_564076, base: "",
    url: url_NetworkInterfacesList_564077, schemes: {Scheme.Https})
type
  Call_NetworkInterfacesCreateOrUpdate_564098 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesCreateOrUpdate_564100(protocol: Scheme; host: string;
...
proc validate_NetworkInterfacesCreateOrUpdate_564099(path: JsonNode;
  ...
  var valid_564118 = path.getOrDefault("networkInterfaceName")
  valid_564118 = validateParameter(valid_564118, JString, required = true,
                                 default = nil)
  if valid_564118 != nil:
    section.add "networkInterfaceName", valid_564118
...
proc call*(call_564123: Call_NetworkInterfacesCreateOrUpdate_564098;
...
proc call*(call_564124: Call_NetworkInterfacesCreateOrUpdate_564098;
  ...
  add(path_564125, "networkInterfaceName", newJString(networkInterfaceName))
...
var networkInterfacesCreateOrUpdate* = Call_NetworkInterfacesCreateOrUpdate_564098(
    ...
    validator: validate_NetworkInterfacesCreateOrUpdate_564099, base: "",
    url: url_NetworkInterfacesCreateOrUpdate_564100, schemes: {Scheme.Https})
type
  Call_NetworkInterfacesGet_564085 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesGet_564087(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkInterfacesGet_564086(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `networkInterfaceName` field"
  var valid_564089 = path.getOrDefault("networkInterfaceName")
  valid_564089 = validateParameter(valid_564089, JString, required = true,
                                 default = nil)
  if valid_564089 != nil:
    section.add "networkInterfaceName", valid_564089
...
proc call*(call_564094: Call_NetworkInterfacesGet_564085; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about the specified network interface.
  ## 
...
proc call*(call_564095: Call_NetworkInterfacesGet_564085; apiVersion: string;
  ...
  add(path_564096, "networkInterfaceName", newJString(networkInterfaceName))
...
var networkInterfacesGet* = Call_NetworkInterfacesGet_564085(
    name: "networkInterfacesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}",
    validator: validate_NetworkInterfacesGet_564086, base: "",
    url: url_NetworkInterfacesGet_564087, schemes: {Scheme.Https})
type
  Call_NetworkInterfacesDelete_564128 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesDelete_564130(protocol: Scheme; host: string; base: string;
...
proc validate_NetworkInterfacesDelete_564129(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `networkInterfaceName` field"
  var valid_564131 = path.getOrDefault("networkInterfaceName")
  valid_564131 = validateParameter(valid_564131, JString, required = true,
                                 default = nil)
  if valid_564131 != nil:
    section.add "networkInterfaceName", valid_564131
...
proc call*(call_564135: Call_NetworkInterfacesDelete_564128; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified network interface.
  ## 
...
proc call*(call_564136: Call_NetworkInterfacesDelete_564128; apiVersion: string;
          networkInterfaceName: string; subscriptionId: string;
  ...
  add(path_564137, "networkInterfaceName", newJString(networkInterfaceName))
...
var networkInterfacesDelete* = Call_NetworkInterfacesDelete_564128(
    name: "networkInterfacesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}",
    validator: validate_NetworkInterfacesDelete_564129, base: "",
    url: url_NetworkInterfacesDelete_564130, schemes: {Scheme.Https})
type
  Call_NetworkInterfacesListEffectiveNetworkSecurityGroups_564139 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesListEffectiveNetworkSecurityGroups_564141(
...
proc validate_NetworkInterfacesListEffectiveNetworkSecurityGroups_564140(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `networkInterfaceName` field"
  var valid_564142 = path.getOrDefault("networkInterfaceName")
  valid_564142 = validateParameter(valid_564142, JString, required = true,
                                 default = nil)
  if valid_564142 != nil:
    section.add "networkInterfaceName", valid_564142
...
proc call*(call_564146: Call_NetworkInterfacesListEffectiveNetworkSecurityGroups_564139;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all network security groups applied to a network interface.
  ## 
...
proc call*(call_564147: Call_NetworkInterfacesListEffectiveNetworkSecurityGroups_564139;
          apiVersion: string; networkInterfaceName: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564148, "networkInterfaceName", newJString(networkInterfaceName))
...
var networkInterfacesListEffectiveNetworkSecurityGroups* = Call_NetworkInterfacesListEffectiveNetworkSecurityGroups_564139(
    ...
    validator: validate_NetworkInterfacesListEffectiveNetworkSecurityGroups_564140,
    base: "", url: url_NetworkInterfacesListEffectiveNetworkSecurityGroups_564141,
    schemes: {Scheme.Https})
type
  Call_NetworkInterfacesGetEffectiveRouteTable_564150 = ref object of OpenApiRestCall_563539
proc url_NetworkInterfacesGetEffectiveRouteTable_564152(protocol: Scheme;
...
proc validate_NetworkInterfacesGetEffectiveRouteTable_564151(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `networkInterfaceName` field"
  var valid_564153 = path.getOrDefault("networkInterfaceName")
  valid_564153 = validateParameter(valid_564153, JString, required = true,
                                 default = nil)
  if valid_564153 != nil:
    section.add "networkInterfaceName", valid_564153
...
proc call*(call_564157: Call_NetworkInterfacesGetEffectiveRouteTable_564150;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all route tables applied to a network interface.
  ## 
...
proc call*(call_564158: Call_NetworkInterfacesGetEffectiveRouteTable_564150;
          apiVersion: string; networkInterfaceName: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564159, "networkInterfaceName", newJString(networkInterfaceName))
...
var networkInterfacesGetEffectiveRouteTable* = Call_NetworkInterfacesGetEffectiveRouteTable_564150(
    ...
    validator: validate_NetworkInterfacesGetEffectiveRouteTable_564151, base: "",
    url: url_NetworkInterfacesGetEffectiveRouteTable_564152,
    schemes: {Scheme.Https})
export
  rest
