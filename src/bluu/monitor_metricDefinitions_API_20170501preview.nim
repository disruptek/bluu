...
proc call*(call_593830: Call_MetricDefinitionsList_593631; path: JsonNode;
...
proc call*(call_593901: Call_MetricDefinitionsList_593631; apiVersion: string;
  ...
  add(path_593902, "resourceUri", newJString(resourceUri))
