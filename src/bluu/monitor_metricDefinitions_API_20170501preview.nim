...
proc call*(call_563963: Call_MetricDefinitionsList_563762; path: JsonNode;
...
proc call*(call_564034: Call_MetricDefinitionsList_563762; apiVersion: string;
  ...
  add(path_564035, "resourceUri", newJString(resourceUri))
