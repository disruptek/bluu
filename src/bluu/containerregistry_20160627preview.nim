...
type
  Call_RegistriesCheckNameAvailability_593630 = ref object of OpenApiRestCall_593408
proc url_RegistriesCheckNameAvailability_593632(protocol: Scheme; host: string;
...
proc validate_RegistriesCheckNameAvailability_593631(path: JsonNode;
...
proc call*(call_593847: Call_RegistriesCheckNameAvailability_593630;
...
proc call*(call_593918: Call_RegistriesCheckNameAvailability_593630;
  ...
  if registryNameCheckRequest != nil:
    body_593922 = registryNameCheckRequest
  result = call_593918.call(path_593919, query_593921, nil, nil, body_593922)

var registriesCheckNameAvailability* = Call_RegistriesCheckNameAvailability_593630(
    ...
    validator: validate_RegistriesCheckNameAvailability_593631, base: "",
    url: url_RegistriesCheckNameAvailability_593632, schemes: {Scheme.Https})
type
  Call_RegistriesList_593961 = ref object of OpenApiRestCall_593408
proc url_RegistriesList_593963(protocol: Scheme; host: string; base: string;
...
proc validate_RegistriesList_593962(path: JsonNode; query: JsonNode;
...
proc call*(call_593966: Call_RegistriesList_593961; path: JsonNode; query: JsonNode;
...
proc call*(call_593967: Call_RegistriesList_593961; apiVersion: string;
...
var registriesList* = Call_RegistriesList_593961(name: "registriesList",
    ...
    validator: validate_RegistriesList_593962, base: "", url: url_RegistriesList_593963,
    schemes: {Scheme.Https})
type
  Call_RegistriesListByResourceGroup_593970 = ref object of OpenApiRestCall_593408
proc url_RegistriesListByResourceGroup_593972(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegistriesListByResourceGroup_593971(path: JsonNode; query: JsonNode;
...
proc call*(call_593976: Call_RegistriesListByResourceGroup_593970; path: JsonNode;
...
proc call*(call_593977: Call_RegistriesListByResourceGroup_593970;
...
var registriesListByResourceGroup* = Call_RegistriesListByResourceGroup_593970(
    ...
    validator: validate_RegistriesListByResourceGroup_593971, base: "",
    url: url_RegistriesListByResourceGroup_593972, schemes: {Scheme.Https})
type
  Call_RegistriesCreateOrUpdate_593991 = ref object of OpenApiRestCall_593408
proc url_RegistriesCreateOrUpdate_593993(protocol: Scheme; host: string;
...
proc validate_RegistriesCreateOrUpdate_593992(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593996 = path.getOrDefault("registryName")
  valid_593996 = validateParameter(valid_593996, JString, required = true,
                                 default = nil)
  if valid_593996 != nil:
    section.add "registryName", valid_593996
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_593999: Call_RegistriesCreateOrUpdate_593991; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a container registry with the specified parameters.
  ## 
...
proc call*(call_594000: Call_RegistriesCreateOrUpdate_593991;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          registry: JsonNode; registryName: string): Recallable =
  ...
  if registry != nil:
    body_594003 = registry
  add(path_594001, "registryName", newJString(registryName))
  result = call_594000.call(path_594001, query_594002, nil, nil, body_594003)

var registriesCreateOrUpdate* = Call_RegistriesCreateOrUpdate_593991(
    name: "registriesCreateOrUpdate", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}",
    validator: validate_RegistriesCreateOrUpdate_593992, base: "",
    url: url_RegistriesCreateOrUpdate_593993, schemes: {Scheme.Https})
type
  Call_RegistriesGetProperties_593980 = ref object of OpenApiRestCall_593408
proc url_RegistriesGetProperties_593982(protocol: Scheme; host: string; base: string;
...
proc validate_RegistriesGetProperties_593981(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593985 = path.getOrDefault("registryName")
  valid_593985 = validateParameter(valid_593985, JString, required = true,
                                 default = nil)
  if valid_593985 != nil:
    section.add "registryName", valid_593985
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_593987: Call_RegistriesGetProperties_593980; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties of the specified container registry.
  ## 
...
proc call*(call_593988: Call_RegistriesGetProperties_593980;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          registryName: string): Recallable =
  ## registriesGetProperties
  ## Gets the properties of the specified container registry.
  ##   resourceGroupName: string (required)
  ##                    : The name of the resource group to which the container registry belongs.
  ##   apiVersion: string (required)
  ...
  add(path_593989, "registryName", newJString(registryName))
  result = call_593988.call(path_593989, query_593990, nil, nil, nil)

var registriesGetProperties* = Call_RegistriesGetProperties_593980(
    name: "registriesGetProperties", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}",
    validator: validate_RegistriesGetProperties_593981, base: "",
    url: url_RegistriesGetProperties_593982, schemes: {Scheme.Https})
type
  Call_RegistriesUpdate_594015 = ref object of OpenApiRestCall_593408
proc url_RegistriesUpdate_594017(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegistriesUpdate_594016(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_594023: Call_RegistriesUpdate_594015; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a container registry with the specified parameters.
  ## 
...
proc call*(call_594024: Call_RegistriesUpdate_594015; resourceGroupName: string;
  ...
  if registryUpdateParameters != nil:
    body_594027 = registryUpdateParameters
...
var registriesUpdate* = Call_RegistriesUpdate_594015(name: "registriesUpdate",
    ...
    validator: validate_RegistriesUpdate_594016, base: "",
    url: url_RegistriesUpdate_594017, schemes: {Scheme.Https})
type
  Call_RegistriesDelete_594004 = ref object of OpenApiRestCall_593408
proc url_RegistriesDelete_594006(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegistriesDelete_594005(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_594009 = path.getOrDefault("registryName")
  valid_594009 = validateParameter(valid_594009, JString, required = true,
                                 default = nil)
  if valid_594009 != nil:
    section.add "registryName", valid_594009
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594011: Call_RegistriesDelete_594004; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a container registry.
  ## 
...
proc call*(call_594012: Call_RegistriesDelete_594004; resourceGroupName: string;
  ...
  add(path_594013, "registryName", newJString(registryName))
  result = call_594012.call(path_594013, query_594014, nil, nil, nil)

var registriesDelete* = Call_RegistriesDelete_594004(name: "registriesDelete",
    ...
    validator: validate_RegistriesDelete_594005, base: "",
    url: url_RegistriesDelete_594006, schemes: {Scheme.Https})
type
  Call_RegistriesGetCredentials_594028 = ref object of OpenApiRestCall_593408
proc url_RegistriesGetCredentials_594030(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.ContainerRegistry/registries/"),
               (kind: VariableSegment, value: "registryName"),
               (kind: ConstantSegment, value: "/getCredentials")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_RegistriesGetCredentials_594029(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594033 = path.getOrDefault("registryName")
  valid_594033 = validateParameter(valid_594033, JString, required = true,
                                 default = nil)
  if valid_594033 != nil:
    section.add "registryName", valid_594033
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594035: Call_RegistriesGetCredentials_594028; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the administrator login credentials for the specified container registry.
  ## 
...
proc call*(call_594036: Call_RegistriesGetCredentials_594028;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          registryName: string): Recallable =
  ## registriesGetCredentials
  ## Gets the administrator login credentials for the specified container registry.
  ##   resourceGroupName: string (required)
  ##                    : The name of the resource group to which the container registry belongs.
  ##   apiVersion: string (required)
...
var registriesGetCredentials* = Call_RegistriesGetCredentials_594028(
    name: "registriesGetCredentials", meth: HttpMethod.HttpPost,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/getCredentials",
    validator: validate_RegistriesGetCredentials_594029, base: "",
    url: url_RegistriesGetCredentials_594030, schemes: {Scheme.Https})
type
  Call_RegistriesRegenerateCredentials_594039 = ref object of OpenApiRestCall_593408
proc url_RegistriesRegenerateCredentials_594041(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.ContainerRegistry/registries/"),
               (kind: VariableSegment, value: "registryName"),
               (kind: ConstantSegment, value: "/regenerateCredentials")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_RegistriesRegenerateCredentials_594040(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594044 = path.getOrDefault("registryName")
  valid_594044 = validateParameter(valid_594044, JString, required = true,
                                 default = nil)
  if valid_594044 != nil:
    section.add "registryName", valid_594044
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594046: Call_RegistriesRegenerateCredentials_594039;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Regenerates the administrator login credentials for the specified container registry.
  ## 
...
proc call*(call_594047: Call_RegistriesRegenerateCredentials_594039;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          registryName: string): Recallable =
  ## registriesRegenerateCredentials
  ## Regenerates the administrator login credentials for the specified container registry.
  ##   resourceGroupName: string (required)
  ##                    : The name of the resource group to which the container registry belongs.
  ##   apiVersion: string (required)
...
var registriesRegenerateCredentials* = Call_RegistriesRegenerateCredentials_594039(
    name: "registriesRegenerateCredentials", meth: HttpMethod.HttpPost,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/regenerateCredentials",
    validator: validate_RegistriesRegenerateCredentials_594040, base: "",
    url: url_RegistriesRegenerateCredentials_594041, schemes: {Scheme.Https})
export
  rest
