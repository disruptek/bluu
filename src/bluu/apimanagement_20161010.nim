...
type
  Call_PolicySnippetsListByService_563778 = ref object of OpenApiRestCall_563556
proc url_PolicySnippetsListByService_563780(protocol: Scheme; host: string;
...
proc validate_PolicySnippetsListByService_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563995: Call_PolicySnippetsListByService_563778; path: JsonNode;
...
proc call*(call_564066: Call_PolicySnippetsListByService_563778;
  ...
  add(path_564067, "serviceName", newJString(serviceName))
  add(query_564069, "scope", newJString(scope))
...
var policySnippetsListByService* = Call_PolicySnippetsListByService_563778(
    ...
    validator: validate_PolicySnippetsListByService_563779, base: "",
    url: url_PolicySnippetsListByService_563780, schemes: {Scheme.Https})
type
  Call_RegionsListByService_564108 = ref object of OpenApiRestCall_563556
proc url_RegionsListByService_564110(protocol: Scheme; host: string; base: string;
...
proc validate_RegionsListByService_564109(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564115: Call_RegionsListByService_564108; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all azure regions in which the service exists.
  ## 
...
proc call*(call_564116: Call_RegionsListByService_564108; serviceName: string;
...
var regionsListByService* = Call_RegionsListByService_564108(
    ...
    validator: validate_RegionsListByService_564109, base: "",
    url: url_RegionsListByService_564110, schemes: {Scheme.Https})
export
  rest
