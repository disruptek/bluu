...
type
  Call_PolicySnippetsListByService_593647 = ref object of OpenApiRestCall_593425
proc url_PolicySnippetsListByService_593649(protocol: Scheme; host: string;
...
proc validate_PolicySnippetsListByService_593648(path: JsonNode; query: JsonNode;
  ...
  var valid_593839 = query.getOrDefault("scope")
  valid_593839 = validateParameter(valid_593839, JString, required = false,
                                 default = newJString("Tenant"))
  if valid_593839 != nil:
    section.add "scope", valid_593839
...
proc call*(call_593862: Call_PolicySnippetsListByService_593647; path: JsonNode;
...
proc call*(call_593933: Call_PolicySnippetsListByService_593647;
  ...
  add(query_593936, "scope", newJString(scope))
  add(path_593934, "subscriptionId", newJString(subscriptionId))
  add(path_593934, "serviceName", newJString(serviceName))
  result = call_593933.call(path_593934, query_593936, nil, nil, nil)

var policySnippetsListByService* = Call_PolicySnippetsListByService_593647(
    ...
    validator: validate_PolicySnippetsListByService_593648, base: "",
    url: url_PolicySnippetsListByService_593649, schemes: {Scheme.Https})
type
  Call_RegionsListByService_593975 = ref object of OpenApiRestCall_593425
proc url_RegionsListByService_593977(protocol: Scheme; host: string; base: string;
...
proc validate_RegionsListByService_593976(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593982: Call_RegionsListByService_593975; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all azure regions in which the service exists.
  ## 
...
proc call*(call_593983: Call_RegionsListByService_593975;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var regionsListByService* = Call_RegionsListByService_593975(
    ...
    validator: validate_RegionsListByService_593976, base: "",
    url: url_RegionsListByService_593977, schemes: {Scheme.Https})
export
  rest
