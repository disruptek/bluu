...
type
  Call_StartContainerLaunchExec_564167 = ref object of OpenApiRestCall_563556
proc url_StartContainerLaunchExec_564169(protocol: Scheme; host: string;
...
proc validate_StartContainerLaunchExec_564168(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564176: Call_StartContainerLaunchExec_564167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts the exec command for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_564177: Call_StartContainerLaunchExec_564167; apiVersion: string;
...
var startContainerLaunchExec* = Call_StartContainerLaunchExec_564167(
    ...
    validator: validate_StartContainerLaunchExec_564168, base: "",
    url: url_StartContainerLaunchExec_564169, schemes: {Scheme.Https})
type
  Call_ContainerLogsList_564181 = ref object of OpenApiRestCall_563556
proc url_ContainerLogsList_564183(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerLogsList_564182(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_564190: Call_ContainerLogsList_564181; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the logs for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_564191: Call_ContainerLogsList_564181; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; containerName: string;
...
var containerLogsList* = Call_ContainerLogsList_564181(name: "containerLogsList",
    ...
    validator: validate_ContainerLogsList_564182, base: "",
    url: url_ContainerLogsList_564183, schemes: {Scheme.Https})
export
  rest
