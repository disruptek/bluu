...
type
  Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594306 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594308(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594307(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_594314: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594306;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## The Set VpnclientIpsecParameters operation sets the vpnclient ipsec policy for P2S client of virtual network gateway in the specified resource group through Network resource provider.
  ## 
...
proc call*(call_594315: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594306;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  if vpnclientIpsecParams != nil:
    body_594318 = vpnclientIpsecParams
  result = call_594315.call(path_594316, query_594317, nil, nil, body_594318)

var virtualNetworkGatewaysSetVpnclientIpsecParameters* = Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594306(
    ...
    validator: validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594307,
    base: "", url: url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_594308,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysSupportedVpnDevices_594319 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkGatewaysSupportedVpnDevices_594321(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysSupportedVpnDevices_594320(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594324 = path.getOrDefault("virtualNetworkGatewayName")
  valid_594324 = validateParameter(valid_594324, JString, required = true,
                                 default = nil)
  if valid_594324 != nil:
    section.add "virtualNetworkGatewayName", valid_594324
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594326: Call_VirtualNetworkGatewaysSupportedVpnDevices_594319;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a xml format representation for supported vpn devices.
  ## 
...
proc call*(call_594327: Call_VirtualNetworkGatewaysSupportedVpnDevices_594319;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkGatewayName: string): Recallable =
...
var virtualNetworkGatewaysSupportedVpnDevices* = Call_VirtualNetworkGatewaysSupportedVpnDevices_594319(
    ...
    validator: validate_VirtualNetworkGatewaysSupportedVpnDevices_594320,
    base: "", url: url_VirtualNetworkGatewaysSupportedVpnDevices_594321,
    schemes: {Scheme.Https})
export
  rest
