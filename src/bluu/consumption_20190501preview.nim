...
proc validate_UsageDetailsDownload_564329(path: JsonNode; query: JsonNode;
  ...
  var valid_564334 = query.getOrDefault("metric")
  valid_564334 = validateParameter(valid_564334, JString, required = false,
                                 default = newJString("actualcost"))
  if valid_564334 != nil:
    section.add "metric", valid_564334
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564335: Call_UsageDetailsDownload_564328; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Download usage details data.
  ## 
...
proc call*(call_564336: Call_UsageDetailsDownload_564328; apiVersion: string;
          scope: string; Filter: string = ""; metric: string = "actualcost"): Recallable =
  ...
  add(query_564338, "metric", newJString(metric))
  add(path_564337, "scope", newJString(scope))
