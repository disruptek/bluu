...
proc call*(call_594206: Call_UsageDetailsDownload_594199; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Download usage details data.
  ## 
...
proc call*(call_594207: Call_UsageDetailsDownload_594199; apiVersion: string;
  ...
  add(query_594209, "metric", newJString(metric))
