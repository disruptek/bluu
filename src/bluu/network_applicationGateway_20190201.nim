...
type
  Call_ApplicationGatewaysBackendHealthOnDemand_594123 = ref object of OpenApiRestCall_593437
proc url_ApplicationGatewaysBackendHealthOnDemand_594125(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationGatewaysBackendHealthOnDemand_594124(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594132: Call_ApplicationGatewaysBackendHealthOnDemand_594123;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the backend health for given combination of backend pool and http setting of the specified application gateway in a resource group.
  ## 
...
proc call*(call_594133: Call_ApplicationGatewaysBackendHealthOnDemand_594123;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(query_594135, "$expand", newJString(Expand))
  add(path_594134, "subscriptionId", newJString(subscriptionId))
  if probeRequest != nil:
    body_594136 = probeRequest
  add(path_594134, "applicationGatewayName", newJString(applicationGatewayName))
  result = call_594133.call(path_594134, query_594135, nil, nil, body_594136)

var applicationGatewaysBackendHealthOnDemand* = Call_ApplicationGatewaysBackendHealthOnDemand_594123(
    ...
    validator: validate_ApplicationGatewaysBackendHealthOnDemand_594124, base: "",
    url: url_ApplicationGatewaysBackendHealthOnDemand_594125,
    schemes: {Scheme.Https})
type
  Call_ApplicationGatewaysStart_594137 = ref object of OpenApiRestCall_593437
proc url_ApplicationGatewaysStart_594139(protocol: Scheme; host: string;
...
proc validate_ApplicationGatewaysStart_594138(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594142 = path.getOrDefault("applicationGatewayName")
  valid_594142 = validateParameter(valid_594142, JString, required = true,
                                 default = nil)
  if valid_594142 != nil:
    section.add "applicationGatewayName", valid_594142
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594144: Call_ApplicationGatewaysStart_594137; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts the specified application gateway.
  ## 
...
proc call*(call_594145: Call_ApplicationGatewaysStart_594137;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          applicationGatewayName: string): Recallable =
  ...
  add(path_594146, "applicationGatewayName", newJString(applicationGatewayName))
  result = call_594145.call(path_594146, query_594147, nil, nil, nil)

var applicationGatewaysStart* = Call_ApplicationGatewaysStart_594137(
    ...
    validator: validate_ApplicationGatewaysStart_594138, base: "",
    url: url_ApplicationGatewaysStart_594139, schemes: {Scheme.Https})
type
  Call_ApplicationGatewaysStop_594148 = ref object of OpenApiRestCall_593437
proc url_ApplicationGatewaysStop_594150(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ApplicationGatewaysStop_594149(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594153 = path.getOrDefault("applicationGatewayName")
  valid_594153 = validateParameter(valid_594153, JString, required = true,
                                 default = nil)
  if valid_594153 != nil:
    section.add "applicationGatewayName", valid_594153
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594155: Call_ApplicationGatewaysStop_594148; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops the specified application gateway in a resource group.
  ## 
...
proc call*(call_594156: Call_ApplicationGatewaysStop_594148;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          applicationGatewayName: string): Recallable =
  ...
  add(path_594157, "applicationGatewayName", newJString(applicationGatewayName))
  result = call_594156.call(path_594157, query_594158, nil, nil, nil)

var applicationGatewaysStop* = Call_ApplicationGatewaysStop_594148(
    ...
    validator: validate_ApplicationGatewaysStop_594149, base: "",
    url: url_ApplicationGatewaysStop_594150, schemes: {Scheme.Https})
export
  rest
