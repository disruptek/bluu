...
proc call*(call_563978: Call_NetworkSecurityGroupsListAll_563777; path: JsonNode;
...
proc call*(call_564049: Call_NetworkSecurityGroupsListAll_563777;
...
type
  Call_NetworkSecurityGroupsList_564091 = ref object of OpenApiRestCall_563555
proc url_NetworkSecurityGroupsList_564093(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkSecurityGroupsList_564092(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564097: Call_NetworkSecurityGroupsList_564091; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all network security groups in a resource group.
  ## 
...
proc call*(call_564098: Call_NetworkSecurityGroupsList_564091; apiVersion: string;
...
var networkSecurityGroupsList* = Call_NetworkSecurityGroupsList_564091(
    ...
    validator: validate_NetworkSecurityGroupsList_564092, base: "",
    url: url_NetworkSecurityGroupsList_564093, schemes: {Scheme.Https})
type
  Call_NetworkSecurityGroupsCreateOrUpdate_564114 = ref object of OpenApiRestCall_563555
proc url_NetworkSecurityGroupsCreateOrUpdate_564116(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkSecurityGroupsCreateOrUpdate_564115(path: JsonNode;
...
proc call*(call_564139: Call_NetworkSecurityGroupsCreateOrUpdate_564114;
...
proc call*(call_564140: Call_NetworkSecurityGroupsCreateOrUpdate_564114;
...
var networkSecurityGroupsCreateOrUpdate* = Call_NetworkSecurityGroupsCreateOrUpdate_564114(
    ...
    validator: validate_NetworkSecurityGroupsCreateOrUpdate_564115, base: "",
    url: url_NetworkSecurityGroupsCreateOrUpdate_564116, schemes: {Scheme.Https})
type
  Call_NetworkSecurityGroupsGet_564101 = ref object of OpenApiRestCall_563555
proc url_NetworkSecurityGroupsGet_564103(protocol: Scheme; host: string;
...
proc validate_NetworkSecurityGroupsGet_564102(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564107 = path.getOrDefault("networkSecurityGroupName")
  valid_564107 = validateParameter(valid_564107, JString, required = true,
                                 default = nil)
  if valid_564107 != nil:
    section.add "networkSecurityGroupName", valid_564107
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564110: Call_NetworkSecurityGroupsGet_564101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified network security group.
  ## 
...
proc call*(call_564111: Call_NetworkSecurityGroupsGet_564101; apiVersion: string;
  ...
  add(path_564112, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_564111.call(path_564112, query_564113, nil, nil, nil)

var networkSecurityGroupsGet* = Call_NetworkSecurityGroupsGet_564101(
    name: "networkSecurityGroupsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}",
    validator: validate_NetworkSecurityGroupsGet_564102, base: "",
    url: url_NetworkSecurityGroupsGet_564103, schemes: {Scheme.Https})
type
...
type
  Call_DefaultSecurityRulesList_564155 = ref object of OpenApiRestCall_563555
proc url_DefaultSecurityRulesList_564157(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_DefaultSecurityRulesList_564156(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564162: Call_DefaultSecurityRulesList_564155; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all default security rules in a network security group.
  ## 
...
proc call*(call_564163: Call_DefaultSecurityRulesList_564155; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          networkSecurityGroupName: string): Recallable =
  ...
  add(path_564164, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_564163.call(path_564164, query_564165, nil, nil, nil)

var defaultSecurityRulesList* = Call_DefaultSecurityRulesList_564155(
    ...
    validator: validate_DefaultSecurityRulesList_564156, base: "",
    url: url_DefaultSecurityRulesList_564157, schemes: {Scheme.Https})
type
  Call_DefaultSecurityRulesGet_564166 = ref object of OpenApiRestCall_563555
proc url_DefaultSecurityRulesGet_564168(protocol: Scheme; host: string; base: string;
...
proc validate_DefaultSecurityRulesGet_564167(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564169 = path.getOrDefault("defaultSecurityRuleName")
  valid_564169 = validateParameter(valid_564169, JString, required = true,
                                 default = nil)
  if valid_564169 != nil:
    section.add "defaultSecurityRuleName", valid_564169
  ...
  var valid_564172 = path.getOrDefault("networkSecurityGroupName")
  valid_564172 = validateParameter(valid_564172, JString, required = true,
                                 default = nil)
  if valid_564172 != nil:
    section.add "networkSecurityGroupName", valid_564172
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564174: Call_DefaultSecurityRulesGet_564166; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the specified default network security rule.
  ## 
...
proc call*(call_564175: Call_DefaultSecurityRulesGet_564166;
  ...
  add(path_564176, "defaultSecurityRuleName", newJString(defaultSecurityRuleName))
  ...
  add(path_564176, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_564175.call(path_564176, query_564177, nil, nil, nil)

var defaultSecurityRulesGet* = Call_DefaultSecurityRulesGet_564166(
    ...
    validator: validate_DefaultSecurityRulesGet_564167, base: "",
    url: url_DefaultSecurityRulesGet_564168, schemes: {Scheme.Https})
type
  Call_SecurityRulesList_564178 = ref object of OpenApiRestCall_563555
proc url_SecurityRulesList_564180(protocol: Scheme; host: string; base: string;
...
proc validate_SecurityRulesList_564179(path: JsonNode; query: JsonNode;
  ...
  var valid_564183 = path.getOrDefault("networkSecurityGroupName")
  valid_564183 = validateParameter(valid_564183, JString, required = true,
                                 default = nil)
  if valid_564183 != nil:
    section.add "networkSecurityGroupName", valid_564183
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564185: Call_SecurityRulesList_564178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all security rules in a network security group.
  ## 
...
proc call*(call_564186: Call_SecurityRulesList_564178; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          networkSecurityGroupName: string): Recallable =
  ## securityRulesList
  ## Gets all security rules in a network security group.
  ...
  add(path_564187, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_564186.call(path_564187, query_564188, nil, nil, nil)

var securityRulesList* = Call_SecurityRulesList_564178(name: "securityRulesList",
    ...
    validator: validate_SecurityRulesList_564179, base: "",
    url: url_SecurityRulesList_564180, schemes: {Scheme.Https})
type
  Call_SecurityRulesCreateOrUpdate_564201 = ref object of OpenApiRestCall_563555
proc url_SecurityRulesCreateOrUpdate_564203(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SecurityRulesCreateOrUpdate_564202(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564204 = path.getOrDefault("securityRuleName")
  valid_564204 = validateParameter(valid_564204, JString, required = true,
                                 default = nil)
  if valid_564204 != nil:
    section.add "securityRuleName", valid_564204
  ...
  var valid_564207 = path.getOrDefault("networkSecurityGroupName")
  valid_564207 = validateParameter(valid_564207, JString, required = true,
                                 default = nil)
  if valid_564207 != nil:
    section.add "networkSecurityGroupName", valid_564207
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564210: Call_SecurityRulesCreateOrUpdate_564201; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a security rule in the specified network security group.
  ## 
...
proc call*(call_564211: Call_SecurityRulesCreateOrUpdate_564201;
  ...
  if securityRuleParameters != nil:
    body_564214 = securityRuleParameters
...
var securityRulesCreateOrUpdate* = Call_SecurityRulesCreateOrUpdate_564201(
    ...
    validator: validate_SecurityRulesCreateOrUpdate_564202, base: "",
    url: url_SecurityRulesCreateOrUpdate_564203, schemes: {Scheme.Https})
type
  Call_SecurityRulesGet_564189 = ref object of OpenApiRestCall_563555
proc url_SecurityRulesGet_564191(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SecurityRulesGet_564190(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `securityRuleName` field"
  var valid_564192 = path.getOrDefault("securityRuleName")
  valid_564192 = validateParameter(valid_564192, JString, required = true,
                                 default = nil)
  if valid_564192 != nil:
    section.add "securityRuleName", valid_564192
  ...
  var valid_564195 = path.getOrDefault("networkSecurityGroupName")
  valid_564195 = validateParameter(valid_564195, JString, required = true,
                                 default = nil)
  if valid_564195 != nil:
    section.add "networkSecurityGroupName", valid_564195
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564197: Call_SecurityRulesGet_564189; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the specified network security rule.
  ## 
...
proc call*(call_564198: Call_SecurityRulesGet_564189; securityRuleName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          networkSecurityGroupName: string): Recallable =
  ## securityRulesGet
  ## Get the specified network security rule.
  ...
  add(path_564199, "securityRuleName", newJString(securityRuleName))
  ...
  add(path_564199, "networkSecurityGroupName",
      newJString(networkSecurityGroupName))
  result = call_564198.call(path_564199, query_564200, nil, nil, nil)

var securityRulesGet* = Call_SecurityRulesGet_564189(name: "securityRulesGet",
    ...
    validator: validate_SecurityRulesGet_564190, base: "",
    url: url_SecurityRulesGet_564191, schemes: {Scheme.Https})
type
  Call_SecurityRulesDelete_564215 = ref object of OpenApiRestCall_563555
proc url_SecurityRulesDelete_564217(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SecurityRulesDelete_564216(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `securityRuleName` field"
  var valid_564218 = path.getOrDefault("securityRuleName")
  valid_564218 = validateParameter(valid_564218, JString, required = true,
                                 default = nil)
  if valid_564218 != nil:
    section.add "securityRuleName", valid_564218
  ...
  var valid_564221 = path.getOrDefault("networkSecurityGroupName")
  valid_564221 = validateParameter(valid_564221, JString, required = true,
                                 default = nil)
  if valid_564221 != nil:
    section.add "networkSecurityGroupName", valid_564221
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564223: Call_SecurityRulesDelete_564215; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified network security rule.
  ## 
...
proc call*(call_564224: Call_SecurityRulesDelete_564215; securityRuleName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          networkSecurityGroupName: string): Recallable =
  ## securityRulesDelete
  ## Deletes the specified network security rule.
...
var securityRulesDelete* = Call_SecurityRulesDelete_564215(
    name: "securityRulesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}/securityRules/{securityRuleName}",
    validator: validate_SecurityRulesDelete_564216, base: "",
    url: url_SecurityRulesDelete_564217, schemes: {Scheme.Https})
export
  rest
