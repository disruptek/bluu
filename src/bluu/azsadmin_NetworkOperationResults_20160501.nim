...
type
  Call_NetworkOperationResultsList_574663 = ref object of OpenApiRestCall_574441
proc url_NetworkOperationResultsList_574665(protocol: Scheme; host: string;
...
proc validate_NetworkOperationResultsList_574664(path: JsonNode; query: JsonNode;
...
proc call*(call_574870: Call_NetworkOperationResultsList_574663; path: JsonNode;
...
proc call*(call_574941: Call_NetworkOperationResultsList_574663;
...
var networkOperationResultsList* = Call_NetworkOperationResultsList_574663(
    ...
    validator: validate_NetworkOperationResultsList_574664, base: "",
    url: url_NetworkOperationResultsList_574665, schemes: {Scheme.Https})
type
  Call_NetworkOperationResultsGet_574983 = ref object of OpenApiRestCall_574441
proc url_NetworkOperationResultsGet_574985(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkOperationResultsGet_574984(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_575000: Call_NetworkOperationResultsGet_574983; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of a network operation.
  ## 
...
proc call*(call_575001: Call_NetworkOperationResultsGet_574983;
...
var networkOperationResultsGet* = Call_NetworkOperationResultsGet_574983(
    ...
    validator: validate_NetworkOperationResultsGet_574984, base: "",
    url: url_NetworkOperationResultsGet_574985, schemes: {Scheme.Https})
export
  rest
