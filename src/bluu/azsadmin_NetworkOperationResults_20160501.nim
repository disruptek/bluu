...
const
  macServiceName = "azsadmin-NetworkOperationResults"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_NetworkOperationResultsList_563761 = ref object of OpenApiRestCall_563539
proc url_NetworkOperationResultsList_563763(protocol: Scheme; host: string;
...
proc validate_NetworkOperationResultsList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563970: Call_NetworkOperationResultsList_563761; path: JsonNode;
...
proc call*(call_564041: Call_NetworkOperationResultsList_563761;
...
var networkOperationResultsList* = Call_NetworkOperationResultsList_563761(
    name: "networkOperationResultsList", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/networkOperationResults",
    validator: validate_NetworkOperationResultsList_563762, base: "",
    url: url_NetworkOperationResultsList_563763, schemes: {Scheme.Https})
type
  Call_NetworkOperationResultsGet_564083 = ref object of OpenApiRestCall_563539
proc url_NetworkOperationResultsGet_564085(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkOperationResultsGet_564084(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564095 = path.getOrDefault("operation")
  valid_564095 = validateParameter(valid_564095, JString, required = true,
                                 default = nil)
  if valid_564095 != nil:
    section.add "operation", valid_564095
...
proc call*(call_564100: Call_NetworkOperationResultsGet_564083; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of a network operation.
  ## 
...
proc call*(call_564101: Call_NetworkOperationResultsGet_564083; operation: string;
          subscriptionId: string; location: string; resourceGroupName: string;
  ...
  add(path_564102, "operation", newJString(operation))
...
var networkOperationResultsGet* = Call_NetworkOperationResultsGet_564083(
    name: "networkOperationResultsGet", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/networkOperationResults/{operation}",
    validator: validate_NetworkOperationResultsGet_564084, base: "",
    url: url_NetworkOperationResultsGet_564085, schemes: {Scheme.Https})
export
  rest
