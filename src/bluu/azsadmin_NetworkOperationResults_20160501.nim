...
type
  Call_NetworkOperationResultsList_593630 = ref object of OpenApiRestCall_593408
proc url_NetworkOperationResultsList_593632(protocol: Scheme; host: string;
...
proc validate_NetworkOperationResultsList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593837: Call_NetworkOperationResultsList_593630; path: JsonNode;
...
proc call*(call_593908: Call_NetworkOperationResultsList_593630;
...
var networkOperationResultsList* = Call_NetworkOperationResultsList_593630(
    ...
    validator: validate_NetworkOperationResultsList_593631, base: "",
    url: url_NetworkOperationResultsList_593632, schemes: {Scheme.Https})
type
  Call_NetworkOperationResultsGet_593950 = ref object of OpenApiRestCall_593408
proc url_NetworkOperationResultsGet_593952(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_NetworkOperationResultsGet_593951(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593967: Call_NetworkOperationResultsGet_593950; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the status of a network operation.
  ## 
...
proc call*(call_593968: Call_NetworkOperationResultsGet_593950;
...
var networkOperationResultsGet* = Call_NetworkOperationResultsGet_593950(
    ...
    validator: validate_NetworkOperationResultsGet_593951, base: "",
    url: url_NetworkOperationResultsGet_593952, schemes: {Scheme.Https})
export
  rest
