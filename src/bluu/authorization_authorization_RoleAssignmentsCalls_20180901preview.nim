...
proc validate_RoleAssignmentsCreateById_564113(path: JsonNode; query: JsonNode;
  ...
  var valid_564132 = path.getOrDefault("roleId")
  valid_564132 = validateParameter(valid_564132, JString, required = true,
                                 default = nil)
  if valid_564132 != nil:
    section.add "roleId", valid_564132
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564136: Call_RoleAssignmentsCreateById_564112; apiVersion: string;
  ...
  add(path_564137, "roleId", newJString(roleId))
...
proc validate_RoleAssignmentsGetById_564104(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `roleId` field"
  var valid_564106 = path.getOrDefault("roleId")
  valid_564106 = validateParameter(valid_564106, JString, required = true,
                                 default = nil)
  if valid_564106 != nil:
    section.add "roleId", valid_564106
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564109: Call_RoleAssignmentsGetById_564103; apiVersion: string;
  ...
  add(path_564110, "roleId", newJString(roleId))
...
proc validate_RoleAssignmentsDeleteById_564141(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `roleId` field"
  var valid_564143 = path.getOrDefault("roleId")
  valid_564143 = validateParameter(valid_564143, JString, required = true,
                                 default = nil)
  if valid_564143 != nil:
    section.add "roleId", valid_564143
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564146: Call_RoleAssignmentsDeleteById_564140; apiVersion: string;
  ...
  add(path_564147, "roleId", newJString(roleId))
