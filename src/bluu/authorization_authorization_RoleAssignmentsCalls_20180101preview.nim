...
proc validate_RoleAssignmentsCreateById_593980(path: JsonNode; query: JsonNode;
  ...
  var valid_593999 = path.getOrDefault("roleId")
  valid_593999 = validateParameter(valid_593999, JString, required = true,
                                 default = nil)
  if valid_593999 != nil:
    section.add "roleId", valid_593999
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594003: Call_RoleAssignmentsCreateById_593979; apiVersion: string;
  ...
  add(path_594004, "roleId", newJString(roleId))
  if parameters != nil:
...
proc validate_RoleAssignmentsGetById_593971(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `roleId` field"
  var valid_593973 = path.getOrDefault("roleId")
  valid_593973 = validateParameter(valid_593973, JString, required = true,
                                 default = nil)
  if valid_593973 != nil:
    section.add "roleId", valid_593973
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_593976: Call_RoleAssignmentsGetById_593970; apiVersion: string;
  ...
  add(path_593977, "roleId", newJString(roleId))
...
proc validate_RoleAssignmentsDeleteById_594008(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `roleId` field"
  var valid_594010 = path.getOrDefault("roleId")
  valid_594010 = validateParameter(valid_594010, JString, required = true,
                                 default = nil)
  if valid_594010 != nil:
    section.add "roleId", valid_594010
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594013: Call_RoleAssignmentsDeleteById_594007; apiVersion: string;
  ...
  add(path_594014, "roleId", newJString(roleId))
