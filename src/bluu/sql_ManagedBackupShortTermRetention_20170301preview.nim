...
type
  Call_ManagedBackupShortTermRetentionPoliciesListByDatabase_593646 = ref object of OpenApiRestCall_593424
proc url_ManagedBackupShortTermRetentionPoliciesListByDatabase_593648(
...
proc validate_ManagedBackupShortTermRetentionPoliciesListByDatabase_593647(
...
proc call*(call_593848: Call_ManagedBackupShortTermRetentionPoliciesListByDatabase_593646;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_593919: Call_ManagedBackupShortTermRetentionPoliciesListByDatabase_593646;
...
var managedBackupShortTermRetentionPoliciesListByDatabase* = Call_ManagedBackupShortTermRetentionPoliciesListByDatabase_593646(
    ...
    validator: validate_ManagedBackupShortTermRetentionPoliciesListByDatabase_593647,
    base: "", url: url_ManagedBackupShortTermRetentionPoliciesListByDatabase_593648,
    schemes: {Scheme.Https})
type
  Call_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593987 = ref object of OpenApiRestCall_593424
proc url_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593989(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593988(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_593997: Call_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593987;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates a managed database's short term retention policy.
  ## 
...
proc call*(call_593998: Call_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593987;
          resourceGroupName: string; apiVersion: string;
...
var managedBackupShortTermRetentionPoliciesCreateOrUpdate* = Call_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593987(
    ...
    validator: validate_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593988,
    base: "", url: url_ManagedBackupShortTermRetentionPoliciesCreateOrUpdate_593989,
    schemes: {Scheme.Https})
type
  Call_ManagedBackupShortTermRetentionPoliciesGet_593961 = ref object of OpenApiRestCall_593424
proc url_ManagedBackupShortTermRetentionPoliciesGet_593963(protocol: Scheme;
...
proc validate_ManagedBackupShortTermRetentionPoliciesGet_593962(path: JsonNode;
...
proc call*(call_593983: Call_ManagedBackupShortTermRetentionPoliciesGet_593961;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a managed database's short term retention policy.
  ## 
...
proc call*(call_593984: Call_ManagedBackupShortTermRetentionPoliciesGet_593961;
          resourceGroupName: string; apiVersion: string;
          managedInstanceName: string; subscriptionId: string; databaseName: string;
...
var managedBackupShortTermRetentionPoliciesGet* = Call_ManagedBackupShortTermRetentionPoliciesGet_593961(
    ...
    validator: validate_ManagedBackupShortTermRetentionPoliciesGet_593962,
    base: "", url: url_ManagedBackupShortTermRetentionPoliciesGet_593963,
    schemes: {Scheme.Https})
type
  Call_ManagedBackupShortTermRetentionPoliciesUpdate_594002 = ref object of OpenApiRestCall_593424
proc url_ManagedBackupShortTermRetentionPoliciesUpdate_594004(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedBackupShortTermRetentionPoliciesUpdate_594003(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ## Updates a managed database's short term retention policy.
  ## 
...
proc call*(call_594012: Call_ManagedBackupShortTermRetentionPoliciesUpdate_594002;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates a managed database's short term retention policy.
  ## 
...
proc call*(call_594013: Call_ManagedBackupShortTermRetentionPoliciesUpdate_594002;
          resourceGroupName: string; apiVersion: string;
          managedInstanceName: string; subscriptionId: string; databaseName: string;
          parameters: JsonNode; policyName: string = "default"): Recallable =
...
var managedBackupShortTermRetentionPoliciesUpdate* = Call_ManagedBackupShortTermRetentionPoliciesUpdate_594002(
    ...
    validator: validate_ManagedBackupShortTermRetentionPoliciesUpdate_594003,
    base: "", url: url_ManagedBackupShortTermRetentionPoliciesUpdate_594004,
    schemes: {Scheme.Https})
export
  rest
