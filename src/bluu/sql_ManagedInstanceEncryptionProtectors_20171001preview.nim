...
type
  Call_ManagedInstanceEncryptionProtectorsListByInstance_563761 = ref object of OpenApiRestCall_563539
proc url_ManagedInstanceEncryptionProtectorsListByInstance_563763(
...
proc validate_ManagedInstanceEncryptionProtectorsListByInstance_563762(
...
proc call*(call_563964: Call_ManagedInstanceEncryptionProtectorsListByInstance_563761;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_564035: Call_ManagedInstanceEncryptionProtectorsListByInstance_563761;
...
var managedInstanceEncryptionProtectorsListByInstance* = Call_ManagedInstanceEncryptionProtectorsListByInstance_563761(
    ...
    validator: validate_ManagedInstanceEncryptionProtectorsListByInstance_563762,
    base: "", url: url_ManagedInstanceEncryptionProtectorsListByInstance_563763,
    schemes: {Scheme.Https})
type
  Call_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564102 = ref object of OpenApiRestCall_563539
proc url_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564104(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564103(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_564107 = path.getOrDefault("encryptionProtectorName")
  valid_564107 = validateParameter(valid_564107, JString, required = true,
                                 default = newJString("current"))
  if valid_564107 != nil:
    section.add "encryptionProtectorName", valid_564107
  var valid_564108 = path.getOrDefault("managedInstanceName")
  valid_564108 = validateParameter(valid_564108, JString, required = true,
                                 default = nil)
  if valid_564108 != nil:
    section.add "managedInstanceName", valid_564108
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_564111: Call_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564102;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates an existing encryption protector.
  ## 
...
proc call*(call_564112: Call_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564102;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
...
var managedInstanceEncryptionProtectorsCreateOrUpdate* = Call_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564102(
    ...
    validator: validate_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564103,
    base: "", url: url_ManagedInstanceEncryptionProtectorsCreateOrUpdate_564104,
    schemes: {Scheme.Https})
type
  Call_ManagedInstanceEncryptionProtectorsGet_564077 = ref object of OpenApiRestCall_563539
proc url_ManagedInstanceEncryptionProtectorsGet_564079(protocol: Scheme;
...
proc validate_ManagedInstanceEncryptionProtectorsGet_564078(path: JsonNode;
  ...
  var valid_564095 = path.getOrDefault("encryptionProtectorName")
  valid_564095 = validateParameter(valid_564095, JString, required = true,
                                 default = newJString("current"))
  if valid_564095 != nil:
    section.add "encryptionProtectorName", valid_564095
  var valid_564096 = path.getOrDefault("managedInstanceName")
  valid_564096 = validateParameter(valid_564096, JString, required = true,
                                 default = nil)
  if valid_564096 != nil:
    section.add "managedInstanceName", valid_564096
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_564098: Call_ManagedInstanceEncryptionProtectorsGet_564077;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a managed instance encryption protector.
  ## 
...
proc call*(call_564099: Call_ManagedInstanceEncryptionProtectorsGet_564077;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          managedInstanceName: string; encryptionProtectorName: string = "current"): Recallable =
...
var managedInstanceEncryptionProtectorsGet* = Call_ManagedInstanceEncryptionProtectorsGet_564077(
    ...
    validator: validate_ManagedInstanceEncryptionProtectorsGet_564078, base: "",
    url: url_ManagedInstanceEncryptionProtectorsGet_564079,
    schemes: {Scheme.Https})
type
  Call_ManagedInstanceEncryptionProtectorsRevalidate_564116 = ref object of OpenApiRestCall_563539
proc url_ManagedInstanceEncryptionProtectorsRevalidate_564118(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedInstanceEncryptionProtectorsRevalidate_564117(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_564121 = path.getOrDefault("encryptionProtectorName")
  valid_564121 = validateParameter(valid_564121, JString, required = true,
                                 default = newJString("current"))
  if valid_564121 != nil:
    section.add "encryptionProtectorName", valid_564121
  var valid_564122 = path.getOrDefault("managedInstanceName")
  valid_564122 = validateParameter(valid_564122, JString, required = true,
                                 default = nil)
  if valid_564122 != nil:
    section.add "managedInstanceName", valid_564122
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_564124: Call_ManagedInstanceEncryptionProtectorsRevalidate_564116;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Revalidates an existing encryption protector.
  ## 
...
proc call*(call_564125: Call_ManagedInstanceEncryptionProtectorsRevalidate_564116;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          managedInstanceName: string; encryptionProtectorName: string = "current"): Recallable =
  ...
  add(path_564126, "managedInstanceName", newJString(managedInstanceName))
  result = call_564125.call(path_564126, query_564127, nil, nil, nil)

var managedInstanceEncryptionProtectorsRevalidate* = Call_ManagedInstanceEncryptionProtectorsRevalidate_564116(
    ...
    validator: validate_ManagedInstanceEncryptionProtectorsRevalidate_564117,
    base: "", url: url_ManagedInstanceEncryptionProtectorsRevalidate_564118,
    schemes: {Scheme.Https})
export
  rest
