...
type
  Call_ApiVersionSetListByService_593680 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetListByService_593682(protocol: Scheme; host: string;
...
proc validate_ApiVersionSetListByService_593681(path: JsonNode; query: JsonNode;
...
proc call*(call_593842: Call_ApiVersionSetListByService_593680; path: JsonNode;
...
proc call*(call_593913: Call_ApiVersionSetListByService_593680;
...
var apiVersionSetListByService* = Call_ApiVersionSetListByService_593680(
    ...
    validator: validate_ApiVersionSetListByService_593681, base: "",
    url: url_ApiVersionSetListByService_593682, schemes: {Scheme.Https})
type
  Call_ApiVersionSetCreateOrUpdate_593976 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetCreateOrUpdate_593978(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetCreateOrUpdate_593977(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593998 = path.getOrDefault("versionSetId")
  valid_593998 = validateParameter(valid_593998, JString, required = true,
                                 default = nil)
  if valid_593998 != nil:
    section.add "versionSetId", valid_593998
...
proc call*(call_594003: Call_ApiVersionSetCreateOrUpdate_593976; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or Updates a Api Version Set.
  ## 
...
proc call*(call_594004: Call_ApiVersionSetCreateOrUpdate_593976;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594005, "versionSetId", newJString(versionSetId))
  if parameters != nil:
...
var apiVersionSetCreateOrUpdate* = Call_ApiVersionSetCreateOrUpdate_593976(
    ...
    validator: validate_ApiVersionSetCreateOrUpdate_593977, base: "",
    url: url_ApiVersionSetCreateOrUpdate_593978, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGetEntityTag_594021 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetGetEntityTag_594023(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetGetEntityTag_594022(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594026 = path.getOrDefault("versionSetId")
  valid_594026 = validateParameter(valid_594026, JString, required = true,
                                 default = nil)
  if valid_594026 != nil:
    section.add "versionSetId", valid_594026
...
proc call*(call_594029: Call_ApiVersionSetGetEntityTag_594021; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_594030: Call_ApiVersionSetGetEntityTag_594021;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594031, "versionSetId", newJString(versionSetId))
  add(path_594031, "serviceName", newJString(serviceName))
  result = call_594030.call(path_594031, query_594032, nil, nil, nil)

var apiVersionSetGetEntityTag* = Call_ApiVersionSetGetEntityTag_594021(
    name: "apiVersionSetGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/api-version-sets/{versionSetId}",
    validator: validate_ApiVersionSetGetEntityTag_594022, base: "",
    url: url_ApiVersionSetGetEntityTag_594023, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGet_593964 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetGet_593966(protocol: Scheme; host: string; base: string;
...
proc validate_ApiVersionSetGet_593965(path: JsonNode; query: JsonNode;
  ...
  var valid_593969 = path.getOrDefault("versionSetId")
  valid_593969 = validateParameter(valid_593969, JString, required = true,
                                 default = nil)
  if valid_593969 != nil:
    section.add "versionSetId", valid_593969
...
proc call*(call_593972: Call_ApiVersionSetGet_593964; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_593973: Call_ApiVersionSetGet_593964; resourceGroupName: string;
  ...
  add(path_593974, "versionSetId", newJString(versionSetId))
  add(path_593974, "serviceName", newJString(serviceName))
  result = call_593973.call(path_593974, query_593975, nil, nil, nil)

var apiVersionSetGet* = Call_ApiVersionSetGet_593964(name: "apiVersionSetGet",
    ...
    validator: validate_ApiVersionSetGet_593965, base: "",
    url: url_ApiVersionSetGet_593966, schemes: {Scheme.Https})
type
  Call_ApiVersionSetUpdate_594033 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetUpdate_594035(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetUpdate_594034(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594038 = path.getOrDefault("versionSetId")
  valid_594038 = validateParameter(valid_594038, JString, required = true,
                                 default = nil)
  if valid_594038 != nil:
    section.add "versionSetId", valid_594038
...
proc call*(call_594043: Call_ApiVersionSetUpdate_594033; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the Api VersionSet specified by its identifier.
  ## 
...
proc call*(call_594044: Call_ApiVersionSetUpdate_594033; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; versionSetId: string;
  ...
  add(path_594045, "versionSetId", newJString(versionSetId))
  if parameters != nil:
...
var apiVersionSetUpdate* = Call_ApiVersionSetUpdate_594033(
    name: "apiVersionSetUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/api-version-sets/{versionSetId}",
    validator: validate_ApiVersionSetUpdate_594034, base: "",
    url: url_ApiVersionSetUpdate_594035, schemes: {Scheme.Https})
type
  Call_ApiVersionSetDelete_594008 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetDelete_594010(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetDelete_594009(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594013 = path.getOrDefault("versionSetId")
  valid_594013 = validateParameter(valid_594013, JString, required = true,
                                 default = nil)
  if valid_594013 != nil:
    section.add "versionSetId", valid_594013
...
proc call*(call_594017: Call_ApiVersionSetDelete_594008; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific Api Version Set.
  ## 
...
proc call*(call_594018: Call_ApiVersionSetDelete_594008; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; versionSetId: string;
          serviceName: string): Recallable =
  ## apiVersionSetDelete
  ## Deletes specific Api Version Set.
  ...
  add(path_594019, "versionSetId", newJString(versionSetId))
  add(path_594019, "serviceName", newJString(serviceName))
  result = call_594018.call(path_594019, query_594020, nil, nil, nil)

var apiVersionSetDelete* = Call_ApiVersionSetDelete_594008(
    name: "apiVersionSetDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/api-version-sets/{versionSetId}",
    validator: validate_ApiVersionSetDelete_594009, base: "",
    url: url_ApiVersionSetDelete_594010, schemes: {Scheme.Https})
export
  rest
