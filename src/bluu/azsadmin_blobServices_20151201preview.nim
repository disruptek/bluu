...
type
  Call_BlobServicesGet_563778 = ref object of OpenApiRestCall_563556
proc url_BlobServicesGet_563780(protocol: Scheme; host: string; base: string;
...
proc validate_BlobServicesGet_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563986: Call_BlobServicesGet_563778; path: JsonNode; query: JsonNode;
...
proc call*(call_564057: Call_BlobServicesGet_563778; apiVersion: string;
...
var blobServicesGet* = Call_BlobServicesGet_563778(name: "blobServicesGet",
    ...
    validator: validate_BlobServicesGet_563779, base: "", url: url_BlobServicesGet_563780,
    schemes: {Scheme.Https})
type
  Call_BlobServicesListMetricDefinitions_564099 = ref object of OpenApiRestCall_563556
proc url_BlobServicesListMetricDefinitions_564101(protocol: Scheme; host: string;
...
proc validate_BlobServicesListMetricDefinitions_564100(path: JsonNode;
...
proc call*(call_564107: Call_BlobServicesListMetricDefinitions_564099;
...
proc call*(call_564108: Call_BlobServicesListMetricDefinitions_564099;
...
var blobServicesListMetricDefinitions* = Call_BlobServicesListMetricDefinitions_564099(
    ...
    validator: validate_BlobServicesListMetricDefinitions_564100, base: "",
    url: url_BlobServicesListMetricDefinitions_564101, schemes: {Scheme.Https})
type
  Call_BlobServicesListMetrics_564111 = ref object of OpenApiRestCall_563556
proc url_BlobServicesListMetrics_564113(protocol: Scheme; host: string; base: string;
...
proc validate_BlobServicesListMetrics_564112(path: JsonNode; query: JsonNode;
...
proc call*(call_564119: Call_BlobServicesListMetrics_564111; path: JsonNode;
...
proc call*(call_564120: Call_BlobServicesListMetrics_564111; apiVersion: string;
          farmId: string; subscriptionId: string; resourceGroupName: string;
          serviceType: string = "default"): Recallable =
...
var blobServicesListMetrics* = Call_BlobServicesListMetrics_564111(
    ...
    validator: validate_BlobServicesListMetrics_564112, base: "",
    url: url_BlobServicesListMetrics_564113, schemes: {Scheme.Https})
export
  rest
