...
type
  Call_AvailableEndpointServicesList_573863 = ref object of OpenApiRestCall_573641
proc url_AvailableEndpointServicesList_573865(protocol: Scheme; host: string;
...
proc validate_AvailableEndpointServicesList_573864(path: JsonNode; query: JsonNode;
...
proc call*(call_574054: Call_AvailableEndpointServicesList_573863; path: JsonNode;
...
proc call*(call_574125: Call_AvailableEndpointServicesList_573863;
...
var availableEndpointServicesList* = Call_AvailableEndpointServicesList_573863(
    ...
    validator: validate_AvailableEndpointServicesList_573864, base: "",
    url: url_AvailableEndpointServicesList_573865, schemes: {Scheme.Https})
export
  rest
