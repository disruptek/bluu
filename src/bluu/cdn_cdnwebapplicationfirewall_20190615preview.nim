...
type
  Call_ManagedRuleSetsList_593647 = ref object of OpenApiRestCall_593425
proc url_ManagedRuleSetsList_593649(protocol: Scheme; host: string; base: string;
...
proc validate_ManagedRuleSetsList_593648(path: JsonNode; query: JsonNode;
...
proc call*(call_593846: Call_ManagedRuleSetsList_593647; path: JsonNode;
...
proc call*(call_593917: Call_ManagedRuleSetsList_593647; apiVersion: string;
...
var managedRuleSetsList* = Call_ManagedRuleSetsList_593647(
    ...
    validator: validate_ManagedRuleSetsList_593648, base: "",
    url: url_ManagedRuleSetsList_593649, schemes: {Scheme.Https})
type
  Call_PoliciesList_593959 = ref object of OpenApiRestCall_593425
proc url_PoliciesList_593961(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesList_593960(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593965: Call_PoliciesList_593959; path: JsonNode; query: JsonNode;
...
proc call*(call_593966: Call_PoliciesList_593959; resourceGroupName: string;
...
var policiesList* = Call_PoliciesList_593959(name: "policiesList",
    ...
    validator: validate_PoliciesList_593960, base: "", url: url_PoliciesList_593961,
    schemes: {Scheme.Https})
type
  Call_PoliciesCreateOrUpdate_593980 = ref object of OpenApiRestCall_593425
proc url_PoliciesCreateOrUpdate_593982(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesCreateOrUpdate_593981(path: JsonNode; query: JsonNode;
  ...
  var valid_594002 = path.getOrDefault("policyName")
  valid_594002 = validateParameter(valid_594002, JString, required = true,
                                 default = nil)
  if valid_594002 != nil:
    section.add "policyName", valid_594002
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request. Current version is 2017-04-02.
...
proc call*(call_594005: Call_PoliciesCreateOrUpdate_593980; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or update policy with specified rule set name within a resource group.
  ## 
...
proc call*(call_594006: Call_PoliciesCreateOrUpdate_593980;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          cdnWebApplicationFirewallPolicy: JsonNode; policyName: string): Recallable =
  ...
  if cdnWebApplicationFirewallPolicy != nil:
    body_594009 = cdnWebApplicationFirewallPolicy
  add(path_594007, "policyName", newJString(policyName))
  result = call_594006.call(path_594007, query_594008, nil, nil, body_594009)

var policiesCreateOrUpdate* = Call_PoliciesCreateOrUpdate_593980(
    ...
    validator: validate_PoliciesCreateOrUpdate_593981, base: "",
    url: url_PoliciesCreateOrUpdate_593982, schemes: {Scheme.Https})
type
  Call_PoliciesGet_593969 = ref object of OpenApiRestCall_593425
proc url_PoliciesGet_593971(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesGet_593970(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593974 = path.getOrDefault("policyName")
  valid_593974 = validateParameter(valid_593974, JString, required = true,
                                 default = nil)
  if valid_593974 != nil:
    section.add "policyName", valid_593974
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request. Current version is 2017-04-02.
...
proc call*(call_593976: Call_PoliciesGet_593969; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieve protection policy with specified name within a resource group.
  ## 
...
proc call*(call_593977: Call_PoliciesGet_593969; resourceGroupName: string;
  ...
  add(path_593978, "policyName", newJString(policyName))
  result = call_593977.call(path_593978, query_593979, nil, nil, nil)

var policiesGet* = Call_PoliciesGet_593969(name: "policiesGet",
                                        meth: HttpMethod.HttpGet,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/CdnWebApplicationFirewallPolicies/{policyName}",
                                        validator: validate_PoliciesGet_593970,
                                        base: "", url: url_PoliciesGet_593971,
                                        schemes: {Scheme.Https})
type
  Call_PoliciesUpdate_594021 = ref object of OpenApiRestCall_593425
proc url_PoliciesUpdate_594023(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesUpdate_594022(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  var valid_594026 = path.getOrDefault("policyName")
  valid_594026 = validateParameter(valid_594026, JString, required = true,
                                 default = nil)
  if valid_594026 != nil:
    section.add "policyName", valid_594026
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request. Current version is 2017-04-02.
...
proc call*(call_594029: Call_PoliciesUpdate_594021; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an existing CdnWebApplicationFirewallPolicy with the specified policy name under the specified subscription and resource group
  ## 
...
proc call*(call_594030: Call_PoliciesUpdate_594021; resourceGroupName: string;
          apiVersion: string;
          cdnWebApplicationFirewallPolicyPatchParameters: JsonNode;
          subscriptionId: string; policyName: string): Recallable =
  ## policiesUpdate
  ## Update an existing CdnWebApplicationFirewallPolicy with the specified policy name under the specified subscription and resource group
  ##   resourceGroupName: string (required)
  ##                    : Name of the Resource group within the Azure subscription.
  ...
  if cdnWebApplicationFirewallPolicyPatchParameters != nil:
    body_594033 = cdnWebApplicationFirewallPolicyPatchParameters
  add(path_594031, "subscriptionId", newJString(subscriptionId))
  add(path_594031, "policyName", newJString(policyName))
  result = call_594030.call(path_594031, query_594032, nil, nil, body_594033)

var policiesUpdate* = Call_PoliciesUpdate_594021(name: "policiesUpdate",
    ...
    validator: validate_PoliciesUpdate_594022, base: "", url: url_PoliciesUpdate_594023,
    schemes: {Scheme.Https})
type
  Call_PoliciesDelete_594010 = ref object of OpenApiRestCall_593425
proc url_PoliciesDelete_594012(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesDelete_594011(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Deletes Policy
  ## 
  ...
  var valid_594015 = path.getOrDefault("policyName")
  valid_594015 = validateParameter(valid_594015, JString, required = true,
                                 default = nil)
  if valid_594015 != nil:
    section.add "policyName", valid_594015
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request. Current version is 2017-04-02.
...
proc call*(call_594017: Call_PoliciesDelete_594010; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes Policy
  ## 
...
proc call*(call_594018: Call_PoliciesDelete_594010; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; policyName: string): Recallable =
  ## policiesDelete
  ## Deletes Policy
  ##   resourceGroupName: string (required)
  ...
  add(path_594019, "policyName", newJString(policyName))
  result = call_594018.call(path_594019, query_594020, nil, nil, nil)

var policiesDelete* = Call_PoliciesDelete_594010(name: "policiesDelete",
    ...
    validator: validate_PoliciesDelete_594011, base: "", url: url_PoliciesDelete_594012,
    schemes: {Scheme.Https})
export
  rest
