...
proc validate_UsageDetailsList_594186(path: JsonNode; query: JsonNode;
  ...
  var valid_594193 = query.getOrDefault("metric")
  valid_594193 = validateParameter(valid_594193, JString, required = false,
                                 default = newJString("actualcost"))
  if valid_594193 != nil:
    section.add "metric", valid_594193
...
proc call*(call_594196: Call_UsageDetailsList_594185; apiVersion: string;
  ...
  add(query_594198, "metric", newJString(metric))
...
type
  Call_UsageDetailsDownload_594199 = ref object of OpenApiRestCall_593439
proc url_UsageDetailsDownload_594201(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UsageDetailsDownload_594200(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594204 = query.getOrDefault("metric")
  valid_594204 = validateParameter(valid_594204, JString, required = false,
                                 default = newJString("actualcost"))
  if valid_594204 != nil:
    section.add "metric", valid_594204
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_594205: Call_UsageDetailsDownload_594199; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Download usage details data.
  ## 
...
proc call*(call_594206: Call_UsageDetailsDownload_594199; apiVersion: string;
  ...
  add(query_594208, "metric", newJString(metric))
  add(path_594207, "scope", newJString(scope))
  result = call_594206.call(path_594207, query_594208, nil, nil, nil)

var usageDetailsDownload* = Call_UsageDetailsDownload_594199(
    name: "usageDetailsDownload", meth: HttpMethod.HttpPost,
    host: "management.azure.com",
    route: "/{scope}/providers/Microsoft.Consumption/usageDetails/download",
    validator: validate_UsageDetailsDownload_594200, base: "",
    url: url_UsageDetailsDownload_594201, schemes: {Scheme.Https})
export
  rest
