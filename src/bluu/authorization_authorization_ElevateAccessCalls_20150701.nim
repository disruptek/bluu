...
type
  Call_GlobalAdministratorElevateAccess_563761 = ref object of OpenApiRestCall_563539
proc url_GlobalAdministratorElevateAccess_563763(protocol: Scheme; host: string;
...
proc validate_GlobalAdministratorElevateAccess_563762(path: JsonNode;
...
proc call*(call_563947: Call_GlobalAdministratorElevateAccess_563761;
...
proc call*(call_564018: Call_GlobalAdministratorElevateAccess_563761;
...
var globalAdministratorElevateAccess* = Call_GlobalAdministratorElevateAccess_563761(
    name: "globalAdministratorElevateAccess", meth: HttpMethod.HttpPost,
    host: "management.azure.com",
    route: "/providers/Microsoft.Authorization/elevateAccess",
    validator: validate_GlobalAdministratorElevateAccess_563762, base: "",
    url: url_GlobalAdministratorElevateAccess_563763, schemes: {Scheme.Https})
export
  rest
