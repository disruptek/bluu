...
type
  Call_SubscriptionCreateOrUpdate_593976 = ref object of OpenApiRestCall_593424
proc url_SubscriptionCreateOrUpdate_593978(protocol: Scheme; host: string;
...
proc validate_SubscriptionCreateOrUpdate_593977(path: JsonNode; query: JsonNode;
  ...
  var valid_593998 = path.getOrDefault("sid")
  valid_593998 = validateParameter(valid_593998, JString, required = true,
                                 default = nil)
  if valid_593998 != nil:
    section.add "sid", valid_593998
...
proc call*(call_594004: Call_SubscriptionCreateOrUpdate_593976; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates the subscription of specified user to the specified product.
  ## 
...
proc call*(call_594005: Call_SubscriptionCreateOrUpdate_593976;
  ...
  add(path_594006, "sid", newJString(sid))
  add(path_594006, "serviceName", newJString(serviceName))
  add(query_594007, "notify", newJBool(notify))
  result = call_594005.call(path_594006, query_594007, nil, nil, body_594008)

var subscriptionCreateOrUpdate* = Call_SubscriptionCreateOrUpdate_593976(
    ...
    validator: validate_SubscriptionCreateOrUpdate_593977, base: "",
    url: url_SubscriptionCreateOrUpdate_593978, schemes: {Scheme.Https})
type
  Call_SubscriptionGetEntityTag_594022 = ref object of OpenApiRestCall_593424
proc url_SubscriptionGetEntityTag_594024(protocol: Scheme; host: string;
...
proc validate_SubscriptionGetEntityTag_594023(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594027 = path.getOrDefault("sid")
  valid_594027 = validateParameter(valid_594027, JString, required = true,
                                 default = nil)
  if valid_594027 != nil:
    section.add "sid", valid_594027
...
proc call*(call_594030: Call_SubscriptionGetEntityTag_594022; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the apimanagement subscription specified by its identifier.
  ## 
...
proc call*(call_594031: Call_SubscriptionGetEntityTag_594022;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594032, "sid", newJString(sid))
  add(path_594032, "serviceName", newJString(serviceName))
  result = call_594031.call(path_594032, query_594033, nil, nil, nil)

var subscriptionGetEntityTag* = Call_SubscriptionGetEntityTag_594022(
    name: "subscriptionGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/subscriptions/{sid}",
    validator: validate_SubscriptionGetEntityTag_594023, base: "",
    url: url_SubscriptionGetEntityTag_594024, schemes: {Scheme.Https})
type
...
proc call*(call_593972: Call_SubscriptionGet_593955; path: JsonNode; query: JsonNode;
...
proc call*(call_593973: Call_SubscriptionGet_593955; resourceGroupName: string;
...
type
  Call_SubscriptionUpdate_594034 = ref object of OpenApiRestCall_593424
proc url_SubscriptionUpdate_594036(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubscriptionUpdate_594035(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_594039 = path.getOrDefault("sid")
  valid_594039 = validateParameter(valid_594039, JString, required = true,
                                 default = nil)
  if valid_594039 != nil:
    section.add "sid", valid_594039
...
proc call*(call_594045: Call_SubscriptionUpdate_594034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of a subscription specified by its identifier.
  ## 
...
proc call*(call_594046: Call_SubscriptionUpdate_594034; resourceGroupName: string;
  ...
  add(path_594047, "sid", newJString(sid))
  add(path_594047, "serviceName", newJString(serviceName))
  add(query_594048, "notify", newJBool(notify))
  result = call_594046.call(path_594047, query_594048, nil, nil, body_594049)

var subscriptionUpdate* = Call_SubscriptionUpdate_594034(
    name: "subscriptionUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/subscriptions/{sid}",
    validator: validate_SubscriptionUpdate_594035, base: "",
    url: url_SubscriptionUpdate_594036, schemes: {Scheme.Https})
type
  Call_SubscriptionDelete_594009 = ref object of OpenApiRestCall_593424
proc url_SubscriptionDelete_594011(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubscriptionDelete_594010(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_594014 = path.getOrDefault("sid")
  valid_594014 = validateParameter(valid_594014, JString, required = true,
                                 default = nil)
  if valid_594014 != nil:
    section.add "sid", valid_594014
...
proc call*(call_594018: Call_SubscriptionDelete_594009; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified subscription.
  ## 
...
proc call*(call_594019: Call_SubscriptionDelete_594009; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; sid: string; serviceName: string): Recallable =
  ## subscriptionDelete
  ## Deletes the specified subscription.
  ##   resourceGroupName: string (required)
  ...
  add(path_594020, "sid", newJString(sid))
  add(path_594020, "serviceName", newJString(serviceName))
  result = call_594019.call(path_594020, query_594021, nil, nil, nil)

var subscriptionDelete* = Call_SubscriptionDelete_594009(
    name: "subscriptionDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/subscriptions/{sid}",
    validator: validate_SubscriptionDelete_594010, base: "",
    url: url_SubscriptionDelete_594011, schemes: {Scheme.Https})
type
  Call_SubscriptionRegeneratePrimaryKey_594050 = ref object of OpenApiRestCall_593424
proc url_SubscriptionRegeneratePrimaryKey_594052(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubscriptionRegeneratePrimaryKey_594051(path: JsonNode;
  ...
  var valid_594055 = path.getOrDefault("sid")
  valid_594055 = validateParameter(valid_594055, JString, required = true,
                                 default = nil)
  if valid_594055 != nil:
    section.add "sid", valid_594055
...
proc call*(call_594058: Call_SubscriptionRegeneratePrimaryKey_594050;
...
proc call*(call_594059: Call_SubscriptionRegeneratePrimaryKey_594050;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          sid: string; serviceName: string): Recallable =
...
var subscriptionRegeneratePrimaryKey* = Call_SubscriptionRegeneratePrimaryKey_594050(
    ...
    validator: validate_SubscriptionRegeneratePrimaryKey_594051, base: "",
    url: url_SubscriptionRegeneratePrimaryKey_594052, schemes: {Scheme.Https})
type
  Call_SubscriptionRegenerateSecondaryKey_594062 = ref object of OpenApiRestCall_593424
proc url_SubscriptionRegenerateSecondaryKey_594064(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubscriptionRegenerateSecondaryKey_594063(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594067 = path.getOrDefault("sid")
  valid_594067 = validateParameter(valid_594067, JString, required = true,
                                 default = nil)
  if valid_594067 != nil:
    section.add "sid", valid_594067
...
proc call*(call_594070: Call_SubscriptionRegenerateSecondaryKey_594062;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Regenerates secondary key of existing subscription of the API Management service instance.
  ## 
...
proc call*(call_594071: Call_SubscriptionRegenerateSecondaryKey_594062;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          sid: string; serviceName: string): Recallable =
  ...
  add(path_594072, "sid", newJString(sid))
  add(path_594072, "serviceName", newJString(serviceName))
  result = call_594071.call(path_594072, query_594073, nil, nil, nil)

var subscriptionRegenerateSecondaryKey* = Call_SubscriptionRegenerateSecondaryKey_594062(
    ...
    validator: validate_SubscriptionRegenerateSecondaryKey_594063, base: "",
    url: url_SubscriptionRegenerateSecondaryKey_594064, schemes: {Scheme.Https})
export
  rest
