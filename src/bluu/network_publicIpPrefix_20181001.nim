...
type
  Call_PublicIPPrefixesListAll_593646 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesListAll_593648(protocol: Scheme; host: string; base: string;
...
proc validate_PublicIPPrefixesListAll_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593836: Call_PublicIPPrefixesListAll_593646; path: JsonNode;
...
proc call*(call_593907: Call_PublicIPPrefixesListAll_593646; apiVersion: string;
...
var publicIPPrefixesListAll* = Call_PublicIPPrefixesListAll_593646(
    ...
    validator: validate_PublicIPPrefixesListAll_593647, base: "",
    url: url_PublicIPPrefixesListAll_593648, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesList_593949 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesList_593951(protocol: Scheme; host: string; base: string;
...
proc validate_PublicIPPrefixesList_593950(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593955: Call_PublicIPPrefixesList_593949; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all public IP prefixes in a resource group.
  ## 
...
proc call*(call_593956: Call_PublicIPPrefixesList_593949;
...
var publicIPPrefixesList* = Call_PublicIPPrefixesList_593949(
    ...
    validator: validate_PublicIPPrefixesList_593950, base: "",
    url: url_PublicIPPrefixesList_593951, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesCreateOrUpdate_593972 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesCreateOrUpdate_593974(protocol: Scheme; host: string;
...
proc validate_PublicIPPrefixesCreateOrUpdate_593973(path: JsonNode;
  ...
  var valid_594003 = path.getOrDefault("publicIpPrefixName")
  valid_594003 = validateParameter(valid_594003, JString, required = true,
                                 default = nil)
  if valid_594003 != nil:
    section.add "publicIpPrefixName", valid_594003
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594006: Call_PublicIPPrefixesCreateOrUpdate_593972; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a static or dynamic public IP prefix.
  ## 
...
proc call*(call_594007: Call_PublicIPPrefixesCreateOrUpdate_593972;
  ...
  add(path_594008, "publicIpPrefixName", newJString(publicIpPrefixName))
  if parameters != nil:
    body_594010 = parameters
  result = call_594007.call(path_594008, query_594009, nil, nil, body_594010)

var publicIPPrefixesCreateOrUpdate* = Call_PublicIPPrefixesCreateOrUpdate_593972(
    ...
    validator: validate_PublicIPPrefixesCreateOrUpdate_593973, base: "",
    url: url_PublicIPPrefixesCreateOrUpdate_593974, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesGet_593959 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesGet_593961(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesGet_593960(path: JsonNode; query: JsonNode;
  ...
  var valid_593965 = path.getOrDefault("publicIpPrefixName")
  valid_593965 = validateParameter(valid_593965, JString, required = true,
                                 default = nil)
  if valid_593965 != nil:
    section.add "publicIpPrefixName", valid_593965
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_593968: Call_PublicIPPrefixesGet_593959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified public IP prefix in a specified resource group.
  ## 
...
proc call*(call_593969: Call_PublicIPPrefixesGet_593959; resourceGroupName: string;
  ...
  add(path_593970, "publicIpPrefixName", newJString(publicIpPrefixName))
  result = call_593969.call(path_593970, query_593971, nil, nil, nil)

var publicIPPrefixesGet* = Call_PublicIPPrefixesGet_593959(
    name: "publicIPPrefixesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesGet_593960, base: "",
    url: url_PublicIPPrefixesGet_593961, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesUpdateTags_594022 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesUpdateTags_594024(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesUpdateTags_594023(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594027 = path.getOrDefault("publicIpPrefixName")
  valid_594027 = validateParameter(valid_594027, JString, required = true,
                                 default = nil)
  if valid_594027 != nil:
    section.add "publicIpPrefixName", valid_594027
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594030: Call_PublicIPPrefixesUpdateTags_594022; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates public IP prefix tags.
  ## 
...
proc call*(call_594031: Call_PublicIPPrefixesUpdateTags_594022;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          publicIpPrefixName: string; parameters: JsonNode): Recallable =
  ...
  add(path_594032, "publicIpPrefixName", newJString(publicIpPrefixName))
  if parameters != nil:
    body_594034 = parameters
  result = call_594031.call(path_594032, query_594033, nil, nil, body_594034)

var publicIPPrefixesUpdateTags* = Call_PublicIPPrefixesUpdateTags_594022(
    name: "publicIPPrefixesUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesUpdateTags_594023, base: "",
    url: url_PublicIPPrefixesUpdateTags_594024, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesDelete_594011 = ref object of OpenApiRestCall_593424
proc url_PublicIPPrefixesDelete_594013(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesDelete_594012(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594016 = path.getOrDefault("publicIpPrefixName")
  valid_594016 = validateParameter(valid_594016, JString, required = true,
                                 default = nil)
  if valid_594016 != nil:
    section.add "publicIpPrefixName", valid_594016
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594018: Call_PublicIPPrefixesDelete_594011; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified public IP prefix.
  ## 
...
proc call*(call_594019: Call_PublicIPPrefixesDelete_594011;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594020, "publicIpPrefixName", newJString(publicIpPrefixName))
  result = call_594019.call(path_594020, query_594021, nil, nil, nil)

var publicIPPrefixesDelete* = Call_PublicIPPrefixesDelete_594011(
    name: "publicIPPrefixesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesDelete_594012, base: "",
    url: url_PublicIPPrefixesDelete_594013, schemes: {Scheme.Https})
export
  rest
