...
type
  Call_OpenIdConnectProviderCreateOrUpdate_593967 = ref object of OpenApiRestCall_593424
proc url_OpenIdConnectProviderCreateOrUpdate_593969(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProviderCreateOrUpdate_593968(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593999 = path.getOrDefault("opid")
  valid_593999 = validateParameter(valid_593999, JString, required = true,
                                 default = nil)
  if valid_593999 != nil:
    section.add "opid", valid_593999
...
proc call*(call_594004: Call_OpenIdConnectProviderCreateOrUpdate_593967;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates the OpenID Connect Provider.
  ## 
...
proc call*(call_594005: Call_OpenIdConnectProviderCreateOrUpdate_593967;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594006, "opid", newJString(opid))
  if parameters != nil:
...
var openIdConnectProviderCreateOrUpdate* = Call_OpenIdConnectProviderCreateOrUpdate_593967(
    ...
    validator: validate_OpenIdConnectProviderCreateOrUpdate_593968, base: "",
    url: url_OpenIdConnectProviderCreateOrUpdate_593969, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProviderGetEntityTag_594022 = ref object of OpenApiRestCall_593424
proc url_OpenIdConnectProviderGetEntityTag_594024(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProviderGetEntityTag_594023(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594027 = path.getOrDefault("opid")
  valid_594027 = validateParameter(valid_594027, JString, required = true,
                                 default = nil)
  if valid_594027 != nil:
    section.add "opid", valid_594027
...
proc call*(call_594030: Call_OpenIdConnectProviderGetEntityTag_594022;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the openIdConnectProvider specified by its identifier.
  ## 
...
proc call*(call_594031: Call_OpenIdConnectProviderGetEntityTag_594022;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594032, "opid", newJString(opid))
  add(path_594032, "serviceName", newJString(serviceName))
  result = call_594031.call(path_594032, query_594033, nil, nil, nil)

var openIdConnectProviderGetEntityTag* = Call_OpenIdConnectProviderGetEntityTag_594022(
    name: "openIdConnectProviderGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProviderGetEntityTag_594023, base: "",
    url: url_OpenIdConnectProviderGetEntityTag_594024, schemes: {Scheme.Https})
type
...
proc validate_OpenIdConnectProviderGet_593956(path: JsonNode; query: JsonNode;
  ...
  var valid_593960 = path.getOrDefault("opid")
  valid_593960 = validateParameter(valid_593960, JString, required = true,
                                 default = nil)
  if valid_593960 != nil:
    section.add "opid", valid_593960
...
proc call*(call_593963: Call_OpenIdConnectProviderGet_593955; path: JsonNode;
...
proc call*(call_593964: Call_OpenIdConnectProviderGet_593955;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          opid: string; serviceName: string): Recallable =
  ...
  add(path_593965, "opid", newJString(opid))
...
type
  Call_OpenIdConnectProviderUpdate_594034 = ref object of OpenApiRestCall_593424
proc url_OpenIdConnectProviderUpdate_594036(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProviderUpdate_594035(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594039 = path.getOrDefault("opid")
  valid_594039 = validateParameter(valid_594039, JString, required = true,
                                 default = nil)
  if valid_594039 != nil:
    section.add "opid", valid_594039
...
proc call*(call_594044: Call_OpenIdConnectProviderUpdate_594034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific OpenID Connect Provider.
  ## 
...
proc call*(call_594045: Call_OpenIdConnectProviderUpdate_594034;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          opid: string; parameters: JsonNode; serviceName: string): Recallable =
  ...
  add(path_594046, "opid", newJString(opid))
  if parameters != nil:
...
var openIdConnectProviderUpdate* = Call_OpenIdConnectProviderUpdate_594034(
    name: "openIdConnectProviderUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProviderUpdate_594035, base: "",
    url: url_OpenIdConnectProviderUpdate_594036, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProviderDelete_594009 = ref object of OpenApiRestCall_593424
proc url_OpenIdConnectProviderDelete_594011(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProviderDelete_594010(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594014 = path.getOrDefault("opid")
  valid_594014 = validateParameter(valid_594014, JString, required = true,
                                 default = nil)
  if valid_594014 != nil:
    section.add "opid", valid_594014
...
proc call*(call_594018: Call_OpenIdConnectProviderDelete_594009; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific OpenID Connect Provider of the API Management service instance.
  ## 
...
proc call*(call_594019: Call_OpenIdConnectProviderDelete_594009;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          opid: string; serviceName: string): Recallable =
  ...
  add(path_594020, "opid", newJString(opid))
  add(path_594020, "serviceName", newJString(serviceName))
  result = call_594019.call(path_594020, query_594021, nil, nil, nil)

var openIdConnectProviderDelete* = Call_OpenIdConnectProviderDelete_594009(
    name: "openIdConnectProviderDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProviderDelete_594010, base: "",
    url: url_OpenIdConnectProviderDelete_594011, schemes: {Scheme.Https})
export
  rest
