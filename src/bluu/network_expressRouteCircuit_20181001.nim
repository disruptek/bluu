...
type
  Call_ExpressRouteCircuitsListRoutesTable_564339 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCircuitsListRoutesTable_564341(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTable_564340(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564345 = path.getOrDefault("devicePath")
  valid_564345 = validateParameter(valid_564345, JString, required = true,
                                 default = nil)
  if valid_564345 != nil:
    section.add "devicePath", valid_564345
...
proc call*(call_564348: Call_ExpressRouteCircuitsListRoutesTable_564339;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_564349: Call_ExpressRouteCircuitsListRoutesTable_564339;
          apiVersion: string; peeringName: string; subscriptionId: string;
          circuitName: string; devicePath: string; resourceGroupName: string): Recallable =
  ...
  add(path_564350, "circuitName", newJString(circuitName))
  add(path_564350, "devicePath", newJString(devicePath))
...
var expressRouteCircuitsListRoutesTable* = Call_ExpressRouteCircuitsListRoutesTable_564339(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTable_564340, base: "",
    url: url_ExpressRouteCircuitsListRoutesTable_564341, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsListRoutesTableSummary_564352 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCircuitsListRoutesTableSummary_564354(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTableSummary_564353(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564358 = path.getOrDefault("devicePath")
  valid_564358 = validateParameter(valid_564358, JString, required = true,
                                 default = nil)
  if valid_564358 != nil:
    section.add "devicePath", valid_564358
...
proc call*(call_564361: Call_ExpressRouteCircuitsListRoutesTableSummary_564352;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table summary associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_564362: Call_ExpressRouteCircuitsListRoutesTableSummary_564352;
          apiVersion: string; peeringName: string; subscriptionId: string;
          circuitName: string; devicePath: string; resourceGroupName: string): Recallable =
  ...
  add(path_564363, "devicePath", newJString(devicePath))
...
var expressRouteCircuitsListRoutesTableSummary* = Call_ExpressRouteCircuitsListRoutesTableSummary_564352(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTableSummary_564353,
    base: "", url: url_ExpressRouteCircuitsListRoutesTableSummary_564354,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetPeeringStats_564365 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCircuitsGetPeeringStats_564367(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetPeeringStats_564366(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564373: Call_ExpressRouteCircuitsGetPeeringStats_564365;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_564374: Call_ExpressRouteCircuitsGetPeeringStats_564365;
          apiVersion: string; peeringName: string; subscriptionId: string;
          circuitName: string; resourceGroupName: string): Recallable =
...
var expressRouteCircuitsGetPeeringStats* = Call_ExpressRouteCircuitsGetPeeringStats_564365(
    ...
    validator: validate_ExpressRouteCircuitsGetPeeringStats_564366, base: "",
    url: url_ExpressRouteCircuitsGetPeeringStats_564367, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetStats_564377 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCircuitsGetStats_564379(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetStats_564378(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564384: Call_ExpressRouteCircuitsGetStats_564377; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_564385: Call_ExpressRouteCircuitsGetStats_564377;
          apiVersion: string; subscriptionId: string; circuitName: string;
          resourceGroupName: string): Recallable =
...
var expressRouteCircuitsGetStats* = Call_ExpressRouteCircuitsGetStats_564377(
    ...
    validator: validate_ExpressRouteCircuitsGetStats_564378, base: "",
    url: url_ExpressRouteCircuitsGetStats_564379, schemes: {Scheme.Https})
export
  rest
