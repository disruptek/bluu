...
type
  Call_ExpressRouteCircuitsListRoutesTable_568439 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCircuitsListRoutesTable_568441(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTable_568440(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568446 = path.getOrDefault("devicePath")
  valid_568446 = validateParameter(valid_568446, JString, required = true,
                                 default = nil)
  if valid_568446 != nil:
    section.add "devicePath", valid_568446
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_568448: Call_ExpressRouteCircuitsListRoutesTable_568439;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_568449: Call_ExpressRouteCircuitsListRoutesTable_568439;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string; devicePath: string): Recallable =
  ...
  add(path_568450, "circuitName", newJString(circuitName))
  add(path_568450, "resourceGroupName", newJString(resourceGroupName))
  add(query_568451, "api-version", newJString(apiVersion))
  add(path_568450, "peeringName", newJString(peeringName))
  add(path_568450, "subscriptionId", newJString(subscriptionId))
  add(path_568450, "devicePath", newJString(devicePath))
  result = call_568449.call(path_568450, query_568451, nil, nil, nil)

var expressRouteCircuitsListRoutesTable* = Call_ExpressRouteCircuitsListRoutesTable_568439(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTable_568440, base: "",
    url: url_ExpressRouteCircuitsListRoutesTable_568441, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsListRoutesTableSummary_568452 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCircuitsListRoutesTableSummary_568454(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTableSummary_568453(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `circuitName` field"
  var valid_568455 = path.getOrDefault("circuitName")
  valid_568455 = validateParameter(valid_568455, JString, required = true,
                                 default = nil)
  if valid_568455 != nil:
    section.add "circuitName", valid_568455
...
proc call*(call_568461: Call_ExpressRouteCircuitsListRoutesTableSummary_568452;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table summary associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_568462: Call_ExpressRouteCircuitsListRoutesTableSummary_568452;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string; devicePath: string): Recallable =
  ...
  add(path_568463, "devicePath", newJString(devicePath))
  result = call_568462.call(path_568463, query_568464, nil, nil, nil)

var expressRouteCircuitsListRoutesTableSummary* = Call_ExpressRouteCircuitsListRoutesTableSummary_568452(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTableSummary_568453,
    base: "", url: url_ExpressRouteCircuitsListRoutesTableSummary_568454,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetPeeringStats_568465 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCircuitsGetPeeringStats_568467(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetPeeringStats_568466(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568470 = path.getOrDefault("peeringName")
  valid_568470 = validateParameter(valid_568470, JString, required = true,
                                 default = nil)
  if valid_568470 != nil:
    section.add "peeringName", valid_568470
...
proc call*(call_568473: Call_ExpressRouteCircuitsGetPeeringStats_568465;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_568474: Call_ExpressRouteCircuitsGetPeeringStats_568465;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string): Recallable =
...
var expressRouteCircuitsGetPeeringStats* = Call_ExpressRouteCircuitsGetPeeringStats_568465(
    ...
    validator: validate_ExpressRouteCircuitsGetPeeringStats_568466, base: "",
    url: url_ExpressRouteCircuitsGetPeeringStats_568467, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetStats_568477 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCircuitsGetStats_568479(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetStats_568478(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_568484: Call_ExpressRouteCircuitsGetStats_568477; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_568485: Call_ExpressRouteCircuitsGetStats_568477;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          subscriptionId: string): Recallable =
...
var expressRouteCircuitsGetStats* = Call_ExpressRouteCircuitsGetStats_568477(
    ...
    validator: validate_ExpressRouteCircuitsGetStats_568478, base: "",
    url: url_ExpressRouteCircuitsGetStats_568479, schemes: {Scheme.Https})
export
  rest
