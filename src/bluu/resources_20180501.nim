...
type
  Call_ProvidersList_593964 = ref object of OpenApiRestCall_593437
proc url_ProvidersList_593966(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProvidersList_593965(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  section = newJObject()
  var valid_593983 = query.getOrDefault("$expand")
  valid_593983 = validateParameter(valid_593983, JString, required = false,
                                 default = nil)
  if valid_593983 != nil:
    section.add "$expand", valid_593983
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_593986: Call_ProvidersList_593964; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all resource providers for a subscription.
  ## 
...
proc call*(call_593987: Call_ProvidersList_593964; apiVersion: string;
  ...
  add(query_593989, "$top", newJInt(Top))
  result = call_593987.call(path_593988, query_593989, nil, nil, nil)

var providersList* = Call_ProvidersList_593964(name: "providersList",
    meth: HttpMethod.HttpGet, host: "management.azure.com",
    route: "/subscriptions/{subscriptionId}/providers",
    validator: validate_ProvidersList_593965, base: "", url: url_ProvidersList_593966,
    schemes: {Scheme.Https})
type
  Call_DeploymentsListAtSubscriptionScope_593990 = ref object of OpenApiRestCall_593437
proc url_DeploymentsListAtSubscriptionScope_593992(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsListAtSubscriptionScope_593991(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593997: Call_DeploymentsListAtSubscriptionScope_593990;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get all the deployments for a subscription.
  ## 
...
proc call*(call_593998: Call_DeploymentsListAtSubscriptionScope_593990;
...
var deploymentsListAtSubscriptionScope* = Call_DeploymentsListAtSubscriptionScope_593990(
    ...
    validator: validate_DeploymentsListAtSubscriptionScope_593991, base: "",
    url: url_DeploymentsListAtSubscriptionScope_593992, schemes: {Scheme.Https})
type
  Call_DeploymentsCreateOrUpdateAtSubscriptionScope_594011 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCreateOrUpdateAtSubscriptionScope_594013(protocol: Scheme;
...
proc validate_DeploymentsCreateOrUpdateAtSubscriptionScope_594012(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594031 = path.getOrDefault("deploymentName")
  valid_594031 = validateParameter(valid_594031, JString, required = true,
                                 default = nil)
  if valid_594031 != nil:
    section.add "deploymentName", valid_594031
...
proc call*(call_594035: Call_DeploymentsCreateOrUpdateAtSubscriptionScope_594011;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## You can provide the template and parameters directly in the request or link to JSON files.
  ## 
...
proc call*(call_594036: Call_DeploymentsCreateOrUpdateAtSubscriptionScope_594011;
  ...
  add(path_594037, "deploymentName", newJString(deploymentName))
...
var deploymentsCreateOrUpdateAtSubscriptionScope* = Call_DeploymentsCreateOrUpdateAtSubscriptionScope_594011(
    ...
    validator: validate_DeploymentsCreateOrUpdateAtSubscriptionScope_594012,
    base: "", url: url_DeploymentsCreateOrUpdateAtSubscriptionScope_594013,
    schemes: {Scheme.Https})
type
  Call_DeploymentsCheckExistenceAtSubscriptionScope_594050 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCheckExistenceAtSubscriptionScope_594052(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsCheckExistenceAtSubscriptionScope_594051(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594053 = path.getOrDefault("deploymentName")
  valid_594053 = validateParameter(valid_594053, JString, required = true,
                                 default = nil)
  if valid_594053 != nil:
    section.add "deploymentName", valid_594053
...
proc call*(call_594056: Call_DeploymentsCheckExistenceAtSubscriptionScope_594050;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Checks whether the deployment exists.
  ## 
...
proc call*(call_594057: Call_DeploymentsCheckExistenceAtSubscriptionScope_594050;
  ...
  add(path_594058, "deploymentName", newJString(deploymentName))
  add(path_594058, "subscriptionId", newJString(subscriptionId))
  result = call_594057.call(path_594058, query_594059, nil, nil, nil)

var deploymentsCheckExistenceAtSubscriptionScope* = Call_DeploymentsCheckExistenceAtSubscriptionScope_594050(
    ...
    validator: validate_DeploymentsCheckExistenceAtSubscriptionScope_594051,
    base: "", url: url_DeploymentsCheckExistenceAtSubscriptionScope_594052,
    schemes: {Scheme.Https})
type
  Call_DeploymentsGetAtSubscriptionScope_594001 = ref object of OpenApiRestCall_593437
proc url_DeploymentsGetAtSubscriptionScope_594003(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsGetAtSubscriptionScope_594002(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets a deployment.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594004 = path.getOrDefault("deploymentName")
  valid_594004 = validateParameter(valid_594004, JString, required = true,
                                 default = nil)
  if valid_594004 != nil:
    section.add "deploymentName", valid_594004
...
proc call*(call_594007: Call_DeploymentsGetAtSubscriptionScope_594001;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a deployment.
  ## 
...
proc call*(call_594008: Call_DeploymentsGetAtSubscriptionScope_594001;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ...
  add(path_594009, "deploymentName", newJString(deploymentName))
  add(path_594009, "subscriptionId", newJString(subscriptionId))
  result = call_594008.call(path_594009, query_594010, nil, nil, nil)

var deploymentsGetAtSubscriptionScope* = Call_DeploymentsGetAtSubscriptionScope_594001(
    ...
    validator: validate_DeploymentsGetAtSubscriptionScope_594002, base: "",
    url: url_DeploymentsGetAtSubscriptionScope_594003, schemes: {Scheme.Https})
type
  Call_DeploymentsDeleteAtSubscriptionScope_594040 = ref object of OpenApiRestCall_593437
proc url_DeploymentsDeleteAtSubscriptionScope_594042(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsDeleteAtSubscriptionScope_594041(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594043 = path.getOrDefault("deploymentName")
  valid_594043 = validateParameter(valid_594043, JString, required = true,
                                 default = nil)
  if valid_594043 != nil:
    section.add "deploymentName", valid_594043
...
proc call*(call_594046: Call_DeploymentsDeleteAtSubscriptionScope_594040;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## A template deployment that is currently running cannot be deleted. Deleting a template deployment removes the associated deployment operations. This is an asynchronous operation that returns a status of 202 until the template deployment is successfully deleted. The Location response header contains the URI that is used to obtain the status of the process. While the process is running, a call to the URI in the Location header returns a status of 202. When the process finishes, the URI in the Location header returns a status of 204 on success. If the asynchronous request failed, the URI in the Location header returns an error-level status code.
  ## 
...
proc call*(call_594047: Call_DeploymentsDeleteAtSubscriptionScope_594040;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ...
  add(path_594048, "deploymentName", newJString(deploymentName))
  add(path_594048, "subscriptionId", newJString(subscriptionId))
  result = call_594047.call(path_594048, query_594049, nil, nil, nil)

var deploymentsDeleteAtSubscriptionScope* = Call_DeploymentsDeleteAtSubscriptionScope_594040(
    name: "deploymentsDeleteAtSubscriptionScope", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.Resources/deployments/{deploymentName}",
    validator: validate_DeploymentsDeleteAtSubscriptionScope_594041, base: "",
    url: url_DeploymentsDeleteAtSubscriptionScope_594042, schemes: {Scheme.Https})
type
  Call_DeploymentsCancelAtSubscriptionScope_594060 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCancelAtSubscriptionScope_594062(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsCancelAtSubscriptionScope_594061(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594063 = path.getOrDefault("deploymentName")
  valid_594063 = validateParameter(valid_594063, JString, required = true,
                                 default = nil)
  if valid_594063 != nil:
    section.add "deploymentName", valid_594063
...
proc call*(call_594066: Call_DeploymentsCancelAtSubscriptionScope_594060;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## You can cancel a deployment only if the provisioningState is Accepted or Running. After the deployment is canceled, the provisioningState is set to Canceled. Canceling a template deployment stops the currently running template deployment and leaves the resources partially deployed.
  ## 
...
proc call*(call_594067: Call_DeploymentsCancelAtSubscriptionScope_594060;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ...
  add(path_594068, "deploymentName", newJString(deploymentName))
  add(path_594068, "subscriptionId", newJString(subscriptionId))
  result = call_594067.call(path_594068, query_594069, nil, nil, nil)

var deploymentsCancelAtSubscriptionScope* = Call_DeploymentsCancelAtSubscriptionScope_594060(
    ...
    validator: validate_DeploymentsCancelAtSubscriptionScope_594061, base: "",
    url: url_DeploymentsCancelAtSubscriptionScope_594062, schemes: {Scheme.Https})
type
  Call_DeploymentsExportTemplateAtSubscriptionScope_594070 = ref object of OpenApiRestCall_593437
proc url_DeploymentsExportTemplateAtSubscriptionScope_594072(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsExportTemplateAtSubscriptionScope_594071(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594073 = path.getOrDefault("deploymentName")
  valid_594073 = validateParameter(valid_594073, JString, required = true,
                                 default = nil)
  if valid_594073 != nil:
    section.add "deploymentName", valid_594073
...
proc call*(call_594076: Call_DeploymentsExportTemplateAtSubscriptionScope_594070;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Exports the template used for specified deployment.
  ## 
...
proc call*(call_594077: Call_DeploymentsExportTemplateAtSubscriptionScope_594070;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ...
  add(path_594078, "deploymentName", newJString(deploymentName))
  add(path_594078, "subscriptionId", newJString(subscriptionId))
  result = call_594077.call(path_594078, query_594079, nil, nil, nil)

var deploymentsExportTemplateAtSubscriptionScope* = Call_DeploymentsExportTemplateAtSubscriptionScope_594070(
    ...
    validator: validate_DeploymentsExportTemplateAtSubscriptionScope_594071,
    base: "", url: url_DeploymentsExportTemplateAtSubscriptionScope_594072,
    schemes: {Scheme.Https})
type
  Call_DeploymentOperationsListAtSubscriptionScope_594080 = ref object of OpenApiRestCall_593437
proc url_DeploymentOperationsListAtSubscriptionScope_594082(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentOperationsListAtSubscriptionScope_594081(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594083 = path.getOrDefault("deploymentName")
  valid_594083 = validateParameter(valid_594083, JString, required = true,
                                 default = nil)
  if valid_594083 != nil:
    section.add "deploymentName", valid_594083
...
proc call*(call_594087: Call_DeploymentOperationsListAtSubscriptionScope_594080;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all deployments operations for a deployment.
  ## 
...
proc call*(call_594088: Call_DeploymentOperationsListAtSubscriptionScope_594080;
          apiVersion: string; deploymentName: string; subscriptionId: string;
  ...
  add(path_594089, "deploymentName", newJString(deploymentName))
...
var deploymentOperationsListAtSubscriptionScope* = Call_DeploymentOperationsListAtSubscriptionScope_594080(
    ...
    validator: validate_DeploymentOperationsListAtSubscriptionScope_594081,
    base: "", url: url_DeploymentOperationsListAtSubscriptionScope_594082,
    schemes: {Scheme.Https})
type
  Call_DeploymentOperationsGetAtSubscriptionScope_594091 = ref object of OpenApiRestCall_593437
proc url_DeploymentOperationsGetAtSubscriptionScope_594093(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentOperationsGetAtSubscriptionScope_594092(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594094 = path.getOrDefault("deploymentName")
  valid_594094 = validateParameter(valid_594094, JString, required = true,
                                 default = nil)
  if valid_594094 != nil:
    section.add "deploymentName", valid_594094
...
proc call*(call_594098: Call_DeploymentOperationsGetAtSubscriptionScope_594091;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a deployments operation.
  ## 
...
proc call*(call_594099: Call_DeploymentOperationsGetAtSubscriptionScope_594091;
          apiVersion: string; deploymentName: string; subscriptionId: string;
  ...
  add(path_594100, "deploymentName", newJString(deploymentName))
...
var deploymentOperationsGetAtSubscriptionScope* = Call_DeploymentOperationsGetAtSubscriptionScope_594091(
    ...
    validator: validate_DeploymentOperationsGetAtSubscriptionScope_594092,
    base: "", url: url_DeploymentOperationsGetAtSubscriptionScope_594093,
    schemes: {Scheme.Https})
type
  Call_DeploymentsValidateAtSubscriptionScope_594102 = ref object of OpenApiRestCall_593437
proc url_DeploymentsValidateAtSubscriptionScope_594104(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsValidateAtSubscriptionScope_594103(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `deploymentName` field"
  var valid_594105 = path.getOrDefault("deploymentName")
  valid_594105 = validateParameter(valid_594105, JString, required = true,
                                 default = nil)
  if valid_594105 != nil:
    section.add "deploymentName", valid_594105
...
proc call*(call_594109: Call_DeploymentsValidateAtSubscriptionScope_594102;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Validates whether the specified template is syntactically correct and will be accepted by Azure Resource Manager..
  ## 
...
proc call*(call_594110: Call_DeploymentsValidateAtSubscriptionScope_594102;
          apiVersion: string; deploymentName: string; subscriptionId: string;
          parameters: JsonNode): Recallable =
  ...
  add(path_594111, "deploymentName", newJString(deploymentName))
...
var deploymentsValidateAtSubscriptionScope* = Call_DeploymentsValidateAtSubscriptionScope_594102(
    ...
    validator: validate_DeploymentsValidateAtSubscriptionScope_594103, base: "",
    url: url_DeploymentsValidateAtSubscriptionScope_594104,
    schemes: {Scheme.Https})
type
  Call_ProvidersGet_594114 = ref object of OpenApiRestCall_593437
proc url_ProvidersGet_594116(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProvidersGet_594115(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594118 = path.getOrDefault("resourceProviderNamespace")
  valid_594118 = validateParameter(valid_594118, JString, required = true,
                                 default = nil)
  if valid_594118 != nil:
    section.add "resourceProviderNamespace", valid_594118
  result.add "path", section
  ## parameters in `query` object:
  ##   $expand: JString
  ...
  ##              : The API version to use for this operation.
  section = newJObject()
  var valid_594119 = query.getOrDefault("$expand")
  valid_594119 = validateParameter(valid_594119, JString, required = false,
                                 default = nil)
  if valid_594119 != nil:
    section.add "$expand", valid_594119
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_594121: Call_ProvidersGet_594114; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified resource provider.
  ## 
...
proc call*(call_594122: Call_ProvidersGet_594114; apiVersion: string;
  ...
  add(query_594124, "$expand", newJString(Expand))
  add(query_594124, "api-version", newJString(apiVersion))
  add(path_594123, "subscriptionId", newJString(subscriptionId))
  add(path_594123, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  result = call_594122.call(path_594123, query_594124, nil, nil, nil)

var providersGet* = Call_ProvidersGet_594114(name: "providersGet",
    meth: HttpMethod.HttpGet, host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}",
    validator: validate_ProvidersGet_594115, base: "", url: url_ProvidersGet_594116,
    schemes: {Scheme.Https})
type
  Call_ProvidersRegister_594125 = ref object of OpenApiRestCall_593437
proc url_ProvidersRegister_594127(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProvidersRegister_594126(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594129 = path.getOrDefault("resourceProviderNamespace")
  valid_594129 = validateParameter(valid_594129, JString, required = true,
                                 default = nil)
  if valid_594129 != nil:
    section.add "resourceProviderNamespace", valid_594129
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594131: Call_ProvidersRegister_594125; path: JsonNode;
...
proc call*(call_594132: Call_ProvidersRegister_594125; apiVersion: string;
  ...
  add(path_594133, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  result = call_594132.call(path_594133, query_594134, nil, nil, nil)

var providersRegister* = Call_ProvidersRegister_594125(name: "providersRegister",
    ...
    validator: validate_ProvidersRegister_594126, base: "",
    url: url_ProvidersRegister_594127, schemes: {Scheme.Https})
type
  Call_ProvidersUnregister_594135 = ref object of OpenApiRestCall_593437
proc url_ProvidersUnregister_594137(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProvidersUnregister_594136(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594139 = path.getOrDefault("resourceProviderNamespace")
  valid_594139 = validateParameter(valid_594139, JString, required = true,
                                 default = nil)
  if valid_594139 != nil:
    section.add "resourceProviderNamespace", valid_594139
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594141: Call_ProvidersUnregister_594135; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Unregisters a subscription from a resource provider.
  ## 
...
proc call*(call_594142: Call_ProvidersUnregister_594135; apiVersion: string;
          subscriptionId: string; resourceProviderNamespace: string): Recallable =
  ## providersUnregister
  ## Unregisters a subscription from a resource provider.
  ##   apiVersion: string (required)
  ...
  add(path_594143, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  result = call_594142.call(path_594143, query_594144, nil, nil, nil)

var providersUnregister* = Call_ProvidersUnregister_594135(
    ...
    validator: validate_ProvidersUnregister_594136, base: "",
    url: url_ProvidersUnregister_594137, schemes: {Scheme.Https})
type
  Call_ResourcesListByResourceGroup_594145 = ref object of OpenApiRestCall_593437
proc url_ResourcesListByResourceGroup_594147(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesListByResourceGroup_594146(path: JsonNode; query: JsonNode;
  ...
  section = newJObject()
  var valid_594150 = query.getOrDefault("$expand")
  valid_594150 = validateParameter(valid_594150, JString, required = false,
                                 default = nil)
  if valid_594150 != nil:
    section.add "$expand", valid_594150
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_594154: Call_ResourcesListByResourceGroup_594145; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the resources for a resource group.
  ## 
...
proc call*(call_594155: Call_ResourcesListByResourceGroup_594145;
  ...
  add(query_594157, "$expand", newJString(Expand))
...
var resourcesListByResourceGroup* = Call_ResourcesListByResourceGroup_594145(
    ...
    validator: validate_ResourcesListByResourceGroup_594146, base: "",
    url: url_ResourcesListByResourceGroup_594147, schemes: {Scheme.Https})
type
  Call_ResourcesMoveResources_594158 = ref object of OpenApiRestCall_593437
proc url_ResourcesMoveResources_594160(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesMoveResources_594159(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594161 = path.getOrDefault("sourceResourceGroupName")
  valid_594161 = validateParameter(valid_594161, JString, required = true,
                                 default = nil)
  if valid_594161 != nil:
    section.add "sourceResourceGroupName", valid_594161
...
proc call*(call_594165: Call_ResourcesMoveResources_594158; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The resources to move must be in the same source resource group. The target resource group may be in a different subscription. When moving resources, both the source group and the target group are locked for the duration of the operation. Write and delete operations are blocked on the groups until the move completes. 
  ## 
...
proc call*(call_594166: Call_ResourcesMoveResources_594158; apiVersion: string;
  ...
  add(path_594167, "sourceResourceGroupName", newJString(sourceResourceGroupName))
  add(path_594167, "subscriptionId", newJString(subscriptionId))
  if parameters != nil:
    body_594169 = parameters
  result = call_594166.call(path_594167, query_594168, nil, nil, body_594169)

var resourcesMoveResources* = Call_ResourcesMoveResources_594158(
    ...
    validator: validate_ResourcesMoveResources_594159, base: "",
    url: url_ResourcesMoveResources_594160, schemes: {Scheme.Https})
type
  Call_ResourcesValidateMoveResources_594170 = ref object of OpenApiRestCall_593437
proc url_ResourcesValidateMoveResources_594172(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesValidateMoveResources_594171(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `sourceResourceGroupName` field"
  var valid_594173 = path.getOrDefault("sourceResourceGroupName")
  valid_594173 = validateParameter(valid_594173, JString, required = true,
                                 default = nil)
  if valid_594173 != nil:
    section.add "sourceResourceGroupName", valid_594173
...
proc call*(call_594177: Call_ResourcesValidateMoveResources_594170; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## This operation checks whether the specified resources can be moved to the target. The resources to move must be in the same source resource group. The target resource group may be in a different subscription. If validation succeeds, it returns HTTP response code 204 (no content). If validation fails, it returns HTTP response code 409 (Conflict) with an error message. Retrieve the URL in the Location header value to check the result of the long-running operation.
  ## 
...
proc call*(call_594178: Call_ResourcesValidateMoveResources_594170;
  ...
  add(path_594179, "sourceResourceGroupName", newJString(sourceResourceGroupName))
...
var resourcesValidateMoveResources* = Call_ResourcesValidateMoveResources_594170(
    ...
    validator: validate_ResourcesValidateMoveResources_594171, base: "",
    url: url_ResourcesValidateMoveResources_594172, schemes: {Scheme.Https})
type
  Call_ResourceGroupsList_594182 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsList_594184(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsList_594183(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594189: Call_ResourceGroupsList_594182; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the resource groups for a subscription.
  ## 
...
proc call*(call_594190: Call_ResourceGroupsList_594182; apiVersion: string;
...
var resourceGroupsList* = Call_ResourceGroupsList_594182(
    name: "resourceGroupsList", meth: HttpMethod.HttpGet,
    host: "management.azure.com",
    route: "/subscriptions/{subscriptionId}/resourcegroups",
    validator: validate_ResourceGroupsList_594183, base: "",
    url: url_ResourceGroupsList_594184, schemes: {Scheme.Https})
type
  Call_ResourceGroupsCreateOrUpdate_594203 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsCreateOrUpdate_594205(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsCreateOrUpdate_594204(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594210: Call_ResourceGroupsCreateOrUpdate_594203; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a resource group.
  ## 
...
proc call*(call_594211: Call_ResourceGroupsCreateOrUpdate_594203;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          parameters: JsonNode): Recallable =
...
var resourceGroupsCreateOrUpdate* = Call_ResourceGroupsCreateOrUpdate_594203(
    ...
    validator: validate_ResourceGroupsCreateOrUpdate_594204, base: "",
    url: url_ResourceGroupsCreateOrUpdate_594205, schemes: {Scheme.Https})
type
  Call_ResourceGroupsCheckExistence_594225 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsCheckExistence_594227(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsCheckExistence_594226(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594231: Call_ResourceGroupsCheckExistence_594225; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Checks whether a resource group exists.
  ## 
...
proc call*(call_594232: Call_ResourceGroupsCheckExistence_594225;
...
var resourceGroupsCheckExistence* = Call_ResourceGroupsCheckExistence_594225(
    name: "resourceGroupsCheckExistence", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}",
    validator: validate_ResourceGroupsCheckExistence_594226, base: "",
    url: url_ResourceGroupsCheckExistence_594227, schemes: {Scheme.Https})
type
  Call_ResourceGroupsGet_594193 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsGet_594195(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsGet_594194(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594199: Call_ResourceGroupsGet_594193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a resource group.
  ## 
...
proc call*(call_594200: Call_ResourceGroupsGet_594193; resourceGroupName: string;
...
var resourceGroupsGet* = Call_ResourceGroupsGet_594193(name: "resourceGroupsGet",
    meth: HttpMethod.HttpGet, host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}",
    validator: validate_ResourceGroupsGet_594194, base: "",
    url: url_ResourceGroupsGet_594195, schemes: {Scheme.Https})
type
  Call_ResourceGroupsUpdate_594235 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsUpdate_594237(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsUpdate_594236(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594242: Call_ResourceGroupsUpdate_594235; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resource groups can be updated through a simple PATCH operation to a group address. The format of the request is the same as that for creating a resource group. If a field is unspecified, the current value is retained.
  ## 
...
proc call*(call_594243: Call_ResourceGroupsUpdate_594235;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          parameters: JsonNode): Recallable =
...
var resourceGroupsUpdate* = Call_ResourceGroupsUpdate_594235(
    name: "resourceGroupsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}",
    validator: validate_ResourceGroupsUpdate_594236, base: "",
    url: url_ResourceGroupsUpdate_594237, schemes: {Scheme.Https})
type
  Call_ResourceGroupsDelete_594215 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsDelete_594217(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsDelete_594216(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594221: Call_ResourceGroupsDelete_594215; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## When you delete a resource group, all of its resources are also deleted. Deleting a resource group deletes all of its template deployments and currently stored operations.
  ## 
...
proc call*(call_594222: Call_ResourceGroupsDelete_594215;
          resourceGroupName: string; apiVersion: string; subscriptionId: string): Recallable =
...
var resourceGroupsDelete* = Call_ResourceGroupsDelete_594215(
    name: "resourceGroupsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}",
    validator: validate_ResourceGroupsDelete_594216, base: "",
    url: url_ResourceGroupsDelete_594217, schemes: {Scheme.Https})
type
  Call_DeploymentOperationsList_594247 = ref object of OpenApiRestCall_593437
proc url_DeploymentOperationsList_594249(protocol: Scheme; host: string;
...
proc validate_DeploymentOperationsList_594248(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets all deployments operations for a deployment.
  ## 
  var section: JsonNode
  ...
  var valid_594251 = path.getOrDefault("deploymentName")
  valid_594251 = validateParameter(valid_594251, JString, required = true,
                                 default = nil)
  if valid_594251 != nil:
    section.add "deploymentName", valid_594251
...
proc call*(call_594255: Call_DeploymentOperationsList_594247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all deployments operations for a deployment.
  ## 
...
proc call*(call_594256: Call_DeploymentOperationsList_594247;
  ...
  add(path_594257, "deploymentName", newJString(deploymentName))
  add(path_594257, "subscriptionId", newJString(subscriptionId))
  add(query_594258, "$top", newJInt(Top))
  result = call_594256.call(path_594257, query_594258, nil, nil, nil)

var deploymentOperationsList* = Call_DeploymentOperationsList_594247(
    ...
    validator: validate_DeploymentOperationsList_594248, base: "",
    url: url_DeploymentOperationsList_594249, schemes: {Scheme.Https})
type
  Call_DeploymentOperationsGet_594259 = ref object of OpenApiRestCall_593437
proc url_DeploymentOperationsGet_594261(protocol: Scheme; host: string; base: string;
...
proc validate_DeploymentOperationsGet_594260(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets a deployments operation.
  ## 
  var section: JsonNode
  ...
  var valid_594263 = path.getOrDefault("deploymentName")
  valid_594263 = validateParameter(valid_594263, JString, required = true,
                                 default = nil)
  if valid_594263 != nil:
    section.add "deploymentName", valid_594263
  ...
  var valid_594265 = path.getOrDefault("operationId")
  valid_594265 = validateParameter(valid_594265, JString, required = true,
                                 default = nil)
  if valid_594265 != nil:
    section.add "operationId", valid_594265
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594267: Call_DeploymentOperationsGet_594259; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a deployments operation.
  ## 
...
proc call*(call_594268: Call_DeploymentOperationsGet_594259;
          resourceGroupName: string; apiVersion: string; deploymentName: string;
  ...
  add(path_594269, "deploymentName", newJString(deploymentName))
  add(path_594269, "subscriptionId", newJString(subscriptionId))
  add(path_594269, "operationId", newJString(operationId))
  result = call_594268.call(path_594269, query_594270, nil, nil, nil)

var deploymentOperationsGet* = Call_DeploymentOperationsGet_594259(
    ...
    validator: validate_DeploymentOperationsGet_594260, base: "",
    url: url_DeploymentOperationsGet_594261, schemes: {Scheme.Https})
type
  Call_ResourceGroupsExportTemplate_594271 = ref object of OpenApiRestCall_593437
proc url_ResourceGroupsExportTemplate_594273(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceGroupsExportTemplate_594272(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594278: Call_ResourceGroupsExportTemplate_594271; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Captures the specified resource group as a template.
  ## 
...
proc call*(call_594279: Call_ResourceGroupsExportTemplate_594271;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          parameters: JsonNode): Recallable =
...
var resourceGroupsExportTemplate* = Call_ResourceGroupsExportTemplate_594271(
    ...
    validator: validate_ResourceGroupsExportTemplate_594272, base: "",
    url: url_ResourceGroupsExportTemplate_594273, schemes: {Scheme.Https})
type
  Call_DeploymentsListByResourceGroup_594283 = ref object of OpenApiRestCall_593437
proc url_DeploymentsListByResourceGroup_594285(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsListByResourceGroup_594284(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594291: Call_DeploymentsListByResourceGroup_594283; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the deployments for a resource group.
  ## 
...
proc call*(call_594292: Call_DeploymentsListByResourceGroup_594283;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var deploymentsListByResourceGroup* = Call_DeploymentsListByResourceGroup_594283(
    ...
    validator: validate_DeploymentsListByResourceGroup_594284, base: "",
    url: url_DeploymentsListByResourceGroup_594285, schemes: {Scheme.Https})
type
  Call_DeploymentsCreateOrUpdate_594306 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCreateOrUpdate_594308(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsCreateOrUpdate_594307(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## You can provide the template and parameters directly in the request or link to JSON files.
  ## 
  var section: JsonNode
  ...
  var valid_594310 = path.getOrDefault("deploymentName")
  valid_594310 = validateParameter(valid_594310, JString, required = true,
                                 default = nil)
  if valid_594310 != nil:
    section.add "deploymentName", valid_594310
...
proc call*(call_594314: Call_DeploymentsCreateOrUpdate_594306; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## You can provide the template and parameters directly in the request or link to JSON files.
  ## 
...
proc call*(call_594315: Call_DeploymentsCreateOrUpdate_594306;
          resourceGroupName: string; apiVersion: string; deploymentName: string;
          subscriptionId: string; parameters: JsonNode): Recallable =
  ...
  add(path_594316, "deploymentName", newJString(deploymentName))
  add(path_594316, "subscriptionId", newJString(subscriptionId))
  if parameters != nil:
    body_594318 = parameters
  result = call_594315.call(path_594316, query_594317, nil, nil, body_594318)

var deploymentsCreateOrUpdate* = Call_DeploymentsCreateOrUpdate_594306(
    ...
    validator: validate_DeploymentsCreateOrUpdate_594307, base: "",
    url: url_DeploymentsCreateOrUpdate_594308, schemes: {Scheme.Https})
type
  Call_DeploymentsCheckExistence_594330 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCheckExistence_594332(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsCheckExistence_594331(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Checks whether the deployment exists.
  ## 
  var section: JsonNode
  ...
  var valid_594334 = path.getOrDefault("deploymentName")
  valid_594334 = validateParameter(valid_594334, JString, required = true,
                                 default = nil)
  if valid_594334 != nil:
    section.add "deploymentName", valid_594334
...
proc call*(call_594337: Call_DeploymentsCheckExistence_594330; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Checks whether the deployment exists.
  ## 
...
proc call*(call_594338: Call_DeploymentsCheckExistence_594330;
          resourceGroupName: string; apiVersion: string; deploymentName: string;
  ...
  add(path_594339, "deploymentName", newJString(deploymentName))
  add(path_594339, "subscriptionId", newJString(subscriptionId))
  result = call_594338.call(path_594339, query_594340, nil, nil, nil)

var deploymentsCheckExistence* = Call_DeploymentsCheckExistence_594330(
    name: "deploymentsCheckExistence", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Resources/deployments/{deploymentName}",
    validator: validate_DeploymentsCheckExistence_594331, base: "",
    url: url_DeploymentsCheckExistence_594332, schemes: {Scheme.Https})
type
  Call_DeploymentsGet_594295 = ref object of OpenApiRestCall_593437
proc url_DeploymentsGet_594297(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsGet_594296(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Gets a deployment.
  ## 
  ...
  var valid_594299 = path.getOrDefault("deploymentName")
  valid_594299 = validateParameter(valid_594299, JString, required = true,
                                 default = nil)
  if valid_594299 != nil:
    section.add "deploymentName", valid_594299
...
proc call*(call_594302: Call_DeploymentsGet_594295; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a deployment.
  ## 
...
proc call*(call_594303: Call_DeploymentsGet_594295; resourceGroupName: string;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ## deploymentsGet
  ## Gets a deployment.
  ##   resourceGroupName: string (required)
  ...
  add(path_594304, "deploymentName", newJString(deploymentName))
  add(path_594304, "subscriptionId", newJString(subscriptionId))
  result = call_594303.call(path_594304, query_594305, nil, nil, nil)

var deploymentsGet* = Call_DeploymentsGet_594295(name: "deploymentsGet",
    ...
    validator: validate_DeploymentsGet_594296, base: "", url: url_DeploymentsGet_594297,
    schemes: {Scheme.Https})
type
  Call_DeploymentsDelete_594319 = ref object of OpenApiRestCall_593437
proc url_DeploymentsDelete_594321(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsDelete_594320(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594323 = path.getOrDefault("deploymentName")
  valid_594323 = validateParameter(valid_594323, JString, required = true,
                                 default = nil)
  if valid_594323 != nil:
    section.add "deploymentName", valid_594323
...
proc call*(call_594326: Call_DeploymentsDelete_594319; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## A template deployment that is currently running cannot be deleted. Deleting a template deployment removes the associated deployment operations. Deleting a template deployment does not affect the state of the resource group. This is an asynchronous operation that returns a status of 202 until the template deployment is successfully deleted. The Location response header contains the URI that is used to obtain the status of the process. While the process is running, a call to the URI in the Location header returns a status of 202. When the process finishes, the URI in the Location header returns a status of 204 on success. If the asynchronous request failed, the URI in the Location header returns an error-level status code.
  ## 
...
proc call*(call_594327: Call_DeploymentsDelete_594319; resourceGroupName: string;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ## deploymentsDelete
  ## A template deployment that is currently running cannot be deleted. Deleting a template deployment removes the associated deployment operations. Deleting a template deployment does not affect the state of the resource group. This is an asynchronous operation that returns a status of 202 until the template deployment is successfully deleted. The Location response header contains the URI that is used to obtain the status of the process. While the process is running, a call to the URI in the Location header returns a status of 202. When the process finishes, the URI in the Location header returns a status of 204 on success. If the asynchronous request failed, the URI in the Location header returns an error-level status code.
  ##   resourceGroupName: string (required)
  ...
  add(path_594328, "deploymentName", newJString(deploymentName))
  add(path_594328, "subscriptionId", newJString(subscriptionId))
  result = call_594327.call(path_594328, query_594329, nil, nil, nil)

var deploymentsDelete* = Call_DeploymentsDelete_594319(name: "deploymentsDelete",
    ...
    validator: validate_DeploymentsDelete_594320, base: "",
    url: url_DeploymentsDelete_594321, schemes: {Scheme.Https})
type
  Call_DeploymentsCancel_594341 = ref object of OpenApiRestCall_593437
proc url_DeploymentsCancel_594343(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsCancel_594342(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594345 = path.getOrDefault("deploymentName")
  valid_594345 = validateParameter(valid_594345, JString, required = true,
                                 default = nil)
  if valid_594345 != nil:
    section.add "deploymentName", valid_594345
...
proc call*(call_594348: Call_DeploymentsCancel_594341; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## You can cancel a deployment only if the provisioningState is Accepted or Running. After the deployment is canceled, the provisioningState is set to Canceled. Canceling a template deployment stops the currently running template deployment and leaves the resource group partially deployed.
  ## 
...
proc call*(call_594349: Call_DeploymentsCancel_594341; resourceGroupName: string;
          apiVersion: string; deploymentName: string; subscriptionId: string): Recallable =
  ## deploymentsCancel
  ## You can cancel a deployment only if the provisioningState is Accepted or Running. After the deployment is canceled, the provisioningState is set to Canceled. Canceling a template deployment stops the currently running template deployment and leaves the resource group partially deployed.
  ##   resourceGroupName: string (required)
  ...
  add(path_594350, "deploymentName", newJString(deploymentName))
  add(path_594350, "subscriptionId", newJString(subscriptionId))
  result = call_594349.call(path_594350, query_594351, nil, nil, nil)

var deploymentsCancel* = Call_DeploymentsCancel_594341(name: "deploymentsCancel",
    ...
    validator: validate_DeploymentsCancel_594342, base: "",
    url: url_DeploymentsCancel_594343, schemes: {Scheme.Https})
type
  Call_DeploymentsExportTemplate_594352 = ref object of OpenApiRestCall_593437
proc url_DeploymentsExportTemplate_594354(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsExportTemplate_594353(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Exports the template used for specified deployment.
  ## 
  var section: JsonNode
  ...
  var valid_594356 = path.getOrDefault("deploymentName")
  valid_594356 = validateParameter(valid_594356, JString, required = true,
                                 default = nil)
  if valid_594356 != nil:
    section.add "deploymentName", valid_594356
...
proc call*(call_594359: Call_DeploymentsExportTemplate_594352; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports the template used for specified deployment.
  ## 
...
proc call*(call_594360: Call_DeploymentsExportTemplate_594352;
          resourceGroupName: string; apiVersion: string; deploymentName: string;
          subscriptionId: string): Recallable =
  ...
  add(path_594361, "deploymentName", newJString(deploymentName))
  add(path_594361, "subscriptionId", newJString(subscriptionId))
  result = call_594360.call(path_594361, query_594362, nil, nil, nil)

var deploymentsExportTemplate* = Call_DeploymentsExportTemplate_594352(
    ...
    validator: validate_DeploymentsExportTemplate_594353, base: "",
    url: url_DeploymentsExportTemplate_594354, schemes: {Scheme.Https})
type
  Call_DeploymentsValidate_594363 = ref object of OpenApiRestCall_593437
proc url_DeploymentsValidate_594365(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DeploymentsValidate_594364(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ## Validates whether the specified template is syntactically correct and will be accepted by Azure Resource Manager..
  ## 
  ...
  var valid_594367 = path.getOrDefault("deploymentName")
  valid_594367 = validateParameter(valid_594367, JString, required = true,
                                 default = nil)
  if valid_594367 != nil:
    section.add "deploymentName", valid_594367
...
proc call*(call_594371: Call_DeploymentsValidate_594363; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Validates whether the specified template is syntactically correct and will be accepted by Azure Resource Manager..
  ## 
...
proc call*(call_594372: Call_DeploymentsValidate_594363; resourceGroupName: string;
          apiVersion: string; deploymentName: string; subscriptionId: string;
          parameters: JsonNode): Recallable =
  ## deploymentsValidate
  ## Validates whether the specified template is syntactically correct and will be accepted by Azure Resource Manager..
  ...
  add(path_594373, "deploymentName", newJString(deploymentName))
...
var deploymentsValidate* = Call_DeploymentsValidate_594363(
    ...
    validator: validate_DeploymentsValidate_594364, base: "",
    url: url_DeploymentsValidate_594365, schemes: {Scheme.Https})
type
  Call_ResourcesCreateOrUpdate_594390 = ref object of OpenApiRestCall_593437
proc url_ResourcesCreateOrUpdate_594392(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ResourcesCreateOrUpdate_594391(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a resource.
  ## 
  var section: JsonNode
  ...
  var valid_594393 = path.getOrDefault("resourceType")
  valid_594393 = validateParameter(valid_594393, JString, required = true,
                                 default = nil)
  if valid_594393 != nil:
    section.add "resourceType", valid_594393
  ...
  var valid_594396 = path.getOrDefault("resourceName")
  valid_594396 = validateParameter(valid_594396, JString, required = true,
                                 default = nil)
  if valid_594396 != nil:
    section.add "resourceName", valid_594396
  var valid_594397 = path.getOrDefault("resourceProviderNamespace")
  valid_594397 = validateParameter(valid_594397, JString, required = true,
                                 default = nil)
  if valid_594397 != nil:
    section.add "resourceProviderNamespace", valid_594397
  var valid_594398 = path.getOrDefault("parentResourcePath")
  valid_594398 = validateParameter(valid_594398, JString, required = true,
                                 default = nil)
  if valid_594398 != nil:
    section.add "parentResourcePath", valid_594398
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
...
proc call*(call_594401: Call_ResourcesCreateOrUpdate_594390; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a resource.
  ## 
...
proc call*(call_594402: Call_ResourcesCreateOrUpdate_594390; resourceType: string;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594403, "resourceType", newJString(resourceType))
  ...
  add(path_594403, "resourceName", newJString(resourceName))
  if parameters != nil:
    body_594405 = parameters
  add(path_594403, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  add(path_594403, "parentResourcePath", newJString(parentResourcePath))
  result = call_594402.call(path_594403, query_594404, nil, nil, body_594405)

var resourcesCreateOrUpdate* = Call_ResourcesCreateOrUpdate_594390(
    ...
    validator: validate_ResourcesCreateOrUpdate_594391, base: "",
    url: url_ResourcesCreateOrUpdate_594392, schemes: {Scheme.Https})
type
  Call_ResourcesCheckExistence_594420 = ref object of OpenApiRestCall_593437
proc url_ResourcesCheckExistence_594422(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ResourcesCheckExistence_594421(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceType` field"
  var valid_594423 = path.getOrDefault("resourceType")
  valid_594423 = validateParameter(valid_594423, JString, required = true,
                                 default = nil)
  if valid_594423 != nil:
    section.add "resourceType", valid_594423
  ...
  var valid_594426 = path.getOrDefault("resourceName")
  valid_594426 = validateParameter(valid_594426, JString, required = true,
                                 default = nil)
  if valid_594426 != nil:
    section.add "resourceName", valid_594426
  var valid_594427 = path.getOrDefault("resourceProviderNamespace")
  valid_594427 = validateParameter(valid_594427, JString, required = true,
                                 default = nil)
  if valid_594427 != nil:
    section.add "resourceProviderNamespace", valid_594427
  var valid_594428 = path.getOrDefault("parentResourcePath")
  valid_594428 = validateParameter(valid_594428, JString, required = true,
                                 default = nil)
  if valid_594428 != nil:
    section.add "parentResourcePath", valid_594428
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594430: Call_ResourcesCheckExistence_594420; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Checks whether a resource exists.
  ## 
...
proc call*(call_594431: Call_ResourcesCheckExistence_594420; resourceType: string;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594432, "resourceType", newJString(resourceType))
  ...
  add(path_594432, "resourceName", newJString(resourceName))
  add(path_594432, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
...
var resourcesCheckExistence* = Call_ResourcesCheckExistence_594420(
    name: "resourcesCheckExistence", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{parentResourcePath}/{resourceType}/{resourceName}",
    validator: validate_ResourcesCheckExistence_594421, base: "",
    url: url_ResourcesCheckExistence_594422, schemes: {Scheme.Https})
type
  Call_ResourcesGet_594376 = ref object of OpenApiRestCall_593437
proc url_ResourcesGet_594378(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesGet_594377(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets a resource.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceType` field"
  var valid_594379 = path.getOrDefault("resourceType")
  valid_594379 = validateParameter(valid_594379, JString, required = true,
                                 default = nil)
  if valid_594379 != nil:
    section.add "resourceType", valid_594379
  ...
  var valid_594382 = path.getOrDefault("resourceName")
  valid_594382 = validateParameter(valid_594382, JString, required = true,
                                 default = nil)
  if valid_594382 != nil:
    section.add "resourceName", valid_594382
  var valid_594383 = path.getOrDefault("resourceProviderNamespace")
  valid_594383 = validateParameter(valid_594383, JString, required = true,
                                 default = nil)
  if valid_594383 != nil:
    section.add "resourceProviderNamespace", valid_594383
  var valid_594384 = path.getOrDefault("parentResourcePath")
  valid_594384 = validateParameter(valid_594384, JString, required = true,
                                 default = nil)
  if valid_594384 != nil:
    section.add "parentResourcePath", valid_594384
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594386: Call_ResourcesGet_594376; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a resource.
  ## 
...
proc call*(call_594387: Call_ResourcesGet_594376; resourceType: string;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          resourceName: string; resourceProviderNamespace: string;
          parentResourcePath: string): Recallable =
  ## resourcesGet
  ...
  add(path_594388, "resourceType", newJString(resourceType))
  ...
  add(path_594388, "resourceName", newJString(resourceName))
  add(path_594388, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  add(path_594388, "parentResourcePath", newJString(parentResourcePath))
  result = call_594387.call(path_594388, query_594389, nil, nil, nil)

var resourcesGet* = Call_ResourcesGet_594376(name: "resourcesGet",
    ...
    validator: validate_ResourcesGet_594377, base: "", url: url_ResourcesGet_594378,
    schemes: {Scheme.Https})
type
  Call_ResourcesUpdate_594434 = ref object of OpenApiRestCall_593437
proc url_ResourcesUpdate_594436(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesUpdate_594435(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ## Updates a resource.
  ## 
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceType` field"
  var valid_594437 = path.getOrDefault("resourceType")
  valid_594437 = validateParameter(valid_594437, JString, required = true,
                                 default = nil)
  if valid_594437 != nil:
    section.add "resourceType", valid_594437
  ...
  var valid_594440 = path.getOrDefault("resourceName")
  valid_594440 = validateParameter(valid_594440, JString, required = true,
                                 default = nil)
  if valid_594440 != nil:
    section.add "resourceName", valid_594440
  var valid_594441 = path.getOrDefault("resourceProviderNamespace")
  valid_594441 = validateParameter(valid_594441, JString, required = true,
                                 default = nil)
  if valid_594441 != nil:
    section.add "resourceProviderNamespace", valid_594441
  var valid_594442 = path.getOrDefault("parentResourcePath")
  valid_594442 = validateParameter(valid_594442, JString, required = true,
                                 default = nil)
  if valid_594442 != nil:
    section.add "parentResourcePath", valid_594442
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594445: Call_ResourcesUpdate_594434; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a resource.
  ## 
...
proc call*(call_594446: Call_ResourcesUpdate_594434; resourceType: string;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          resourceName: string; parameters: JsonNode;
          resourceProviderNamespace: string; parentResourcePath: string): Recallable =
  ## resourcesUpdate
  ...
  add(path_594447, "resourceType", newJString(resourceType))
  ...
  add(path_594447, "resourceName", newJString(resourceName))
  if parameters != nil:
    body_594449 = parameters
  add(path_594447, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  add(path_594447, "parentResourcePath", newJString(parentResourcePath))
  result = call_594446.call(path_594447, query_594448, nil, nil, body_594449)

var resourcesUpdate* = Call_ResourcesUpdate_594434(name: "resourcesUpdate",
    ...
    validator: validate_ResourcesUpdate_594435, base: "", url: url_ResourcesUpdate_594436,
    schemes: {Scheme.Https})
type
  Call_ResourcesDelete_594406 = ref object of OpenApiRestCall_593437
proc url_ResourcesDelete_594408(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesDelete_594407(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ## Deletes a resource.
  ## 
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceType` field"
  var valid_594409 = path.getOrDefault("resourceType")
  valid_594409 = validateParameter(valid_594409, JString, required = true,
                                 default = nil)
  if valid_594409 != nil:
    section.add "resourceType", valid_594409
  ...
  var valid_594412 = path.getOrDefault("resourceName")
  valid_594412 = validateParameter(valid_594412, JString, required = true,
                                 default = nil)
  if valid_594412 != nil:
    section.add "resourceName", valid_594412
  var valid_594413 = path.getOrDefault("resourceProviderNamespace")
  valid_594413 = validateParameter(valid_594413, JString, required = true,
                                 default = nil)
  if valid_594413 != nil:
    section.add "resourceProviderNamespace", valid_594413
  var valid_594414 = path.getOrDefault("parentResourcePath")
  valid_594414 = validateParameter(valid_594414, JString, required = true,
                                 default = nil)
  if valid_594414 != nil:
    section.add "parentResourcePath", valid_594414
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594416: Call_ResourcesDelete_594406; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a resource.
  ## 
...
proc call*(call_594417: Call_ResourcesDelete_594406; resourceType: string;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          resourceName: string; resourceProviderNamespace: string;
          parentResourcePath: string): Recallable =
  ## resourcesDelete
  ...
  add(path_594418, "resourceType", newJString(resourceType))
  ...
  add(path_594418, "resourceName", newJString(resourceName))
  add(path_594418, "resourceProviderNamespace",
      newJString(resourceProviderNamespace))
  add(path_594418, "parentResourcePath", newJString(parentResourcePath))
  result = call_594417.call(path_594418, query_594419, nil, nil, nil)

var resourcesDelete* = Call_ResourcesDelete_594406(name: "resourcesDelete",
    ...
    validator: validate_ResourcesDelete_594407, base: "", url: url_ResourcesDelete_594408,
    schemes: {Scheme.Https})
type
  Call_ResourcesList_594450 = ref object of OpenApiRestCall_593437
proc url_ResourcesList_594452(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesList_594451(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##          : The filter to apply on the operation.<br><br>The properties you can use for eq (equals) or ne (not equals) are: location, resourceType, name, resourceGroup, identity, identity/principalId, plan, plan/publisher, plan/product, plan/name, plan/version, and plan/promotionCode.<br><br>For example, to filter by a resource type, use: $filter=resourceType eq 'Microsoft.Network/virtualNetworks'<br><br>You can use substringof(value, property) in the filter. The properties you can use for substring are: name and resourceGroup.<br><br>For example, to get all resources with 'demo' anywhere in the name, use: $filter=substringof('demo', name)<br><br>You can link more than one substringof together by adding and/or operators.<br><br>You can filter by tag names and values. For example, to filter for a tag name and value, use $filter=tagName eq 'tag1' and tagValue eq 'Value1'<br><br>You can use some properties together when filtering. The combinations you can use are: substringof and/or resourceType, plan and plan/publisher and plan/name, identity and identity/principalId.
  section = newJObject()
  var valid_594454 = query.getOrDefault("$expand")
  valid_594454 = validateParameter(valid_594454, JString, required = false,
                                 default = nil)
  if valid_594454 != nil:
    section.add "$expand", valid_594454
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
  ...
  var valid_594456 = query.getOrDefault("$top")
  valid_594456 = validateParameter(valid_594456, JInt, required = false, default = nil)
  if valid_594456 != nil:
    section.add "$top", valid_594456
  var valid_594457 = query.getOrDefault("$filter")
  valid_594457 = validateParameter(valid_594457, JString, required = false,
                                 default = nil)
  if valid_594457 != nil:
    section.add "$filter", valid_594457
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_594458: Call_ResourcesList_594450; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the resources in a subscription.
  ## 
...
proc call*(call_594459: Call_ResourcesList_594450; apiVersion: string;
  ...
  add(query_594461, "$top", newJInt(Top))
  add(query_594461, "$filter", newJString(Filter))
  result = call_594459.call(path_594460, query_594461, nil, nil, nil)

var resourcesList* = Call_ResourcesList_594450(name: "resourcesList",
    meth: HttpMethod.HttpGet, host: "management.azure.com",
    route: "/subscriptions/{subscriptionId}/resources",
    validator: validate_ResourcesList_594451, base: "", url: url_ResourcesList_594452,
    schemes: {Scheme.Https})
type
  Call_TagsList_594462 = ref object of OpenApiRestCall_593437
proc url_TagsList_594464(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagsList_594463(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594467: Call_TagsList_594462; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the names and values of all resource tags that are defined in a subscription.
  ## 
...
proc call*(call_594468: Call_TagsList_594462; apiVersion: string;
          subscriptionId: string): Recallable =
  ## tagsList
  ## Gets the names and values of all resource tags that are defined in a subscription.
  ##   apiVersion: string (required)
...
var tagsList* = Call_TagsList_594462(name: "tagsList", meth: HttpMethod.HttpGet,
                                  host: "management.azure.com", route: "/subscriptions/{subscriptionId}/tagNames",
                                  validator: validate_TagsList_594463, base: "",
                                  url: url_TagsList_594464,
                                  schemes: {Scheme.Https})
type
  Call_TagsCreateOrUpdate_594471 = ref object of OpenApiRestCall_593437
proc url_TagsCreateOrUpdate_594473(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagsCreateOrUpdate_594472(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_594474 = path.getOrDefault("tagName")
  valid_594474 = validateParameter(valid_594474, JString, required = true,
                                 default = nil)
  if valid_594474 != nil:
    section.add "tagName", valid_594474
...
proc call*(call_594477: Call_TagsCreateOrUpdate_594471; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The tag name can have a maximum of 512 characters and is case insensitive. Tag names created by Azure have prefixes of microsoft, azure, or windows. You cannot create tags with one of these prefixes.
  ## 
...
proc call*(call_594478: Call_TagsCreateOrUpdate_594471; apiVersion: string;
  ...
  add(path_594479, "tagName", newJString(tagName))
  add(path_594479, "subscriptionId", newJString(subscriptionId))
  result = call_594478.call(path_594479, query_594480, nil, nil, nil)

var tagsCreateOrUpdate* = Call_TagsCreateOrUpdate_594471(
    name: "tagsCreateOrUpdate", meth: HttpMethod.HttpPut,
    host: "management.azure.com",
    route: "/subscriptions/{subscriptionId}/tagNames/{tagName}",
    validator: validate_TagsCreateOrUpdate_594472, base: "",
    url: url_TagsCreateOrUpdate_594473, schemes: {Scheme.Https})
type
  Call_TagsDelete_594481 = ref object of OpenApiRestCall_593437
proc url_TagsDelete_594483(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagsDelete_594482(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `tagName` field"
  var valid_594484 = path.getOrDefault("tagName")
  valid_594484 = validateParameter(valid_594484, JString, required = true,
                                 default = nil)
  if valid_594484 != nil:
    section.add "tagName", valid_594484
...
proc call*(call_594487: Call_TagsDelete_594481; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## You must remove all values from a resource tag before you can delete it.
  ## 
...
proc call*(call_594488: Call_TagsDelete_594481; apiVersion: string; tagName: string;
          subscriptionId: string): Recallable =
  ## tagsDelete
  ## You must remove all values from a resource tag before you can delete it.
  ##   apiVersion: string (required)
  ...
  add(path_594489, "tagName", newJString(tagName))
  add(path_594489, "subscriptionId", newJString(subscriptionId))
  result = call_594488.call(path_594489, query_594490, nil, nil, nil)

var tagsDelete* = Call_TagsDelete_594481(name: "tagsDelete",
                                      meth: HttpMethod.HttpDelete,
                                      host: "management.azure.com", route: "/subscriptions/{subscriptionId}/tagNames/{tagName}",
                                      validator: validate_TagsDelete_594482,
                                      base: "", url: url_TagsDelete_594483,
                                      schemes: {Scheme.Https})
type
  Call_TagsCreateOrUpdateValue_594491 = ref object of OpenApiRestCall_593437
proc url_TagsCreateOrUpdateValue_594493(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_TagsCreateOrUpdateValue_594492(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `tagName` field"
  var valid_594494 = path.getOrDefault("tagName")
  valid_594494 = validateParameter(valid_594494, JString, required = true,
                                 default = nil)
  if valid_594494 != nil:
    section.add "tagName", valid_594494
  ...
  var valid_594496 = path.getOrDefault("tagValue")
  valid_594496 = validateParameter(valid_594496, JString, required = true,
                                 default = nil)
  if valid_594496 != nil:
    section.add "tagValue", valid_594496
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594498: Call_TagsCreateOrUpdateValue_594491; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a tag value. The name of the tag must already exist.
  ## 
...
proc call*(call_594499: Call_TagsCreateOrUpdateValue_594491; apiVersion: string;
  ...
  add(path_594500, "tagName", newJString(tagName))
  add(path_594500, "subscriptionId", newJString(subscriptionId))
  add(path_594500, "tagValue", newJString(tagValue))
  result = call_594499.call(path_594500, query_594501, nil, nil, nil)

var tagsCreateOrUpdateValue* = Call_TagsCreateOrUpdateValue_594491(
    ...
    validator: validate_TagsCreateOrUpdateValue_594492, base: "",
    url: url_TagsCreateOrUpdateValue_594493, schemes: {Scheme.Https})
type
  Call_TagsDeleteValue_594502 = ref object of OpenApiRestCall_593437
proc url_TagsDeleteValue_594504(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagsDeleteValue_594503(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ## Deletes a tag value.
  ## 
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `tagName` field"
  var valid_594505 = path.getOrDefault("tagName")
  valid_594505 = validateParameter(valid_594505, JString, required = true,
                                 default = nil)
  if valid_594505 != nil:
    section.add "tagName", valid_594505
  ...
  var valid_594507 = path.getOrDefault("tagValue")
  valid_594507 = validateParameter(valid_594507, JString, required = true,
                                 default = nil)
  if valid_594507 != nil:
    section.add "tagValue", valid_594507
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594509: Call_TagsDeleteValue_594502; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a tag value.
  ## 
...
proc call*(call_594510: Call_TagsDeleteValue_594502; apiVersion: string;
          tagName: string; subscriptionId: string; tagValue: string): Recallable =
  ## tagsDeleteValue
  ## Deletes a tag value.
  ##   apiVersion: string (required)
  ...
  add(path_594511, "tagName", newJString(tagName))
  add(path_594511, "subscriptionId", newJString(subscriptionId))
  add(path_594511, "tagValue", newJString(tagValue))
  result = call_594510.call(path_594511, query_594512, nil, nil, nil)

var tagsDeleteValue* = Call_TagsDeleteValue_594502(name: "tagsDeleteValue",
    ...
    validator: validate_TagsDeleteValue_594503, base: "", url: url_TagsDeleteValue_594504,
    schemes: {Scheme.Https})
type
  Call_ResourcesCreateOrUpdateById_594522 = ref object of OpenApiRestCall_593437
proc url_ResourcesCreateOrUpdateById_594524(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesCreateOrUpdateById_594523(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594525 = path.getOrDefault("resourceId")
  valid_594525 = validateParameter(valid_594525, JString, required = true,
                                 default = nil)
  if valid_594525 != nil:
    section.add "resourceId", valid_594525
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594528: Call_ResourcesCreateOrUpdateById_594522; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create a resource by ID.
  ## 
...
proc call*(call_594529: Call_ResourcesCreateOrUpdateById_594522;
  ...
  add(path_594530, "resourceId", newJString(resourceId))
  if parameters != nil:
    body_594532 = parameters
  result = call_594529.call(path_594530, query_594531, nil, nil, body_594532)

var resourcesCreateOrUpdateById* = Call_ResourcesCreateOrUpdateById_594522(
    name: "resourcesCreateOrUpdateById", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/{resourceId}",
    validator: validate_ResourcesCreateOrUpdateById_594523, base: "",
    url: url_ResourcesCreateOrUpdateById_594524, schemes: {Scheme.Https})
type
  Call_ResourcesCheckExistenceById_594542 = ref object of OpenApiRestCall_593437
proc url_ResourcesCheckExistenceById_594544(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesCheckExistenceById_594543(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceId` field"
  var valid_594545 = path.getOrDefault("resourceId")
  valid_594545 = validateParameter(valid_594545, JString, required = true,
                                 default = nil)
  if valid_594545 != nil:
    section.add "resourceId", valid_594545
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594547: Call_ResourcesCheckExistenceById_594542; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Checks by ID whether a resource exists.
  ## 
...
proc call*(call_594548: Call_ResourcesCheckExistenceById_594542;
  ...
  add(path_594549, "resourceId", newJString(resourceId))
  result = call_594548.call(path_594549, query_594550, nil, nil, nil)

var resourcesCheckExistenceById* = Call_ResourcesCheckExistenceById_594542(
    name: "resourcesCheckExistenceById", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/{resourceId}",
    validator: validate_ResourcesCheckExistenceById_594543, base: "",
    url: url_ResourcesCheckExistenceById_594544, schemes: {Scheme.Https})
type
  Call_ResourcesGetById_594513 = ref object of OpenApiRestCall_593437
proc url_ResourcesGetById_594515(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesGetById_594514(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceId` field"
  var valid_594516 = path.getOrDefault("resourceId")
  valid_594516 = validateParameter(valid_594516, JString, required = true,
                                 default = nil)
  if valid_594516 != nil:
    section.add "resourceId", valid_594516
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594518: Call_ResourcesGetById_594513; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a resource by ID.
  ## 
...
proc call*(call_594519: Call_ResourcesGetById_594513; apiVersion: string;
  ...
  add(path_594520, "resourceId", newJString(resourceId))
  result = call_594519.call(path_594520, query_594521, nil, nil, nil)

var resourcesGetById* = Call_ResourcesGetById_594513(name: "resourcesGetById",
    meth: HttpMethod.HttpGet, host: "management.azure.com", route: "/{resourceId}",
    validator: validate_ResourcesGetById_594514, base: "",
    url: url_ResourcesGetById_594515, schemes: {Scheme.Https})
type
  Call_ResourcesUpdateById_594551 = ref object of OpenApiRestCall_593437
proc url_ResourcesUpdateById_594553(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesUpdateById_594552(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceId` field"
  var valid_594554 = path.getOrDefault("resourceId")
  valid_594554 = validateParameter(valid_594554, JString, required = true,
                                 default = nil)
  if valid_594554 != nil:
    section.add "resourceId", valid_594554
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594557: Call_ResourcesUpdateById_594551; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a resource by ID.
  ## 
...
proc call*(call_594558: Call_ResourcesUpdateById_594551; apiVersion: string;
  ...
  add(path_594559, "resourceId", newJString(resourceId))
  if parameters != nil:
    body_594561 = parameters
  result = call_594558.call(path_594559, query_594560, nil, nil, body_594561)

var resourcesUpdateById* = Call_ResourcesUpdateById_594551(
    name: "resourcesUpdateById", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/{resourceId}",
    validator: validate_ResourcesUpdateById_594552, base: "",
    url: url_ResourcesUpdateById_594553, schemes: {Scheme.Https})
type
  Call_ResourcesDeleteById_594533 = ref object of OpenApiRestCall_593437
proc url_ResourcesDeleteById_594535(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourcesDeleteById_594534(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `resourceId` field"
  var valid_594536 = path.getOrDefault("resourceId")
  valid_594536 = validateParameter(valid_594536, JString, required = true,
                                 default = nil)
  if valid_594536 != nil:
    section.add "resourceId", valid_594536
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the operation.
...
proc call*(call_594538: Call_ResourcesDeleteById_594533; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a resource by ID.
  ## 
...
proc call*(call_594539: Call_ResourcesDeleteById_594533; apiVersion: string;
          resourceId: string): Recallable =
  ## resourcesDeleteById
  ## Deletes a resource by ID.
  ##   apiVersion: string (required)
  ...
  add(path_594540, "resourceId", newJString(resourceId))
  result = call_594539.call(path_594540, query_594541, nil, nil, nil)

var resourcesDeleteById* = Call_ResourcesDeleteById_594533(
    name: "resourcesDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{resourceId}",
    validator: validate_ResourcesDeleteById_594534, base: "",
    url: url_ResourcesDeleteById_594535, schemes: {Scheme.Https})
export
  rest
