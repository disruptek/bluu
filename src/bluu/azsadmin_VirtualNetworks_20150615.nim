...
type
  Call_VirtualNetworksList_563761 = ref object of OpenApiRestCall_563539
proc url_VirtualNetworksList_563763(protocol: Scheme; host: string; base: string;
...
proc validate_VirtualNetworksList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563972: Call_VirtualNetworksList_563761; path: JsonNode;
...
proc call*(call_564043: Call_VirtualNetworksList_563761; subscriptionId: string;
...
var virtualNetworksList* = Call_VirtualNetworksList_563761(
    ...
    validator: validate_VirtualNetworksList_563762, base: "",
    url: url_VirtualNetworksList_563763, schemes: {Scheme.Https})
export
  rest
