...
type
  Call_VirtualNetworksList_593630 = ref object of OpenApiRestCall_593408
proc url_VirtualNetworksList_593632(protocol: Scheme; host: string; base: string;
...
proc validate_VirtualNetworksList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593839: Call_VirtualNetworksList_593630; path: JsonNode;
...
proc call*(call_593910: Call_VirtualNetworksList_593630; subscriptionId: string;
...
var virtualNetworksList* = Call_VirtualNetworksList_593630(
    ...
    validator: validate_VirtualNetworksList_593631, base: "",
    url: url_VirtualNetworksList_593632, schemes: {Scheme.Https})
export
  rest
