...
type
  Call_DatabaseOperationsListByDatabase_567879 = ref object of OpenApiRestCall_567657
proc url_DatabaseOperationsListByDatabase_567881(protocol: Scheme; host: string;
...
proc validate_DatabaseOperationsListByDatabase_567880(path: JsonNode;
...
proc call*(call_568081: Call_DatabaseOperationsListByDatabase_567879;
...
proc call*(call_568152: Call_DatabaseOperationsListByDatabase_567879;
...
var databaseOperationsListByDatabase* = Call_DatabaseOperationsListByDatabase_567879(
    ...
    validator: validate_DatabaseOperationsListByDatabase_567880, base: "",
    url: url_DatabaseOperationsListByDatabase_567881, schemes: {Scheme.Https})
type
  Call_DatabaseOperationsCancel_568194 = ref object of OpenApiRestCall_567657
proc url_DatabaseOperationsCancel_568196(protocol: Scheme; host: string;
...
proc validate_DatabaseOperationsCancel_568195(path: JsonNode; query: JsonNode;
...
proc call*(call_568203: Call_DatabaseOperationsCancel_568194; path: JsonNode;
...
proc call*(call_568204: Call_DatabaseOperationsCancel_568194;
          resourceGroupName: string; apiVersion: string; serverName: string;
          subscriptionId: string; databaseName: string; operationId: string): Recallable =
...
var databaseOperationsCancel* = Call_DatabaseOperationsCancel_568194(
    ...
    validator: validate_DatabaseOperationsCancel_568195, base: "",
    url: url_DatabaseOperationsCancel_568196, schemes: {Scheme.Https})
export
  rest
