...
type
  Call_ContainerGroupsUpdate_564154 = ref object of OpenApiRestCall_563556
proc url_ContainerGroupsUpdate_564156(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerGroupsUpdate_564155(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564159 = path.getOrDefault("containerGroupName")
  valid_564159 = validateParameter(valid_564159, JString, required = true,
                                 default = nil)
  if valid_564159 != nil:
    section.add "containerGroupName", valid_564159
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_564162: Call_ContainerGroupsUpdate_564154; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates container group tags with specified values.
  ## 
...
proc call*(call_564163: Call_ContainerGroupsUpdate_564154; Resource: JsonNode;
  ...
  add(path_564164, "containerGroupName", newJString(containerGroupName))
  result = call_564163.call(path_564164, query_564165, nil, nil, body_564166)

var containerGroupsUpdate* = Call_ContainerGroupsUpdate_564154(
    name: "containerGroupsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroups/{containerGroupName}",
    validator: validate_ContainerGroupsUpdate_564155, base: "",
    url: url_ContainerGroupsUpdate_564156, schemes: {Scheme.Https})
type
...
type
  Call_ContainerExecuteCommand_564167 = ref object of OpenApiRestCall_563556
proc url_ContainerExecuteCommand_564169(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ContainerExecuteCommand_564168(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564172 = path.getOrDefault("containerName")
  valid_564172 = validateParameter(valid_564172, JString, required = true,
                                 default = nil)
  if valid_564172 != nil:
    section.add "containerName", valid_564172
  var valid_564173 = path.getOrDefault("containerGroupName")
  valid_564173 = validateParameter(valid_564173, JString, required = true,
                                 default = nil)
  if valid_564173 != nil:
    section.add "containerGroupName", valid_564173
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_564176: Call_ContainerExecuteCommand_564167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Executes a command for a specific container instance in a specified resource group and container group.
  ## 
...
proc call*(call_564177: Call_ContainerExecuteCommand_564167; apiVersion: string;
  ...
  add(path_564178, "containerName", newJString(containerName))
  if containerExecRequest != nil:
    body_564180 = containerExecRequest
  add(path_564178, "containerGroupName", newJString(containerGroupName))
  result = call_564177.call(path_564178, query_564179, nil, nil, body_564180)

var containerExecuteCommand* = Call_ContainerExecuteCommand_564167(
    ...
    validator: validate_ContainerExecuteCommand_564168, base: "",
    url: url_ContainerExecuteCommand_564169, schemes: {Scheme.Https})
type
  Call_ContainerListLogs_564181 = ref object of OpenApiRestCall_563556
proc url_ContainerListLogs_564183(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerListLogs_564182(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_564187 = path.getOrDefault("containerGroupName")
  valid_564187 = validateParameter(valid_564187, JString, required = true,
                                 default = nil)
  if valid_564187 != nil:
    section.add "containerGroupName", valid_564187
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_564190: Call_ContainerListLogs_564181; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the logs for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_564191: Call_ContainerListLogs_564181; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; containerName: string;
  ...
  add(query_564193, "tail", newJInt(tail))
  add(path_564192, "resourceGroupName", newJString(resourceGroupName))
  add(path_564192, "containerName", newJString(containerName))
  add(path_564192, "containerGroupName", newJString(containerGroupName))
  result = call_564191.call(path_564192, query_564193, nil, nil, nil)

var containerListLogs* = Call_ContainerListLogs_564181(name: "containerListLogs",
    ...
    validator: validate_ContainerListLogs_564182, base: "",
    url: url_ContainerListLogs_564183, schemes: {Scheme.Https})
type
  Call_ContainerGroupsRestart_564194 = ref object of OpenApiRestCall_563556
proc url_ContainerGroupsRestart_564196(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerGroupsRestart_564195(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564199 = path.getOrDefault("containerGroupName")
  valid_564199 = validateParameter(valid_564199, JString, required = true,
                                 default = nil)
  if valid_564199 != nil:
    section.add "containerGroupName", valid_564199
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_564201: Call_ContainerGroupsRestart_564194; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Restarts all containers in a container group in place. If container image has updates, new image will be downloaded.
  ## 
...
proc call*(call_564202: Call_ContainerGroupsRestart_564194; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          containerGroupName: string): Recallable =
  ...
  add(path_564203, "containerGroupName", newJString(containerGroupName))
  result = call_564202.call(path_564203, query_564204, nil, nil, nil)

var containerGroupsRestart* = Call_ContainerGroupsRestart_564194(
    ...
    validator: validate_ContainerGroupsRestart_564195, base: "",
    url: url_ContainerGroupsRestart_564196, schemes: {Scheme.Https})
type
  Call_ContainerGroupsStop_564205 = ref object of OpenApiRestCall_563556
proc url_ContainerGroupsStop_564207(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerGroupsStop_564206(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564210 = path.getOrDefault("containerGroupName")
  valid_564210 = validateParameter(valid_564210, JString, required = true,
                                 default = nil)
  if valid_564210 != nil:
    section.add "containerGroupName", valid_564210
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_564212: Call_ContainerGroupsStop_564205; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops all containers in a container group. Compute resources will be deallocated and billing will stop.
  ## 
...
proc call*(call_564213: Call_ContainerGroupsStop_564205; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          containerGroupName: string): Recallable =
  ## containerGroupsStop
  ## Stops all containers in a container group. Compute resources will be deallocated and billing will stop.
  ...
  add(path_564214, "containerGroupName", newJString(containerGroupName))
  result = call_564213.call(path_564214, query_564215, nil, nil, nil)

var containerGroupsStop* = Call_ContainerGroupsStop_564205(
    ...
    validator: validate_ContainerGroupsStop_564206, base: "",
    url: url_ContainerGroupsStop_564207, schemes: {Scheme.Https})
export
  rest
