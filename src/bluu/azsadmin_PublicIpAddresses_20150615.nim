...
type
  Call_PublicIPAddressesList_574663 = ref object of OpenApiRestCall_574441
proc url_PublicIPAddressesList_574665(protocol: Scheme; host: string; base: string;
...
proc validate_PublicIPAddressesList_574664(path: JsonNode; query: JsonNode;
...
proc call*(call_574872: Call_PublicIPAddressesList_574663; path: JsonNode;
...
proc call*(call_574943: Call_PublicIPAddressesList_574663; subscriptionId: string;
...
var publicIPAddressesList* = Call_PublicIPAddressesList_574663(
    ...
    validator: validate_PublicIPAddressesList_574664, base: "",
    url: url_PublicIPAddressesList_574665, schemes: {Scheme.Https})
export
  rest
