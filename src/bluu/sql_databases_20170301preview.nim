...
var databasesDelete* = Call_DatabasesDelete_593986(name: "databasesDelete",
    ...
    schemes: {Scheme.Https})
type
  Call_DatabasesExport_594012 = ref object of OpenApiRestCall_593424
proc url_DatabasesExport_594014(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabasesExport_594013(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ## Exports a database.
  ## 
...
proc call*(call_594021: Call_DatabasesExport_594012; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports a database.
  ## 
...
proc call*(call_594022: Call_DatabasesExport_594012; resourceGroupName: string;
          apiVersion: string; serverName: string; subscriptionId: string;
          databaseName: string; parameters: JsonNode): Recallable =
  ## databasesExport
  ## Exports a database.
...
var databasesExport* = Call_DatabasesExport_594012(name: "databasesExport",
    ...
    validator: validate_DatabasesExport_594013, base: "", url: url_DatabasesExport_594014,
    schemes: {Scheme.Https})
type
...
var databasesResume* = Call_DatabasesResume_594038(name: "databasesResume",
    ...
    schemes: {Scheme.Https})
type
  Call_DatabasesListByElasticPool_594050 = ref object of OpenApiRestCall_593424
proc url_DatabasesListByElasticPool_594052(protocol: Scheme; host: string;
...
proc validate_DatabasesListByElasticPool_594051(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594055 = path.getOrDefault("elasticPoolName")
  valid_594055 = validateParameter(valid_594055, JString, required = true,
                                 default = nil)
  if valid_594055 != nil:
    section.add "elasticPoolName", valid_594055
...
proc call*(call_594058: Call_DatabasesListByElasticPool_594050; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of databases in an elastic pool.
  ## 
...
proc call*(call_594059: Call_DatabasesListByElasticPool_594050;
          resourceGroupName: string; apiVersion: string; serverName: string;
  ...
  add(path_594060, "elasticPoolName", newJString(elasticPoolName))
  add(path_594060, "subscriptionId", newJString(subscriptionId))
  result = call_594059.call(path_594060, query_594061, nil, nil, nil)

var databasesListByElasticPool* = Call_DatabasesListByElasticPool_594050(
    ...
    validator: validate_DatabasesListByElasticPool_594051, base: "",
    url: url_DatabasesListByElasticPool_594052, schemes: {Scheme.Https})
export
  rest
