...
type
  Call_ProductListByTags_563777 = ref object of OpenApiRestCall_563555
proc url_ProductListByTags_563779(protocol: Scheme; host: string; base: string;
...
proc validate_ProductListByTags_563778(path: JsonNode; query: JsonNode;
  ...
  var valid_563947 = query.getOrDefault("includeNotTaggedProducts")
  valid_563947 = validateParameter(valid_563947, JBool, required = false, default = nil)
  if valid_563947 != nil:
    section.add "includeNotTaggedProducts", valid_563947
...
proc call*(call_563976: Call_ProductListByTags_563777; path: JsonNode;
...
proc call*(call_564047: Call_ProductListByTags_563777; serviceName: string;
  ...
  add(query_564050, "includeNotTaggedProducts", newJBool(includeNotTaggedProducts))
...
var productListByTags* = Call_ProductListByTags_563777(name: "productListByTags",
    ...
    validator: validate_ProductListByTags_563778, base: "",
    url: url_ProductListByTags_563779, schemes: {Scheme.Https})
export
  rest
