...
type
  Call_RegionListByService_593646 = ref object of OpenApiRestCall_593424
proc url_RegionListByService_593648(protocol: Scheme; host: string; base: string;
...
proc validate_RegionListByService_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593838: Call_RegionListByService_593646; path: JsonNode;
...
proc call*(call_593909: Call_RegionListByService_593646; resourceGroupName: string;
...
var regionListByService* = Call_RegionListByService_593646(
    ...
    validator: validate_RegionListByService_593647, base: "",
    url: url_RegionListByService_593648, schemes: {Scheme.Https})
export
  rest
