...
type
  Call_RegionListByService_563777 = ref object of OpenApiRestCall_563555
proc url_RegionListByService_563779(protocol: Scheme; host: string; base: string;
...
proc validate_RegionListByService_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563971: Call_RegionListByService_563777; path: JsonNode;
...
proc call*(call_564042: Call_RegionListByService_563777; serviceName: string;
...
var regionListByService* = Call_RegionListByService_563777(
    ...
    validator: validate_RegionListByService_563778, base: "",
    url: url_RegionListByService_563779, schemes: {Scheme.Https})
export
  rest
