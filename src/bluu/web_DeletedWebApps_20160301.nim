...
type
  Call_DeletedWebAppsList_593630 = ref object of OpenApiRestCall_593408
proc url_DeletedWebAppsList_593632(protocol: Scheme; host: string; base: string;
...
proc validate_DeletedWebAppsList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593829: Call_DeletedWebAppsList_593630; path: JsonNode;
...
proc call*(call_593900: Call_DeletedWebAppsList_593630; apiVersion: string;
...
var deletedWebAppsList* = Call_DeletedWebAppsList_593630(
    ...
    validator: validate_DeletedWebAppsList_593631, base: "",
    url: url_DeletedWebAppsList_593632, schemes: {Scheme.Https})
export
  rest
