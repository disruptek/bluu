...
type
  Call_ManagedDatabasesCompleteRestore_593630 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesCompleteRestore_593632(protocol: Scheme; host: string;
...
proc validate_ManagedDatabasesCompleteRestore_593631(path: JsonNode;
  ...
  var valid_593806 = path.getOrDefault("locationName")
  valid_593806 = validateParameter(valid_593806, JString, required = true,
                                 default = nil)
  if valid_593806 != nil:
    section.add "locationName", valid_593806
  var valid_593807 = path.getOrDefault("operationId")
  valid_593807 = validateParameter(valid_593807, JString, required = true,
                                 default = nil)
  if valid_593807 != nil:
    section.add "operationId", valid_593807
...
proc call*(call_593832: Call_ManagedDatabasesCompleteRestore_593630;
...
proc call*(call_593903: Call_ManagedDatabasesCompleteRestore_593630;
  ...
  add(path_593904, "locationName", newJString(locationName))
  add(path_593904, "operationId", newJString(operationId))
  result = call_593903.call(path_593904, query_593906, nil, nil, body_593907)

var managedDatabasesCompleteRestore* = Call_ManagedDatabasesCompleteRestore_593630(
    ...
    validator: validate_ManagedDatabasesCompleteRestore_593631, base: "",
    url: url_ManagedDatabasesCompleteRestore_593632, schemes: {Scheme.Https})
type
  Call_ManagedDatabasesListByInstance_593946 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesListByInstance_593948(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedDatabasesListByInstance_593947(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593953: Call_ManagedDatabasesListByInstance_593946; path: JsonNode;
...
proc call*(call_593954: Call_ManagedDatabasesListByInstance_593946;
  ...
  add(path_593955, "managedInstanceName", newJString(managedInstanceName))
  add(path_593955, "subscriptionId", newJString(subscriptionId))
  result = call_593954.call(path_593955, query_593956, nil, nil, nil)

var managedDatabasesListByInstance* = Call_ManagedDatabasesListByInstance_593946(
    ...
    validator: validate_ManagedDatabasesListByInstance_593947, base: "",
    url: url_ManagedDatabasesListByInstance_593948, schemes: {Scheme.Https})
type
  Call_ManagedDatabasesCreateOrUpdate_593969 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesCreateOrUpdate_593971(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedDatabasesCreateOrUpdate_593970(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593975 = path.getOrDefault("databaseName")
  valid_593975 = validateParameter(valid_593975, JString, required = true,
                                 default = nil)
  if valid_593975 != nil:
    section.add "databaseName", valid_593975
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593978: Call_ManagedDatabasesCreateOrUpdate_593969; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new database or updates an existing database.
  ## 
...
proc call*(call_593979: Call_ManagedDatabasesCreateOrUpdate_593969;
          resourceGroupName: string; apiVersion: string;
  ...
  add(path_593980, "databaseName", newJString(databaseName))
  if parameters != nil:
    body_593982 = parameters
  result = call_593979.call(path_593980, query_593981, nil, nil, body_593982)

var managedDatabasesCreateOrUpdate* = Call_ManagedDatabasesCreateOrUpdate_593969(
    ...
    validator: validate_ManagedDatabasesCreateOrUpdate_593970, base: "",
    url: url_ManagedDatabasesCreateOrUpdate_593971, schemes: {Scheme.Https})
type
  Call_ManagedDatabasesGet_593957 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesGet_593959(protocol: Scheme; host: string; base: string;
...
proc validate_ManagedDatabasesGet_593958(path: JsonNode; query: JsonNode;
  ...
  var valid_593961 = path.getOrDefault("managedInstanceName")
  valid_593961 = validateParameter(valid_593961, JString, required = true,
                                 default = nil)
  if valid_593961 != nil:
    section.add "managedInstanceName", valid_593961
  var valid_593962 = path.getOrDefault("subscriptionId")
  valid_593962 = validateParameter(valid_593962, JString, required = true,
                                 default = nil)
  if valid_593962 != nil:
    section.add "subscriptionId", valid_593962
  var valid_593963 = path.getOrDefault("databaseName")
  valid_593963 = validateParameter(valid_593963, JString, required = true,
                                 default = nil)
  if valid_593963 != nil:
    section.add "databaseName", valid_593963
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593965: Call_ManagedDatabasesGet_593957; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a managed database.
  ## 
...
proc call*(call_593966: Call_ManagedDatabasesGet_593957; resourceGroupName: string;
  ...
  add(path_593967, "databaseName", newJString(databaseName))
  result = call_593966.call(path_593967, query_593968, nil, nil, nil)

var managedDatabasesGet* = Call_ManagedDatabasesGet_593957(
    name: "managedDatabasesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}",
    validator: validate_ManagedDatabasesGet_593958, base: "",
    url: url_ManagedDatabasesGet_593959, schemes: {Scheme.Https})
type
  Call_ManagedDatabasesUpdate_593995 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesUpdate_593997(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedDatabasesUpdate_593996(path: JsonNode; query: JsonNode;
  ...
  var valid_593999 = path.getOrDefault("managedInstanceName")
  valid_593999 = validateParameter(valid_593999, JString, required = true,
                                 default = nil)
  if valid_593999 != nil:
    section.add "managedInstanceName", valid_593999
...
proc call*(call_594004: Call_ManagedDatabasesUpdate_593995; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing database.
  ## 
...
proc call*(call_594005: Call_ManagedDatabasesUpdate_593995;
          resourceGroupName: string; apiVersion: string;
          managedInstanceName: string; subscriptionId: string; databaseName: string;
          parameters: JsonNode): Recallable =
...
var managedDatabasesUpdate* = Call_ManagedDatabasesUpdate_593995(
    name: "managedDatabasesUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}",
    validator: validate_ManagedDatabasesUpdate_593996, base: "",
    url: url_ManagedDatabasesUpdate_593997, schemes: {Scheme.Https})
type
  Call_ManagedDatabasesDelete_593983 = ref object of OpenApiRestCall_593408
proc url_ManagedDatabasesDelete_593985(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedDatabasesDelete_593984(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593989 = path.getOrDefault("databaseName")
  valid_593989 = validateParameter(valid_593989, JString, required = true,
                                 default = nil)
  if valid_593989 != nil:
    section.add "databaseName", valid_593989
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593991: Call_ManagedDatabasesDelete_593983; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a managed database.
  ## 
...
proc call*(call_593992: Call_ManagedDatabasesDelete_593983;
          resourceGroupName: string; apiVersion: string;
  ...
  add(path_593993, "databaseName", newJString(databaseName))
  result = call_593992.call(path_593993, query_593994, nil, nil, nil)

var managedDatabasesDelete* = Call_ManagedDatabasesDelete_593983(
    name: "managedDatabasesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}",
    validator: validate_ManagedDatabasesDelete_593984, base: "",
    url: url_ManagedDatabasesDelete_593985, schemes: {Scheme.Https})
export
  rest
