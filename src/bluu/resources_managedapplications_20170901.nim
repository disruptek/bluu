...
type
  Call_ApplicationDefinitionsCreateOrUpdateById_594088 = ref object of OpenApiRestCall_593425
proc url_ApplicationDefinitionsCreateOrUpdateById_594090(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsCreateOrUpdateById_594089(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application definition.
  ## 
  var section: JsonNode
  ...
  var valid_594091 = path.getOrDefault("applicationDefinitionId")
  valid_594091 = validateParameter(valid_594091, JString, required = true,
                                 default = nil)
  if valid_594091 != nil:
    section.add "applicationDefinitionId", valid_594091
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594094: Call_ApplicationDefinitionsCreateOrUpdateById_594088;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates a new managed application definition.
  ## 
...
proc call*(call_594095: Call_ApplicationDefinitionsCreateOrUpdateById_594088;
  ...
  add(path_594096, "applicationDefinitionId", newJString(applicationDefinitionId))
  if parameters != nil:
    body_594098 = parameters
  result = call_594095.call(path_594096, query_594097, nil, nil, body_594098)

var applicationDefinitionsCreateOrUpdateById* = Call_ApplicationDefinitionsCreateOrUpdateById_594088(
    ...
    validator: validate_ApplicationDefinitionsCreateOrUpdateById_594089, base: "",
    url: url_ApplicationDefinitionsCreateOrUpdateById_594090,
    schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsGetById_594079 = ref object of OpenApiRestCall_593425
proc url_ApplicationDefinitionsGetById_594081(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsGetById_594080(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_594082 = path.getOrDefault("applicationDefinitionId")
  valid_594082 = validateParameter(valid_594082, JString, required = true,
                                 default = nil)
  if valid_594082 != nil:
    section.add "applicationDefinitionId", valid_594082
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594084: Call_ApplicationDefinitionsGetById_594079; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application definition.
  ## 
...
proc call*(call_594085: Call_ApplicationDefinitionsGetById_594079;
  ...
  add(path_594086, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_594085.call(path_594086, query_594087, nil, nil, nil)

var applicationDefinitionsGetById* = Call_ApplicationDefinitionsGetById_594079(
    name: "applicationDefinitionsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsGetById_594080, base: "",
    url: url_ApplicationDefinitionsGetById_594081, schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsDeleteById_594099 = ref object of OpenApiRestCall_593425
proc url_ApplicationDefinitionsDeleteById_594101(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsDeleteById_594100(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_594102 = path.getOrDefault("applicationDefinitionId")
  valid_594102 = validateParameter(valid_594102, JString, required = true,
                                 default = nil)
  if valid_594102 != nil:
    section.add "applicationDefinitionId", valid_594102
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594104: Call_ApplicationDefinitionsDeleteById_594099;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes the managed application definition.
  ## 
...
proc call*(call_594105: Call_ApplicationDefinitionsDeleteById_594099;
          apiVersion: string; applicationDefinitionId: string): Recallable =
  ...
  add(path_594106, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_594105.call(path_594106, query_594107, nil, nil, nil)

var applicationDefinitionsDeleteById* = Call_ApplicationDefinitionsDeleteById_594099(
    name: "applicationDefinitionsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsDeleteById_594100, base: "",
    url: url_ApplicationDefinitionsDeleteById_594101, schemes: {Scheme.Https})
type
  Call_ApplicationsCreateOrUpdateById_594117 = ref object of OpenApiRestCall_593425
proc url_ApplicationsCreateOrUpdateById_594119(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsCreateOrUpdateById_594118(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application.
  ## 
  var section: JsonNode
  ...
  var valid_594120 = path.getOrDefault("applicationId")
  valid_594120 = validateParameter(valid_594120, JString, required = true,
                                 default = nil)
  if valid_594120 != nil:
    section.add "applicationId", valid_594120
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594123: Call_ApplicationsCreateOrUpdateById_594117; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new managed application.
  ## 
...
proc call*(call_594124: Call_ApplicationsCreateOrUpdateById_594117;
  ...
  add(path_594125, "applicationId", newJString(applicationId))
  if parameters != nil:
    body_594127 = parameters
  result = call_594124.call(path_594125, query_594126, nil, nil, body_594127)

var applicationsCreateOrUpdateById* = Call_ApplicationsCreateOrUpdateById_594117(
    name: "applicationsCreateOrUpdateById", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsCreateOrUpdateById_594118, base: "",
    url: url_ApplicationsCreateOrUpdateById_594119, schemes: {Scheme.Https})
type
  Call_ApplicationsGetById_594108 = ref object of OpenApiRestCall_593425
proc url_ApplicationsGetById_594110(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsGetById_594109(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ## Gets the managed application.
  ## 
...
proc call*(call_594113: Call_ApplicationsGetById_594108; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application.
  ## 
...
proc call*(call_594114: Call_ApplicationsGetById_594108; apiVersion: string;
  ...
  add(path_594115, "applicationId", newJString(applicationId))
  result = call_594114.call(path_594115, query_594116, nil, nil, nil)

var applicationsGetById* = Call_ApplicationsGetById_594108(
    name: "applicationsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsGetById_594109, base: "",
    url: url_ApplicationsGetById_594110, schemes: {Scheme.Https})
type
  Call_ApplicationsUpdateById_594137 = ref object of OpenApiRestCall_593425
proc url_ApplicationsUpdateById_594139(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsUpdateById_594138(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `applicationId` field"
  var valid_594140 = path.getOrDefault("applicationId")
  valid_594140 = validateParameter(valid_594140, JString, required = true,
                                 default = nil)
  if valid_594140 != nil:
    section.add "applicationId", valid_594140
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594143: Call_ApplicationsUpdateById_594137; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
...
proc call*(call_594144: Call_ApplicationsUpdateById_594137; apiVersion: string;
  ...
  add(path_594145, "applicationId", newJString(applicationId))
  if parameters != nil:
    body_594147 = parameters
  result = call_594144.call(path_594145, query_594146, nil, nil, body_594147)

var applicationsUpdateById* = Call_ApplicationsUpdateById_594137(
    name: "applicationsUpdateById", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsUpdateById_594138, base: "",
    url: url_ApplicationsUpdateById_594139, schemes: {Scheme.Https})
type
  Call_ApplicationsDeleteById_594128 = ref object of OpenApiRestCall_593425
proc url_ApplicationsDeleteById_594130(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsDeleteById_594129(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `applicationId` field"
  var valid_594131 = path.getOrDefault("applicationId")
  valid_594131 = validateParameter(valid_594131, JString, required = true,
                                 default = nil)
  if valid_594131 != nil:
    section.add "applicationId", valid_594131
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_594133: Call_ApplicationsDeleteById_594128; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the managed application.
  ## 
...
proc call*(call_594134: Call_ApplicationsDeleteById_594128; apiVersion: string;
          applicationId: string): Recallable =
  ...
  add(path_594135, "applicationId", newJString(applicationId))
  result = call_594134.call(path_594135, query_594136, nil, nil, nil)

var applicationsDeleteById* = Call_ApplicationsDeleteById_594128(
    name: "applicationsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsDeleteById_594129, base: "",
    url: url_ApplicationsDeleteById_594130, schemes: {Scheme.Https})
export
  rest
