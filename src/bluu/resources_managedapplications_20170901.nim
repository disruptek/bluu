...
type
  Call_ApplicationDefinitionsCreateOrUpdateById_564221 = ref object of OpenApiRestCall_563556
proc url_ApplicationDefinitionsCreateOrUpdateById_564223(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsCreateOrUpdateById_564222(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application definition.
  ## 
  var section: JsonNode
  ...
  var valid_564224 = path.getOrDefault("applicationDefinitionId")
  valid_564224 = validateParameter(valid_564224, JString, required = true,
                                 default = nil)
  if valid_564224 != nil:
    section.add "applicationDefinitionId", valid_564224
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564227: Call_ApplicationDefinitionsCreateOrUpdateById_564221;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates a new managed application definition.
  ## 
...
proc call*(call_564228: Call_ApplicationDefinitionsCreateOrUpdateById_564221;
  ...
  add(path_564229, "applicationDefinitionId", newJString(applicationDefinitionId))
  if parameters != nil:
    body_564231 = parameters
  result = call_564228.call(path_564229, query_564230, nil, nil, body_564231)

var applicationDefinitionsCreateOrUpdateById* = Call_ApplicationDefinitionsCreateOrUpdateById_564221(
    ...
    validator: validate_ApplicationDefinitionsCreateOrUpdateById_564222, base: "",
    url: url_ApplicationDefinitionsCreateOrUpdateById_564223,
    schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsGetById_564212 = ref object of OpenApiRestCall_563556
proc url_ApplicationDefinitionsGetById_564214(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsGetById_564213(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_564215 = path.getOrDefault("applicationDefinitionId")
  valid_564215 = validateParameter(valid_564215, JString, required = true,
                                 default = nil)
  if valid_564215 != nil:
    section.add "applicationDefinitionId", valid_564215
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564217: Call_ApplicationDefinitionsGetById_564212; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application definition.
  ## 
...
proc call*(call_564218: Call_ApplicationDefinitionsGetById_564212;
  ...
  add(path_564219, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_564218.call(path_564219, query_564220, nil, nil, nil)

var applicationDefinitionsGetById* = Call_ApplicationDefinitionsGetById_564212(
    name: "applicationDefinitionsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsGetById_564213, base: "",
    url: url_ApplicationDefinitionsGetById_564214, schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsDeleteById_564232 = ref object of OpenApiRestCall_563556
proc url_ApplicationDefinitionsDeleteById_564234(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsDeleteById_564233(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_564235 = path.getOrDefault("applicationDefinitionId")
  valid_564235 = validateParameter(valid_564235, JString, required = true,
                                 default = nil)
  if valid_564235 != nil:
    section.add "applicationDefinitionId", valid_564235
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564237: Call_ApplicationDefinitionsDeleteById_564232;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes the managed application definition.
  ## 
...
proc call*(call_564238: Call_ApplicationDefinitionsDeleteById_564232;
          apiVersion: string; applicationDefinitionId: string): Recallable =
  ...
  add(path_564239, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_564238.call(path_564239, query_564240, nil, nil, nil)

var applicationDefinitionsDeleteById* = Call_ApplicationDefinitionsDeleteById_564232(
    name: "applicationDefinitionsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsDeleteById_564233, base: "",
    url: url_ApplicationDefinitionsDeleteById_564234, schemes: {Scheme.Https})
type
  Call_ApplicationsCreateOrUpdateById_564250 = ref object of OpenApiRestCall_563556
proc url_ApplicationsCreateOrUpdateById_564252(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsCreateOrUpdateById_564251(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application.
  ## 
  var section: JsonNode
  ...
  var valid_564253 = path.getOrDefault("applicationId")
  valid_564253 = validateParameter(valid_564253, JString, required = true,
                                 default = nil)
  if valid_564253 != nil:
    section.add "applicationId", valid_564253
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564256: Call_ApplicationsCreateOrUpdateById_564250; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new managed application.
  ## 
...
proc call*(call_564257: Call_ApplicationsCreateOrUpdateById_564250;
  ...
  add(path_564258, "applicationId", newJString(applicationId))
  result = call_564257.call(path_564258, query_564259, nil, nil, body_564260)

var applicationsCreateOrUpdateById* = Call_ApplicationsCreateOrUpdateById_564250(
    name: "applicationsCreateOrUpdateById", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsCreateOrUpdateById_564251, base: "",
    url: url_ApplicationsCreateOrUpdateById_564252, schemes: {Scheme.Https})
type
  Call_ApplicationsGetById_564241 = ref object of OpenApiRestCall_563556
proc url_ApplicationsGetById_564243(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsGetById_564242(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ## Gets the managed application.
  ## 
...
proc call*(call_564246: Call_ApplicationsGetById_564241; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application.
  ## 
...
proc call*(call_564247: Call_ApplicationsGetById_564241; apiVersion: string;
  ...
  add(path_564248, "applicationId", newJString(applicationId))
  result = call_564247.call(path_564248, query_564249, nil, nil, nil)

var applicationsGetById* = Call_ApplicationsGetById_564241(
    name: "applicationsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsGetById_564242, base: "",
    url: url_ApplicationsGetById_564243, schemes: {Scheme.Https})
type
  Call_ApplicationsUpdateById_564270 = ref object of OpenApiRestCall_563556
proc url_ApplicationsUpdateById_564272(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsUpdateById_564271(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
  var section: JsonNode
...
proc call*(call_564276: Call_ApplicationsUpdateById_564270; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
...
proc call*(call_564277: Call_ApplicationsUpdateById_564270; apiVersion: string;
  ...
  add(path_564278, "applicationId", newJString(applicationId))
  result = call_564277.call(path_564278, query_564279, nil, nil, body_564280)

var applicationsUpdateById* = Call_ApplicationsUpdateById_564270(
    name: "applicationsUpdateById", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsUpdateById_564271, base: "",
    url: url_ApplicationsUpdateById_564272, schemes: {Scheme.Https})
type
  Call_ApplicationsDeleteById_564261 = ref object of OpenApiRestCall_563556
proc url_ApplicationsDeleteById_564263(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsDeleteById_564262(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `applicationId` field"
  var valid_564264 = path.getOrDefault("applicationId")
  valid_564264 = validateParameter(valid_564264, JString, required = true,
                                 default = nil)
  if valid_564264 != nil:
    section.add "applicationId", valid_564264
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_564266: Call_ApplicationsDeleteById_564261; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the managed application.
  ## 
...
proc call*(call_564267: Call_ApplicationsDeleteById_564261; apiVersion: string;
          applicationId: string): Recallable =
  ...
  add(path_564268, "applicationId", newJString(applicationId))
  result = call_564267.call(path_564268, query_564269, nil, nil, nil)

var applicationsDeleteById* = Call_ApplicationsDeleteById_564261(
    name: "applicationsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsDeleteById_564262, base: "",
    url: url_ApplicationsDeleteById_564263, schemes: {Scheme.Https})
export
  rest
