...
type
  Call_ApplicationDefinitionsCreateOrUpdateById_568321 = ref object of OpenApiRestCall_567658
proc url_ApplicationDefinitionsCreateOrUpdateById_568323(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
  assert path != nil, "path is required to populate template"
  assert "applicationDefinitionId" in path,
        "`applicationDefinitionId` is a required path parameter"
  const
    segments = @[(kind: ConstantSegment, value: "/"),
               (kind: VariableSegment, value: "applicationDefinitionId")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_ApplicationDefinitionsCreateOrUpdateById_568322(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application definition.
  ## 
  var section: JsonNode
  result = newJObject()
  ## parameters in `path` object:
  ##   applicationDefinitionId: JString (required)
  ##                          : The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, 
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_568324 = path.getOrDefault("applicationDefinitionId")
  valid_568324 = validateParameter(valid_568324, JString, required = true,
                                 default = nil)
  if valid_568324 != nil:
    section.add "applicationDefinitionId", valid_568324
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568327: Call_ApplicationDefinitionsCreateOrUpdateById_568321;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates a new managed application definition.
  ## 
...
proc call*(call_568328: Call_ApplicationDefinitionsCreateOrUpdateById_568321;
          apiVersion: string; applicationDefinitionId: string; parameters: JsonNode): Recallable =
  ...
  add(path_568329, "applicationDefinitionId", newJString(applicationDefinitionId))
  if parameters != nil:
    body_568331 = parameters
  result = call_568328.call(path_568329, query_568330, nil, nil, body_568331)

var applicationDefinitionsCreateOrUpdateById* = Call_ApplicationDefinitionsCreateOrUpdateById_568321(
    name: "applicationDefinitionsCreateOrUpdateById", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsCreateOrUpdateById_568322, base: "",
    url: url_ApplicationDefinitionsCreateOrUpdateById_568323,
    schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsGetById_568312 = ref object of OpenApiRestCall_567658
proc url_ApplicationDefinitionsGetById_568314(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsGetById_568313(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Gets the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_568315 = path.getOrDefault("applicationDefinitionId")
  valid_568315 = validateParameter(valid_568315, JString, required = true,
                                 default = nil)
  if valid_568315 != nil:
    section.add "applicationDefinitionId", valid_568315
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568317: Call_ApplicationDefinitionsGetById_568312; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application definition.
  ## 
...
proc call*(call_568318: Call_ApplicationDefinitionsGetById_568312;
          apiVersion: string; applicationDefinitionId: string): Recallable =
  ...
  add(path_568319, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_568318.call(path_568319, query_568320, nil, nil, nil)

var applicationDefinitionsGetById* = Call_ApplicationDefinitionsGetById_568312(
    name: "applicationDefinitionsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsGetById_568313, base: "",
    url: url_ApplicationDefinitionsGetById_568314, schemes: {Scheme.Https})
type
  Call_ApplicationDefinitionsDeleteById_568332 = ref object of OpenApiRestCall_567658
proc url_ApplicationDefinitionsDeleteById_568334(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationDefinitionsDeleteById_568333(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application definition.
  ## 
  var section: JsonNode
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `applicationDefinitionId` field"
  var valid_568335 = path.getOrDefault("applicationDefinitionId")
  valid_568335 = validateParameter(valid_568335, JString, required = true,
                                 default = nil)
  if valid_568335 != nil:
    section.add "applicationDefinitionId", valid_568335
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568337: Call_ApplicationDefinitionsDeleteById_568332;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Deletes the managed application definition.
  ## 
...
proc call*(call_568338: Call_ApplicationDefinitionsDeleteById_568332;
          apiVersion: string; applicationDefinitionId: string): Recallable =
  ...
  add(path_568339, "applicationDefinitionId", newJString(applicationDefinitionId))
  result = call_568338.call(path_568339, query_568340, nil, nil, nil)

var applicationDefinitionsDeleteById* = Call_ApplicationDefinitionsDeleteById_568332(
    name: "applicationDefinitionsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationDefinitionId}",
    validator: validate_ApplicationDefinitionsDeleteById_568333, base: "",
    url: url_ApplicationDefinitionsDeleteById_568334, schemes: {Scheme.Https})
type
  Call_ApplicationsCreateOrUpdateById_568350 = ref object of OpenApiRestCall_567658
proc url_ApplicationsCreateOrUpdateById_568352(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsCreateOrUpdateById_568351(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Creates a new managed application.
  ## 
  var section: JsonNode
  ...
  var valid_568353 = path.getOrDefault("applicationId")
  valid_568353 = validateParameter(valid_568353, JString, required = true,
                                 default = nil)
  if valid_568353 != nil:
    section.add "applicationId", valid_568353
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568356: Call_ApplicationsCreateOrUpdateById_568350; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new managed application.
  ## 
...
proc call*(call_568357: Call_ApplicationsCreateOrUpdateById_568350;
  ...
  add(path_568358, "applicationId", newJString(applicationId))
  if parameters != nil:
    body_568360 = parameters
  result = call_568357.call(path_568358, query_568359, nil, nil, body_568360)

var applicationsCreateOrUpdateById* = Call_ApplicationsCreateOrUpdateById_568350(
    name: "applicationsCreateOrUpdateById", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsCreateOrUpdateById_568351, base: "",
    url: url_ApplicationsCreateOrUpdateById_568352, schemes: {Scheme.Https})
type
  Call_ApplicationsGetById_568341 = ref object of OpenApiRestCall_567658
proc url_ApplicationsGetById_568343(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsGetById_568342(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ## Gets the managed application.
  ## 
...
proc call*(call_568346: Call_ApplicationsGetById_568341; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the managed application.
  ## 
...
proc call*(call_568347: Call_ApplicationsGetById_568341; apiVersion: string;
  ...
  add(path_568348, "applicationId", newJString(applicationId))
  result = call_568347.call(path_568348, query_568349, nil, nil, nil)

var applicationsGetById* = Call_ApplicationsGetById_568341(
    name: "applicationsGetById", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsGetById_568342, base: "",
    url: url_ApplicationsGetById_568343, schemes: {Scheme.Https})
type
  Call_ApplicationsUpdateById_568370 = ref object of OpenApiRestCall_567658
proc url_ApplicationsUpdateById_568372(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsUpdateById_568371(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `applicationId` field"
  var valid_568373 = path.getOrDefault("applicationId")
  valid_568373 = validateParameter(valid_568373, JString, required = true,
                                 default = nil)
  if valid_568373 != nil:
    section.add "applicationId", valid_568373
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568376: Call_ApplicationsUpdateById_568370; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing managed application. The only value that can be updated via PATCH currently is the tags.
  ## 
...
proc call*(call_568377: Call_ApplicationsUpdateById_568370; apiVersion: string;
  ...
  add(path_568378, "applicationId", newJString(applicationId))
  if parameters != nil:
    body_568380 = parameters
  result = call_568377.call(path_568378, query_568379, nil, nil, body_568380)

var applicationsUpdateById* = Call_ApplicationsUpdateById_568370(
    name: "applicationsUpdateById", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsUpdateById_568371, base: "",
    url: url_ApplicationsUpdateById_568372, schemes: {Scheme.Https})
type
  Call_ApplicationsDeleteById_568361 = ref object of OpenApiRestCall_567658
proc url_ApplicationsDeleteById_568363(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsDeleteById_568362(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Deletes the managed application.
  ## 
  var section: JsonNode
  ...
  assert path != nil,
        "path argument is necessary due to required `applicationId` field"
  var valid_568364 = path.getOrDefault("applicationId")
  valid_568364 = validateParameter(valid_568364, JString, required = true,
                                 default = nil)
  if valid_568364 != nil:
    section.add "applicationId", valid_568364
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for this operation.
...
proc call*(call_568366: Call_ApplicationsDeleteById_568361; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the managed application.
  ## 
...
proc call*(call_568367: Call_ApplicationsDeleteById_568361; apiVersion: string;
          applicationId: string): Recallable =
  ...
  add(path_568368, "applicationId", newJString(applicationId))
  result = call_568367.call(path_568368, query_568369, nil, nil, nil)

var applicationsDeleteById* = Call_ApplicationsDeleteById_568361(
    name: "applicationsDeleteById", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{applicationId}",
    validator: validate_ApplicationsDeleteById_568362, base: "",
    url: url_ApplicationsDeleteById_568363, schemes: {Scheme.Https})
export
  rest
