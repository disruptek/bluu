...
type
  Call_UsagesListByVaults_567880 = ref object of OpenApiRestCall_567658
proc url_UsagesListByVaults_567882(protocol: Scheme; host: string; base: string;
...
proc validate_UsagesListByVaults_567881(path: JsonNode; query: JsonNode;
...
proc call*(call_568081: Call_UsagesListByVaults_567880; path: JsonNode;
...
proc call*(call_568152: Call_UsagesListByVaults_567880; resourceGroupName: string;
...
var usagesListByVaults* = Call_UsagesListByVaults_567880(
    ...
    validator: validate_UsagesListByVaults_567881, base: "",
    url: url_UsagesListByVaults_567882, schemes: {Scheme.Https})
export
  rest
