...
type
  Call_UsagesListByVaults_593647 = ref object of OpenApiRestCall_593425
proc url_UsagesListByVaults_593649(protocol: Scheme; host: string; base: string;
...
proc validate_UsagesListByVaults_593648(path: JsonNode; query: JsonNode;
...
proc call*(call_593848: Call_UsagesListByVaults_593647; path: JsonNode;
...
proc call*(call_593919: Call_UsagesListByVaults_593647; resourceGroupName: string;
...
var usagesListByVaults* = Call_UsagesListByVaults_593647(
    ...
    validator: validate_UsagesListByVaults_593648, base: "",
    url: url_UsagesListByVaults_593649, schemes: {Scheme.Https})
export
  rest
