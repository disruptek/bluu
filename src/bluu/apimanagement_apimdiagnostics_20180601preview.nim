...
type
  Call_DiagnosticListByService_563777 = ref object of OpenApiRestCall_563555
proc url_DiagnosticListByService_563779(protocol: Scheme; host: string; base: string;
...
proc validate_DiagnosticListByService_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563975: Call_DiagnosticListByService_563777; path: JsonNode;
...
proc call*(call_564046: Call_DiagnosticListByService_563777; serviceName: string;
...
var diagnosticListByService* = Call_DiagnosticListByService_563777(
    ...
    validator: validate_DiagnosticListByService_563778, base: "",
    url: url_DiagnosticListByService_563779, schemes: {Scheme.Https})
type
  Call_DiagnosticCreateOrUpdate_564100 = ref object of OpenApiRestCall_563555
proc url_DiagnosticCreateOrUpdate_564102(protocol: Scheme; host: string;
...
proc validate_DiagnosticCreateOrUpdate_564101(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564137: Call_DiagnosticCreateOrUpdate_564100; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new Diagnostic or updates an existing one.
  ## 
...
proc call*(call_564138: Call_DiagnosticCreateOrUpdate_564100; serviceName: string;
...
var diagnosticCreateOrUpdate* = Call_DiagnosticCreateOrUpdate_564100(
    ...
    validator: validate_DiagnosticCreateOrUpdate_564101, base: "",
    url: url_DiagnosticCreateOrUpdate_564102, schemes: {Scheme.Https})
type
  Call_DiagnosticGetEntityTag_564155 = ref object of OpenApiRestCall_563555
...
type
  Call_DiagnosticGet_564088 = ref object of OpenApiRestCall_563555
proc url_DiagnosticGet_564090(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DiagnosticGet_564089(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_564093 = path.getOrDefault("diagnosticId")
  valid_564093 = validateParameter(valid_564093, JString, required = true,
                                 default = nil)
  if valid_564093 != nil:
    section.add "diagnosticId", valid_564093
...
proc call*(call_564096: Call_DiagnosticGet_564088; path: JsonNode; query: JsonNode;
...
proc call*(call_564097: Call_DiagnosticGet_564088; serviceName: string;
          apiVersion: string; subscriptionId: string; diagnosticId: string;
          resourceGroupName: string): Recallable =
  ## diagnosticGet
  ## Gets the details of the Diagnostic specified by its identifier.
  ...
  add(path_564098, "diagnosticId", newJString(diagnosticId))
...
var diagnosticGet* = Call_DiagnosticGet_564088(name: "diagnosticGet",
    ...
    validator: validate_DiagnosticGet_564089, base: "", url: url_DiagnosticGet_564090,
    schemes: {Scheme.Https})
type
  Call_DiagnosticUpdate_564167 = ref object of OpenApiRestCall_563555
...
type
  Call_DiagnosticDelete_564142 = ref object of OpenApiRestCall_563555
