...
type
  Call_BastionHostsUpdateTags_568237 = ref object of OpenApiRestCall_567641
proc url_BastionHostsUpdateTags_568239(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BastionHostsUpdateTags_568238(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568242 = path.getOrDefault("bastionHostName")
  valid_568242 = validateParameter(valid_568242, JString, required = true,
                                 default = nil)
  if valid_568242 != nil:
    section.add "bastionHostName", valid_568242
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_568245: Call_BastionHostsUpdateTags_568237; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates bastion host tags.
  ## 
...
proc call*(call_568246: Call_BastionHostsUpdateTags_568237;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_568247, "bastionHostName", newJString(bastionHostName))
  if bastionHostParameters != nil:
    body_568249 = bastionHostParameters
  result = call_568246.call(path_568247, query_568248, nil, nil, body_568249)

var bastionHostsUpdateTags* = Call_BastionHostsUpdateTags_568237(
    name: "bastionHostsUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}",
    validator: validate_BastionHostsUpdateTags_568238, base: "",
    url: url_BastionHostsUpdateTags_568239, schemes: {Scheme.Https})
type
