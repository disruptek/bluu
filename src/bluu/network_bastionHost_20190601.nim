...
type
  Call_BastionHostsUpdateTags_564137 = ref object of OpenApiRestCall_563539
proc url_BastionHostsUpdateTags_564139(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BastionHostsUpdateTags_564138(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564141 = path.getOrDefault("bastionHostName")
  valid_564141 = validateParameter(valid_564141, JString, required = true,
                                 default = nil)
  if valid_564141 != nil:
    section.add "bastionHostName", valid_564141
...
proc call*(call_564145: Call_BastionHostsUpdateTags_564137; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates bastion host tags.
  ## 
...
proc call*(call_564146: Call_BastionHostsUpdateTags_564137; apiVersion: string;
          subscriptionId: string; bastionHostName: string;
          resourceGroupName: string; bastionHostParameters: JsonNode): Recallable =
  ...
  add(path_564147, "bastionHostName", newJString(bastionHostName))
  add(path_564147, "resourceGroupName", newJString(resourceGroupName))
  if bastionHostParameters != nil:
    body_564149 = bastionHostParameters
  result = call_564146.call(path_564147, query_564148, nil, nil, body_564149)

var bastionHostsUpdateTags* = Call_BastionHostsUpdateTags_564137(
    name: "bastionHostsUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}",
    validator: validate_BastionHostsUpdateTags_564138, base: "",
    url: url_BastionHostsUpdateTags_564139, schemes: {Scheme.Https})
type
