...
proc call*(call_594004: Call_AuthorizationServerCreateOrUpdate_593976;
  ...
  add(path_594005, "authsid", newJString(authsid))
...
type
  Call_AuthorizationServerGetEntityTag_594021 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerGetEntityTag_594023(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerGetEntityTag_594022(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594025 = path.getOrDefault("authsid")
  valid_594025 = validateParameter(valid_594025, JString, required = true,
                                 default = nil)
  if valid_594025 != nil:
    section.add "authsid", valid_594025
...
proc call*(call_594029: Call_AuthorizationServerGetEntityTag_594021;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the authorizationServer specified by its identifier.
  ## 
...
proc call*(call_594030: Call_AuthorizationServerGetEntityTag_594021;
          resourceGroupName: string; apiVersion: string; authsid: string;
  ...
  add(path_594031, "authsid", newJString(authsid))
...
var authorizationServerGetEntityTag* = Call_AuthorizationServerGetEntityTag_594021(
    name: "authorizationServerGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerGetEntityTag_594022, base: "",
    url: url_AuthorizationServerGetEntityTag_594023, schemes: {Scheme.Https})
type
...
type
  Call_AuthorizationServerUpdate_594033 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerUpdate_594035(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerUpdate_594034(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594037 = path.getOrDefault("authsid")
  valid_594037 = validateParameter(valid_594037, JString, required = true,
                                 default = nil)
  if valid_594037 != nil:
    section.add "authsid", valid_594037
...
proc call*(call_594043: Call_AuthorizationServerUpdate_594033; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the authorization server specified by its identifier.
  ## 
...
proc call*(call_594044: Call_AuthorizationServerUpdate_594033;
          resourceGroupName: string; apiVersion: string; authsid: string;
          subscriptionId: string; parameters: JsonNode; serviceName: string): Recallable =
  ...
  add(path_594045, "authsid", newJString(authsid))
...
var authorizationServerUpdate* = Call_AuthorizationServerUpdate_594033(
    name: "authorizationServerUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerUpdate_594034, base: "",
    url: url_AuthorizationServerUpdate_594035, schemes: {Scheme.Https})
type
  Call_AuthorizationServerDelete_594008 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerDelete_594010(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerDelete_594009(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594012 = path.getOrDefault("authsid")
  valid_594012 = validateParameter(valid_594012, JString, required = true,
                                 default = nil)
  if valid_594012 != nil:
    section.add "authsid", valid_594012
...
proc call*(call_594017: Call_AuthorizationServerDelete_594008; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific authorization server instance.
  ## 
...
proc call*(call_594018: Call_AuthorizationServerDelete_594008;
          resourceGroupName: string; apiVersion: string; authsid: string;
          subscriptionId: string; serviceName: string): Recallable =
  ...
  add(path_594019, "authsid", newJString(authsid))
...
var authorizationServerDelete* = Call_AuthorizationServerDelete_594008(
    name: "authorizationServerDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerDelete_594009, base: "",
    url: url_AuthorizationServerDelete_594010, schemes: {Scheme.Https})
export
  rest
