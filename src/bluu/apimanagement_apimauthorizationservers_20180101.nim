...
type
  Call_AuthorizationServerCreateOrUpdate_564109 = ref object of OpenApiRestCall_563555
proc url_AuthorizationServerCreateOrUpdate_564111(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerCreateOrUpdate_564110(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564130 = path.getOrDefault("authsid")
  valid_564130 = validateParameter(valid_564130, JString, required = true,
                                 default = nil)
  if valid_564130 != nil:
    section.add "authsid", valid_564130
...
proc call*(call_564136: Call_AuthorizationServerCreateOrUpdate_564109;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new authorization server or updates an existing authorization server.
  ## 
...
proc call*(call_564137: Call_AuthorizationServerCreateOrUpdate_564109;
  ...
  add(path_564138, "authsid", newJString(authsid))
...
var authorizationServerCreateOrUpdate* = Call_AuthorizationServerCreateOrUpdate_564109(
    ...
    validator: validate_AuthorizationServerCreateOrUpdate_564110, base: "",
    url: url_AuthorizationServerCreateOrUpdate_564111, schemes: {Scheme.Https})
type
  Call_AuthorizationServerGetEntityTag_564154 = ref object of OpenApiRestCall_563555
proc url_AuthorizationServerGetEntityTag_564156(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerGetEntityTag_564155(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564158 = path.getOrDefault("authsid")
  valid_564158 = validateParameter(valid_564158, JString, required = true,
                                 default = nil)
  if valid_564158 != nil:
    section.add "authsid", valid_564158
...
proc call*(call_564162: Call_AuthorizationServerGetEntityTag_564154;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the authorizationServer specified by its identifier.
  ## 
...
proc call*(call_564163: Call_AuthorizationServerGetEntityTag_564154;
          serviceName: string; apiVersion: string; authsid: string;
  ...
  add(path_564164, "authsid", newJString(authsid))
...
var authorizationServerGetEntityTag* = Call_AuthorizationServerGetEntityTag_564154(
    name: "authorizationServerGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerGetEntityTag_564155, base: "",
    url: url_AuthorizationServerGetEntityTag_564156, schemes: {Scheme.Https})
type
...
proc call*(call_564105: Call_AuthorizationServerGet_564088; path: JsonNode;
...
proc call*(call_564106: Call_AuthorizationServerGet_564088; serviceName: string;
...
type
  Call_AuthorizationServerUpdate_564166 = ref object of OpenApiRestCall_563555
proc url_AuthorizationServerUpdate_564168(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerUpdate_564167(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564170 = path.getOrDefault("authsid")
  valid_564170 = validateParameter(valid_564170, JString, required = true,
                                 default = nil)
  if valid_564170 != nil:
    section.add "authsid", valid_564170
...
proc call*(call_564176: Call_AuthorizationServerUpdate_564166; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the authorization server specified by its identifier.
  ## 
...
proc call*(call_564177: Call_AuthorizationServerUpdate_564166; serviceName: string;
          apiVersion: string; authsid: string; subscriptionId: string;
  ...
  add(path_564178, "authsid", newJString(authsid))
...
var authorizationServerUpdate* = Call_AuthorizationServerUpdate_564166(
    name: "authorizationServerUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerUpdate_564167, base: "",
    url: url_AuthorizationServerUpdate_564168, schemes: {Scheme.Https})
type
  Call_AuthorizationServerDelete_564141 = ref object of OpenApiRestCall_563555
proc url_AuthorizationServerDelete_564143(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerDelete_564142(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564145 = path.getOrDefault("authsid")
  valid_564145 = validateParameter(valid_564145, JString, required = true,
                                 default = nil)
  if valid_564145 != nil:
    section.add "authsid", valid_564145
...
proc call*(call_564150: Call_AuthorizationServerDelete_564141; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific authorization server instance.
  ## 
...
proc call*(call_564151: Call_AuthorizationServerDelete_564141; serviceName: string;
          apiVersion: string; authsid: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564152, "authsid", newJString(authsid))
...
var authorizationServerDelete* = Call_AuthorizationServerDelete_564141(
    name: "authorizationServerDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerDelete_564142, base: "",
    url: url_AuthorizationServerDelete_564143, schemes: {Scheme.Https})
export
  rest
