...
var policyEventsListQueryResultsForResource* = Call_PolicyEventsListQueryResultsForResource_594017(
    ...
    schemes: {Scheme.Https})
type
  Call_PolicyEventsGetMetadata_594034 = ref object of OpenApiRestCall_593425
proc url_PolicyEventsGetMetadata_594036(protocol: Scheme; host: string; base: string;
...
proc validate_PolicyEventsGetMetadata_594035(path: JsonNode; query: JsonNode;
  ...
  var valid_594037 = path.getOrDefault("scope")
...
proc call*(call_594039: Call_PolicyEventsGetMetadata_594034; path: JsonNode;
...
proc call*(call_594040: Call_PolicyEventsGetMetadata_594034; apiVersion: string;
  ...
  add(path_594041, "scope", newJString(scope))
  result = call_594040.call(path_594041, query_594042, nil, nil, nil)

var policyEventsGetMetadata* = Call_PolicyEventsGetMetadata_594034(
    ...
    validator: validate_PolicyEventsGetMetadata_594035, base: "",
    url: url_PolicyEventsGetMetadata_594036, schemes: {Scheme.Https})
export
  rest
