...
type
  Call_InputsListByStreamingJob_567879 = ref object of OpenApiRestCall_567657
proc url_InputsListByStreamingJob_567881(protocol: Scheme; host: string;
...
proc validate_InputsListByStreamingJob_567880(path: JsonNode; query: JsonNode;
...
proc call*(call_568082: Call_InputsListByStreamingJob_567879; path: JsonNode;
...
proc call*(call_568153: Call_InputsListByStreamingJob_567879;
...
var inputsListByStreamingJob* = Call_InputsListByStreamingJob_567879(
    ...
    validator: validate_InputsListByStreamingJob_567880, base: "",
    url: url_InputsListByStreamingJob_567881, schemes: {Scheme.Https})
type
  Call_InputsCreateOrReplace_568207 = ref object of OpenApiRestCall_567657
proc url_InputsCreateOrReplace_568209(protocol: Scheme; host: string; base: string;
...
proc validate_InputsCreateOrReplace_568208(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568228 = path.getOrDefault("inputName")
  valid_568228 = validateParameter(valid_568228, JString, required = true,
                                 default = nil)
  if valid_568228 != nil:
    section.add "inputName", valid_568228
  var valid_568229 = path.getOrDefault("subscriptionId")
  valid_568229 = validateParameter(valid_568229, JString, required = true,
                                 default = nil)
  if valid_568229 != nil:
    section.add "subscriptionId", valid_568229
  var valid_568230 = path.getOrDefault("jobName")
  valid_568230 = validateParameter(valid_568230, JString, required = true,
                                 default = nil)
  if valid_568230 != nil:
    section.add "jobName", valid_568230
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_568235: Call_InputsCreateOrReplace_568207; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates an input or replaces an already existing input under an existing streaming job.
  ## 
...
proc call*(call_568236: Call_InputsCreateOrReplace_568207;
  ...
  add(path_568237, "inputName", newJString(inputName))
...
var inputsCreateOrReplace* = Call_InputsCreateOrReplace_568207(
    ...
    validator: validate_InputsCreateOrReplace_568208, base: "",
    url: url_InputsCreateOrReplace_568209, schemes: {Scheme.Https})
type
  Call_InputsGet_568195 = ref object of OpenApiRestCall_567657
proc url_InputsGet_568197(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InputsGet_568196(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_568199 = path.getOrDefault("inputName")
  valid_568199 = validateParameter(valid_568199, JString, required = true,
                                 default = nil)
  if valid_568199 != nil:
    section.add "inputName", valid_568199
  var valid_568200 = path.getOrDefault("subscriptionId")
  valid_568200 = validateParameter(valid_568200, JString, required = true,
                                 default = nil)
  if valid_568200 != nil:
    section.add "subscriptionId", valid_568200
  var valid_568201 = path.getOrDefault("jobName")
  valid_568201 = validateParameter(valid_568201, JString, required = true,
                                 default = nil)
  if valid_568201 != nil:
    section.add "jobName", valid_568201
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_568203: Call_InputsGet_568195; path: JsonNode; query: JsonNode;
...
proc call*(call_568204: Call_InputsGet_568195; resourceGroupName: string;
  ...
  add(path_568205, "inputName", newJString(inputName))
...
var inputsGet* = Call_InputsGet_568195(name: "inputsGet", meth: HttpMethod.HttpGet,
                                    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/inputs/{inputName}",
                                    validator: validate_InputsGet_568196,
                                    base: "", url: url_InputsGet_568197,
                                    schemes: {Scheme.Https})
type
  Call_InputsUpdate_568252 = ref object of OpenApiRestCall_567657
proc url_InputsUpdate_568254(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InputsUpdate_568253(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568256 = path.getOrDefault("inputName")
  valid_568256 = validateParameter(valid_568256, JString, required = true,
                                 default = nil)
  if valid_568256 != nil:
    section.add "inputName", valid_568256
  var valid_568257 = path.getOrDefault("subscriptionId")
  valid_568257 = validateParameter(valid_568257, JString, required = true,
                                 default = nil)
  if valid_568257 != nil:
    section.add "subscriptionId", valid_568257
  var valid_568258 = path.getOrDefault("jobName")
  valid_568258 = validateParameter(valid_568258, JString, required = true,
                                 default = nil)
  if valid_568258 != nil:
    section.add "jobName", valid_568258
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_568262: Call_InputsUpdate_568252; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing input under an existing streaming job. This can be used to partially update (ie. update one or two properties) an input without affecting the rest the job or input definition.
  ## 
...
proc call*(call_568263: Call_InputsUpdate_568252; resourceGroupName: string;
          apiVersion: string; inputName: string; subscriptionId: string;
  ...
  add(path_568264, "inputName", newJString(inputName))
...
var inputsUpdate* = Call_InputsUpdate_568252(name: "inputsUpdate",
    ...
    validator: validate_InputsUpdate_568253, base: "", url: url_InputsUpdate_568254,
    schemes: {Scheme.Https})
type
  Call_InputsDelete_568240 = ref object of OpenApiRestCall_567657
proc url_InputsDelete_568242(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InputsDelete_568241(path: JsonNode; query: JsonNode; header: JsonNode;
                                 formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568244 = path.getOrDefault("inputName")
  valid_568244 = validateParameter(valid_568244, JString, required = true,
                                 default = nil)
  if valid_568244 != nil:
    section.add "inputName", valid_568244
  var valid_568245 = path.getOrDefault("subscriptionId")
  valid_568245 = validateParameter(valid_568245, JString, required = true,
                                 default = nil)
  if valid_568245 != nil:
    section.add "subscriptionId", valid_568245
  var valid_568246 = path.getOrDefault("jobName")
  valid_568246 = validateParameter(valid_568246, JString, required = true,
                                 default = nil)
  if valid_568246 != nil:
    section.add "jobName", valid_568246
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_568248: Call_InputsDelete_568240; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an input from the streaming job.
  ## 
...
proc call*(call_568249: Call_InputsDelete_568240; resourceGroupName: string;
          apiVersion: string; inputName: string; subscriptionId: string;
          jobName: string): Recallable =
  ## inputsDelete
  ## Deletes an input from the streaming job.
  ...
  add(path_568250, "inputName", newJString(inputName))
...
var inputsDelete* = Call_InputsDelete_568240(name: "inputsDelete",
    ...
    validator: validate_InputsDelete_568241, base: "", url: url_InputsDelete_568242,
    schemes: {Scheme.Https})
type
  Call_InputsTest_568267 = ref object of OpenApiRestCall_567657
proc url_InputsTest_568269(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InputsTest_568268(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568271 = path.getOrDefault("inputName")
  valid_568271 = validateParameter(valid_568271, JString, required = true,
                                 default = nil)
  if valid_568271 != nil:
    section.add "inputName", valid_568271
  var valid_568272 = path.getOrDefault("subscriptionId")
  valid_568272 = validateParameter(valid_568272, JString, required = true,
                                 default = nil)
  if valid_568272 != nil:
    section.add "subscriptionId", valid_568272
  var valid_568273 = path.getOrDefault("jobName")
  valid_568273 = validateParameter(valid_568273, JString, required = true,
                                 default = nil)
  if valid_568273 != nil:
    section.add "jobName", valid_568273
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_568276: Call_InputsTest_568267; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Tests whether an input’s datasource is reachable and usable by the Azure Stream Analytics service.
  ## 
...
proc call*(call_568277: Call_InputsTest_568267; resourceGroupName: string;
          apiVersion: string; inputName: string; subscriptionId: string;
  ...
  add(path_568278, "inputName", newJString(inputName))
...
var inputsTest* = Call_InputsTest_568267(name: "inputsTest",
                                      ...
                                      validator: validate_InputsTest_568268,
                                      base: "", url: url_InputsTest_568269,
                                      schemes: {Scheme.Https})
export
  rest
