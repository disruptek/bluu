...
type
  Call_VirtualNetworkGatewaysResetVpnClientSharedKey_564439 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysResetVpnClientSharedKey_564441(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysResetVpnClientSharedKey_564440(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_564446: Call_VirtualNetworkGatewaysResetVpnClientSharedKey_564439;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Resets the VPN client shared key of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_564447: Call_VirtualNetworkGatewaysResetVpnClientSharedKey_564439;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_564448, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564447.call(path_564448, query_564449, nil, nil, nil)

var virtualNetworkGatewaysResetVpnClientSharedKey* = Call_VirtualNetworkGatewaysResetVpnClientSharedKey_564439(
    ...
    validator: validate_VirtualNetworkGatewaysResetVpnClientSharedKey_564440,
    base: "", url: url_VirtualNetworkGatewaysResetVpnClientSharedKey_564441,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564450 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564452(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564451(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_564455 = path.getOrDefault("virtualNetworkGatewayName")
  valid_564455 = validateParameter(valid_564455, JString, required = true,
                                 default = nil)
  if valid_564455 != nil:
    section.add "virtualNetworkGatewayName", valid_564455
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564458: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564450;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## The Set VpnclientIpsecParameters operation sets the vpnclient ipsec policy for P2S client of virtual network gateway in the specified resource group through Network resource provider.
  ## 
...
proc call*(call_564459: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564450;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  if vpnclientIpsecParams != nil:
    body_564462 = vpnclientIpsecParams
  add(path_564460, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564459.call(path_564460, query_564461, nil, nil, body_564462)

var virtualNetworkGatewaysSetVpnclientIpsecParameters* = Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564450(
    ...
    validator: validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564451,
    base: "", url: url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_564452,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysSupportedVpnDevices_564463 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysSupportedVpnDevices_564465(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysSupportedVpnDevices_564464(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564468 = path.getOrDefault("virtualNetworkGatewayName")
  valid_564468 = validateParameter(valid_564468, JString, required = true,
                                 default = nil)
  if valid_564468 != nil:
    section.add "virtualNetworkGatewayName", valid_564468
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564470: Call_VirtualNetworkGatewaysSupportedVpnDevices_564463;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a xml format representation for supported vpn devices.
  ## 
...
proc call*(call_564471: Call_VirtualNetworkGatewaysSupportedVpnDevices_564463;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_564472, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564471.call(path_564472, query_564473, nil, nil, nil)

var virtualNetworkGatewaysSupportedVpnDevices* = Call_VirtualNetworkGatewaysSupportedVpnDevices_564463(
    ...
    validator: validate_VirtualNetworkGatewaysSupportedVpnDevices_564464,
    base: "", url: url_VirtualNetworkGatewaysSupportedVpnDevices_564465,
    schemes: {Scheme.Https})
export
  rest
