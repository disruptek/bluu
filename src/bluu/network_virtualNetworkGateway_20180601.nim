...
type
  Call_VirtualNetworkGatewaysResetVpnClientSharedKey_568539 = ref object of OpenApiRestCall_567657
proc url_VirtualNetworkGatewaysResetVpnClientSharedKey_568541(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysResetVpnClientSharedKey_568540(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_568546: Call_VirtualNetworkGatewaysResetVpnClientSharedKey_568539;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Resets the VPN client shared key of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_568547: Call_VirtualNetworkGatewaysResetVpnClientSharedKey_568539;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_568548, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_568547.call(path_568548, query_568549, nil, nil, nil)

var virtualNetworkGatewaysResetVpnClientSharedKey* = Call_VirtualNetworkGatewaysResetVpnClientSharedKey_568539(
    ...
    validator: validate_VirtualNetworkGatewaysResetVpnClientSharedKey_568540,
    base: "", url: url_VirtualNetworkGatewaysResetVpnClientSharedKey_568541,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568550 = ref object of OpenApiRestCall_567657
proc url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568552(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568551(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
  ...
  var valid_568555 = path.getOrDefault("virtualNetworkGatewayName")
  valid_568555 = validateParameter(valid_568555, JString, required = true,
                                 default = nil)
  if valid_568555 != nil:
    section.add "virtualNetworkGatewayName", valid_568555
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_568558: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568550;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## The Set VpnclientIpsecParameters operation sets the vpnclient ipsec policy for P2S client of virtual network gateway in the specified resource group through Network resource provider.
  ## 
...
proc call*(call_568559: Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568550;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_568560, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  if vpnclientIpsecParams != nil:
    body_568562 = vpnclientIpsecParams
  result = call_568559.call(path_568560, query_568561, nil, nil, body_568562)

var virtualNetworkGatewaysSetVpnclientIpsecParameters* = Call_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568550(
    ...
    validator: validate_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568551,
    base: "", url: url_VirtualNetworkGatewaysSetVpnclientIpsecParameters_568552,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysSupportedVpnDevices_568563 = ref object of OpenApiRestCall_567657
proc url_VirtualNetworkGatewaysSupportedVpnDevices_568565(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysSupportedVpnDevices_568564(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568568 = path.getOrDefault("virtualNetworkGatewayName")
  valid_568568 = validateParameter(valid_568568, JString, required = true,
                                 default = nil)
  if valid_568568 != nil:
    section.add "virtualNetworkGatewayName", valid_568568
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_568570: Call_VirtualNetworkGatewaysSupportedVpnDevices_568563;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a xml format representation for supported vpn devices.
  ## 
...
proc call*(call_568571: Call_VirtualNetworkGatewaysSupportedVpnDevices_568563;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_568572, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_568571.call(path_568572, query_568573, nil, nil, nil)

var virtualNetworkGatewaysSupportedVpnDevices* = Call_VirtualNetworkGatewaysSupportedVpnDevices_568563(
    ...
    validator: validate_VirtualNetworkGatewaysSupportedVpnDevices_568564,
    base: "", url: url_VirtualNetworkGatewaysSupportedVpnDevices_568565,
    schemes: {Scheme.Https})
export
  rest
