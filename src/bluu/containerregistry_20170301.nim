...
proc call*(call_594033: Call_RegistriesCreate_594024; resourceGroupName: string;
  ...
  if registryCreateParameters != nil:
    body_594036 = registryCreateParameters
...
type
  Call_RegistriesRegenerateCredential_594072 = ref object of OpenApiRestCall_593424
proc url_RegistriesRegenerateCredential_594074(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegistriesRegenerateCredential_594073(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594080: Call_RegistriesRegenerateCredential_594072; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Regenerates one of the login credentials for the specified container registry.
  ## 
...
proc call*(call_594081: Call_RegistriesRegenerateCredential_594072;
  ...
  if regenerateCredentialParameters != nil:
    body_594084 = regenerateCredentialParameters
  ...
  add(path_594082, "registryName", newJString(registryName))
  result = call_594081.call(path_594082, query_594083, nil, nil, body_594084)

var registriesRegenerateCredential* = Call_RegistriesRegenerateCredential_594072(
    ...
    validator: validate_RegistriesRegenerateCredential_594073, base: "",
    url: url_RegistriesRegenerateCredential_594074, schemes: {Scheme.Https})
export
  rest
