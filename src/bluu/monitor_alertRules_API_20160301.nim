...
type
  Call_AlertRulesListBySubscription_593647 = ref object of OpenApiRestCall_593425
proc url_AlertRulesListBySubscription_593649(protocol: Scheme; host: string;
...
proc validate_AlertRulesListBySubscription_593648(path: JsonNode; query: JsonNode;
...
proc call*(call_593846: Call_AlertRulesListBySubscription_593647; path: JsonNode;
...
proc call*(call_593917: Call_AlertRulesListBySubscription_593647;
...
var alertRulesListBySubscription* = Call_AlertRulesListBySubscription_593647(
    ...
    validator: validate_AlertRulesListBySubscription_593648, base: "",
    url: url_AlertRulesListBySubscription_593649, schemes: {Scheme.Https})
type
  Call_AlertRulesListByResourceGroup_593959 = ref object of OpenApiRestCall_593425
proc url_AlertRulesListByResourceGroup_593961(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AlertRulesListByResourceGroup_593960(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593965: Call_AlertRulesListByResourceGroup_593959; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the alert rules within a resource group.
  ## 
...
proc call*(call_593966: Call_AlertRulesListByResourceGroup_593959;
...
var alertRulesListByResourceGroup* = Call_AlertRulesListByResourceGroup_593959(
    ...
    validator: validate_AlertRulesListByResourceGroup_593960, base: "",
    url: url_AlertRulesListByResourceGroup_593961, schemes: {Scheme.Https})
type
  Call_AlertRulesCreateOrUpdate_593980 = ref object of OpenApiRestCall_593425
proc url_AlertRulesCreateOrUpdate_593982(protocol: Scheme; host: string;
...
proc validate_AlertRulesCreateOrUpdate_593981(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593984 = path.getOrDefault("ruleName")
  valid_593984 = validateParameter(valid_593984, JString, required = true,
                                 default = nil)
  if valid_593984 != nil:
    section.add "ruleName", valid_593984
...
proc call*(call_593988: Call_AlertRulesCreateOrUpdate_593980; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates an alert rule.
  ## 
...
proc call*(call_593989: Call_AlertRulesCreateOrUpdate_593980;
  ...
  add(path_593990, "ruleName", newJString(ruleName))
...
var alertRulesCreateOrUpdate* = Call_AlertRulesCreateOrUpdate_593980(
    ...
    validator: validate_AlertRulesCreateOrUpdate_593981, base: "",
    url: url_AlertRulesCreateOrUpdate_593982, schemes: {Scheme.Https})
type
  Call_AlertRulesGet_593969 = ref object of OpenApiRestCall_593425
proc url_AlertRulesGet_593971(protocol: Scheme; host: string; base: string;
...
proc validate_AlertRulesGet_593970(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_593973 = path.getOrDefault("ruleName")
  valid_593973 = validateParameter(valid_593973, JString, required = true,
                                 default = nil)
  if valid_593973 != nil:
    section.add "ruleName", valid_593973
...
proc call*(call_593976: Call_AlertRulesGet_593969; path: JsonNode; query: JsonNode;
...
proc call*(call_593977: Call_AlertRulesGet_593969; resourceGroupName: string;
...
var alertRulesGet* = Call_AlertRulesGet_593969(name: "alertRulesGet",
    ...
    validator: validate_AlertRulesGet_593970, base: "", url: url_AlertRulesGet_593971,
    schemes: {Scheme.Https})
type
  Call_AlertRulesUpdate_594004 = ref object of OpenApiRestCall_593425
proc url_AlertRulesUpdate_594006(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AlertRulesUpdate_594005(path: JsonNode; query: JsonNode;
  ...
  var valid_594025 = path.getOrDefault("ruleName")
  valid_594025 = validateParameter(valid_594025, JString, required = true,
                                 default = nil)
  if valid_594025 != nil:
    section.add "ruleName", valid_594025
...
proc call*(call_594029: Call_AlertRulesUpdate_594004; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing AlertRuleResource. To update other fields use the CreateOrUpdate method.
  ## 
...
proc call*(call_594030: Call_AlertRulesUpdate_594004; resourceGroupName: string;
          apiVersion: string; ruleName: string; subscriptionId: string;
          alertRulesResource: JsonNode): Recallable =
  ## alertRulesUpdate
  ## Updates an existing AlertRuleResource. To update other fields use the CreateOrUpdate method.
  ##   resourceGroupName: string (required)
  ##                    : The name of the resource group.
...
var alertRulesUpdate* = Call_AlertRulesUpdate_594004(name: "alertRulesUpdate",
    ...
    validator: validate_AlertRulesUpdate_594005, base: "",
    url: url_AlertRulesUpdate_594006, schemes: {Scheme.Https})
type
  Call_AlertRulesDelete_593993 = ref object of OpenApiRestCall_593425
proc url_AlertRulesDelete_593995(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AlertRulesDelete_593994(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_593997 = path.getOrDefault("ruleName")
  valid_593997 = validateParameter(valid_593997, JString, required = true,
                                 default = nil)
  if valid_593997 != nil:
    section.add "ruleName", valid_593997
...
proc call*(call_594000: Call_AlertRulesDelete_593993; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an alert rule
  ## 
...
proc call*(call_594001: Call_AlertRulesDelete_593993; resourceGroupName: string;
          apiVersion: string; ruleName: string; subscriptionId: string): Recallable =
  ## alertRulesDelete
  ## Deletes an alert rule
  ##   resourceGroupName: string (required)
...
var alertRulesDelete* = Call_AlertRulesDelete_593993(name: "alertRulesDelete",
    ...
    validator: validate_AlertRulesDelete_593994, base: "",
    url: url_AlertRulesDelete_593995, schemes: {Scheme.Https})
export
  rest
