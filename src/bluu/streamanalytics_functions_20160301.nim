...
type
  Call_FunctionsListByStreamingJob_593646 = ref object of OpenApiRestCall_593424
proc url_FunctionsListByStreamingJob_593648(protocol: Scheme; host: string;
...
proc validate_FunctionsListByStreamingJob_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593849: Call_FunctionsListByStreamingJob_593646; path: JsonNode;
...
proc call*(call_593920: Call_FunctionsListByStreamingJob_593646;
...
var functionsListByStreamingJob* = Call_FunctionsListByStreamingJob_593646(
    ...
    validator: validate_FunctionsListByStreamingJob_593647, base: "",
    url: url_FunctionsListByStreamingJob_593648, schemes: {Scheme.Https})
type
  Call_FunctionsCreateOrReplace_593974 = ref object of OpenApiRestCall_593424
proc url_FunctionsCreateOrReplace_593976(protocol: Scheme; host: string;
...
proc validate_FunctionsCreateOrReplace_593975(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593997 = path.getOrDefault("functionName")
  valid_593997 = validateParameter(valid_593997, JString, required = true,
                                 default = nil)
  if valid_593997 != nil:
    section.add "functionName", valid_593997
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594002: Call_FunctionsCreateOrReplace_593974; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a function or replaces an already existing function under an existing streaming job.
  ## 
...
proc call*(call_594003: Call_FunctionsCreateOrReplace_593974;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594004, "functionName", newJString(functionName))
  if function != nil:
    body_594006 = function
  result = call_594003.call(path_594004, query_594005, nil, nil, body_594006)

var functionsCreateOrReplace* = Call_FunctionsCreateOrReplace_593974(
    ...
    validator: validate_FunctionsCreateOrReplace_593975, base: "",
    url: url_FunctionsCreateOrReplace_593976, schemes: {Scheme.Https})
type
  Call_FunctionsGet_593962 = ref object of OpenApiRestCall_593424
proc url_FunctionsGet_593964(protocol: Scheme; host: string; base: string;
...
proc validate_FunctionsGet_593963(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_593968 = path.getOrDefault("functionName")
  valid_593968 = validateParameter(valid_593968, JString, required = true,
                                 default = nil)
  if valid_593968 != nil:
    section.add "functionName", valid_593968
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_593970: Call_FunctionsGet_593962; path: JsonNode; query: JsonNode;
...
proc call*(call_593971: Call_FunctionsGet_593962; resourceGroupName: string;
  ...
  add(path_593972, "functionName", newJString(functionName))
  result = call_593971.call(path_593972, query_593973, nil, nil, nil)

var functionsGet* = Call_FunctionsGet_593962(name: "functionsGet",
    ...
    validator: validate_FunctionsGet_593963, base: "", url: url_FunctionsGet_593964,
    schemes: {Scheme.Https})
type
  Call_FunctionsUpdate_594019 = ref object of OpenApiRestCall_593424
proc url_FunctionsUpdate_594021(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_FunctionsUpdate_594020(path: JsonNode; query: JsonNode;
  ...
  var valid_594025 = path.getOrDefault("functionName")
  valid_594025 = validateParameter(valid_594025, JString, required = true,
                                 default = nil)
  if valid_594025 != nil:
    section.add "functionName", valid_594025
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594029: Call_FunctionsUpdate_594019; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing function under an existing streaming job. This can be used to partially update (ie. update one or two properties) a function without affecting the rest the job or function definition.
  ## 
...
proc call*(call_594030: Call_FunctionsUpdate_594019; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; jobName: string;
  ...
  add(path_594031, "functionName", newJString(functionName))
  if function != nil:
    body_594033 = function
  result = call_594030.call(path_594031, query_594032, nil, nil, body_594033)

var functionsUpdate* = Call_FunctionsUpdate_594019(name: "functionsUpdate",
    ...
    validator: validate_FunctionsUpdate_594020, base: "", url: url_FunctionsUpdate_594021,
    schemes: {Scheme.Https})
type
  Call_FunctionsDelete_594007 = ref object of OpenApiRestCall_593424
proc url_FunctionsDelete_594009(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_FunctionsDelete_594008(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  var valid_594013 = path.getOrDefault("functionName")
  valid_594013 = validateParameter(valid_594013, JString, required = true,
                                 default = nil)
  if valid_594013 != nil:
    section.add "functionName", valid_594013
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594015: Call_FunctionsDelete_594007; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a function from the streaming job.
  ## 
...
proc call*(call_594016: Call_FunctionsDelete_594007; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; jobName: string;
          functionName: string): Recallable =
  ## functionsDelete
  ## Deletes a function from the streaming job.
  ...
  add(path_594017, "functionName", newJString(functionName))
  result = call_594016.call(path_594017, query_594018, nil, nil, nil)

var functionsDelete* = Call_FunctionsDelete_594007(name: "functionsDelete",
    ...
    validator: validate_FunctionsDelete_594008, base: "", url: url_FunctionsDelete_594009,
    schemes: {Scheme.Https})
type
  Call_FunctionsRetrieveDefaultDefinition_594034 = ref object of OpenApiRestCall_593424
proc url_FunctionsRetrieveDefaultDefinition_594036(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_FunctionsRetrieveDefaultDefinition_594035(path: JsonNode;
  ...
  var valid_594040 = path.getOrDefault("functionName")
  valid_594040 = validateParameter(valid_594040, JString, required = true,
                                 default = nil)
  if valid_594040 != nil:
    section.add "functionName", valid_594040
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594043: Call_FunctionsRetrieveDefaultDefinition_594034;
...
proc call*(call_594044: Call_FunctionsRetrieveDefaultDefinition_594034;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  if functionRetrieveDefaultDefinitionParameters != nil:
    body_594047 = functionRetrieveDefaultDefinitionParameters
  add(path_594045, "subscriptionId", newJString(subscriptionId))
  add(path_594045, "jobName", newJString(jobName))
  add(path_594045, "functionName", newJString(functionName))
  result = call_594044.call(path_594045, query_594046, nil, nil, body_594047)

var functionsRetrieveDefaultDefinition* = Call_FunctionsRetrieveDefaultDefinition_594034(
    ...
    validator: validate_FunctionsRetrieveDefaultDefinition_594035, base: "",
    url: url_FunctionsRetrieveDefaultDefinition_594036, schemes: {Scheme.Https})
type
  Call_FunctionsTest_594048 = ref object of OpenApiRestCall_593424
proc url_FunctionsTest_594050(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_FunctionsTest_594049(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594053 = path.getOrDefault("jobName")
  valid_594053 = validateParameter(valid_594053, JString, required = true,
                                 default = nil)
  if valid_594053 != nil:
    section.add "jobName", valid_594053
  var valid_594054 = path.getOrDefault("functionName")
  valid_594054 = validateParameter(valid_594054, JString, required = true,
                                 default = nil)
  if valid_594054 != nil:
    section.add "functionName", valid_594054
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594057: Call_FunctionsTest_594048; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Tests if the information provided for a function is valid. This can range from testing the connection to the underlying web service behind the function or making sure the function code provided is syntactically correct.
  ## 
...
proc call*(call_594058: Call_FunctionsTest_594048; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; jobName: string;
  ...
  add(path_594059, "functionName", newJString(functionName))
  if function != nil:
    body_594061 = function
  result = call_594058.call(path_594059, query_594060, nil, nil, body_594061)

var functionsTest* = Call_FunctionsTest_594048(name: "functionsTest",
    ...
    validator: validate_FunctionsTest_594049, base: "", url: url_FunctionsTest_594050,
    schemes: {Scheme.Https})
export
  rest
