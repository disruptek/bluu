...
type
  Call_ResourceNavigationLinksGet_594111 = ref object of OpenApiRestCall_593424
proc url_ResourceNavigationLinksGet_594113(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ResourceNavigationLinksGet_594112(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594119: Call_ResourceNavigationLinksGet_594111; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of resource navigation links for a subnet.
  ## 
...
proc call*(call_594120: Call_ResourceNavigationLinksGet_594111;
          resourceGroupName: string; subnetName: string; apiVersion: string;
          subscriptionId: string; virtualNetworkName: string): Recallable =
...
var resourceNavigationLinksGet* = Call_ResourceNavigationLinksGet_594111(
    ...
    validator: validate_ResourceNavigationLinksGet_594112, base: "",
    url: url_ResourceNavigationLinksGet_594113, schemes: {Scheme.Https})
type
  Call_ServiceAssociationLinksGet_594123 = ref object of OpenApiRestCall_593424
proc url_ServiceAssociationLinksGet_594125(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServiceAssociationLinksGet_594124(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594131: Call_ServiceAssociationLinksGet_594123; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of service association links for a subnet.
  ## 
...
proc call*(call_594132: Call_ServiceAssociationLinksGet_594123;
          resourceGroupName: string; subnetName: string; apiVersion: string;
          subscriptionId: string; virtualNetworkName: string): Recallable =
...
var serviceAssociationLinksGet* = Call_ServiceAssociationLinksGet_594123(
    ...
    validator: validate_ServiceAssociationLinksGet_594124, base: "",
    url: url_ServiceAssociationLinksGet_594125, schemes: {Scheme.Https})
type
  Call_VirtualNetworksListUsage_594135 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksListUsage_594137(protocol: Scheme; host: string;
...
proc validate_VirtualNetworksListUsage_594136(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Lists usage stats.
  ## 
  var section: JsonNode
  ...
  var valid_594140 = path.getOrDefault("virtualNetworkName")
  valid_594140 = validateParameter(valid_594140, JString, required = true,
                                 default = nil)
  if valid_594140 != nil:
    section.add "virtualNetworkName", valid_594140
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594142: Call_VirtualNetworksListUsage_594135; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists usage stats.
  ## 
...
proc call*(call_594143: Call_VirtualNetworksListUsage_594135;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_594144, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594143.call(path_594144, query_594145, nil, nil, nil)

var virtualNetworksListUsage* = Call_VirtualNetworksListUsage_594135(
    ...
    validator: validate_VirtualNetworksListUsage_594136, base: "",
    url: url_VirtualNetworksListUsage_594137, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsList_594146 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsList_594148(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsList_594147(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594151 = path.getOrDefault("virtualNetworkName")
  valid_594151 = validateParameter(valid_594151, JString, required = true,
                                 default = nil)
  if valid_594151 != nil:
    section.add "virtualNetworkName", valid_594151
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594153: Call_VirtualNetworkPeeringsList_594146; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all virtual network peerings in a virtual network.
  ## 
...
proc call*(call_594154: Call_VirtualNetworkPeeringsList_594146;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
...
var virtualNetworkPeeringsList* = Call_VirtualNetworkPeeringsList_594146(
    ...
    validator: validate_VirtualNetworkPeeringsList_594147, base: "",
    url: url_VirtualNetworkPeeringsList_594148, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsCreateOrUpdate_594169 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsCreateOrUpdate_594171(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsCreateOrUpdate_594170(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594174 = path.getOrDefault("virtualNetworkName")
  valid_594174 = validateParameter(valid_594174, JString, required = true,
                                 default = nil)
  if valid_594174 != nil:
    section.add "virtualNetworkName", valid_594174
  var valid_594175 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594175 = validateParameter(valid_594175, JString, required = true,
                                 default = nil)
  if valid_594175 != nil:
    section.add "virtualNetworkPeeringName", valid_594175
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594178: Call_VirtualNetworkPeeringsCreateOrUpdate_594169;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a peering in the specified virtual network.
  ## 
...
proc call*(call_594179: Call_VirtualNetworkPeeringsCreateOrUpdate_594169;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594180, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594180, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  if VirtualNetworkPeeringParameters != nil:
    body_594182 = VirtualNetworkPeeringParameters
  result = call_594179.call(path_594180, query_594181, nil, nil, body_594182)

var virtualNetworkPeeringsCreateOrUpdate* = Call_VirtualNetworkPeeringsCreateOrUpdate_594169(
    ...
    validator: validate_VirtualNetworkPeeringsCreateOrUpdate_594170, base: "",
    url: url_VirtualNetworkPeeringsCreateOrUpdate_594171, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsGet_594157 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsGet_594159(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsGet_594158(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594162 = path.getOrDefault("virtualNetworkName")
  valid_594162 = validateParameter(valid_594162, JString, required = true,
                                 default = nil)
  if valid_594162 != nil:
    section.add "virtualNetworkName", valid_594162
  var valid_594163 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594163 = validateParameter(valid_594163, JString, required = true,
                                 default = nil)
  if valid_594163 != nil:
    section.add "virtualNetworkPeeringName", valid_594163
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594165: Call_VirtualNetworkPeeringsGet_594157; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified virtual network peering.
  ## 
...
proc call*(call_594166: Call_VirtualNetworkPeeringsGet_594157;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594167, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594167, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  result = call_594166.call(path_594167, query_594168, nil, nil, nil)

var virtualNetworkPeeringsGet* = Call_VirtualNetworkPeeringsGet_594157(
    name: "virtualNetworkPeeringsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsGet_594158, base: "",
    url: url_VirtualNetworkPeeringsGet_594159, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsDelete_594183 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsDelete_594185(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsDelete_594184(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594191: Call_VirtualNetworkPeeringsDelete_594183; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified virtual network peering.
  ## 
...
proc call*(call_594192: Call_VirtualNetworkPeeringsDelete_594183;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string; virtualNetworkPeeringName: string): Recallable =
  ...
  add(path_594193, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594193, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  result = call_594192.call(path_594193, query_594194, nil, nil, nil)

var virtualNetworkPeeringsDelete* = Call_VirtualNetworkPeeringsDelete_594183(
    name: "virtualNetworkPeeringsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsDelete_594184, base: "",
    url: url_VirtualNetworkPeeringsDelete_594185, schemes: {Scheme.Https})
export
  rest
