...
const
  macServiceName = "azsadmin-ApplicationOperationResults"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_ApplicationOperationResultsList_593630 = ref object of OpenApiRestCall_593408
proc url_ApplicationOperationResultsList_593632(protocol: Scheme; host: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.Fabric.Admin/fabricLocations/"),
               ...
               (kind: ConstantSegment, value: "/applicationOperationResults")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_ApplicationOperationResultsList_593631(path: JsonNode;
...
proc call*(call_593837: Call_ApplicationOperationResultsList_593630;
...
proc call*(call_593908: Call_ApplicationOperationResultsList_593630;
...
var applicationOperationResultsList* = Call_ApplicationOperationResultsList_593630(
    name: "applicationOperationResultsList", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/applicationOperationResults",
    validator: validate_ApplicationOperationResultsList_593631, base: "",
    url: url_ApplicationOperationResultsList_593632, schemes: {Scheme.Https})
type
  Call_ApplicationOperationResultsGet_593950 = ref object of OpenApiRestCall_593408
proc url_ApplicationOperationResultsGet_593952(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationOperationResultsGet_593951(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593967: Call_ApplicationOperationResultsGet_593950; path: JsonNode;
...
proc call*(call_593968: Call_ApplicationOperationResultsGet_593950;
...
var applicationOperationResultsGet* = Call_ApplicationOperationResultsGet_593950(
    name: "applicationOperationResultsGet", meth: HttpMethod.HttpGet,
    host: "adminmanagement.local.azurestack.external", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/applicationOperationResults/{operation}",
    validator: validate_ApplicationOperationResultsGet_593951, base: "",
    url: url_ApplicationOperationResultsGet_593952, schemes: {Scheme.Https})
export
  rest
