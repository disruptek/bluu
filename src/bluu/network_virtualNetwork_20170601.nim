...
proc call*(call_593845: Call_VirtualNetworksListAll_593646; path: JsonNode;
...
proc call*(call_593916: Call_VirtualNetworksListAll_593646; apiVersion: string;
...
type
  Call_VirtualNetworksList_593958 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksList_593960(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworksList_593959(path: JsonNode; query: JsonNode;
...
proc call*(call_593964: Call_VirtualNetworksList_593958; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all virtual networks in a resource group.
  ## 
...
proc call*(call_593965: Call_VirtualNetworksList_593958; resourceGroupName: string;
...
var virtualNetworksList* = Call_VirtualNetworksList_593958(
    ...
    validator: validate_VirtualNetworksList_593959, base: "",
    url: url_VirtualNetworksList_593960, schemes: {Scheme.Https})
type
  Call_VirtualNetworksCreateOrUpdate_593981 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksCreateOrUpdate_593983(protocol: Scheme; host: string;
...
proc validate_VirtualNetworksCreateOrUpdate_593982(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594006: Call_VirtualNetworksCreateOrUpdate_593981; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a virtual network in the specified resource group.
  ## 
...
proc call*(call_594007: Call_VirtualNetworksCreateOrUpdate_593981;
...
var virtualNetworksCreateOrUpdate* = Call_VirtualNetworksCreateOrUpdate_593981(
    ...
    validator: validate_VirtualNetworksCreateOrUpdate_593982, base: "",
    url: url_VirtualNetworksCreateOrUpdate_593983, schemes: {Scheme.Https})
type
  Call_VirtualNetworksGet_593968 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksGet_593970(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworksGet_593969(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_593974 = path.getOrDefault("virtualNetworkName")
  valid_593974 = validateParameter(valid_593974, JString, required = true,
                                 default = nil)
  if valid_593974 != nil:
    section.add "virtualNetworkName", valid_593974
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_593977: Call_VirtualNetworksGet_593968; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified virtual network by resource group.
  ## 
...
proc call*(call_593978: Call_VirtualNetworksGet_593968; resourceGroupName: string;
  ...
  add(path_593979, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_593978.call(path_593979, query_593980, nil, nil, nil)

var virtualNetworksGet* = Call_VirtualNetworksGet_593968(
    name: "virtualNetworksGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}",
    validator: validate_VirtualNetworksGet_593969, base: "",
    url: url_VirtualNetworksGet_593970, schemes: {Scheme.Https})
type
...
type
  Call_VirtualNetworksCheckIPAddressAvailability_594022 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksCheckIPAddressAvailability_594024(protocol: Scheme;
...
proc validate_VirtualNetworksCheckIPAddressAvailability_594023(path: JsonNode;
  ...
  var valid_594029 = query.getOrDefault("ipAddress")
  valid_594029 = validateParameter(valid_594029, JString, required = false,
                                 default = nil)
  if valid_594029 != nil:
    section.add "ipAddress", valid_594029
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_594030: Call_VirtualNetworksCheckIPAddressAvailability_594022;
...
proc call*(call_594031: Call_VirtualNetworksCheckIPAddressAvailability_594022;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(query_594033, "ipAddress", newJString(ipAddress))
...
var virtualNetworksCheckIPAddressAvailability* = Call_VirtualNetworksCheckIPAddressAvailability_594022(
    ...
    validator: validate_VirtualNetworksCheckIPAddressAvailability_594023,
    base: "", url: url_VirtualNetworksCheckIPAddressAvailability_594024,
    schemes: {Scheme.Https})
type
  Call_SubnetsList_594034 = ref object of OpenApiRestCall_593424
proc url_SubnetsList_594036(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubnetsList_594035(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_594039 = path.getOrDefault("virtualNetworkName")
  valid_594039 = validateParameter(valid_594039, JString, required = true,
                                 default = nil)
  if valid_594039 != nil:
    section.add "virtualNetworkName", valid_594039
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594041: Call_SubnetsList_594034; path: JsonNode; query: JsonNode;
...
proc call*(call_594042: Call_SubnetsList_594034; resourceGroupName: string;
  ...
  add(path_594043, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594042.call(path_594043, query_594044, nil, nil, nil)

var subnetsList* = Call_SubnetsList_594034(name: "subnetsList",
                                        ...
                                        validator: validate_SubnetsList_594035,
                                        base: "", url: url_SubnetsList_594036,
                                        schemes: {Scheme.Https})
type
  Call_SubnetsCreateOrUpdate_594058 = ref object of OpenApiRestCall_593424
proc url_SubnetsCreateOrUpdate_594060(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubnetsCreateOrUpdate_594059(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594067: Call_SubnetsCreateOrUpdate_594058; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a subnet in the specified virtual network.
  ## 
...
proc call*(call_594068: Call_SubnetsCreateOrUpdate_594058;
  ...
  if subnetParameters != nil:
    body_594071 = subnetParameters
  result = call_594068.call(path_594069, query_594070, nil, nil, body_594071)

var subnetsCreateOrUpdate* = Call_SubnetsCreateOrUpdate_594058(
    ...
    validator: validate_SubnetsCreateOrUpdate_594059, base: "",
    url: url_SubnetsCreateOrUpdate_594060, schemes: {Scheme.Https})
type
  Call_SubnetsGet_594045 = ref object of OpenApiRestCall_593424
proc url_SubnetsGet_594047(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubnetsGet_594046(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594049 = path.getOrDefault("subnetName")
  valid_594049 = validateParameter(valid_594049, JString, required = true,
                                 default = nil)
  if valid_594049 != nil:
    section.add "subnetName", valid_594049
  var valid_594050 = path.getOrDefault("subscriptionId")
  valid_594050 = validateParameter(valid_594050, JString, required = true,
                                 default = nil)
  if valid_594050 != nil:
    section.add "subscriptionId", valid_594050
  var valid_594051 = path.getOrDefault("virtualNetworkName")
  valid_594051 = validateParameter(valid_594051, JString, required = true,
                                 default = nil)
  if valid_594051 != nil:
    section.add "virtualNetworkName", valid_594051
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
  ...
  var valid_594053 = query.getOrDefault("$expand")
  valid_594053 = validateParameter(valid_594053, JString, required = false,
                                 default = nil)
  if valid_594053 != nil:
    section.add "$expand", valid_594053
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_594054: Call_SubnetsGet_594045; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified subnet by virtual network and resource group.
  ## 
...
proc call*(call_594055: Call_SubnetsGet_594045; resourceGroupName: string;
  ...
  add(path_594056, "subnetName", newJString(subnetName))
...
var subnetsGet* = Call_SubnetsGet_594045(name: "subnetsGet",
                                      meth: HttpMethod.HttpGet,
                                      host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}",
                                      validator: validate_SubnetsGet_594046,
                                      base: "", url: url_SubnetsGet_594047,
                                      schemes: {Scheme.Https})
type
  Call_SubnetsDelete_594072 = ref object of OpenApiRestCall_593424
proc url_SubnetsDelete_594074(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_SubnetsDelete_594073(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594076 = path.getOrDefault("subnetName")
  valid_594076 = validateParameter(valid_594076, JString, required = true,
                                 default = nil)
  if valid_594076 != nil:
    section.add "subnetName", valid_594076
  var valid_594077 = path.getOrDefault("subscriptionId")
  valid_594077 = validateParameter(valid_594077, JString, required = true,
                                 default = nil)
  if valid_594077 != nil:
    section.add "subscriptionId", valid_594077
  var valid_594078 = path.getOrDefault("virtualNetworkName")
  valid_594078 = validateParameter(valid_594078, JString, required = true,
                                 default = nil)
  if valid_594078 != nil:
    section.add "virtualNetworkName", valid_594078
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594080: Call_SubnetsDelete_594072; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified subnet.
  ## 
...
proc call*(call_594081: Call_SubnetsDelete_594072; resourceGroupName: string;
          subnetName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ## subnetsDelete
  ## Deletes the specified subnet.
...
var subnetsDelete* = Call_SubnetsDelete_594072(name: "subnetsDelete",
    ...
    validator: validate_SubnetsDelete_594073, base: "", url: url_SubnetsDelete_594074,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworksListUsage_594084 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksListUsage_594086(protocol: Scheme; host: string;
...
proc validate_VirtualNetworksListUsage_594085(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Lists usage stats.
  ## 
  var section: JsonNode
  ...
  var valid_594089 = path.getOrDefault("virtualNetworkName")
  valid_594089 = validateParameter(valid_594089, JString, required = true,
                                 default = nil)
  if valid_594089 != nil:
    section.add "virtualNetworkName", valid_594089
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594091: Call_VirtualNetworksListUsage_594084; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists usage stats.
  ## 
...
proc call*(call_594092: Call_VirtualNetworksListUsage_594084;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_594093, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594092.call(path_594093, query_594094, nil, nil, nil)

var virtualNetworksListUsage* = Call_VirtualNetworksListUsage_594084(
    ...
    validator: validate_VirtualNetworksListUsage_594085, base: "",
    url: url_VirtualNetworksListUsage_594086, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsList_594095 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsList_594097(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsList_594096(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594100 = path.getOrDefault("virtualNetworkName")
  valid_594100 = validateParameter(valid_594100, JString, required = true,
                                 default = nil)
  if valid_594100 != nil:
    section.add "virtualNetworkName", valid_594100
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594102: Call_VirtualNetworkPeeringsList_594095; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all virtual network peerings in a virtual network.
  ## 
...
proc call*(call_594103: Call_VirtualNetworkPeeringsList_594095;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_594104, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594103.call(path_594104, query_594105, nil, nil, nil)

var virtualNetworkPeeringsList* = Call_VirtualNetworkPeeringsList_594095(
    ...
    validator: validate_VirtualNetworkPeeringsList_594096, base: "",
    url: url_VirtualNetworkPeeringsList_594097, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsCreateOrUpdate_594118 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsCreateOrUpdate_594120(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsCreateOrUpdate_594119(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594123 = path.getOrDefault("virtualNetworkName")
  valid_594123 = validateParameter(valid_594123, JString, required = true,
                                 default = nil)
  if valid_594123 != nil:
    section.add "virtualNetworkName", valid_594123
  var valid_594124 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594124 = validateParameter(valid_594124, JString, required = true,
                                 default = nil)
  if valid_594124 != nil:
    section.add "virtualNetworkPeeringName", valid_594124
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594127: Call_VirtualNetworkPeeringsCreateOrUpdate_594118;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a peering in the specified virtual network.
  ## 
...
proc call*(call_594128: Call_VirtualNetworkPeeringsCreateOrUpdate_594118;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  if VirtualNetworkPeeringParameters != nil:
    body_594131 = VirtualNetworkPeeringParameters
  result = call_594128.call(path_594129, query_594130, nil, nil, body_594131)

var virtualNetworkPeeringsCreateOrUpdate* = Call_VirtualNetworkPeeringsCreateOrUpdate_594118(
    ...
    validator: validate_VirtualNetworkPeeringsCreateOrUpdate_594119, base: "",
    url: url_VirtualNetworkPeeringsCreateOrUpdate_594120, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsGet_594106 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsGet_594108(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsGet_594107(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594111 = path.getOrDefault("virtualNetworkName")
  valid_594111 = validateParameter(valid_594111, JString, required = true,
                                 default = nil)
  if valid_594111 != nil:
    section.add "virtualNetworkName", valid_594111
  var valid_594112 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594112 = validateParameter(valid_594112, JString, required = true,
                                 default = nil)
  if valid_594112 != nil:
    section.add "virtualNetworkPeeringName", valid_594112
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594114: Call_VirtualNetworkPeeringsGet_594106; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified virtual network peering.
  ## 
...
proc call*(call_594115: Call_VirtualNetworkPeeringsGet_594106;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594116, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594116, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  result = call_594115.call(path_594116, query_594117, nil, nil, nil)

var virtualNetworkPeeringsGet* = Call_VirtualNetworkPeeringsGet_594106(
    name: "virtualNetworkPeeringsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsGet_594107, base: "",
    url: url_VirtualNetworkPeeringsGet_594108, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsDelete_594132 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsDelete_594134(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsDelete_594133(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594137 = path.getOrDefault("virtualNetworkName")
  valid_594137 = validateParameter(valid_594137, JString, required = true,
                                 default = nil)
  if valid_594137 != nil:
    section.add "virtualNetworkName", valid_594137
  var valid_594138 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594138 = validateParameter(valid_594138, JString, required = true,
                                 default = nil)
  if valid_594138 != nil:
    section.add "virtualNetworkPeeringName", valid_594138
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594140: Call_VirtualNetworkPeeringsDelete_594132; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified virtual network peering.
  ## 
...
proc call*(call_594141: Call_VirtualNetworkPeeringsDelete_594132;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string; virtualNetworkPeeringName: string): Recallable =
...
var virtualNetworkPeeringsDelete* = Call_VirtualNetworkPeeringsDelete_594132(
    name: "virtualNetworkPeeringsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsDelete_594133, base: "",
    url: url_VirtualNetworkPeeringsDelete_594134, schemes: {Scheme.Https})
export
  rest
