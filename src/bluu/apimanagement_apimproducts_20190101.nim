...
type
  Call_ProductPolicyCreateOrUpdate_564332 = ref object of OpenApiRestCall_563555
proc url_ProductPolicyCreateOrUpdate_564334(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProductPolicyCreateOrUpdate_564333(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##           : ETag of the Entity. Not required when creating an entity, but required when updating an entity.
  section = newJObject()
  var valid_564341 = header.getOrDefault("If-Match")
  valid_564341 = validateParameter(valid_564341, JString, required = false,
                                 default = nil)
  if valid_564341 != nil:
    section.add "If-Match", valid_564341
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_564343: Call_ProductPolicyCreateOrUpdate_564332; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates policy configuration for the Product.
  ## 
...
proc call*(call_564344: Call_ProductPolicyCreateOrUpdate_564332;
          serviceName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_564345, "policyId", newJString(policyId))
  add(path_564345, "resourceGroupName", newJString(resourceGroupName))
  if parameters != nil:
    body_564347 = parameters
  add(path_564345, "productId", newJString(productId))
  result = call_564344.call(path_564345, query_564346, nil, nil, body_564347)

var productPolicyCreateOrUpdate* = Call_ProductPolicyCreateOrUpdate_564332(
    ...
    validator: validate_ProductPolicyCreateOrUpdate_564333, base: "",
    url: url_ProductPolicyCreateOrUpdate_564334, schemes: {Scheme.Https})
type
  Call_ProductPolicyGetEntityTag_564362 = ref object of OpenApiRestCall_563555
proc url_ProductPolicyGetEntityTag_564364(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProductPolicyGetEntityTag_564363(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564371: Call_ProductPolicyGetEntityTag_564362; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the ETag of the policy configuration at the Product level.
  ## 
...
proc call*(call_564372: Call_ProductPolicyGetEntityTag_564362; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564373, "serviceName", newJString(serviceName))
  add(query_564374, "api-version", newJString(apiVersion))
  add(path_564373, "subscriptionId", newJString(subscriptionId))
  add(path_564373, "policyId", newJString(policyId))
  add(path_564373, "resourceGroupName", newJString(resourceGroupName))
  add(path_564373, "productId", newJString(productId))
  result = call_564372.call(path_564373, query_564374, nil, nil, nil)

var productPolicyGetEntityTag* = Call_ProductPolicyGetEntityTag_564362(
    name: "productPolicyGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/policies/{policyId}",
    validator: validate_ProductPolicyGetEntityTag_564363, base: "",
    url: url_ProductPolicyGetEntityTag_564364, schemes: {Scheme.Https})
type
...
proc call*(call_564328: Call_ProductPolicyGet_564305; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the policy configuration at the Product level.
  ## 
...
proc call*(call_564329: Call_ProductPolicyGet_564305; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          productId: string; policyId: string = "policy"; format: string = "xml"): Recallable =
  ## productPolicyGet
  ## Get the policy configuration at the Product level.
  ##   serviceName: string (required)
  ##              : The name of the API Management service.
  ...
  add(path_564330, "policyId", newJString(policyId))
  add(path_564330, "resourceGroupName", newJString(resourceGroupName))
  add(query_564331, "format", newJString(format))
  add(path_564330, "productId", newJString(productId))
...
type
  Call_ProductPolicyDelete_564348 = ref object of OpenApiRestCall_563555
proc url_ProductPolicyDelete_564350(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ProductPolicyDelete_564349(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564353 = path.getOrDefault("policyId")
  valid_564353 = validateParameter(valid_564353, JString, required = true,
                                 default = newJString("policy"))
  if valid_564353 != nil:
    section.add "policyId", valid_564353
  ...
  var valid_564355 = path.getOrDefault("productId")
  valid_564355 = validateParameter(valid_564355, JString, required = true,
                                 default = nil)
  if valid_564355 != nil:
    section.add "productId", valid_564355
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
  ...
  assert header != nil,
        "header argument is necessary due to required `If-Match` field"
  var valid_564357 = header.getOrDefault("If-Match")
  valid_564357 = validateParameter(valid_564357, JString, required = true,
                                 default = nil)
  if valid_564357 != nil:
    section.add "If-Match", valid_564357
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  if body != nil:
...
proc call*(call_564358: Call_ProductPolicyDelete_564348; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the policy configuration at the Product.
  ## 
...
proc call*(call_564359: Call_ProductPolicyDelete_564348; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          productId: string; policyId: string = "policy"): Recallable =
  ## productPolicyDelete
  ## Deletes the policy configuration at the Product.
  ...
  add(path_564360, "serviceName", newJString(serviceName))
  add(query_564361, "api-version", newJString(apiVersion))
  add(path_564360, "subscriptionId", newJString(subscriptionId))
  add(path_564360, "policyId", newJString(policyId))
  add(path_564360, "resourceGroupName", newJString(resourceGroupName))
  add(path_564360, "productId", newJString(productId))
  result = call_564359.call(path_564360, query_564361, nil, nil, nil)

var productPolicyDelete* = Call_ProductPolicyDelete_564348(
    name: "productPolicyDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/policies/{policyId}",
    validator: validate_ProductPolicyDelete_564349, base: "",
    url: url_ProductPolicyDelete_564350, schemes: {Scheme.Https})
type
  Call_ProductSubscriptionsList_564375 = ref object of OpenApiRestCall_563555
proc url_ProductSubscriptionsList_564377(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ProductSubscriptionsList_564376(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564378 = path.getOrDefault("serviceName")
  valid_564378 = validateParameter(valid_564378, JString, required = true,
                                 default = nil)
  if valid_564378 != nil:
    section.add "serviceName", valid_564378
  ...
  var valid_564381 = path.getOrDefault("productId")
  valid_564381 = validateParameter(valid_564381, JString, required = true,
                                 default = nil)
  if valid_564381 != nil:
    section.add "productId", valid_564381
  result.add "path", section
  ## parameters in `query` object:
  ##   $top: JInt
  ##       : Number of records to return.
...
proc call*(call_564386: Call_ProductSubscriptionsList_564375; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the collection of subscriptions to the specified product.
  ## 
...
proc call*(call_564387: Call_ProductSubscriptionsList_564375; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          productId: string; Top: int = 0; Skip: int = 0; Filter: string = ""): Recallable =
  ...
  add(path_564388, "serviceName", newJString(serviceName))
...
var productSubscriptionsList* = Call_ProductSubscriptionsList_564375(
    ...
    validator: validate_ProductSubscriptionsList_564376, base: "",
    url: url_ProductSubscriptionsList_564377, schemes: {Scheme.Https})
type
  Call_TagListByProduct_564390 = ref object of OpenApiRestCall_563555
proc url_TagListByProduct_564392(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagListByProduct_564391(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564393 = path.getOrDefault("serviceName")
  valid_564393 = validateParameter(valid_564393, JString, required = true,
                                 default = nil)
  if valid_564393 != nil:
    section.add "serviceName", valid_564393
  ...
  var valid_564396 = path.getOrDefault("productId")
  valid_564396 = validateParameter(valid_564396, JString, required = true,
                                 default = nil)
  if valid_564396 != nil:
    section.add "productId", valid_564396
  result.add "path", section
  ## parameters in `query` object:
  ##   $top: JInt
  ##       : Number of records to return.
  ...
  section = newJObject()
  var valid_564397 = query.getOrDefault("$top")
  valid_564397 = validateParameter(valid_564397, JInt, required = false, default = nil)
  if valid_564397 != nil:
    section.add "$top", valid_564397
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
  ...
  var valid_564399 = query.getOrDefault("$skip")
  valid_564399 = validateParameter(valid_564399, JInt, required = false, default = nil)
  if valid_564399 != nil:
    section.add "$skip", valid_564399
  var valid_564400 = query.getOrDefault("$filter")
  valid_564400 = validateParameter(valid_564400, JString, required = false,
                                 default = nil)
  if valid_564400 != nil:
    section.add "$filter", valid_564400
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564401: Call_TagListByProduct_564390; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all Tags associated with the Product.
  ## 
...
proc call*(call_564402: Call_TagListByProduct_564390; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          productId: string; Top: int = 0; Skip: int = 0; Filter: string = ""): Recallable =
  ## tagListByProduct
  ## Lists all Tags associated with the Product.
  ...
  add(path_564403, "serviceName", newJString(serviceName))
  add(query_564404, "$top", newJInt(Top))
  add(query_564404, "api-version", newJString(apiVersion))
  add(path_564403, "subscriptionId", newJString(subscriptionId))
  add(query_564404, "$skip", newJInt(Skip))
  add(path_564403, "resourceGroupName", newJString(resourceGroupName))
  add(query_564404, "$filter", newJString(Filter))
  add(path_564403, "productId", newJString(productId))
  result = call_564402.call(path_564403, query_564404, nil, nil, nil)

var tagListByProduct* = Call_TagListByProduct_564390(name: "tagListByProduct",
    ...
    validator: validate_TagListByProduct_564391, base: "",
    url: url_TagListByProduct_564392, schemes: {Scheme.Https})
type
  Call_TagAssignToProduct_564418 = ref object of OpenApiRestCall_563555
proc url_TagAssignToProduct_564420(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagAssignToProduct_564419(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564421 = path.getOrDefault("serviceName")
  valid_564421 = validateParameter(valid_564421, JString, required = true,
                                 default = nil)
  if valid_564421 != nil:
    section.add "serviceName", valid_564421
  var valid_564422 = path.getOrDefault("tagId")
  valid_564422 = validateParameter(valid_564422, JString, required = true,
                                 default = nil)
  if valid_564422 != nil:
    section.add "tagId", valid_564422
  ...
  var valid_564425 = path.getOrDefault("productId")
  valid_564425 = validateParameter(valid_564425, JString, required = true,
                                 default = nil)
  if valid_564425 != nil:
    section.add "productId", valid_564425
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564427: Call_TagAssignToProduct_564418; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Assign tag to the Product.
  ## 
...
proc call*(call_564428: Call_TagAssignToProduct_564418; serviceName: string;
...
var tagAssignToProduct* = Call_TagAssignToProduct_564418(
    ...
    validator: validate_TagAssignToProduct_564419, base: "",
    url: url_TagAssignToProduct_564420, schemes: {Scheme.Https})
type
  Call_TagGetEntityStateByProduct_564444 = ref object of OpenApiRestCall_563555
proc url_TagGetEntityStateByProduct_564446(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagGetEntityStateByProduct_564445(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564447 = path.getOrDefault("serviceName")
  valid_564447 = validateParameter(valid_564447, JString, required = true,
                                 default = nil)
  if valid_564447 != nil:
    section.add "serviceName", valid_564447
  var valid_564448 = path.getOrDefault("tagId")
  valid_564448 = validateParameter(valid_564448, JString, required = true,
                                 default = nil)
  if valid_564448 != nil:
    section.add "tagId", valid_564448
  ...
  var valid_564451 = path.getOrDefault("productId")
  valid_564451 = validateParameter(valid_564451, JString, required = true,
                                 default = nil)
  if valid_564451 != nil:
    section.add "productId", valid_564451
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564453: Call_TagGetEntityStateByProduct_564444; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state version of the tag specified by its identifier.
  ## 
...
proc call*(call_564454: Call_TagGetEntityStateByProduct_564444;
  ...
  add(path_564455, "serviceName", newJString(serviceName))
  add(query_564456, "api-version", newJString(apiVersion))
  add(path_564455, "tagId", newJString(tagId))
  add(path_564455, "subscriptionId", newJString(subscriptionId))
  add(path_564455, "resourceGroupName", newJString(resourceGroupName))
  add(path_564455, "productId", newJString(productId))
  result = call_564454.call(path_564455, query_564456, nil, nil, nil)

var tagGetEntityStateByProduct* = Call_TagGetEntityStateByProduct_564444(
    name: "tagGetEntityStateByProduct", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId}",
    validator: validate_TagGetEntityStateByProduct_564445, base: "",
    url: url_TagGetEntityStateByProduct_564446, schemes: {Scheme.Https})
type
  Call_TagGetByProduct_564405 = ref object of OpenApiRestCall_563555
proc url_TagGetByProduct_564407(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagGetByProduct_564406(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564408 = path.getOrDefault("serviceName")
  valid_564408 = validateParameter(valid_564408, JString, required = true,
                                 default = nil)
  if valid_564408 != nil:
    section.add "serviceName", valid_564408
  var valid_564409 = path.getOrDefault("tagId")
  valid_564409 = validateParameter(valid_564409, JString, required = true,
                                 default = nil)
  if valid_564409 != nil:
    section.add "tagId", valid_564409
  ...
  var valid_564412 = path.getOrDefault("productId")
  valid_564412 = validateParameter(valid_564412, JString, required = true,
                                 default = nil)
  if valid_564412 != nil:
    section.add "productId", valid_564412
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564414: Call_TagGetByProduct_564405; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get tag associated with the Product.
  ## 
...
proc call*(call_564415: Call_TagGetByProduct_564405; serviceName: string;
          apiVersion: string; tagId: string; subscriptionId: string;
          resourceGroupName: string; productId: string): Recallable =
  ## tagGetByProduct
  ## Get tag associated with the Product.
...
var tagGetByProduct* = Call_TagGetByProduct_564405(name: "tagGetByProduct",
    ...
    validator: validate_TagGetByProduct_564406, base: "", url: url_TagGetByProduct_564407,
    schemes: {Scheme.Https})
type
  Call_TagDetachFromProduct_564431 = ref object of OpenApiRestCall_563555
proc url_TagDetachFromProduct_564433(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TagDetachFromProduct_564432(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564434 = path.getOrDefault("serviceName")
  valid_564434 = validateParameter(valid_564434, JString, required = true,
                                 default = nil)
  if valid_564434 != nil:
    section.add "serviceName", valid_564434
  var valid_564435 = path.getOrDefault("tagId")
  valid_564435 = validateParameter(valid_564435, JString, required = true,
                                 default = nil)
  if valid_564435 != nil:
    section.add "tagId", valid_564435
  ...
  var valid_564438 = path.getOrDefault("productId")
  valid_564438 = validateParameter(valid_564438, JString, required = true,
                                 default = nil)
  if valid_564438 != nil:
    section.add "productId", valid_564438
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564440: Call_TagDetachFromProduct_564431; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Detach the tag from the Product.
  ## 
...
proc call*(call_564441: Call_TagDetachFromProduct_564431; serviceName: string;
          apiVersion: string; tagId: string; subscriptionId: string;
          resourceGroupName: string; productId: string): Recallable =
  ...
  add(path_564442, "serviceName", newJString(serviceName))
  add(query_564443, "api-version", newJString(apiVersion))
  add(path_564442, "tagId", newJString(tagId))
  add(path_564442, "subscriptionId", newJString(subscriptionId))
  add(path_564442, "resourceGroupName", newJString(resourceGroupName))
  add(path_564442, "productId", newJString(productId))
  result = call_564441.call(path_564442, query_564443, nil, nil, nil)

var tagDetachFromProduct* = Call_TagDetachFromProduct_564431(
    name: "tagDetachFromProduct", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/tags/{tagId}",
    validator: validate_TagDetachFromProduct_564432, base: "",
    url: url_TagDetachFromProduct_564433, schemes: {Scheme.Https})
export
  rest
