...
type
  Call_UsageListByLocation_593985 = ref object of OpenApiRestCall_593425
proc url_UsageListByLocation_593987(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UsageListByLocation_593986(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_593991: Call_UsageListByLocation_593985; path: JsonNode;
...
proc call*(call_593992: Call_UsageListByLocation_593985; apiVersion: string;
...
var usageListByLocation* = Call_UsageListByLocation_593985(
    ...
    validator: validate_UsageListByLocation_593986, base: "",
    url: url_UsageListByLocation_593987, schemes: {Scheme.Https})
type
...
type
  Call_UsageList_594013 = ref object of OpenApiRestCall_593425
proc url_UsageList_594015(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_UsageList_594014(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594018: Call_UsageList_594013; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the current usage count and the limit for the resources under the subscription.
  ## 
...
proc call*(call_594019: Call_UsageList_594013; apiVersion: string;
          subscriptionId: string): Recallable =
  ## usageList
  ## Gets the current usage count and the limit for the resources under the subscription.
  ##   apiVersion: string (required)
...
var usageList* = Call_UsageList_594013(name: "usageList", meth: HttpMethod.HttpGet,
                                    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.Storage/usages",
                                    validator: validate_UsageList_594014,
                                    base: "", url: url_UsageList_594015,
                                    schemes: {Scheme.Https})
type
...
type
  Call_StorageAccountsRegenerateKey_594127 = ref object of OpenApiRestCall_593425
proc url_StorageAccountsRegenerateKey_594129(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsRegenerateKey_594128(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594135: Call_StorageAccountsRegenerateKey_594127; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Regenerates one of the access keys for the specified storage account.
  ## 
...
proc call*(call_594136: Call_StorageAccountsRegenerateKey_594127;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var storageAccountsRegenerateKey* = Call_StorageAccountsRegenerateKey_594127(
    ...
    validator: validate_StorageAccountsRegenerateKey_594128, base: "",
    url: url_StorageAccountsRegenerateKey_594129, schemes: {Scheme.Https})
export
  rest
