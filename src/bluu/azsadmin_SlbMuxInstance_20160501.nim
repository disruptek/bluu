...
type
  Call_SlbMuxInstancesList_593630 = ref object of OpenApiRestCall_593408
proc url_SlbMuxInstancesList_593632(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.Fabric.Admin/fabricLocations/"),
               ...
               (kind: ConstantSegment, value: "/slbMuxInstances")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_SlbMuxInstancesList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593837: Call_SlbMuxInstancesList_593630; path: JsonNode;
...
proc call*(call_593908: Call_SlbMuxInstancesList_593630; resourceGroupName: string;
...
var slbMuxInstancesList* = Call_SlbMuxInstancesList_593630(
    ...
    validator: validate_SlbMuxInstancesList_593631, base: "",
    url: url_SlbMuxInstancesList_593632, schemes: {Scheme.Https})
type
  Call_SlbMuxInstancesGet_593950 = ref object of OpenApiRestCall_593408
proc url_SlbMuxInstancesGet_593952(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
  ...
  assert "resourceGroupName" in path,
        "`resourceGroupName` is a required path parameter"
  assert "location" in path, "`location` is a required path parameter"
  assert "slbMuxInstance" in path, "`slbMuxInstance` is a required path parameter"
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
               (kind: VariableSegment, value: "subscriptionId"),
               (kind: ConstantSegment, value: "/resourceGroups/"),
        ...
        value: "/providers/Microsoft.Fabric.Admin/fabricLocations/"),
               (kind: VariableSegment, value: "location"),
               (kind: ConstantSegment, value: "/slbMuxInstances/"),
               (kind: VariableSegment, value: "slbMuxInstance")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_SlbMuxInstancesGet_593951(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_593964 = path.getOrDefault("slbMuxInstance")
  valid_593964 = validateParameter(valid_593964, JString, required = true,
                                 default = nil)
  if valid_593964 != nil:
    section.add "slbMuxInstance", valid_593964
...
proc call*(call_593967: Call_SlbMuxInstancesGet_593950; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the requested software load balancer multiplexer instance.
  ## 
...
proc call*(call_593968: Call_SlbMuxInstancesGet_593950; resourceGroupName: string;
  ...
  ##   subscriptionId: string (required)
  ##                 : Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
  ##   slbMuxInstance: string (required)
  ##                 : Name of a SLB MUX instance.
  ##   location: string (required)
  ##           : Location of the resource.
  ...
  add(path_593969, "slbMuxInstance", newJString(slbMuxInstance))
  add(path_593969, "location", newJString(location))
  result = call_593968.call(path_593969, query_593970, nil, nil, nil)

var slbMuxInstancesGet* = Call_SlbMuxInstancesGet_593950(
    ...
    validator: validate_SlbMuxInstancesGet_593951, base: "",
    url: url_SlbMuxInstancesGet_593952, schemes: {Scheme.Https})
export
  rest
