...
const
  macServiceName = "sql-virtualNetworkRules"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_VirtualNetworkRulesListByServer_563761 = ref object of OpenApiRestCall_563539
proc url_VirtualNetworkRulesListByServer_563763(protocol: Scheme; host: string;
...
proc validate_VirtualNetworkRulesListByServer_563762(path: JsonNode;
...
proc call*(call_563964: Call_VirtualNetworkRulesListByServer_563761;
...
proc call*(call_564035: Call_VirtualNetworkRulesListByServer_563761;
...
var virtualNetworkRulesListByServer* = Call_VirtualNetworkRulesListByServer_563761(
    name: "virtualNetworkRulesListByServer", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules",
    validator: validate_VirtualNetworkRulesListByServer_563762, base: "",
    url: url_VirtualNetworkRulesListByServer_563763, schemes: {Scheme.Https})
type
  Call_VirtualNetworkRulesCreateOrUpdate_564089 = ref object of OpenApiRestCall_563539
proc url_VirtualNetworkRulesCreateOrUpdate_564091(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkRulesCreateOrUpdate_564090(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564093 = path.getOrDefault("virtualNetworkRuleName")
  valid_564093 = validateParameter(valid_564093, JString, required = true,
                                 default = nil)
  if valid_564093 != nil:
    section.add "virtualNetworkRuleName", valid_564093
...
proc call*(call_564098: Call_VirtualNetworkRulesCreateOrUpdate_564089;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates an existing virtual network rule.
  ## 
...
proc call*(call_564099: Call_VirtualNetworkRulesCreateOrUpdate_564089;
  ...
  add(path_564100, "virtualNetworkRuleName", newJString(virtualNetworkRuleName))
...
var virtualNetworkRulesCreateOrUpdate* = Call_VirtualNetworkRulesCreateOrUpdate_564089(
    name: "virtualNetworkRulesCreateOrUpdate", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}",
    validator: validate_VirtualNetworkRulesCreateOrUpdate_564090, base: "",
    url: url_VirtualNetworkRulesCreateOrUpdate_564091, schemes: {Scheme.Https})
type
  Call_VirtualNetworkRulesGet_564077 = ref object of OpenApiRestCall_563539
proc url_VirtualNetworkRulesGet_564079(protocol: Scheme; host: string; base: string;
...
proc validate_VirtualNetworkRulesGet_564078(path: JsonNode; query: JsonNode;
  ...
  var valid_564081 = path.getOrDefault("virtualNetworkRuleName")
  valid_564081 = validateParameter(valid_564081, JString, required = true,
                                 default = nil)
  if valid_564081 != nil:
    section.add "virtualNetworkRuleName", valid_564081
...
proc call*(call_564085: Call_VirtualNetworkRulesGet_564077; path: JsonNode;
...
proc call*(call_564086: Call_VirtualNetworkRulesGet_564077; apiVersion: string;
  ...
  add(path_564087, "virtualNetworkRuleName", newJString(virtualNetworkRuleName))
...
var virtualNetworkRulesGet* = Call_VirtualNetworkRulesGet_564077(
    name: "virtualNetworkRulesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}",
    validator: validate_VirtualNetworkRulesGet_564078, base: "",
    url: url_VirtualNetworkRulesGet_564079, schemes: {Scheme.Https})
type
  Call_VirtualNetworkRulesDelete_564103 = ref object of OpenApiRestCall_563539
proc url_VirtualNetworkRulesDelete_564105(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkRulesDelete_564104(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564107 = path.getOrDefault("virtualNetworkRuleName")
  valid_564107 = validateParameter(valid_564107, JString, required = true,
                                 default = nil)
  if valid_564107 != nil:
    section.add "virtualNetworkRuleName", valid_564107
...
proc call*(call_564111: Call_VirtualNetworkRulesDelete_564103; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the virtual network rule with the given name.
  ## 
...
proc call*(call_564112: Call_VirtualNetworkRulesDelete_564103; apiVersion: string;
          serverName: string; virtualNetworkRuleName: string;
          subscriptionId: string; resourceGroupName: string): Recallable =
  ...
  add(path_564113, "virtualNetworkRuleName", newJString(virtualNetworkRuleName))
...
var virtualNetworkRulesDelete* = Call_VirtualNetworkRulesDelete_564103(
    name: "virtualNetworkRulesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}",
    validator: validate_VirtualNetworkRulesDelete_564104, base: "",
    url: url_VirtualNetworkRulesDelete_564105, schemes: {Scheme.Https})
export
  rest
