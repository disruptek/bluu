...
proc validate_CheckDnsNameAvailability_593631(path: JsonNode; query: JsonNode;
  ...
  var valid_593808 = query.getOrDefault("domainNameLabel")
  valid_593808 = validateParameter(valid_593808, JString, required = true,
                                 default = nil)
  if valid_593808 != nil:
    section.add "domainNameLabel", valid_593808
...
proc call*(call_593831: Call_CheckDnsNameAvailability_593630; path: JsonNode;
...
proc call*(call_593902: Call_CheckDnsNameAvailability_593630; apiVersion: string;
  ...
  add(query_593905, "domainNameLabel", newJString(domainNameLabel))
