...
var serversDelete* = Call_ServersDelete_594036(name: "serversDelete",
    ...
    schemes: {Scheme.Https})
type
  Call_ServersDissociateGateway_594060 = ref object of OpenApiRestCall_593425
proc url_ServersDissociateGateway_594062(protocol: Scheme; host: string;
...
proc validate_ServersDissociateGateway_594061(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594067: Call_ServersDissociateGateway_594060; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Dissociates a Unified Gateway associated with the server.
  ## 
...
proc call*(call_594068: Call_ServersDissociateGateway_594060;
...
var serversDissociateGateway* = Call_ServersDissociateGateway_594060(
    ...
    validator: validate_ServersDissociateGateway_594061, base: "",
    url: url_ServersDissociateGateway_594062, schemes: {Scheme.Https})
type
  Call_ServersListGatewayStatus_594071 = ref object of OpenApiRestCall_593425
proc url_ServersListGatewayStatus_594073(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ServersListGatewayStatus_594072(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594078: Call_ServersListGatewayStatus_594071; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Return the gateway status of the specified Analysis Services server instance.
  ## 
...
proc call*(call_594079: Call_ServersListGatewayStatus_594071;
          resourceGroupName: string; apiVersion: string; serverName: string;
          subscriptionId: string): Recallable =
...
var serversListGatewayStatus* = Call_ServersListGatewayStatus_594071(
    ...
    validator: validate_ServersListGatewayStatus_594072, base: "",
    url: url_ServersListGatewayStatus_594073, schemes: {Scheme.Https})
type
  Call_ServersResume_594082 = ref object of OpenApiRestCall_593425
proc url_ServersResume_594084(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersResume_594083(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594089: Call_ServersResume_594082; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resumes operation of the specified Analysis Services server instance.
  ## 
...
proc call*(call_594090: Call_ServersResume_594082; resourceGroupName: string;
          apiVersion: string; serverName: string; subscriptionId: string): Recallable =
  ## serversResume
  ## Resumes operation of the specified Analysis Services server instance.
  ##   resourceGroupName: string (required)
...
var serversResume* = Call_ServersResume_594082(name: "serversResume",
    ...
    validator: validate_ServersResume_594083, base: "", url: url_ServersResume_594084,
    schemes: {Scheme.Https})
type
  Call_ServersListSkusForExisting_594093 = ref object of OpenApiRestCall_593425
proc url_ServersListSkusForExisting_594095(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersListSkusForExisting_594094(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594097 = path.getOrDefault("serverName")
  valid_594097 = validateParameter(valid_594097, JString, required = true,
                                 default = nil)
  if valid_594097 != nil:
    section.add "serverName", valid_594097
...
proc call*(call_594100: Call_ServersListSkusForExisting_594093; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists eligible SKUs for an Analysis Services resource.
  ## 
...
proc call*(call_594101: Call_ServersListSkusForExisting_594093;
          resourceGroupName: string; apiVersion: string; serverName: string;
          subscriptionId: string): Recallable =
  ...
  add(path_594102, "serverName", newJString(serverName))
  add(path_594102, "subscriptionId", newJString(subscriptionId))
  result = call_594101.call(path_594102, query_594103, nil, nil, nil)

var serversListSkusForExisting* = Call_ServersListSkusForExisting_594093(
    ...
    validator: validate_ServersListSkusForExisting_594094, base: "",
    url: url_ServersListSkusForExisting_594095, schemes: {Scheme.Https})
type
  Call_ServersSuspend_594104 = ref object of OpenApiRestCall_593425
proc url_ServersSuspend_594106(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersSuspend_594105(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  var valid_594108 = path.getOrDefault("serverName")
  valid_594108 = validateParameter(valid_594108, JString, required = true,
                                 default = nil)
  if valid_594108 != nil:
    section.add "serverName", valid_594108
...
proc call*(call_594111: Call_ServersSuspend_594104; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Suspends operation of the specified Analysis Services server instance.
  ## 
...
proc call*(call_594112: Call_ServersSuspend_594104; resourceGroupName: string;
          apiVersion: string; serverName: string; subscriptionId: string): Recallable =
  ## serversSuspend
  ## Suspends operation of the specified Analysis Services server instance.
  ##   resourceGroupName: string (required)
...
var serversSuspend* = Call_ServersSuspend_594104(name: "serversSuspend",
    ...
    validator: validate_ServersSuspend_594105, base: "", url: url_ServersSuspend_594106,
    schemes: {Scheme.Https})
export
  rest
