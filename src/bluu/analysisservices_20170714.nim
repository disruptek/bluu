...
var serversDelete* = Call_ServersDelete_564169(name: "serversDelete",
    ...
    schemes: {Scheme.Https})
type
  Call_ServersDissociateGateway_564193 = ref object of OpenApiRestCall_563556
proc url_ServersDissociateGateway_564195(protocol: Scheme; host: string;
...
proc validate_ServersDissociateGateway_564194(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564200: Call_ServersDissociateGateway_564193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Dissociates a Unified Gateway associated with the server.
  ## 
...
proc call*(call_564201: Call_ServersDissociateGateway_564193; apiVersion: string;
          serverName: string; subscriptionId: string; resourceGroupName: string): Recallable =
...
var serversDissociateGateway* = Call_ServersDissociateGateway_564193(
    ...
    validator: validate_ServersDissociateGateway_564194, base: "",
    url: url_ServersDissociateGateway_564195, schemes: {Scheme.Https})
type
  Call_ServersListGatewayStatus_564204 = ref object of OpenApiRestCall_563556
proc url_ServersListGatewayStatus_564206(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ServersListGatewayStatus_564205(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564211: Call_ServersListGatewayStatus_564204; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Return the gateway status of the specified Analysis Services server instance.
  ## 
...
proc call*(call_564212: Call_ServersListGatewayStatus_564204; apiVersion: string;
          serverName: string; subscriptionId: string; resourceGroupName: string): Recallable =
...
var serversListGatewayStatus* = Call_ServersListGatewayStatus_564204(
    ...
    validator: validate_ServersListGatewayStatus_564205, base: "",
    url: url_ServersListGatewayStatus_564206, schemes: {Scheme.Https})
type
  Call_ServersResume_564215 = ref object of OpenApiRestCall_563556
proc url_ServersResume_564217(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersResume_564216(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564222: Call_ServersResume_564215; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resumes operation of the specified Analysis Services server instance.
  ## 
...
proc call*(call_564223: Call_ServersResume_564215; apiVersion: string;
          serverName: string; subscriptionId: string; resourceGroupName: string): Recallable =
  ## serversResume
  ## Resumes operation of the specified Analysis Services server instance.
  ##   apiVersion: string (required)
...
var serversResume* = Call_ServersResume_564215(name: "serversResume",
    ...
    validator: validate_ServersResume_564216, base: "", url: url_ServersResume_564217,
    schemes: {Scheme.Https})
type
  Call_ServersListSkusForExisting_564226 = ref object of OpenApiRestCall_563556
proc url_ServersListSkusForExisting_564228(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersListSkusForExisting_564227(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serverName` field"
  var valid_564229 = path.getOrDefault("serverName")
  valid_564229 = validateParameter(valid_564229, JString, required = true,
                                 default = nil)
  if valid_564229 != nil:
    section.add "serverName", valid_564229
...
proc call*(call_564233: Call_ServersListSkusForExisting_564226; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists eligible SKUs for an Analysis Services resource.
  ## 
...
proc call*(call_564234: Call_ServersListSkusForExisting_564226; apiVersion: string;
          serverName: string; subscriptionId: string; resourceGroupName: string): Recallable =
  ...
  add(path_564235, "serverName", newJString(serverName))
...
var serversListSkusForExisting* = Call_ServersListSkusForExisting_564226(
    ...
    validator: validate_ServersListSkusForExisting_564227, base: "",
    url: url_ServersListSkusForExisting_564228, schemes: {Scheme.Https})
type
  Call_ServersSuspend_564237 = ref object of OpenApiRestCall_563556
proc url_ServersSuspend_564239(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersSuspend_564238(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serverName` field"
  var valid_564240 = path.getOrDefault("serverName")
  valid_564240 = validateParameter(valid_564240, JString, required = true,
                                 default = nil)
  if valid_564240 != nil:
    section.add "serverName", valid_564240
...
proc call*(call_564244: Call_ServersSuspend_564237; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Suspends operation of the specified Analysis Services server instance.
  ## 
...
proc call*(call_564245: Call_ServersSuspend_564237; apiVersion: string;
          serverName: string; subscriptionId: string; resourceGroupName: string): Recallable =
  ## serversSuspend
  ## Suspends operation of the specified Analysis Services server instance.
  ##   apiVersion: string (required)
  ...
  add(path_564246, "serverName", newJString(serverName))
...
var serversSuspend* = Call_ServersSuspend_564237(name: "serversSuspend",
    ...
    validator: validate_ServersSuspend_564238, base: "", url: url_ServersSuspend_564239,
    schemes: {Scheme.Https})
export
  rest
