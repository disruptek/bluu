...
type
  Call_ScriptActionsListByCluster_564112 = ref object of OpenApiRestCall_563555
proc url_ScriptActionsListByCluster_564114(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ScriptActionsListByCluster_564113(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564119: Call_ScriptActionsListByCluster_564112; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the persisted script actions for the specified cluster.
  ## 
...
proc call*(call_564120: Call_ScriptActionsListByCluster_564112;
          clusterName: string; apiVersion: string; subscriptionId: string;
...
var scriptActionsListByCluster* = Call_ScriptActionsListByCluster_564112(
    ...
    validator: validate_ScriptActionsListByCluster_564113, base: "",
    url: url_ScriptActionsListByCluster_564114, schemes: {Scheme.Https})
type
...
type
  Call_ScriptExecutionHistoryListByCluster_564135 = ref object of OpenApiRestCall_563555
proc url_ScriptExecutionHistoryListByCluster_564137(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ScriptExecutionHistoryListByCluster_564136(path: JsonNode;
...
proc call*(call_564142: Call_ScriptExecutionHistoryListByCluster_564135;
...
proc call*(call_564143: Call_ScriptExecutionHistoryListByCluster_564135;
          clusterName: string; apiVersion: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
...
var scriptExecutionHistoryListByCluster* = Call_ScriptExecutionHistoryListByCluster_564135(
    ...
    validator: validate_ScriptExecutionHistoryListByCluster_564136, base: "",
    url: url_ScriptExecutionHistoryListByCluster_564137, schemes: {Scheme.Https})
type
