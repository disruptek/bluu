...
proc validate_AlertsList_593649(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_593827 = query.getOrDefault("$select")
  valid_593827 = validateParameter(valid_593827, JString, required = false,
                                 default = nil)
  if valid_593827 != nil:
    section.add "$select", valid_593827
...
proc call*(call_593851: Call_AlertsList_593648; path: JsonNode; query: JsonNode;
...
proc call*(call_593922: Call_AlertsList_593648; apiVersion: string;
  ...
  add(query_593925, "$expand", newJString(Expand))
  add(path_593923, "subscriptionId", newJString(subscriptionId))
  add(query_593925, "$select", newJString(Select))
...
type
  Call_AlertsListSubscriptionLevelAlertsByRegion_593964 = ref object of OpenApiRestCall_593426
proc url_AlertsListSubscriptionLevelAlertsByRegion_593966(protocol: Scheme;
...
proc validate_AlertsListSubscriptionLevelAlertsByRegion_593965(path: JsonNode;
  ...
  var valid_593967 = path.getOrDefault("ascLocation")
  valid_593967 = validateParameter(valid_593967, JString, required = true,
                                 default = nil)
  if valid_593967 != nil:
    section.add "ascLocation", valid_593967
  ...
  var valid_593971 = query.getOrDefault("$select")
  valid_593971 = validateParameter(valid_593971, JString, required = false,
                                 default = nil)
  if valid_593971 != nil:
    section.add "$select", valid_593971
...
proc call*(call_593973: Call_AlertsListSubscriptionLevelAlertsByRegion_593964;
...
proc call*(call_593974: Call_AlertsListSubscriptionLevelAlertsByRegion_593964;
  ...
  add(path_593975, "ascLocation", newJString(ascLocation))
  add(path_593975, "subscriptionId", newJString(subscriptionId))
  add(query_593976, "$select", newJString(Select))
  add(query_593976, "$filter", newJString(Filter))
  result = call_593974.call(path_593975, query_593976, nil, nil, nil)

var alertsListSubscriptionLevelAlertsByRegion* = Call_AlertsListSubscriptionLevelAlertsByRegion_593964(
    ...
    validator: validate_AlertsListSubscriptionLevelAlertsByRegion_593965,
    base: "", url: url_AlertsListSubscriptionLevelAlertsByRegion_593966,
    schemes: {Scheme.Https})
type
  Call_AlertsGetSubscriptionLevelAlert_593977 = ref object of OpenApiRestCall_593426
proc url_AlertsGetSubscriptionLevelAlert_593979(protocol: Scheme; host: string;
...
proc validate_AlertsGetSubscriptionLevelAlert_593978(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_593984: Call_AlertsGetSubscriptionLevelAlert_593977;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get an alert that is associated with a subscription
  ## 
...
proc call*(call_593985: Call_AlertsGetSubscriptionLevelAlert_593977;
          apiVersion: string; ascLocation: string; subscriptionId: string;
...
var alertsGetSubscriptionLevelAlert* = Call_AlertsGetSubscriptionLevelAlert_593977(
    ...
    validator: validate_AlertsGetSubscriptionLevelAlert_593978, base: "",
    url: url_AlertsGetSubscriptionLevelAlert_593979, schemes: {Scheme.Https})
type
