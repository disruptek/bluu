...
proc url_PerformanceTiersList_564129(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
               (kind: VariableSegment, value: "subscriptionId"), (
        kind: ConstantSegment,
        value: "/providers/Microsoft.DBforMySQL/performanceTiers")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get
...
var performanceTiersList* = Call_PerformanceTiersList_564127(
    ...
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/performanceTiers",
...
type
  Call_ServersCreateOrUpdate_564166 = ref object of OpenApiRestCall_563555
proc url_ServersCreateOrUpdate_564168(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServersCreateOrUpdate_564167(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564174: Call_ServersCreateOrUpdate_564166; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a new server or updates an existing server. The update action will overwrite the existing server.
  ## 
...
proc call*(call_564175: Call_ServersCreateOrUpdate_564166; apiVersion: string;
...
var serversCreateOrUpdate* = Call_ServersCreateOrUpdate_564166(
    ...
    validator: validate_ServersCreateOrUpdate_564167, base: "",
    url: url_ServersCreateOrUpdate_564168, schemes: {Scheme.Https})
type
