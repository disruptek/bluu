...
type
  Call_ExpressRouteCircuitsListRoutesTable_594206 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCircuitsListRoutesTable_594208(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTable_594207(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594213 = path.getOrDefault("devicePath")
  valid_594213 = validateParameter(valid_594213, JString, required = true,
                                 default = nil)
  if valid_594213 != nil:
    section.add "devicePath", valid_594213
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594215: Call_ExpressRouteCircuitsListRoutesTable_594206;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_594216: Call_ExpressRouteCircuitsListRoutesTable_594206;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string; devicePath: string): Recallable =
  ...
  add(path_594217, "circuitName", newJString(circuitName))
  add(path_594217, "resourceGroupName", newJString(resourceGroupName))
  add(query_594218, "api-version", newJString(apiVersion))
  add(path_594217, "peeringName", newJString(peeringName))
  add(path_594217, "subscriptionId", newJString(subscriptionId))
  add(path_594217, "devicePath", newJString(devicePath))
  result = call_594216.call(path_594217, query_594218, nil, nil, nil)

var expressRouteCircuitsListRoutesTable* = Call_ExpressRouteCircuitsListRoutesTable_594206(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTable_594207, base: "",
    url: url_ExpressRouteCircuitsListRoutesTable_594208, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsListRoutesTableSummary_594219 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCircuitsListRoutesTableSummary_594221(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsListRoutesTableSummary_594220(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594228: Call_ExpressRouteCircuitsListRoutesTableSummary_594219;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the currently advertised routes table summary associated with the express route circuit in a resource group.
  ## 
...
proc call*(call_594229: Call_ExpressRouteCircuitsListRoutesTableSummary_594219;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string; devicePath: string): Recallable =
  ...
  add(path_594230, "devicePath", newJString(devicePath))
  result = call_594229.call(path_594230, query_594231, nil, nil, nil)

var expressRouteCircuitsListRoutesTableSummary* = Call_ExpressRouteCircuitsListRoutesTableSummary_594219(
    ...
    validator: validate_ExpressRouteCircuitsListRoutesTableSummary_594220,
    base: "", url: url_ExpressRouteCircuitsListRoutesTableSummary_594221,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetPeeringStats_594232 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCircuitsGetPeeringStats_594234(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetPeeringStats_594233(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594237 = path.getOrDefault("peeringName")
  valid_594237 = validateParameter(valid_594237, JString, required = true,
                                 default = nil)
  if valid_594237 != nil:
    section.add "peeringName", valid_594237
...
proc call*(call_594240: Call_ExpressRouteCircuitsGetPeeringStats_594232;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets all stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_594241: Call_ExpressRouteCircuitsGetPeeringStats_594232;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          peeringName: string; subscriptionId: string): Recallable =
...
var expressRouteCircuitsGetPeeringStats* = Call_ExpressRouteCircuitsGetPeeringStats_594232(
    ...
    validator: validate_ExpressRouteCircuitsGetPeeringStats_594233, base: "",
    url: url_ExpressRouteCircuitsGetPeeringStats_594234, schemes: {Scheme.Https})
type
  Call_ExpressRouteCircuitsGetStats_594244 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCircuitsGetStats_594246(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCircuitsGetStats_594245(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594251: Call_ExpressRouteCircuitsGetStats_594244; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the stats from an express route circuit in a resource group.
  ## 
...
proc call*(call_594252: Call_ExpressRouteCircuitsGetStats_594244;
          circuitName: string; resourceGroupName: string; apiVersion: string;
          subscriptionId: string): Recallable =
  ...
  add(path_594253, "circuitName", newJString(circuitName))
...
var expressRouteCircuitsGetStats* = Call_ExpressRouteCircuitsGetStats_594244(
    ...
    validator: validate_ExpressRouteCircuitsGetStats_594245, base: "",
    url: url_ExpressRouteCircuitsGetStats_594246, schemes: {Scheme.Https})
export
  rest
