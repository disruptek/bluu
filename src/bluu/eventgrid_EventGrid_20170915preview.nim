...
type
  Call_EventSubscriptionsCreate_564310 = ref object of OpenApiRestCall_563540
proc url_EventSubscriptionsCreate_564312(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_EventSubscriptionsCreate_564311(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564317: Call_EventSubscriptionsCreate_564310; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Asynchronously creates a new event subscription to the specified scope. Existing event subscriptions cannot be updated with this API and should instead use the Update event subscription API.
  ## 
...
proc call*(call_564318: Call_EventSubscriptionsCreate_564310; apiVersion: string;
...
var eventSubscriptionsCreate* = Call_EventSubscriptionsCreate_564310(
    ...
    validator: validate_EventSubscriptionsCreate_564311, base: "",
    url: url_EventSubscriptionsCreate_564312, schemes: {Scheme.Https})
type
