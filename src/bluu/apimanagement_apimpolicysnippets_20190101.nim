...
type
  Call_PolicySnippetListByService_563777 = ref object of OpenApiRestCall_563555
proc url_PolicySnippetListByService_563779(protocol: Scheme; host: string;
...
proc validate_PolicySnippetListByService_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563985: Call_PolicySnippetListByService_563777; path: JsonNode;
...
proc call*(call_564056: Call_PolicySnippetListByService_563777;
...
var policySnippetListByService* = Call_PolicySnippetListByService_563777(
    ...
    validator: validate_PolicySnippetListByService_563778, base: "",
    url: url_PolicySnippetListByService_563779, schemes: {Scheme.Https})
export
  rest
