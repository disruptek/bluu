...
type
  Call_ApplicationTypesCreateOrUpdate_564134 = ref object of OpenApiRestCall_563564
proc url_ApplicationTypesCreateOrUpdate_564136(protocol: Scheme; host: string;
...
proc validate_ApplicationTypesCreateOrUpdate_564135(path: JsonNode;
...
proc call*(call_564160: Call_ApplicationTypesCreateOrUpdate_564134; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or update a Service Fabric application type name resource with the specified name.
  ## 
...
proc call*(call_564161: Call_ApplicationTypesCreateOrUpdate_564134;
...
var applicationTypesCreateOrUpdate* = Call_ApplicationTypesCreateOrUpdate_564134(
    ...
    validator: validate_ApplicationTypesCreateOrUpdate_564135, base: "",
    url: url_ApplicationTypesCreateOrUpdate_564136, schemes: {Scheme.Https})
type
...
proc call*(call_564131: Call_ApplicationTypesGet_564122; clusterName: string;
          ...
          resourceGroupName: string; apiVersion: string = "2019-03-01"): Recallable =
  ## applicationTypesGet
  ## Get a Service Fabric application type name resource created or in the process of being created in the Service Fabric cluster resource.
  ##   clusterName: string (required)
  ##              : The name of the cluster resource.
...
type
  Call_ApplicationTypeVersionsCreateOrUpdate_564202 = ref object of OpenApiRestCall_563564
proc url_ApplicationTypeVersionsCreateOrUpdate_564204(protocol: Scheme;
...
proc validate_ApplicationTypeVersionsCreateOrUpdate_564203(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564212: Call_ApplicationTypeVersionsCreateOrUpdate_564202;
...
proc call*(call_564213: Call_ApplicationTypeVersionsCreateOrUpdate_564202;
...
var applicationTypeVersionsCreateOrUpdate* = Call_ApplicationTypeVersionsCreateOrUpdate_564202(
    ...
    validator: validate_ApplicationTypeVersionsCreateOrUpdate_564203, base: "",
    url: url_ApplicationTypeVersionsCreateOrUpdate_564204, schemes: {Scheme.Https})
type
...
type
  Call_ApplicationsCreateOrUpdate_564253 = ref object of OpenApiRestCall_563564
proc url_ApplicationsCreateOrUpdate_564255(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApplicationsCreateOrUpdate_564254(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564262: Call_ApplicationsCreateOrUpdate_564253; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or update a Service Fabric application resource with the specified name.
  ## 
...
proc call*(call_564263: Call_ApplicationsCreateOrUpdate_564253;
          clusterName: string; applicationName: string; subscriptionId: string;
          resourceGroupName: string; parameters: JsonNode;
          apiVersion: string = "2019-03-01"): Recallable =
...
var applicationsCreateOrUpdate* = Call_ApplicationsCreateOrUpdate_564253(
    ...
    validator: validate_ApplicationsCreateOrUpdate_564254, base: "",
    url: url_ApplicationsCreateOrUpdate_564255, schemes: {Scheme.Https})
type
...
var servicesList* = Call_ServicesList_564293(name: "servicesList",
    ...
    schemes: {Scheme.Https})
type
  Call_ServicesCreateOrUpdate_564318 = ref object of OpenApiRestCall_563564
proc url_ServicesCreateOrUpdate_564320(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesCreateOrUpdate_564319(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564328: Call_ServicesCreateOrUpdate_564318; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or update a Service Fabric service resource with the specified name.
  ## 
...
proc call*(call_564329: Call_ServicesCreateOrUpdate_564318; clusterName: string;
...
var servicesCreateOrUpdate* = Call_ServicesCreateOrUpdate_564318(
    ...
    validator: validate_ServicesCreateOrUpdate_564319, base: "",
    url: url_ServicesCreateOrUpdate_564320, schemes: {Scheme.Https})
type
