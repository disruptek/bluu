...
type
  Call_IoTSecuritySolutionsList_563777 = ref object of OpenApiRestCall_563555
proc url_IoTSecuritySolutionsList_563779(protocol: Scheme; host: string;
...
proc validate_IoTSecuritySolutionsList_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563980: Call_IoTSecuritySolutionsList_563777; path: JsonNode;
...
proc call*(call_564051: Call_IoTSecuritySolutionsList_563777; apiVersion: string;
...
var ioTSecuritySolutionsList* = Call_IoTSecuritySolutionsList_563777(
    ...
    validator: validate_IoTSecuritySolutionsList_563778, base: "",
    url: url_IoTSecuritySolutionsList_563779, schemes: {Scheme.Https})
type
  Call_IoTSecuritySolutionsResourceGroupList_564093 = ref object of OpenApiRestCall_563555
proc url_IoTSecuritySolutionsResourceGroupList_564095(protocol: Scheme;
...
proc validate_IoTSecuritySolutionsResourceGroupList_564094(path: JsonNode;
...
proc call*(call_564100: Call_IoTSecuritySolutionsResourceGroupList_564093;
...
proc call*(call_564101: Call_IoTSecuritySolutionsResourceGroupList_564093;
...
var ioTSecuritySolutionsResourceGroupList* = Call_IoTSecuritySolutionsResourceGroupList_564093(
    ...
    validator: validate_IoTSecuritySolutionsResourceGroupList_564094, base: "",
    url: url_IoTSecuritySolutionsResourceGroupList_564095, schemes: {Scheme.Https})
type
  Call_IotSecuritySolutionCreate_564115 = ref object of OpenApiRestCall_563555
proc url_IotSecuritySolutionCreate_564117(protocol: Scheme; host: string;
...
proc validate_IotSecuritySolutionCreate_564116(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564123: Call_IotSecuritySolutionCreate_564115; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create new solution manager
  ## 
...
proc call*(call_564124: Call_IotSecuritySolutionCreate_564115; apiVersion: string;
          solutionName: string; iotSecuritySolutionData: JsonNode;
...
var iotSecuritySolutionCreate* = Call_IotSecuritySolutionCreate_564115(
    ...
    validator: validate_IotSecuritySolutionCreate_564116, base: "",
    url: url_IotSecuritySolutionCreate_564117, schemes: {Scheme.Https})
type
