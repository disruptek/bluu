...
type
  Call_IoTSecuritySolutionsList_573879 = ref object of OpenApiRestCall_573657
proc url_IoTSecuritySolutionsList_573881(protocol: Scheme; host: string;
...
proc validate_IoTSecuritySolutionsList_573880(path: JsonNode; query: JsonNode;
...
proc call*(call_574080: Call_IoTSecuritySolutionsList_573879; path: JsonNode;
...
proc call*(call_574151: Call_IoTSecuritySolutionsList_573879; apiVersion: string;
...
var ioTSecuritySolutionsList* = Call_IoTSecuritySolutionsList_573879(
    ...
    validator: validate_IoTSecuritySolutionsList_573880, base: "",
    url: url_IoTSecuritySolutionsList_573881, schemes: {Scheme.Https})
type
  Call_IoTSecuritySolutionsResourceGroupList_574193 = ref object of OpenApiRestCall_573657
proc url_IoTSecuritySolutionsResourceGroupList_574195(protocol: Scheme;
...
proc validate_IoTSecuritySolutionsResourceGroupList_574194(path: JsonNode;
...
proc call*(call_574200: Call_IoTSecuritySolutionsResourceGroupList_574193;
...
proc call*(call_574201: Call_IoTSecuritySolutionsResourceGroupList_574193;
...
var ioTSecuritySolutionsResourceGroupList* = Call_IoTSecuritySolutionsResourceGroupList_574193(
    ...
    validator: validate_IoTSecuritySolutionsResourceGroupList_574194, base: "",
    url: url_IoTSecuritySolutionsResourceGroupList_574195, schemes: {Scheme.Https})
type
  Call_IotSecuritySolutionCreate_574215 = ref object of OpenApiRestCall_573657
proc url_IotSecuritySolutionCreate_574217(protocol: Scheme; host: string;
...
proc validate_IotSecuritySolutionCreate_574216(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_574223: Call_IotSecuritySolutionCreate_574215; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create new solution manager
  ## 
...
proc call*(call_574224: Call_IotSecuritySolutionCreate_574215;
...
var iotSecuritySolutionCreate* = Call_IotSecuritySolutionCreate_574215(
    ...
    validator: validate_IotSecuritySolutionCreate_574216, base: "",
    url: url_IotSecuritySolutionCreate_574217, schemes: {Scheme.Https})
type
