...
var topicsDelete* = Call_TopicsDelete_594093(name: "topicsDelete",
    ...
    schemes: {Scheme.Https})
type
  Call_TopicsListSharedAccessKeys_594104 = ref object of OpenApiRestCall_593409
proc url_TopicsListSharedAccessKeys_594106(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TopicsListSharedAccessKeys_594105(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594111: Call_TopicsListSharedAccessKeys_594104; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List the two keys used to publish to a topic
  ## 
...
proc call*(call_594112: Call_TopicsListSharedAccessKeys_594104;
          resourceGroupName: string; apiVersion: string; topicName: string;
          subscriptionId: string): Recallable =
...
var topicsListSharedAccessKeys* = Call_TopicsListSharedAccessKeys_594104(
    ...
    validator: validate_TopicsListSharedAccessKeys_594105, base: "",
    url: url_TopicsListSharedAccessKeys_594106, schemes: {Scheme.Https})
type
  Call_TopicsRegenerateKey_594115 = ref object of OpenApiRestCall_593409
proc url_TopicsRegenerateKey_594117(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TopicsRegenerateKey_594116(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594119 = path.getOrDefault("topicName")
  valid_594119 = validateParameter(valid_594119, JString, required = true,
                                 default = nil)
  if valid_594119 != nil:
    section.add "topicName", valid_594119
...
proc call*(call_594123: Call_TopicsRegenerateKey_594115; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Regenerate a shared access key for a topic
  ## 
...
proc call*(call_594124: Call_TopicsRegenerateKey_594115; resourceGroupName: string;
...
var topicsRegenerateKey* = Call_TopicsRegenerateKey_594115(
    ...
    validator: validate_TopicsRegenerateKey_594116, base: "",
    url: url_TopicsRegenerateKey_594117, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsListByResource_594128 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsListByResource_594130(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EventSubscriptionsListByResource_594129(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594131 = path.getOrDefault("providerNamespace")
  valid_594131 = validateParameter(valid_594131, JString, required = true,
                                 default = nil)
  if valid_594131 != nil:
    section.add "providerNamespace", valid_594131
  ...
  var valid_594134 = path.getOrDefault("resourceName")
  valid_594134 = validateParameter(valid_594134, JString, required = true,
                                 default = nil)
  if valid_594134 != nil:
    section.add "resourceName", valid_594134
  var valid_594135 = path.getOrDefault("resourceTypeName")
  valid_594135 = validateParameter(valid_594135, JString, required = true,
                                 default = nil)
  if valid_594135 != nil:
    section.add "resourceTypeName", valid_594135
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594137: Call_EventSubscriptionsListByResource_594128;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List all event subscriptions that have been created for a specific topic
  ## 
...
proc call*(call_594138: Call_EventSubscriptionsListByResource_594128;
  ...
  add(path_594139, "providerNamespace", newJString(providerNamespace))
  ...
  add(path_594139, "resourceTypeName", newJString(resourceTypeName))
  result = call_594138.call(path_594139, query_594140, nil, nil, nil)

var eventSubscriptionsListByResource* = Call_EventSubscriptionsListByResource_594128(
    ...
    validator: validate_EventSubscriptionsListByResource_594129, base: "",
    url: url_EventSubscriptionsListByResource_594130, schemes: {Scheme.Https})
type
  Call_TopicsListEventTypes_594141 = ref object of OpenApiRestCall_593409
proc url_TopicsListEventTypes_594143(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TopicsListEventTypes_594142(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594150: Call_TopicsListEventTypes_594141; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List event types for a topic
  ## 
...
proc call*(call_594151: Call_TopicsListEventTypes_594141;
          providerNamespace: string; resourceGroupName: string; apiVersion: string;
          subscriptionId: string; resourceName: string; resourceTypeName: string): Recallable =
...
var topicsListEventTypes* = Call_TopicsListEventTypes_594141(
    ...
    validator: validate_TopicsListEventTypes_594142, base: "",
    url: url_TopicsListEventTypes_594143, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsCreate_594164 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsCreate_594166(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_EventSubscriptionsCreate_594165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594167 = path.getOrDefault("eventSubscriptionName")
  valid_594167 = validateParameter(valid_594167, JString, required = true,
                                 default = nil)
  if valid_594167 != nil:
    section.add "eventSubscriptionName", valid_594167
  var valid_594168 = path.getOrDefault("scope")
  valid_594168 = validateParameter(valid_594168, JString, required = true,
                                 default = nil)
  if valid_594168 != nil:
    section.add "scope", valid_594168
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594171: Call_EventSubscriptionsCreate_594164; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Asynchronously creates a new event subscription to the specified scope. Existing event subscriptions cannot be updated with this API and should instead use the Update event subscription API.
  ## 
...
proc call*(call_594172: Call_EventSubscriptionsCreate_594164;
  ...
  if eventSubscriptionInfo != nil:
    body_594175 = eventSubscriptionInfo
  add(query_594174, "api-version", newJString(apiVersion))
  add(path_594173, "eventSubscriptionName", newJString(eventSubscriptionName))
  add(path_594173, "scope", newJString(scope))
  result = call_594172.call(path_594173, query_594174, nil, nil, body_594175)

var eventSubscriptionsCreate* = Call_EventSubscriptionsCreate_594164(
    ...
    validator: validate_EventSubscriptionsCreate_594165, base: "",
    url: url_EventSubscriptionsCreate_594166, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsGet_594154 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsGet_594156(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EventSubscriptionsGet_594155(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventSubscriptionName` field"
  var valid_594157 = path.getOrDefault("eventSubscriptionName")
  valid_594157 = validateParameter(valid_594157, JString, required = true,
                                 default = nil)
  if valid_594157 != nil:
    section.add "eventSubscriptionName", valid_594157
  var valid_594158 = path.getOrDefault("scope")
  valid_594158 = validateParameter(valid_594158, JString, required = true,
                                 default = nil)
  if valid_594158 != nil:
    section.add "scope", valid_594158
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594160: Call_EventSubscriptionsGet_594154; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get properties of an event subscription
  ## 
...
proc call*(call_594161: Call_EventSubscriptionsGet_594154; apiVersion: string;
          eventSubscriptionName: string; scope: string): Recallable =
  ...
  add(path_594162, "eventSubscriptionName", newJString(eventSubscriptionName))
  add(path_594162, "scope", newJString(scope))
  result = call_594161.call(path_594162, query_594163, nil, nil, nil)

var eventSubscriptionsGet* = Call_EventSubscriptionsGet_594154(
    name: "eventSubscriptionsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/{scope}/providers/Microsoft.EventGrid/eventSubscriptions/{eventSubscriptionName}",
    validator: validate_EventSubscriptionsGet_594155, base: "",
    url: url_EventSubscriptionsGet_594156, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsUpdate_594186 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsUpdate_594188(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_EventSubscriptionsUpdate_594187(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventSubscriptionName` field"
  var valid_594189 = path.getOrDefault("eventSubscriptionName")
  valid_594189 = validateParameter(valid_594189, JString, required = true,
                                 default = nil)
  if valid_594189 != nil:
    section.add "eventSubscriptionName", valid_594189
  var valid_594190 = path.getOrDefault("scope")
  valid_594190 = validateParameter(valid_594190, JString, required = true,
                                 default = nil)
  if valid_594190 != nil:
    section.add "scope", valid_594190
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594193: Call_EventSubscriptionsUpdate_594186; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Asynchronously updates an existing event subscription.
  ## 
...
proc call*(call_594194: Call_EventSubscriptionsUpdate_594186; apiVersion: string;
  ...
  add(path_594195, "eventSubscriptionName", newJString(eventSubscriptionName))
  add(path_594195, "scope", newJString(scope))
  if eventSubscriptionUpdateParameters != nil:
    body_594197 = eventSubscriptionUpdateParameters
  result = call_594194.call(path_594195, query_594196, nil, nil, body_594197)

var eventSubscriptionsUpdate* = Call_EventSubscriptionsUpdate_594186(
    name: "eventSubscriptionsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/{scope}/providers/Microsoft.EventGrid/eventSubscriptions/{eventSubscriptionName}",
    validator: validate_EventSubscriptionsUpdate_594187, base: "",
    url: url_EventSubscriptionsUpdate_594188, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsDelete_594176 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsDelete_594178(protocol: Scheme; host: string;
                                        base: string; route: string; path: JsonNode;
                                        query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_EventSubscriptionsDelete_594177(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventSubscriptionName` field"
  var valid_594179 = path.getOrDefault("eventSubscriptionName")
  valid_594179 = validateParameter(valid_594179, JString, required = true,
                                 default = nil)
  if valid_594179 != nil:
    section.add "eventSubscriptionName", valid_594179
  var valid_594180 = path.getOrDefault("scope")
  valid_594180 = validateParameter(valid_594180, JString, required = true,
                                 default = nil)
  if valid_594180 != nil:
    section.add "scope", valid_594180
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594182: Call_EventSubscriptionsDelete_594176; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an existing event subscription
  ## 
...
proc call*(call_594183: Call_EventSubscriptionsDelete_594176; apiVersion: string;
          eventSubscriptionName: string; scope: string): Recallable =
  ...
  add(path_594184, "eventSubscriptionName", newJString(eventSubscriptionName))
  add(path_594184, "scope", newJString(scope))
  result = call_594183.call(path_594184, query_594185, nil, nil, nil)

var eventSubscriptionsDelete* = Call_EventSubscriptionsDelete_594176(
    name: "eventSubscriptionsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/{scope}/providers/Microsoft.EventGrid/eventSubscriptions/{eventSubscriptionName}",
    validator: validate_EventSubscriptionsDelete_594177, base: "",
    url: url_EventSubscriptionsDelete_594178, schemes: {Scheme.Https})
type
  Call_EventSubscriptionsGetFullUrl_594198 = ref object of OpenApiRestCall_593409
proc url_EventSubscriptionsGetFullUrl_594200(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EventSubscriptionsGetFullUrl_594199(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventSubscriptionName` field"
  var valid_594201 = path.getOrDefault("eventSubscriptionName")
  valid_594201 = validateParameter(valid_594201, JString, required = true,
                                 default = nil)
  if valid_594201 != nil:
    section.add "eventSubscriptionName", valid_594201
  var valid_594202 = path.getOrDefault("scope")
  valid_594202 = validateParameter(valid_594202, JString, required = true,
                                 default = nil)
  if valid_594202 != nil:
    section.add "scope", valid_594202
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_594204: Call_EventSubscriptionsGetFullUrl_594198; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the full endpoint URL for an event subscription
  ## 
...
proc call*(call_594205: Call_EventSubscriptionsGetFullUrl_594198;
  ...
  add(path_594206, "eventSubscriptionName", newJString(eventSubscriptionName))
  add(path_594206, "scope", newJString(scope))
  result = call_594205.call(path_594206, query_594207, nil, nil, nil)

var eventSubscriptionsGetFullUrl* = Call_EventSubscriptionsGetFullUrl_594198(
    ...
    validator: validate_EventSubscriptionsGetFullUrl_594199, base: "",
    url: url_EventSubscriptionsGetFullUrl_594200, schemes: {Scheme.Https})
export
  rest
