...
proc validate_PathGetProperties_564288(path: JsonNode; query: JsonNode;
  ...
  var valid_564294 = query.getOrDefault("upn")
  valid_564294 = validateParameter(valid_564294, JBool, required = false, default = nil)
  if valid_564294 != nil:
    section.add "upn", valid_564294
  result.add "query", section
  ## parameters in `header` object:
  ##   x-ms-lease-id: JString
  ...
  ##           : Optional.  An ETag value. Specify this header to perform the operation only if the resource's ETag matches the value specified. The ETag must be specified in quotes.
  section = newJObject()
  var valid_564295 = header.getOrDefault("x-ms-lease-id")
  valid_564295 = validateParameter(valid_564295, JString, required = false,
                                 default = nil)
  if valid_564295 != nil:
    section.add "x-ms-lease-id", valid_564295
  var valid_564296 = header.getOrDefault("x-ms-version")
  valid_564296 = validateParameter(valid_564296, JString, required = false,
                                 default = nil)
  if valid_564296 != nil:
    section.add "x-ms-version", valid_564296
  var valid_564297 = header.getOrDefault("x-ms-date")
  valid_564297 = validateParameter(valid_564297, JString, required = false,
                                 default = nil)
  if valid_564297 != nil:
    section.add "x-ms-date", valid_564297
  var valid_564298 = header.getOrDefault("If-Unmodified-Since")
  valid_564298 = validateParameter(valid_564298, JString, required = false,
                                 default = nil)
  if valid_564298 != nil:
    section.add "If-Unmodified-Since", valid_564298
  var valid_564299 = header.getOrDefault("x-ms-client-request-id")
  valid_564299 = validateParameter(valid_564299, JString, required = false,
                                 default = nil)
  if valid_564299 != nil:
    section.add "x-ms-client-request-id", valid_564299
  var valid_564300 = header.getOrDefault("If-Modified-Since")
  valid_564300 = validateParameter(valid_564300, JString, required = false,
                                 default = nil)
  if valid_564300 != nil:
    section.add "If-Modified-Since", valid_564300
...
proc call*(call_564303: Call_PathGetProperties_564287; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get Properties returns all system and user defined properties for a path. Get Status returns all system defined properties for a path. Get Access Control List returns the access control list for a path. This operation supports conditional HTTP requests.  For more information, see [Specifying Conditional Headers for Blob Service Operations](https://docs.microsoft.com/en-us/rest/api/storageservices/specifying-conditional-headers-for-blob-service-operations).
  ## 
...
proc call*(call_564304: Call_PathGetProperties_564287; path: string;
          filesystem: string; action: string = "getAccessControl"; timeout: int = 0;
  ...
  add(query_564306, "action", newJString(action))
  add(query_564306, "timeout", newJInt(timeout))
  add(query_564306, "upn", newJBool(upn))
  add(path_564305, "path", newJString(path))
  add(path_564305, "filesystem", newJString(filesystem))
...
var pathRead* = Call_PathRead_564186(name: "pathRead", meth: HttpMethod.HttpGet,
                                  ...
                                  schemes: {Scheme.Https})
type
  Call_PathUpdate_564307 = ref object of OpenApiRestCall_563556
proc url_PathUpdate_564309(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PathUpdate_564308(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `path` field"
  var valid_564310 = path.getOrDefault("path")
  valid_564310 = validateParameter(valid_564310, JString, required = true,
                                 default = nil)
  if valid_564310 != nil:
    section.add "path", valid_564310
  var valid_564311 = path.getOrDefault("filesystem")
  valid_564311 = validateParameter(valid_564311, JString, required = true,
                                 default = nil)
  if valid_564311 != nil:
    section.add "filesystem", valid_564311
  result.add "path", section
  ## parameters in `query` object:
  ...
  var valid_564312 = query.getOrDefault("action")
  valid_564312 = validateParameter(valid_564312, JString, required = true,
                                 default = newJString("append"))
  if valid_564312 != nil:
    section.add "action", valid_564312
  var valid_564313 = query.getOrDefault("position")
  valid_564313 = validateParameter(valid_564313, JInt, required = false, default = nil)
  if valid_564313 != nil:
    section.add "position", valid_564313
  var valid_564314 = query.getOrDefault("retainUncommittedData")
  valid_564314 = validateParameter(valid_564314, JBool, required = false, default = nil)
  if valid_564314 != nil:
    section.add "retainUncommittedData", valid_564314
  ...
  var valid_564316 = query.getOrDefault("close")
  valid_564316 = validateParameter(valid_564316, JBool, required = false, default = nil)
  if valid_564316 != nil:
    section.add "close", valid_564316
  result.add "query", section
  ## parameters in `header` object:
  ##   x-ms-lease-id: JString
  ...
  section = newJObject()
  var valid_564317 = header.getOrDefault("x-ms-lease-id")
  valid_564317 = validateParameter(valid_564317, JString, required = false,
                                 default = nil)
  if valid_564317 != nil:
    section.add "x-ms-lease-id", valid_564317
  var valid_564318 = header.getOrDefault("x-ms-permissions")
  valid_564318 = validateParameter(valid_564318, JString, required = false,
                                 default = nil)
  if valid_564318 != nil:
    section.add "x-ms-permissions", valid_564318
  var valid_564319 = header.getOrDefault("x-ms-version")
  valid_564319 = validateParameter(valid_564319, JString, required = false,
                                 default = nil)
  if valid_564319 != nil:
    section.add "x-ms-version", valid_564319
  var valid_564320 = header.getOrDefault("Content-Length")
  valid_564320 = validateParameter(valid_564320, JInt, required = false, default = nil)
  if valid_564320 != nil:
    section.add "Content-Length", valid_564320
  var valid_564321 = header.getOrDefault("x-ms-date")
  valid_564321 = validateParameter(valid_564321, JString, required = false,
                                 default = nil)
  if valid_564321 != nil:
    section.add "x-ms-date", valid_564321
  var valid_564322 = header.getOrDefault("x-ms-content-type")
  valid_564322 = validateParameter(valid_564322, JString, required = false,
                                 default = nil)
  if valid_564322 != nil:
    section.add "x-ms-content-type", valid_564322
  var valid_564323 = header.getOrDefault("x-ms-properties")
  valid_564323 = validateParameter(valid_564323, JString, required = false,
                                 default = nil)
  if valid_564323 != nil:
    section.add "x-ms-properties", valid_564323
  var valid_564324 = header.getOrDefault("x-ms-acl")
  valid_564324 = validateParameter(valid_564324, JString, required = false,
                                 default = nil)
  if valid_564324 != nil:
    section.add "x-ms-acl", valid_564324
  var valid_564325 = header.getOrDefault("x-ms-content-disposition")
  valid_564325 = validateParameter(valid_564325, JString, required = false,
                                 default = nil)
  if valid_564325 != nil:
    section.add "x-ms-content-disposition", valid_564325
  var valid_564326 = header.getOrDefault("x-ms-client-request-id")
  valid_564326 = validateParameter(valid_564326, JString, required = false,
                                 default = nil)
  if valid_564326 != nil:
    section.add "x-ms-client-request-id", valid_564326
  var valid_564327 = header.getOrDefault("If-Unmodified-Since")
  valid_564327 = validateParameter(valid_564327, JString, required = false,
                                 default = nil)
  if valid_564327 != nil:
    section.add "If-Unmodified-Since", valid_564327
  var valid_564328 = header.getOrDefault("Content-MD5")
  valid_564328 = validateParameter(valid_564328, JString, required = false,
                                 default = nil)
  if valid_564328 != nil:
    section.add "Content-MD5", valid_564328
  var valid_564329 = header.getOrDefault("If-Modified-Since")
  valid_564329 = validateParameter(valid_564329, JString, required = false,
                                 default = nil)
  if valid_564329 != nil:
    section.add "If-Modified-Since", valid_564329
  var valid_564330 = header.getOrDefault("If-None-Match")
  valid_564330 = validateParameter(valid_564330, JString, required = false,
                                 default = nil)
  if valid_564330 != nil:
    section.add "If-None-Match", valid_564330
  var valid_564331 = header.getOrDefault("x-ms-cache-control")
  valid_564331 = validateParameter(valid_564331, JString, required = false,
                                 default = nil)
  if valid_564331 != nil:
    section.add "x-ms-cache-control", valid_564331
  var valid_564332 = header.getOrDefault("x-ms-owner")
  valid_564332 = validateParameter(valid_564332, JString, required = false,
                                 default = nil)
  if valid_564332 != nil:
    section.add "x-ms-owner", valid_564332
  var valid_564333 = header.getOrDefault("x-ms-group")
  valid_564333 = validateParameter(valid_564333, JString, required = false,
                                 default = nil)
  if valid_564333 != nil:
    section.add "x-ms-group", valid_564333
  var valid_564334 = header.getOrDefault("x-ms-content-md5")
  valid_564334 = validateParameter(valid_564334, JString, required = false,
                                 default = nil)
  if valid_564334 != nil:
    section.add "x-ms-content-md5", valid_564334
  var valid_564335 = header.getOrDefault("x-ms-content-encoding")
  valid_564335 = validateParameter(valid_564335, JString, required = false,
                                 default = nil)
  if valid_564335 != nil:
    section.add "x-ms-content-encoding", valid_564335
  var valid_564336 = header.getOrDefault("x-ms-content-language")
  valid_564336 = validateParameter(valid_564336, JString, required = false,
                                 default = nil)
  if valid_564336 != nil:
    section.add "x-ms-content-language", valid_564336
  var valid_564337 = header.getOrDefault("If-Match")
  valid_564337 = validateParameter(valid_564337, JString, required = false,
                                 default = nil)
  if valid_564337 != nil:
    section.add "If-Match", valid_564337
  result.add "header", section
  section = newJObject()
  result.add "formData", section
...
proc call*(call_564339: Call_PathUpdate_564307; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Uploads data to be appended to a file, flushes (writes) previously uploaded data to a file, sets properties for a file or directory, or sets access control for a file or directory. Data can only be appended to a file. This operation supports conditional HTTP requests. For more information, see [Specifying Conditional Headers for Blob Service Operations](https://docs.microsoft.com/en-us/rest/api/storageservices/specifying-conditional-headers-for-blob-service-operations).
  ## 
...
proc call*(call_564340: Call_PathUpdate_564307; path: string; filesystem: string;
  ...
  add(query_564342, "action", newJString(action))
  add(query_564342, "position", newJInt(position))
  add(query_564342, "retainUncommittedData", newJBool(retainUncommittedData))
  add(query_564342, "timeout", newJInt(timeout))
  if requestBody != nil:
    body_564343 = requestBody
  add(query_564342, "close", newJBool(close))
  add(path_564341, "path", newJString(path))
  add(path_564341, "filesystem", newJString(filesystem))
  result = call_564340.call(path_564341, query_564342, nil, nil, body_564343)

var pathUpdate* = Call_PathUpdate_564307(name: "pathUpdate",
                                      meth: HttpMethod.HttpPatch,
                                      host: "azure.local",
                                      route: "/{filesystem}/{path}",
                                      validator: validate_PathUpdate_564308,
                                      base: "", url: url_PathUpdate_564309,
                                      schemes: {Scheme.Https})
type
