...
type
  Call_ServiceTagsList_573863 = ref object of OpenApiRestCall_573641
proc url_ServiceTagsList_573865(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        kind: ConstantSegment, value: "/providers/Microsoft.Network/locations/"),
               ...
               (kind: ConstantSegment, value: "/serviceTags")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_ServiceTagsList_573864(path: JsonNode; query: JsonNode;
...
proc call*(call_574054: Call_ServiceTagsList_573863; path: JsonNode; query: JsonNode;
...
proc call*(call_574125: Call_ServiceTagsList_573863; apiVersion: string;
...
var serviceTagsList* = Call_ServiceTagsList_573863(name: "serviceTagsList",
    ...
    validator: validate_ServiceTagsList_573864, base: "", url: url_ServiceTagsList_573865,
