...
type
  Call_IotHubResourceUpdate_564164 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceUpdate_564166(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceUpdate_564165(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564186 = path.getOrDefault("resourceName")
  valid_564186 = validateParameter(valid_564186, JString, required = true,
                                 default = nil)
  if valid_564186 != nil:
    section.add "resourceName", valid_564186
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564189: Call_IotHubResourceUpdate_564164; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update an existing IoT Hub tags. to update other fields use the CreateOrUpdate method
  ## 
...
proc call*(call_564190: Call_IotHubResourceUpdate_564164; apiVersion: string;
...
var iotHubResourceUpdate* = Call_IotHubResourceUpdate_564164(
    name: "iotHubResourceUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}",
    validator: validate_IotHubResourceUpdate_564165, base: "",
    url: url_IotHubResourceUpdate_564166, schemes: {Scheme.Https})
type
...
type
  Call_IotHubResourceGetKeysForKeyName_564194 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetKeysForKeyName_564196(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetKeysForKeyName_564195(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564197 = path.getOrDefault("keyName")
  valid_564197 = validateParameter(valid_564197, JString, required = true,
                                 default = nil)
  if valid_564197 != nil:
    section.add "keyName", valid_564197
...
proc call*(call_564202: Call_IotHubResourceGetKeysForKeyName_564194;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a shared access policy by name from an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-security.
  ## 
...
proc call*(call_564203: Call_IotHubResourceGetKeysForKeyName_564194;
  ...
  add(path_564204, "keyName", newJString(keyName))
...
var iotHubResourceGetKeysForKeyName* = Call_IotHubResourceGetKeysForKeyName_564194(
    ...
    validator: validate_IotHubResourceGetKeysForKeyName_564195, base: "",
    url: url_IotHubResourceGetKeysForKeyName_564196, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetStats_564206 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetStats_564208(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetStats_564207(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564213: Call_IotHubResourceGetStats_564206; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the statistics from an IoT hub.
  ## 
...
proc call*(call_564214: Call_IotHubResourceGetStats_564206; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var iotHubResourceGetStats* = Call_IotHubResourceGetStats_564206(
    ...
    validator: validate_IotHubResourceGetStats_564207, base: "",
    url: url_IotHubResourceGetStats_564208, schemes: {Scheme.Https})
type
  Call_CertificatesListByIotHub_564217 = ref object of OpenApiRestCall_563564
proc url_CertificatesListByIotHub_564219(protocol: Scheme; host: string;
...
proc validate_CertificatesListByIotHub_564218(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564222 = path.getOrDefault("resourceName")
  valid_564222 = validateParameter(valid_564222, JString, required = true,
                                 default = nil)
  if valid_564222 != nil:
    section.add "resourceName", valid_564222
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564224: Call_CertificatesListByIotHub_564217; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the list of certificates.
  ## 
...
proc call*(call_564225: Call_CertificatesListByIotHub_564217; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564226, "resourceName", newJString(resourceName))
  result = call_564225.call(path_564226, query_564227, nil, nil, nil)

var certificatesListByIotHub* = Call_CertificatesListByIotHub_564217(
    ...
    validator: validate_CertificatesListByIotHub_564218, base: "",
    url: url_CertificatesListByIotHub_564219, schemes: {Scheme.Https})
type
  Call_CertificatesCreateOrUpdate_564240 = ref object of OpenApiRestCall_563564
proc url_CertificatesCreateOrUpdate_564242(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesCreateOrUpdate_564241(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  var valid_564248 = header.getOrDefault("If-Match")
  valid_564248 = validateParameter(valid_564248, JString, required = false,
                                 default = nil)
  if valid_564248 != nil:
    section.add "If-Match", valid_564248
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  ## parameters in `body` object:
...
proc call*(call_564250: Call_CertificatesCreateOrUpdate_564240; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Adds new or replaces existing certificate.
  ## 
...
proc call*(call_564251: Call_CertificatesCreateOrUpdate_564240; apiVersion: string;
  ...
  if certificateDescription != nil:
    body_564254 = certificateDescription
  add(path_564252, "resourceGroupName", newJString(resourceGroupName))
  add(path_564252, "resourceName", newJString(resourceName))
  add(path_564252, "certificateName", newJString(certificateName))
  result = call_564251.call(path_564252, query_564253, nil, nil, body_564254)

var certificatesCreateOrUpdate* = Call_CertificatesCreateOrUpdate_564240(
    ...
    validator: validate_CertificatesCreateOrUpdate_564241, base: "",
    url: url_CertificatesCreateOrUpdate_564242, schemes: {Scheme.Https})
type
  Call_CertificatesGet_564228 = ref object of OpenApiRestCall_563564
proc url_CertificatesGet_564230(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesGet_564229(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  var valid_564234 = path.getOrDefault("certificateName")
  valid_564234 = validateParameter(valid_564234, JString, required = true,
                                 default = nil)
  if valid_564234 != nil:
    section.add "certificateName", valid_564234
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564236: Call_CertificatesGet_564228; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the certificate.
  ## 
...
proc call*(call_564237: Call_CertificatesGet_564228; apiVersion: string;
  ...
  add(path_564238, "resourceName", newJString(resourceName))
  add(path_564238, "certificateName", newJString(certificateName))
  result = call_564237.call(path_564238, query_564239, nil, nil, nil)

var certificatesGet* = Call_CertificatesGet_564228(name: "certificatesGet",
    ...
    validator: validate_CertificatesGet_564229, base: "", url: url_CertificatesGet_564230,
    schemes: {Scheme.Https})
type
  Call_CertificatesDelete_564255 = ref object of OpenApiRestCall_563564
proc url_CertificatesDelete_564257(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesDelete_564256(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_564260 = path.getOrDefault("resourceName")
  valid_564260 = validateParameter(valid_564260, JString, required = true,
                                 default = nil)
  if valid_564260 != nil:
    section.add "resourceName", valid_564260
  var valid_564261 = path.getOrDefault("certificateName")
  valid_564261 = validateParameter(valid_564261, JString, required = true,
                                 default = nil)
  if valid_564261 != nil:
    section.add "certificateName", valid_564261
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
  ...
  var valid_564263 = header.getOrDefault("If-Match")
  valid_564263 = validateParameter(valid_564263, JString, required = true,
                                 default = nil)
  if valid_564263 != nil:
    section.add "If-Match", valid_564263
  result.add "header", section
  section = newJObject()
  result.add "formData", section
  if body != nil:
...
proc call*(call_564264: Call_CertificatesDelete_564255; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an existing X509 certificate or does nothing if it does not exist.
  ## 
...
proc call*(call_564265: Call_CertificatesDelete_564255; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string;
          certificateName: string): Recallable =
  ## certificatesDelete
  ## Deletes an existing X509 certificate or does nothing if it does not exist.
  ...
  add(path_564266, "certificateName", newJString(certificateName))
  result = call_564265.call(path_564266, query_564267, nil, nil, nil)

var certificatesDelete* = Call_CertificatesDelete_564255(
    name: "certificatesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/certificates/{certificateName}",
    validator: validate_CertificatesDelete_564256, base: "",
    url: url_CertificatesDelete_564257, schemes: {Scheme.Https})
type
  Call_CertificatesGenerateVerificationCode_564268 = ref object of OpenApiRestCall_563564
proc url_CertificatesGenerateVerificationCode_564270(protocol: Scheme;
...
proc validate_CertificatesGenerateVerificationCode_564269(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564274 = path.getOrDefault("certificateName")
  valid_564274 = validateParameter(valid_564274, JString, required = true,
                                 default = nil)
  if valid_564274 != nil:
    section.add "certificateName", valid_564274
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564277: Call_CertificatesGenerateVerificationCode_564268;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Generates verification code for proof of possession flow. The verification code will be used to generate a leaf certificate.
  ## 
...
proc call*(call_564278: Call_CertificatesGenerateVerificationCode_564268;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564279, "certificateName", newJString(certificateName))
  result = call_564278.call(path_564279, query_564280, nil, nil, nil)

var certificatesGenerateVerificationCode* = Call_CertificatesGenerateVerificationCode_564268(
    ...
    validator: validate_CertificatesGenerateVerificationCode_564269, base: "",
    url: url_CertificatesGenerateVerificationCode_564270, schemes: {Scheme.Https})
type
  Call_CertificatesVerify_564281 = ref object of OpenApiRestCall_563564
proc url_CertificatesVerify_564283(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesVerify_564282(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_564287 = path.getOrDefault("certificateName")
  valid_564287 = validateParameter(valid_564287, JString, required = true,
                                 default = nil)
  if valid_564287 != nil:
    section.add "certificateName", valid_564287
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564291: Call_CertificatesVerify_564281; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Verifies the certificate's private key possession by providing the leaf cert issued by the verifying pre uploaded certificate.
  ## 
...
proc call*(call_564292: Call_CertificatesVerify_564281; apiVersion: string;
  ...
  if certificateVerificationBody != nil:
    body_564295 = certificateVerificationBody
  add(path_564293, "resourceGroupName", newJString(resourceGroupName))
  add(path_564293, "resourceName", newJString(resourceName))
  add(path_564293, "certificateName", newJString(certificateName))
  result = call_564292.call(path_564293, query_564294, nil, nil, body_564295)

var certificatesVerify* = Call_CertificatesVerify_564281(
    ...
    validator: validate_CertificatesVerify_564282, base: "",
    url: url_CertificatesVerify_564283, schemes: {Scheme.Https})
type
  Call_IotHubResourceListEventHubConsumerGroups_564296 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceListEventHubConsumerGroups_564298(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListEventHubConsumerGroups_564297(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564299 = path.getOrDefault("eventHubEndpointName")
  valid_564299 = validateParameter(valid_564299, JString, required = true,
                                 default = nil)
  if valid_564299 != nil:
    section.add "eventHubEndpointName", valid_564299
  ...
  var valid_564302 = path.getOrDefault("resourceName")
  valid_564302 = validateParameter(valid_564302, JString, required = true,
                                 default = nil)
  if valid_564302 != nil:
    section.add "resourceName", valid_564302
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564304: Call_IotHubResourceListEventHubConsumerGroups_564296;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a list of the consumer groups in the Event Hub-compatible device-to-cloud endpoint in an IoT hub.
  ## 
...
proc call*(call_564305: Call_IotHubResourceListEventHubConsumerGroups_564296;
  ...
  add(path_564306, "eventHubEndpointName", newJString(eventHubEndpointName))
  ...
  add(path_564306, "resourceName", newJString(resourceName))
  result = call_564305.call(path_564306, query_564307, nil, nil, nil)

var iotHubResourceListEventHubConsumerGroups* = Call_IotHubResourceListEventHubConsumerGroups_564296(
    ...
    validator: validate_IotHubResourceListEventHubConsumerGroups_564297, base: "",
    url: url_IotHubResourceListEventHubConsumerGroups_564298,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceCreateEventHubConsumerGroup_564321 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceCreateEventHubConsumerGroup_564323(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceCreateEventHubConsumerGroup_564322(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564324 = path.getOrDefault("eventHubEndpointName")
  valid_564324 = validateParameter(valid_564324, JString, required = true,
                                 default = nil)
  if valid_564324 != nil:
    section.add "eventHubEndpointName", valid_564324
  var valid_564325 = path.getOrDefault("name")
  valid_564325 = validateParameter(valid_564325, JString, required = true,
                                 default = nil)
  if valid_564325 != nil:
    section.add "name", valid_564325
  ...
  var valid_564328 = path.getOrDefault("resourceName")
  valid_564328 = validateParameter(valid_564328, JString, required = true,
                                 default = nil)
  if valid_564328 != nil:
    section.add "resourceName", valid_564328
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564330: Call_IotHubResourceCreateEventHubConsumerGroup_564321;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Add a consumer group to an Event Hub-compatible endpoint in an IoT hub.
  ## 
...
proc call*(call_564331: Call_IotHubResourceCreateEventHubConsumerGroup_564321;
  ...
  add(path_564332, "eventHubEndpointName", newJString(eventHubEndpointName))
  ...
  add(path_564332, "resourceName", newJString(resourceName))
  result = call_564331.call(path_564332, query_564333, nil, nil, nil)

var iotHubResourceCreateEventHubConsumerGroup* = Call_IotHubResourceCreateEventHubConsumerGroup_564321(
    ...
    validator: validate_IotHubResourceCreateEventHubConsumerGroup_564322,
    base: "", url: url_IotHubResourceCreateEventHubConsumerGroup_564323,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceGetEventHubConsumerGroup_564308 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetEventHubConsumerGroup_564310(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetEventHubConsumerGroup_564309(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564311 = path.getOrDefault("eventHubEndpointName")
  valid_564311 = validateParameter(valid_564311, JString, required = true,
                                 default = nil)
  if valid_564311 != nil:
    section.add "eventHubEndpointName", valid_564311
...
proc call*(call_564317: Call_IotHubResourceGetEventHubConsumerGroup_564308;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a consumer group from the Event Hub-compatible device-to-cloud endpoint for an IoT hub.
  ## 
...
proc call*(call_564318: Call_IotHubResourceGetEventHubConsumerGroup_564308;
          eventHubEndpointName: string; apiVersion: string; name: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564319, "eventHubEndpointName", newJString(eventHubEndpointName))
  ...
  add(path_564319, "resourceName", newJString(resourceName))
  result = call_564318.call(path_564319, query_564320, nil, nil, nil)

var iotHubResourceGetEventHubConsumerGroup* = Call_IotHubResourceGetEventHubConsumerGroup_564308(
    name: "iotHubResourceGetEventHubConsumerGroup", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/eventHubEndpoints/{eventHubEndpointName}/ConsumerGroups/{name}",
    validator: validate_IotHubResourceGetEventHubConsumerGroup_564309, base: "",
    url: url_IotHubResourceGetEventHubConsumerGroup_564310,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceDeleteEventHubConsumerGroup_564334 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceDeleteEventHubConsumerGroup_564336(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceDeleteEventHubConsumerGroup_564335(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564337 = path.getOrDefault("eventHubEndpointName")
  valid_564337 = validateParameter(valid_564337, JString, required = true,
                                 default = nil)
  if valid_564337 != nil:
    section.add "eventHubEndpointName", valid_564337
  var valid_564338 = path.getOrDefault("name")
  valid_564338 = validateParameter(valid_564338, JString, required = true,
                                 default = nil)
  if valid_564338 != nil:
    section.add "name", valid_564338
  ...
  var valid_564341 = path.getOrDefault("resourceName")
  valid_564341 = validateParameter(valid_564341, JString, required = true,
                                 default = nil)
  if valid_564341 != nil:
    section.add "resourceName", valid_564341
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564343: Call_IotHubResourceDeleteEventHubConsumerGroup_564334;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Delete a consumer group from an Event Hub-compatible endpoint in an IoT hub.
  ## 
...
proc call*(call_564344: Call_IotHubResourceDeleteEventHubConsumerGroup_564334;
          eventHubEndpointName: string; apiVersion: string; name: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564345, "eventHubEndpointName", newJString(eventHubEndpointName))
  add(query_564346, "api-version", newJString(apiVersion))
  add(path_564345, "name", newJString(name))
  add(path_564345, "subscriptionId", newJString(subscriptionId))
  add(path_564345, "resourceGroupName", newJString(resourceGroupName))
  add(path_564345, "resourceName", newJString(resourceName))
  result = call_564344.call(path_564345, query_564346, nil, nil, nil)

var iotHubResourceDeleteEventHubConsumerGroup* = Call_IotHubResourceDeleteEventHubConsumerGroup_564334(
    ...
    validator: validate_IotHubResourceDeleteEventHubConsumerGroup_564335,
    base: "", url: url_IotHubResourceDeleteEventHubConsumerGroup_564336,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceExportDevices_564347 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceExportDevices_564349(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceExportDevices_564348(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564352 = path.getOrDefault("resourceName")
  valid_564352 = validateParameter(valid_564352, JString, required = true,
                                 default = nil)
  if valid_564352 != nil:
    section.add "resourceName", valid_564352
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564355: Call_IotHubResourceExportDevices_564347; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports all the device identities in the IoT hub identity registry to an Azure Storage blob container. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities.
  ## 
...
proc call*(call_564356: Call_IotHubResourceExportDevices_564347;
...
var iotHubResourceExportDevices* = Call_IotHubResourceExportDevices_564347(
    ...
    validator: validate_IotHubResourceExportDevices_564348, base: "",
    url: url_IotHubResourceExportDevices_564349, schemes: {Scheme.Https})
type
  Call_IotHubResourceImportDevices_564360 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceImportDevices_564362(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceImportDevices_564361(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564365 = path.getOrDefault("resourceName")
  valid_564365 = validateParameter(valid_564365, JString, required = true,
                                 default = nil)
  if valid_564365 != nil:
    section.add "resourceName", valid_564365
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564368: Call_IotHubResourceImportDevices_564360; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Import, update, or delete device identities in the IoT hub identity registry from a blob. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities.
  ## 
...
proc call*(call_564369: Call_IotHubResourceImportDevices_564360;
  ...
  if importDevicesParameters != nil:
    body_564372 = importDevicesParameters
  ...
  add(path_564370, "resourceName", newJString(resourceName))
  result = call_564369.call(path_564370, query_564371, nil, nil, body_564372)

var iotHubResourceImportDevices* = Call_IotHubResourceImportDevices_564360(
    ...
    validator: validate_IotHubResourceImportDevices_564361, base: "",
    url: url_IotHubResourceImportDevices_564362, schemes: {Scheme.Https})
type
  Call_IotHubResourceListJobs_564373 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceListJobs_564375(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListJobs_564374(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564378 = path.getOrDefault("resourceName")
  valid_564378 = validateParameter(valid_564378, JString, required = true,
                                 default = nil)
  if valid_564378 != nil:
    section.add "resourceName", valid_564378
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564380: Call_IotHubResourceListJobs_564373; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get a list of all the jobs in an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry.
  ## 
...
proc call*(call_564381: Call_IotHubResourceListJobs_564373; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564382, "resourceName", newJString(resourceName))
  result = call_564381.call(path_564382, query_564383, nil, nil, nil)

var iotHubResourceListJobs* = Call_IotHubResourceListJobs_564373(
    ...
    validator: validate_IotHubResourceListJobs_564374, base: "",
    url: url_IotHubResourceListJobs_564375, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetJob_564384 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetJob_564386(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetJob_564385(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564387 = path.getOrDefault("jobId")
  valid_564387 = validateParameter(valid_564387, JString, required = true,
                                 default = nil)
  if valid_564387 != nil:
    section.add "jobId", valid_564387
  ...
  var valid_564390 = path.getOrDefault("resourceName")
  valid_564390 = validateParameter(valid_564390, JString, required = true,
                                 default = nil)
  if valid_564390 != nil:
    section.add "resourceName", valid_564390
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564392: Call_IotHubResourceGetJob_564384; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the details of a job from an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry.
  ## 
...
proc call*(call_564393: Call_IotHubResourceGetJob_564384; jobId: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          resourceName: string): Recallable =
  ...
  add(path_564394, "jobId", newJString(jobId))
  ...
  add(path_564394, "resourceName", newJString(resourceName))
  result = call_564393.call(path_564394, query_564395, nil, nil, nil)

var iotHubResourceGetJob* = Call_IotHubResourceGetJob_564384(
    ...
    validator: validate_IotHubResourceGetJob_564385, base: "",
    url: url_IotHubResourceGetJob_564386, schemes: {Scheme.Https})
type
  Call_IotHubResourceListKeys_564396 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceListKeys_564398(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListKeys_564397(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564403: Call_IotHubResourceListKeys_564396; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the security metadata for an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-security.
  ## 
...
proc call*(call_564404: Call_IotHubResourceListKeys_564396; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564405, "resourceName", newJString(resourceName))
  result = call_564404.call(path_564405, query_564406, nil, nil, nil)

var iotHubResourceListKeys* = Call_IotHubResourceListKeys_564396(
    ...
    validator: validate_IotHubResourceListKeys_564397, base: "",
    url: url_IotHubResourceListKeys_564398, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetQuotaMetrics_564407 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetQuotaMetrics_564409(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetQuotaMetrics_564408(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564412 = path.getOrDefault("resourceName")
  valid_564412 = validateParameter(valid_564412, JString, required = true,
                                 default = nil)
  if valid_564412 != nil:
    section.add "resourceName", valid_564412
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564414: Call_IotHubResourceGetQuotaMetrics_564407; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the quota metrics for an IoT hub.
  ## 
...
proc call*(call_564415: Call_IotHubResourceGetQuotaMetrics_564407;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          resourceName: string): Recallable =
...
var iotHubResourceGetQuotaMetrics* = Call_IotHubResourceGetQuotaMetrics_564407(
    ...
    validator: validate_IotHubResourceGetQuotaMetrics_564408, base: "",
    url: url_IotHubResourceGetQuotaMetrics_564409, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetValidSkus_564418 = ref object of OpenApiRestCall_563564
proc url_IotHubResourceGetValidSkus_564420(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetValidSkus_564419(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564425: Call_IotHubResourceGetValidSkus_564418; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the list of valid SKUs for an IoT hub.
  ## 
...
proc call*(call_564426: Call_IotHubResourceGetValidSkus_564418; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var iotHubResourceGetValidSkus* = Call_IotHubResourceGetValidSkus_564418(
    ...
    validator: validate_IotHubResourceGetValidSkus_564419, base: "",
    url: url_IotHubResourceGetValidSkus_564420, schemes: {Scheme.Https})
export
  rest
