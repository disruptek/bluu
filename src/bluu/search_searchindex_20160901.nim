...
type
  Call_DocumentsProxyCount_593630 = ref object of OpenApiRestCall_593408
proc url_DocumentsProxyCount_593632(protocol: Scheme; host: string; base: string;
...
proc validate_DocumentsProxyCount_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593815: Call_DocumentsProxyCount_593630; path: JsonNode;
...
proc call*(call_593886: Call_DocumentsProxyCount_593630; apiVersion: string): Recallable =
  ## documentsProxyCount
  ## Queries the number of documents in the Azure Search index.
  ## https://docs.microsoft.com/rest/api/searchservice/Count-Documents
...
var documentsProxyCount* = Call_DocumentsProxyCount_593630(
    name: "documentsProxyCount", meth: HttpMethod.HttpGet, host: "azure.local",
    route: "/docs/$count", validator: validate_DocumentsProxyCount_593631, base: "",
    url: url_DocumentsProxyCount_593632, schemes: {Scheme.Https})
export
  rest
