...
type
  Call_ElasticPoolOperationsListByElasticPool_563777 = ref object of OpenApiRestCall_563555
proc url_ElasticPoolOperationsListByElasticPool_563779(protocol: Scheme;
...
proc validate_ElasticPoolOperationsListByElasticPool_563778(path: JsonNode;
  ...
  var valid_563954 = path.getOrDefault("elasticPoolName")
  valid_563954 = validateParameter(valid_563954, JString, required = true,
                                 default = nil)
  if valid_563954 != nil:
    section.add "elasticPoolName", valid_563954
...
proc call*(call_563981: Call_ElasticPoolOperationsListByElasticPool_563777;
...
proc call*(call_564052: Call_ElasticPoolOperationsListByElasticPool_563777;
  ...
  add(path_564053, "elasticPoolName", newJString(elasticPoolName))
...
var elasticPoolOperationsListByElasticPool* = Call_ElasticPoolOperationsListByElasticPool_563777(
    ...
    validator: validate_ElasticPoolOperationsListByElasticPool_563778, base: "",
    url: url_ElasticPoolOperationsListByElasticPool_563779,
    schemes: {Scheme.Https})
type
  Call_ElasticPoolOperationsCancel_564094 = ref object of OpenApiRestCall_563555
proc url_ElasticPoolOperationsCancel_564096(protocol: Scheme; host: string;
...
proc validate_ElasticPoolOperationsCancel_564095(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `elasticPoolName` field"
  var valid_564097 = path.getOrDefault("elasticPoolName")
  valid_564097 = validateParameter(valid_564097, JString, required = true,
                                 default = nil)
  if valid_564097 != nil:
    section.add "elasticPoolName", valid_564097
  var valid_564098 = path.getOrDefault("serverName")
  valid_564098 = validateParameter(valid_564098, JString, required = true,
                                 default = nil)
  if valid_564098 != nil:
    section.add "serverName", valid_564098
  var valid_564099 = path.getOrDefault("operationId")
  valid_564099 = validateParameter(valid_564099, JString, required = true,
                                 default = nil)
  if valid_564099 != nil:
    section.add "operationId", valid_564099
...
proc call*(call_564103: Call_ElasticPoolOperationsCancel_564094; path: JsonNode;
...
proc call*(call_564104: Call_ElasticPoolOperationsCancel_564094;
          elasticPoolName: string; apiVersion: string; serverName: string;
  ...
  add(path_564105, "elasticPoolName", newJString(elasticPoolName))
...
var elasticPoolOperationsCancel* = Call_ElasticPoolOperationsCancel_564094(
    ...
    validator: validate_ElasticPoolOperationsCancel_564095, base: "",
    url: url_ElasticPoolOperationsCancel_564096, schemes: {Scheme.Https})
export
  rest
