...
type
  Call_ApplicationGatewaysStart_564252 = ref object of OpenApiRestCall_563564
proc url_ApplicationGatewaysStart_564254(protocol: Scheme; host: string;
...
proc validate_ApplicationGatewaysStart_564253(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564259: Call_ApplicationGatewaysStart_564252; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Starts the specified application gateway.
  ## 
...
proc call*(call_564260: Call_ApplicationGatewaysStart_564252; apiVersion: string;
          subscriptionId: string; applicationGatewayName: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564261, "applicationGatewayName", newJString(applicationGatewayName))
...
var applicationGatewaysStart* = Call_ApplicationGatewaysStart_564252(
    ...
    validator: validate_ApplicationGatewaysStart_564253, base: "",
    url: url_ApplicationGatewaysStart_564254, schemes: {Scheme.Https})
type
  Call_ApplicationGatewaysStop_564263 = ref object of OpenApiRestCall_563564
proc url_ApplicationGatewaysStop_564265(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ApplicationGatewaysStop_564264(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564267 = path.getOrDefault("applicationGatewayName")
  valid_564267 = validateParameter(valid_564267, JString, required = true,
                                 default = nil)
  if valid_564267 != nil:
    section.add "applicationGatewayName", valid_564267
...
proc call*(call_564270: Call_ApplicationGatewaysStop_564263; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops the specified application gateway in a resource group.
  ## 
...
proc call*(call_564271: Call_ApplicationGatewaysStop_564263; apiVersion: string;
          subscriptionId: string; applicationGatewayName: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564272, "applicationGatewayName", newJString(applicationGatewayName))
...
var applicationGatewaysStop* = Call_ApplicationGatewaysStop_564263(
    ...
    validator: validate_ApplicationGatewaysStop_564264, base: "",
    url: url_ApplicationGatewaysStop_564265, schemes: {Scheme.Https})
export
  rest
