...
proc call*(call_593837: Call_ManagedRuleSetsList_593647; path: JsonNode;
...
proc call*(call_593908: Call_ManagedRuleSetsList_593647; apiVersion: string;
...
type
  Call_PoliciesList_593950 = ref object of OpenApiRestCall_593425
proc url_PoliciesList_593952(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PoliciesList_593951(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593965: Call_PoliciesList_593950; path: JsonNode; query: JsonNode;
...
proc call*(call_593966: Call_PoliciesList_593950; resourceGroupName: string;
...
var policiesList* = Call_PoliciesList_593950(name: "policiesList",
    ...
    validator: validate_PoliciesList_593951, base: "", url: url_PoliciesList_593952,
