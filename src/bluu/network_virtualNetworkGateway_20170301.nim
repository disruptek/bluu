...
type
  Call_VirtualNetworkGatewaysGeneratevpnclientpackage_564281 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysGeneratevpnclientpackage_564283(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGeneratevpnclientpackage_564282(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_564289: Call_VirtualNetworkGatewaysGeneratevpnclientpackage_564281;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Generates VPN client package for P2S client of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_564290: Call_VirtualNetworkGatewaysGeneratevpnclientpackage_564281;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          parameters: JsonNode; virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_564291, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564290.call(path_564291, query_564292, nil, nil, body_564293)

var virtualNetworkGatewaysGeneratevpnclientpackage* = Call_VirtualNetworkGatewaysGeneratevpnclientpackage_564281(
    ...
    validator: validate_VirtualNetworkGatewaysGeneratevpnclientpackage_564282,
    base: "", url: url_VirtualNetworkGatewaysGeneratevpnclientpackage_564283,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetAdvertisedRoutes_564294 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysGetAdvertisedRoutes_564296(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetAdvertisedRoutes_564295(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564301 = query.getOrDefault("peer")
  valid_564301 = validateParameter(valid_564301, JString, required = true,
                                 default = nil)
  if valid_564301 != nil:
    section.add "peer", valid_564301
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564302: Call_VirtualNetworkGatewaysGetAdvertisedRoutes_564294;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## This operation retrieves a list of routes the virtual network gateway is advertising to the specified peer.
  ## 
...
proc call*(call_564303: Call_VirtualNetworkGatewaysGetAdvertisedRoutes_564294;
  ...
  add(query_564305, "peer", newJString(peer))
  add(path_564304, "resourceGroupName", newJString(resourceGroupName))
  add(path_564304, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564303.call(path_564304, query_564305, nil, nil, nil)

var virtualNetworkGatewaysGetAdvertisedRoutes* = Call_VirtualNetworkGatewaysGetAdvertisedRoutes_564294(
    ...
    validator: validate_VirtualNetworkGatewaysGetAdvertisedRoutes_564295,
    base: "", url: url_VirtualNetworkGatewaysGetAdvertisedRoutes_564296,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetBgpPeerStatus_564306 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysGetBgpPeerStatus_564308(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetBgpPeerStatus_564307(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564311 = path.getOrDefault("virtualNetworkGatewayName")
  valid_564311 = validateParameter(valid_564311, JString, required = true,
                                 default = nil)
  if valid_564311 != nil:
    section.add "virtualNetworkGatewayName", valid_564311
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
  ...
  var valid_564313 = query.getOrDefault("peer")
  valid_564313 = validateParameter(valid_564313, JString, required = false,
                                 default = nil)
  if valid_564313 != nil:
    section.add "peer", valid_564313
  result.add "query", section
  section = newJObject()
  result.add "header", section
  section = newJObject()
...
proc call*(call_564314: Call_VirtualNetworkGatewaysGetBgpPeerStatus_564306;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## The GetBgpPeerStatus operation retrieves the status of all BGP peers.
  ## 
...
proc call*(call_564315: Call_VirtualNetworkGatewaysGetBgpPeerStatus_564306;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(query_564317, "peer", newJString(peer))
  add(path_564316, "resourceGroupName", newJString(resourceGroupName))
  add(path_564316, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564315.call(path_564316, query_564317, nil, nil, nil)

var virtualNetworkGatewaysGetBgpPeerStatus* = Call_VirtualNetworkGatewaysGetBgpPeerStatus_564306(
    ...
    validator: validate_VirtualNetworkGatewaysGetBgpPeerStatus_564307, base: "",
    url: url_VirtualNetworkGatewaysGetBgpPeerStatus_564308,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetLearnedRoutes_564318 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysGetLearnedRoutes_564320(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetLearnedRoutes_564319(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564325: Call_VirtualNetworkGatewaysGetLearnedRoutes_564318;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## This operation retrieves a list of routes the virtual network gateway has learned, including routes learned from BGP peers.
  ## 
...
proc call*(call_564326: Call_VirtualNetworkGatewaysGetLearnedRoutes_564318;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          virtualNetworkGatewayName: string): Recallable =
...
var virtualNetworkGatewaysGetLearnedRoutes* = Call_VirtualNetworkGatewaysGetLearnedRoutes_564318(
    ...
    validator: validate_VirtualNetworkGatewaysGetLearnedRoutes_564319, base: "",
    url: url_VirtualNetworkGatewaysGetLearnedRoutes_564320,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysReset_564329 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysReset_564331(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysReset_564330(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  ##              : Client API version.
  section = newJObject()
  var valid_564335 = query.getOrDefault("gatewayVip")
  valid_564335 = validateParameter(valid_564335, JString, required = false,
                                 default = nil)
  if valid_564335 != nil:
    section.add "gatewayVip", valid_564335
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_564337: Call_VirtualNetworkGatewaysReset_564329; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resets the primary of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_564338: Call_VirtualNetworkGatewaysReset_564329;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(query_564340, "gatewayVip", newJString(gatewayVip))
...
var virtualNetworkGatewaysReset* = Call_VirtualNetworkGatewaysReset_564329(
    ...
    validator: validate_VirtualNetworkGatewaysReset_564330, base: "",
    url: url_VirtualNetworkGatewaysReset_564331, schemes: {Scheme.Https})
export
  rest
