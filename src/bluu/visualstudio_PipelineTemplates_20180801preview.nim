...
const
  macServiceName = "visualstudio-PipelineTemplates"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_PipelineTemplatesList_563761 = ref object of OpenApiRestCall_563539
proc url_PipelineTemplatesList_563763(protocol: Scheme; host: string; base: string;
...
proc validate_PipelineTemplatesList_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563947: Call_PipelineTemplatesList_563761; path: JsonNode;
...
proc call*(call_564018: Call_PipelineTemplatesList_563761; apiVersion: string): Recallable =
...
var pipelineTemplatesList* = Call_PipelineTemplatesList_563761(
    name: "pipelineTemplatesList", meth: HttpMethod.HttpGet,
    host: "management.azure.com",
    route: "/providers/microsoft.visualstudio/pipelineTemplates",
    validator: validate_PipelineTemplatesList_563762, base: "",
    url: url_PipelineTemplatesList_563763, schemes: {Scheme.Https})
export
  rest
