...
type
  Call_PipelineTemplatesList_593630 = ref object of OpenApiRestCall_593408
proc url_PipelineTemplatesList_593632(protocol: Scheme; host: string; base: string;
...
proc validate_PipelineTemplatesList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593814: Call_PipelineTemplatesList_593630; path: JsonNode;
...
proc call*(call_593885: Call_PipelineTemplatesList_593630; apiVersion: string): Recallable =
...
var pipelineTemplatesList* = Call_PipelineTemplatesList_593630(
    name: "pipelineTemplatesList", meth: HttpMethod.HttpGet,
    host: "management.azure.com",
    route: "/providers/microsoft.visualstudio/pipelineTemplates",
    validator: validate_PipelineTemplatesList_593631, base: "",
    url: url_PipelineTemplatesList_593632, schemes: {Scheme.Https})
export
  rest
