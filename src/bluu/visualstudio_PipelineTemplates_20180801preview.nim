...
type
  Call_PipelineTemplatesList_567863 = ref object of OpenApiRestCall_567641
proc url_PipelineTemplatesList_567865(protocol: Scheme; host: string; base: string;
...
proc validate_PipelineTemplatesList_567864(path: JsonNode; query: JsonNode;
...
proc call*(call_568047: Call_PipelineTemplatesList_567863; path: JsonNode;
...
proc call*(call_568118: Call_PipelineTemplatesList_567863; apiVersion: string): Recallable =
...
var pipelineTemplatesList* = Call_PipelineTemplatesList_567863(
    name: "pipelineTemplatesList", meth: HttpMethod.HttpGet,
    host: "management.azure.com",
    route: "/providers/microsoft.visualstudio/pipelineTemplates",
    validator: validate_PipelineTemplatesList_567864, base: "",
    url: url_PipelineTemplatesList_567865, schemes: {Scheme.Https})
export
  rest
