...
type
  Call_AgentPoolsList_564109 = ref object of OpenApiRestCall_563556
proc url_AgentPoolsList_564111(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AgentPoolsList_564110(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil,
        "path argument is necessary due to required `managedClusterName` field"
  var valid_564112 = path.getOrDefault("managedClusterName")
  valid_564112 = validateParameter(valid_564112, JString, required = true,
                                 default = nil)
  if valid_564112 != nil:
    section.add "managedClusterName", valid_564112
...
proc call*(call_564116: Call_AgentPoolsList_564109; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of agent pools in the specified managed cluster. The operation returns properties of each agent pool.
  ## 
...
proc call*(call_564117: Call_AgentPoolsList_564109; managedClusterName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string): Recallable =
  ## agentPoolsList
  ## Gets a list of agent pools in the specified managed cluster. The operation returns properties of each agent pool.
  ...
  add(path_564118, "managedClusterName", newJString(managedClusterName))
...
var agentPoolsList* = Call_AgentPoolsList_564109(name: "agentPoolsList",
    ...
    validator: validate_AgentPoolsList_564110, base: "", url: url_AgentPoolsList_564111,
    schemes: {Scheme.Https})
type
  Call_AgentPoolsCreateOrUpdate_564132 = ref object of OpenApiRestCall_563556
proc url_AgentPoolsCreateOrUpdate_564134(protocol: Scheme; host: string;
...
proc validate_AgentPoolsCreateOrUpdate_564133(path: JsonNode; query: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `managedClusterName` field"
  var valid_564135 = path.getOrDefault("managedClusterName")
  valid_564135 = validateParameter(valid_564135, JString, required = true,
                                 default = nil)
  if valid_564135 != nil:
    section.add "managedClusterName", valid_564135
  var valid_564136 = path.getOrDefault("subscriptionId")
  valid_564136 = validateParameter(valid_564136, JString, required = true,
                                 default = nil)
  if valid_564136 != nil:
    section.add "subscriptionId", valid_564136
  var valid_564137 = path.getOrDefault("agentPoolName")
  valid_564137 = validateParameter(valid_564137, JString, required = true,
                                 default = nil)
  if valid_564137 != nil:
    section.add "agentPoolName", valid_564137
...
proc call*(call_564141: Call_AgentPoolsCreateOrUpdate_564132; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates an agent pool in the specified managed cluster.
  ## 
...
proc call*(call_564142: Call_AgentPoolsCreateOrUpdate_564132;
          managedClusterName: string; apiVersion: string; subscriptionId: string;
          agentPoolName: string; resourceGroupName: string; parameters: JsonNode): Recallable =
  ...
  add(path_564143, "managedClusterName", newJString(managedClusterName))
  add(query_564144, "api-version", newJString(apiVersion))
  add(path_564143, "subscriptionId", newJString(subscriptionId))
  add(path_564143, "agentPoolName", newJString(agentPoolName))
...
var agentPoolsCreateOrUpdate* = Call_AgentPoolsCreateOrUpdate_564132(
    ...
    validator: validate_AgentPoolsCreateOrUpdate_564133, base: "",
    url: url_AgentPoolsCreateOrUpdate_564134, schemes: {Scheme.Https})
type
  Call_AgentPoolsGet_564120 = ref object of OpenApiRestCall_563556
proc url_AgentPoolsGet_564122(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AgentPoolsGet_564121(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  assert path != nil,
        "path argument is necessary due to required `managedClusterName` field"
  var valid_564123 = path.getOrDefault("managedClusterName")
  valid_564123 = validateParameter(valid_564123, JString, required = true,
                                 default = nil)
  if valid_564123 != nil:
    section.add "managedClusterName", valid_564123
  var valid_564124 = path.getOrDefault("subscriptionId")
  valid_564124 = validateParameter(valid_564124, JString, required = true,
                                 default = nil)
  if valid_564124 != nil:
    section.add "subscriptionId", valid_564124
  var valid_564125 = path.getOrDefault("agentPoolName")
  valid_564125 = validateParameter(valid_564125, JString, required = true,
                                 default = nil)
  if valid_564125 != nil:
    section.add "agentPoolName", valid_564125
...
proc call*(call_564128: Call_AgentPoolsGet_564120; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the agent pool by managed cluster and resource group.
  ## 
...
proc call*(call_564129: Call_AgentPoolsGet_564120; managedClusterName: string;
  ...
  add(path_564130, "managedClusterName", newJString(managedClusterName))
  add(query_564131, "api-version", newJString(apiVersion))
  add(path_564130, "subscriptionId", newJString(subscriptionId))
  add(path_564130, "agentPoolName", newJString(agentPoolName))
...
var agentPoolsGet* = Call_AgentPoolsGet_564120(name: "agentPoolsGet",
    ...
    validator: validate_AgentPoolsGet_564121, base: "", url: url_AgentPoolsGet_564122,
    schemes: {Scheme.Https})
type
  Call_AgentPoolsDelete_564146 = ref object of OpenApiRestCall_563556
proc url_AgentPoolsDelete_564148(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AgentPoolsDelete_564147(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `managedClusterName` field"
  var valid_564149 = path.getOrDefault("managedClusterName")
  valid_564149 = validateParameter(valid_564149, JString, required = true,
                                 default = nil)
  if valid_564149 != nil:
    section.add "managedClusterName", valid_564149
  var valid_564150 = path.getOrDefault("subscriptionId")
  valid_564150 = validateParameter(valid_564150, JString, required = true,
                                 default = nil)
  if valid_564150 != nil:
    section.add "subscriptionId", valid_564150
  var valid_564151 = path.getOrDefault("agentPoolName")
  valid_564151 = validateParameter(valid_564151, JString, required = true,
                                 default = nil)
  if valid_564151 != nil:
    section.add "agentPoolName", valid_564151
...
proc call*(call_564154: Call_AgentPoolsDelete_564146; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the agent pool in the specified managed cluster.
  ## 
...
proc call*(call_564155: Call_AgentPoolsDelete_564146; managedClusterName: string;
          apiVersion: string; subscriptionId: string; agentPoolName: string;
          resourceGroupName: string): Recallable =
  ## agentPoolsDelete
  ## Deletes the agent pool in the specified managed cluster.
  ...
  add(path_564156, "managedClusterName", newJString(managedClusterName))
  add(query_564157, "api-version", newJString(apiVersion))
  add(path_564156, "subscriptionId", newJString(subscriptionId))
  add(path_564156, "agentPoolName", newJString(agentPoolName))
...
var agentPoolsDelete* = Call_AgentPoolsDelete_564146(name: "agentPoolsDelete",
    ...
    validator: validate_AgentPoolsDelete_564147, base: "",
    url: url_AgentPoolsDelete_564148, schemes: {Scheme.Https})
type
  Call_ManagedClustersCreateOrUpdate_564169 = ref object of OpenApiRestCall_563556
proc url_ManagedClustersCreateOrUpdate_564171(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedClustersCreateOrUpdate_564170(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564174 = path.getOrDefault("resourceName")
  valid_564174 = validateParameter(valid_564174, JString, required = true,
                                 default = nil)
  if valid_564174 != nil:
    section.add "resourceName", valid_564174
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_564177: Call_ManagedClustersCreateOrUpdate_564169; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a managed cluster with the specified configuration for agents and Kubernetes version.
  ## 
...
proc call*(call_564178: Call_ManagedClustersCreateOrUpdate_564169;
  ...
  add(path_564179, "resourceName", newJString(resourceName))
  if parameters != nil:
    body_564181 = parameters
  result = call_564178.call(path_564179, query_564180, nil, nil, body_564181)

var managedClustersCreateOrUpdate* = Call_ManagedClustersCreateOrUpdate_564169(
    ...
    validator: validate_ManagedClustersCreateOrUpdate_564170, base: "",
    url: url_ManagedClustersCreateOrUpdate_564171, schemes: {Scheme.Https})
type
  Call_ManagedClustersGet_564158 = ref object of OpenApiRestCall_563556
proc url_ManagedClustersGet_564160(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedClustersGet_564159(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_564163 = path.getOrDefault("resourceName")
  valid_564163 = validateParameter(valid_564163, JString, required = true,
                                 default = nil)
  if valid_564163 != nil:
    section.add "resourceName", valid_564163
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_564165: Call_ManagedClustersGet_564158; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the managed cluster with a specified resource group and name.
  ## 
...
proc call*(call_564166: Call_ManagedClustersGet_564158; apiVersion: string;
  ...
  add(path_564167, "resourceName", newJString(resourceName))
  result = call_564166.call(path_564167, query_564168, nil, nil, nil)

var managedClustersGet* = Call_ManagedClustersGet_564158(
    name: "managedClustersGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}",
    validator: validate_ManagedClustersGet_564159, base: "",
    url: url_ManagedClustersGet_564160, schemes: {Scheme.Https})
type
  Call_ManagedClustersUpdateTags_564193 = ref object of OpenApiRestCall_563556
proc url_ManagedClustersUpdateTags_564195(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedClustersUpdateTags_564194(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564218: Call_ManagedClustersUpdateTags_564193; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a managed cluster with the specified tags.
  ## 
...
proc call*(call_564219: Call_ManagedClustersUpdateTags_564193; apiVersion: string;
...
var managedClustersUpdateTags* = Call_ManagedClustersUpdateTags_564193(
    name: "managedClustersUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}",
    validator: validate_ManagedClustersUpdateTags_564194, base: "",
    url: url_ManagedClustersUpdateTags_564195, schemes: {Scheme.Https})
type
  Call_ManagedClustersDelete_564182 = ref object of OpenApiRestCall_563556
proc url_ManagedClustersDelete_564184(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedClustersDelete_564183(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564189: Call_ManagedClustersDelete_564182; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the managed cluster with a specified resource group and name.
  ## 
...
proc call*(call_564190: Call_ManagedClustersDelete_564182; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var managedClustersDelete* = Call_ManagedClustersDelete_564182(
    name: "managedClustersDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}",
    validator: validate_ManagedClustersDelete_564183, base: "",
    url: url_ManagedClustersDelete_564184, schemes: {Scheme.Https})
type
  Call_ManagedClustersGetAccessProfile_564223 = ref object of OpenApiRestCall_563556
proc url_ManagedClustersGetAccessProfile_564225(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedClustersGetAccessProfile_564224(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564227 = path.getOrDefault("roleName")
  valid_564227 = validateParameter(valid_564227, JString, required = true,
                                 default = nil)
  if valid_564227 != nil:
    section.add "roleName", valid_564227
...
proc call*(call_564231: Call_ManagedClustersGetAccessProfile_564223;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the accessProfile for the specified role name of the managed cluster with a specified resource group and name.
  ## 
...
proc call*(call_564232: Call_ManagedClustersGetAccessProfile_564223;
  ...
  add(path_564233, "roleName", newJString(roleName))
...
var managedClustersGetAccessProfile* = Call_ManagedClustersGetAccessProfile_564223(
    ...
    validator: validate_ManagedClustersGetAccessProfile_564224, base: "",
    url: url_ManagedClustersGetAccessProfile_564225, schemes: {Scheme.Https})
type
