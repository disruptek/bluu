...
type
  Call_ContainerLogsList_568254 = ref object of OpenApiRestCall_567658
proc url_ContainerLogsList_568256(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerLogsList_568255(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_568258 = path.getOrDefault("containerName")
  valid_568258 = validateParameter(valid_568258, JString, required = true,
                                 default = nil)
  if valid_568258 != nil:
    section.add "containerName", valid_568258
  var valid_568259 = path.getOrDefault("subscriptionId")
  valid_568259 = validateParameter(valid_568259, JString, required = true,
                                 default = nil)
  if valid_568259 != nil:
    section.add "subscriptionId", valid_568259
  var valid_568260 = path.getOrDefault("containerGroupName")
  valid_568260 = validateParameter(valid_568260, JString, required = true,
                                 default = nil)
  if valid_568260 != nil:
    section.add "containerGroupName", valid_568260
  result.add "path", section
  ## parameters in `query` object:
  ##   tail: JInt
...
proc call*(call_568263: Call_ContainerLogsList_568254; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the logs for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_568264: Call_ContainerLogsList_568254; resourceGroupName: string;
  ...
  add(query_568266, "tail", newJInt(tail))
  add(query_568266, "api-version", newJString(apiVersion))
  add(path_568265, "containerName", newJString(containerName))
  add(path_568265, "subscriptionId", newJString(subscriptionId))
  add(path_568265, "containerGroupName", newJString(containerGroupName))
  result = call_568264.call(path_568265, query_568266, nil, nil, nil)

var containerLogsList* = Call_ContainerLogsList_568254(name: "containerLogsList",
    ...
    validator: validate_ContainerLogsList_568255, base: "",
    url: url_ContainerLogsList_568256, schemes: {Scheme.Https})
export
  rest
