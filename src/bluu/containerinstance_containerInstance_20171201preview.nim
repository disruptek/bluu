...
type
  Call_ContainerLogsList_594021 = ref object of OpenApiRestCall_593425
proc url_ContainerLogsList_594023(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerLogsList_594022(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594025 = path.getOrDefault("containerName")
  valid_594025 = validateParameter(valid_594025, JString, required = true,
                                 default = nil)
  if valid_594025 != nil:
    section.add "containerName", valid_594025
  var valid_594026 = path.getOrDefault("subscriptionId")
  valid_594026 = validateParameter(valid_594026, JString, required = true,
                                 default = nil)
  if valid_594026 != nil:
    section.add "subscriptionId", valid_594026
  var valid_594027 = path.getOrDefault("containerGroupName")
  valid_594027 = validateParameter(valid_594027, JString, required = true,
                                 default = nil)
  if valid_594027 != nil:
    section.add "containerGroupName", valid_594027
  result.add "path", section
  ## parameters in `query` object:
  ##   tail: JInt
...
proc call*(call_594030: Call_ContainerLogsList_594021; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the logs for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_594031: Call_ContainerLogsList_594021; resourceGroupName: string;
  ...
  add(query_594033, "tail", newJInt(tail))
  add(query_594033, "api-version", newJString(apiVersion))
  add(path_594032, "containerName", newJString(containerName))
  add(path_594032, "subscriptionId", newJString(subscriptionId))
  add(path_594032, "containerGroupName", newJString(containerGroupName))
  result = call_594031.call(path_594032, query_594033, nil, nil, nil)

var containerLogsList* = Call_ContainerLogsList_594021(name: "containerLogsList",
    ...
    validator: validate_ContainerLogsList_594022, base: "",
    url: url_ContainerLogsList_594023, schemes: {Scheme.Https})
export
  rest
