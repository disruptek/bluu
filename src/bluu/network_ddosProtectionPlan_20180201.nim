...
proc call*(call_563962: Call_DdosProtectionPlansList_563761; path: JsonNode;
...
proc call*(call_564033: Call_DdosProtectionPlansList_563761; apiVersion: string;
...
type
  Call_DdosProtectionPlansListByResourceGroup_564075 = ref object of OpenApiRestCall_563539
proc url_DdosProtectionPlansListByResourceGroup_564077(protocol: Scheme;
...
proc validate_DdosProtectionPlansListByResourceGroup_564076(path: JsonNode;
...
proc call*(call_564081: Call_DdosProtectionPlansListByResourceGroup_564075;
...
proc call*(call_564082: Call_DdosProtectionPlansListByResourceGroup_564075;
...
var ddosProtectionPlansListByResourceGroup* = Call_DdosProtectionPlansListByResourceGroup_564075(
    ...
    validator: validate_DdosProtectionPlansListByResourceGroup_564076, base: "",
    url: url_DdosProtectionPlansListByResourceGroup_564077,
    schemes: {Scheme.Https})
type
  Call_DdosProtectionPlansCreateOrUpdate_564096 = ref object of OpenApiRestCall_563539
proc url_DdosProtectionPlansCreateOrUpdate_564098(protocol: Scheme; host: string;
...
proc validate_DdosProtectionPlansCreateOrUpdate_564097(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564121: Call_DdosProtectionPlansCreateOrUpdate_564096;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a DDoS protection plan.
  ## 
...
proc call*(call_564122: Call_DdosProtectionPlansCreateOrUpdate_564096;
...
var ddosProtectionPlansCreateOrUpdate* = Call_DdosProtectionPlansCreateOrUpdate_564096(
    ...
    validator: validate_DdosProtectionPlansCreateOrUpdate_564097, base: "",
    url: url_DdosProtectionPlansCreateOrUpdate_564098, schemes: {Scheme.Https})
type
  Call_DdosProtectionPlansGet_564085 = ref object of OpenApiRestCall_563539
proc url_DdosProtectionPlansGet_564087(protocol: Scheme; host: string; base: string;
...
proc validate_DdosProtectionPlansGet_564086(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564090 = path.getOrDefault("ddosProtectionPlanName")
  valid_564090 = validateParameter(valid_564090, JString, required = true,
                                 default = nil)
  if valid_564090 != nil:
    section.add "ddosProtectionPlanName", valid_564090
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564092: Call_DdosProtectionPlansGet_564085; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets information about the specified DDoS protection plan.
  ## 
...
proc call*(call_564093: Call_DdosProtectionPlansGet_564085; apiVersion: string;
  ...
  add(path_564094, "ddosProtectionPlanName", newJString(ddosProtectionPlanName))
  result = call_564093.call(path_564094, query_564095, nil, nil, nil)

var ddosProtectionPlansGet* = Call_DdosProtectionPlansGet_564085(
    name: "ddosProtectionPlansGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ddosProtectionPlans/{ddosProtectionPlanName}",
    validator: validate_DdosProtectionPlansGet_564086, base: "",
    url: url_DdosProtectionPlansGet_564087, schemes: {Scheme.Https})
type
