...
proc call*(call_563997: Call_VolumesList_563777; path: JsonNode; query: JsonNode;
...
proc call*(call_564068: Call_VolumesList_563777; scaleUnit: string;
...
type
  Call_VolumesGet_564110 = ref object of OpenApiRestCall_563555
proc url_VolumesGet_564112(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VolumesGet_564111(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564117 = path.getOrDefault("volume")
  valid_564117 = validateParameter(valid_564117, JString, required = true,
                                 default = nil)
  if valid_564117 != nil:
    section.add "volume", valid_564117
  var valid_564118 = path.getOrDefault("storageSubSystem")
  valid_564118 = validateParameter(valid_564118, JString, required = true,
                                 default = nil)
  if valid_564118 != nil:
    section.add "storageSubSystem", valid_564118
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API Version.
...
proc call*(call_564120: Call_VolumesGet_564110; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Return the requested a storage volume.
  ## 
...
proc call*(call_564121: Call_VolumesGet_564110; scaleUnit: string;
          subscriptionId: string; location: string; resourceGroupName: string;
          volume: string; storageSubSystem: string;
...
var volumesGet* = Call_VolumesGet_564110(name: "volumesGet",
                                      ...
                                      validator: validate_VolumesGet_564111,
                                      base: "", url: url_VolumesGet_564112,
                                      schemes: {Scheme.Https})
export
  rest
