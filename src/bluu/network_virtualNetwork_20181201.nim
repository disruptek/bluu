...
type
  Call_VirtualNetworksListUsage_564244 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworksListUsage_564246(protocol: Scheme; host: string;
...
proc validate_VirtualNetworksListUsage_564245(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Lists usage stats.
  ## 
  var section: JsonNode
  ...
  var valid_564249 = path.getOrDefault("virtualNetworkName")
  valid_564249 = validateParameter(valid_564249, JString, required = true,
                                 default = nil)
  if valid_564249 != nil:
    section.add "virtualNetworkName", valid_564249
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564251: Call_VirtualNetworksListUsage_564244; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists usage stats.
  ## 
...
proc call*(call_564252: Call_VirtualNetworksListUsage_564244; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_564253, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_564252.call(path_564253, query_564254, nil, nil, nil)

var virtualNetworksListUsage* = Call_VirtualNetworksListUsage_564244(
    ...
    validator: validate_VirtualNetworksListUsage_564245, base: "",
    url: url_VirtualNetworksListUsage_564246, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsList_564255 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkPeeringsList_564257(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsList_564256(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564260 = path.getOrDefault("virtualNetworkName")
  valid_564260 = validateParameter(valid_564260, JString, required = true,
                                 default = nil)
  if valid_564260 != nil:
    section.add "virtualNetworkName", valid_564260
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564262: Call_VirtualNetworkPeeringsList_564255; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all virtual network peerings in a virtual network.
  ## 
...
proc call*(call_564263: Call_VirtualNetworkPeeringsList_564255; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_564264, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_564263.call(path_564264, query_564265, nil, nil, nil)

var virtualNetworkPeeringsList* = Call_VirtualNetworkPeeringsList_564255(
    ...
    validator: validate_VirtualNetworkPeeringsList_564256, base: "",
    url: url_VirtualNetworkPeeringsList_564257, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsCreateOrUpdate_564278 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkPeeringsCreateOrUpdate_564280(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsCreateOrUpdate_564279(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564287: Call_VirtualNetworkPeeringsCreateOrUpdate_564278;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a peering in the specified virtual network.
  ## 
...
proc call*(call_564288: Call_VirtualNetworkPeeringsCreateOrUpdate_564278;
  ...
  add(path_564289, "virtualNetworkPeeringName",
  ...
  if VirtualNetworkPeeringParameters != nil:
    body_564291 = VirtualNetworkPeeringParameters
  add(path_564289, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_564288.call(path_564289, query_564290, nil, nil, body_564291)

var virtualNetworkPeeringsCreateOrUpdate* = Call_VirtualNetworkPeeringsCreateOrUpdate_564278(
    ...
    validator: validate_VirtualNetworkPeeringsCreateOrUpdate_564279, base: "",
    url: url_VirtualNetworkPeeringsCreateOrUpdate_564280, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsGet_564266 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkPeeringsGet_564268(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsGet_564267(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `virtualNetworkPeeringName` field"
  var valid_564269 = path.getOrDefault("virtualNetworkPeeringName")
  valid_564269 = validateParameter(valid_564269, JString, required = true,
                                 default = nil)
  if valid_564269 != nil:
    section.add "virtualNetworkPeeringName", valid_564269
  ...
  var valid_564272 = path.getOrDefault("virtualNetworkName")
  valid_564272 = validateParameter(valid_564272, JString, required = true,
                                 default = nil)
  if valid_564272 != nil:
    section.add "virtualNetworkName", valid_564272
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_564274: Call_VirtualNetworkPeeringsGet_564266; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified virtual network peering.
  ## 
...
proc call*(call_564275: Call_VirtualNetworkPeeringsGet_564266;
          virtualNetworkPeeringName: string; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_564276, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  ...
  add(path_564276, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_564275.call(path_564276, query_564277, nil, nil, nil)

var virtualNetworkPeeringsGet* = Call_VirtualNetworkPeeringsGet_564266(
    name: "virtualNetworkPeeringsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsGet_564267, base: "",
    url: url_VirtualNetworkPeeringsGet_564268, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsDelete_564292 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkPeeringsDelete_564294(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsDelete_564293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `virtualNetworkPeeringName` field"
  var valid_564295 = path.getOrDefault("virtualNetworkPeeringName")
  valid_564295 = validateParameter(valid_564295, JString, required = true,
                                 default = nil)
  if valid_564295 != nil:
    section.add "virtualNetworkPeeringName", valid_564295
...
proc call*(call_564300: Call_VirtualNetworkPeeringsDelete_564292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified virtual network peering.
  ## 
...
proc call*(call_564301: Call_VirtualNetworkPeeringsDelete_564292;
          virtualNetworkPeeringName: string; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_564302, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
...
var virtualNetworkPeeringsDelete* = Call_VirtualNetworkPeeringsDelete_564292(
    name: "virtualNetworkPeeringsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsDelete_564293, base: "",
    url: url_VirtualNetworkPeeringsDelete_564294, schemes: {Scheme.Https})
export
  rest
