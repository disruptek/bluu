...
type
  Call_VirtualNetworksListUsage_594111 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworksListUsage_594113(protocol: Scheme; host: string;
...
proc validate_VirtualNetworksListUsage_594112(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Lists usage stats.
  ## 
  var section: JsonNode
  ...
  var valid_594116 = path.getOrDefault("virtualNetworkName")
  valid_594116 = validateParameter(valid_594116, JString, required = true,
                                 default = nil)
  if valid_594116 != nil:
    section.add "virtualNetworkName", valid_594116
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594118: Call_VirtualNetworksListUsage_594111; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists usage stats.
  ## 
...
proc call*(call_594119: Call_VirtualNetworksListUsage_594111;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_594120, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594119.call(path_594120, query_594121, nil, nil, nil)

var virtualNetworksListUsage* = Call_VirtualNetworksListUsage_594111(
    ...
    validator: validate_VirtualNetworksListUsage_594112, base: "",
    url: url_VirtualNetworksListUsage_594113, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsList_594122 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsList_594124(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsList_594123(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594127 = path.getOrDefault("virtualNetworkName")
  valid_594127 = validateParameter(valid_594127, JString, required = true,
                                 default = nil)
  if valid_594127 != nil:
    section.add "virtualNetworkName", valid_594127
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594129: Call_VirtualNetworkPeeringsList_594122; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all virtual network peerings in a virtual network.
  ## 
...
proc call*(call_594130: Call_VirtualNetworkPeeringsList_594122;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string): Recallable =
  ...
  add(path_594131, "virtualNetworkName", newJString(virtualNetworkName))
  result = call_594130.call(path_594131, query_594132, nil, nil, nil)

var virtualNetworkPeeringsList* = Call_VirtualNetworkPeeringsList_594122(
    ...
    validator: validate_VirtualNetworkPeeringsList_594123, base: "",
    url: url_VirtualNetworkPeeringsList_594124, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsCreateOrUpdate_594145 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsCreateOrUpdate_594147(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsCreateOrUpdate_594146(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594154: Call_VirtualNetworkPeeringsCreateOrUpdate_594145;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a peering in the specified virtual network.
  ## 
...
proc call*(call_594155: Call_VirtualNetworkPeeringsCreateOrUpdate_594145;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594156, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594156, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  if VirtualNetworkPeeringParameters != nil:
    body_594158 = VirtualNetworkPeeringParameters
  result = call_594155.call(path_594156, query_594157, nil, nil, body_594158)

var virtualNetworkPeeringsCreateOrUpdate* = Call_VirtualNetworkPeeringsCreateOrUpdate_594145(
    ...
    validator: validate_VirtualNetworkPeeringsCreateOrUpdate_594146, base: "",
    url: url_VirtualNetworkPeeringsCreateOrUpdate_594147, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsGet_594133 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsGet_594135(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsGet_594134(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594138 = path.getOrDefault("virtualNetworkName")
  valid_594138 = validateParameter(valid_594138, JString, required = true,
                                 default = nil)
  if valid_594138 != nil:
    section.add "virtualNetworkName", valid_594138
  var valid_594139 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594139 = validateParameter(valid_594139, JString, required = true,
                                 default = nil)
  if valid_594139 != nil:
    section.add "virtualNetworkPeeringName", valid_594139
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594141: Call_VirtualNetworkPeeringsGet_594133; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified virtual network peering.
  ## 
...
proc call*(call_594142: Call_VirtualNetworkPeeringsGet_594133;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594143, "virtualNetworkName", newJString(virtualNetworkName))
  add(path_594143, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  result = call_594142.call(path_594143, query_594144, nil, nil, nil)

var virtualNetworkPeeringsGet* = Call_VirtualNetworkPeeringsGet_594133(
    name: "virtualNetworkPeeringsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsGet_594134, base: "",
    url: url_VirtualNetworkPeeringsGet_594135, schemes: {Scheme.Https})
type
  Call_VirtualNetworkPeeringsDelete_594159 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkPeeringsDelete_594161(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkPeeringsDelete_594160(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594164 = path.getOrDefault("virtualNetworkName")
  valid_594164 = validateParameter(valid_594164, JString, required = true,
                                 default = nil)
  if valid_594164 != nil:
    section.add "virtualNetworkName", valid_594164
  var valid_594165 = path.getOrDefault("virtualNetworkPeeringName")
  valid_594165 = validateParameter(valid_594165, JString, required = true,
                                 default = nil)
  if valid_594165 != nil:
    section.add "virtualNetworkPeeringName", valid_594165
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594167: Call_VirtualNetworkPeeringsDelete_594159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified virtual network peering.
  ## 
...
proc call*(call_594168: Call_VirtualNetworkPeeringsDelete_594159;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkName: string; virtualNetworkPeeringName: string): Recallable =
  ...
  add(path_594169, "virtualNetworkPeeringName",
      newJString(virtualNetworkPeeringName))
  result = call_594168.call(path_594169, query_594170, nil, nil, nil)

var virtualNetworkPeeringsDelete* = Call_VirtualNetworkPeeringsDelete_594159(
    name: "virtualNetworkPeeringsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}",
    validator: validate_VirtualNetworkPeeringsDelete_594160, base: "",
    url: url_VirtualNetworkPeeringsDelete_594161, schemes: {Scheme.Https})
export
  rest
