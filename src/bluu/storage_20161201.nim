...
type
  Call_StorageAccountsListAccountSAS_564187 = ref object of OpenApiRestCall_563556
proc url_StorageAccountsListAccountSAS_564189(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsListAccountSAS_564188(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564195: Call_StorageAccountsListAccountSAS_564187; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List SAS credentials of a storage account.
  ## 
...
proc call*(call_564196: Call_StorageAccountsListAccountSAS_564187;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
...
var storageAccountsListAccountSAS* = Call_StorageAccountsListAccountSAS_564187(
    ...
    validator: validate_StorageAccountsListAccountSAS_564188, base: "",
    url: url_StorageAccountsListAccountSAS_564189, schemes: {Scheme.Https})
type
  Call_StorageAccountsListServiceSAS_564200 = ref object of OpenApiRestCall_563556
proc url_StorageAccountsListServiceSAS_564202(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsListServiceSAS_564201(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564218: Call_StorageAccountsListServiceSAS_564200; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List service SAS credentials of a specific resource.
  ## 
...
proc call*(call_564219: Call_StorageAccountsListServiceSAS_564200;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          parameters: JsonNode; accountName: string): Recallable =
...
var storageAccountsListServiceSAS* = Call_StorageAccountsListServiceSAS_564200(
    ...
    validator: validate_StorageAccountsListServiceSAS_564201, base: "",
    url: url_StorageAccountsListServiceSAS_564202, schemes: {Scheme.Https})
type
  Call_StorageAccountsListKeys_564223 = ref object of OpenApiRestCall_563556
proc url_StorageAccountsListKeys_564225(protocol: Scheme; host: string; base: string;
...
proc validate_StorageAccountsListKeys_564224(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564230: Call_StorageAccountsListKeys_564223; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the access keys for the specified storage account.
  ## 
...
proc call*(call_564231: Call_StorageAccountsListKeys_564223; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; accountName: string): Recallable =
...
var storageAccountsListKeys* = Call_StorageAccountsListKeys_564223(
    ...
    validator: validate_StorageAccountsListKeys_564224, base: "",
    url: url_StorageAccountsListKeys_564225, schemes: {Scheme.Https})
type
  Call_StorageAccountsRegenerateKey_564234 = ref object of OpenApiRestCall_563556
proc url_StorageAccountsRegenerateKey_564236(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsRegenerateKey_564235(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564242: Call_StorageAccountsRegenerateKey_564234; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Regenerates one of the access keys for the specified storage account.
  ## 
...
proc call*(call_564243: Call_StorageAccountsRegenerateKey_564234;
...
var storageAccountsRegenerateKey* = Call_StorageAccountsRegenerateKey_564234(
    ...
    validator: validate_StorageAccountsRegenerateKey_564235, base: "",
    url: url_StorageAccountsRegenerateKey_564236, schemes: {Scheme.Https})
export
  rest
