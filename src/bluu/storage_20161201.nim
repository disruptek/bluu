...
type
  Call_StorageAccountsListAccountSAS_594054 = ref object of OpenApiRestCall_593425
proc url_StorageAccountsListAccountSAS_594056(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsListAccountSAS_594055(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594062: Call_StorageAccountsListAccountSAS_594054; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List SAS credentials of a storage account.
  ## 
...
proc call*(call_594063: Call_StorageAccountsListAccountSAS_594054;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          parameters: JsonNode; accountName: string): Recallable =
...
var storageAccountsListAccountSAS* = Call_StorageAccountsListAccountSAS_594054(
    ...
    validator: validate_StorageAccountsListAccountSAS_594055, base: "",
    url: url_StorageAccountsListAccountSAS_594056, schemes: {Scheme.Https})
type
  Call_StorageAccountsListServiceSAS_594067 = ref object of OpenApiRestCall_593425
proc url_StorageAccountsListServiceSAS_594069(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsListServiceSAS_594068(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594085: Call_StorageAccountsListServiceSAS_594067; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## List service SAS credentials of a specific resource.
  ## 
...
proc call*(call_594086: Call_StorageAccountsListServiceSAS_594067;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          parameters: JsonNode; accountName: string): Recallable =
  ...
  add(path_594087, "accountName", newJString(accountName))
  result = call_594086.call(path_594087, query_594088, nil, nil, body_594089)

var storageAccountsListServiceSAS* = Call_StorageAccountsListServiceSAS_594067(
    ...
    validator: validate_StorageAccountsListServiceSAS_594068, base: "",
    url: url_StorageAccountsListServiceSAS_594069, schemes: {Scheme.Https})
type
  Call_StorageAccountsListKeys_594090 = ref object of OpenApiRestCall_593425
proc url_StorageAccountsListKeys_594092(protocol: Scheme; host: string; base: string;
...
proc validate_StorageAccountsListKeys_594091(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594097: Call_StorageAccountsListKeys_594090; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists the access keys for the specified storage account.
  ## 
...
proc call*(call_594098: Call_StorageAccountsListKeys_594090;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          accountName: string): Recallable =
...
var storageAccountsListKeys* = Call_StorageAccountsListKeys_594090(
    ...
    validator: validate_StorageAccountsListKeys_594091, base: "",
    url: url_StorageAccountsListKeys_594092, schemes: {Scheme.Https})
type
  Call_StorageAccountsRegenerateKey_594101 = ref object of OpenApiRestCall_593425
proc url_StorageAccountsRegenerateKey_594103(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_StorageAccountsRegenerateKey_594102(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594109: Call_StorageAccountsRegenerateKey_594101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Regenerates one of the access keys for the specified storage account.
  ## 
...
proc call*(call_594110: Call_StorageAccountsRegenerateKey_594101;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var storageAccountsRegenerateKey* = Call_StorageAccountsRegenerateKey_594101(
    ...
    validator: validate_StorageAccountsRegenerateKey_594102, base: "",
    url: url_StorageAccountsRegenerateKey_594103, schemes: {Scheme.Https})
export
  rest
