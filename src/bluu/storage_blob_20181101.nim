...
proc call*(call_563972: Call_BlobContainersList_563778; path: JsonNode;
...
proc call*(call_564043: Call_BlobContainersList_563778; apiVersion: string;
...
type
  Call_BlobContainersGet_564085 = ref object of OpenApiRestCall_563556
proc url_BlobContainersGet_564087(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BlobContainersGet_564086(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_564102: Call_BlobContainersGet_564085; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets properties of a specified container. 
  ## 
...
proc call*(call_564103: Call_BlobContainersGet_564085; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; containerName: string;
...
var blobContainersGet* = Call_BlobContainersGet_564085(name: "blobContainersGet",
    ...
    validator: validate_BlobContainersGet_564086, base: "",
    url: url_BlobContainersGet_564087, schemes: {Scheme.Https})
type
...
type
  Call_BlobServicesSetServiceProperties_564298 = ref object of OpenApiRestCall_563556
proc url_BlobServicesSetServiceProperties_564300(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BlobServicesSetServiceProperties_564299(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564302 = path.getOrDefault("BlobServicesName")
  valid_564302 = validateParameter(valid_564302, JString, required = true,
                                 default = newJString("default"))
  if valid_564302 != nil:
    section.add "BlobServicesName", valid_564302
...
proc call*(call_564307: Call_BlobServicesSetServiceProperties_564298;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Sets the properties of a storage account’s Blob service, including properties for Storage Analytics and CORS (Cross-Origin Resource Sharing) rules. 
  ## 
...
proc call*(call_564308: Call_BlobServicesSetServiceProperties_564298;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564309, "BlobServicesName", newJString(BlobServicesName))
...
var blobServicesSetServiceProperties* = Call_BlobServicesSetServiceProperties_564298(
    ...
    validator: validate_BlobServicesSetServiceProperties_564299, base: "",
    url: url_BlobServicesSetServiceProperties_564300, schemes: {Scheme.Https})
type
  Call_BlobServicesGetServiceProperties_564286 = ref object of OpenApiRestCall_563556
proc url_BlobServicesGetServiceProperties_564288(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BlobServicesGetServiceProperties_564287(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564290 = path.getOrDefault("BlobServicesName")
  valid_564290 = validateParameter(valid_564290, JString, required = true,
                                 default = newJString("default"))
  if valid_564290 != nil:
    section.add "BlobServicesName", valid_564290
...
proc call*(call_564294: Call_BlobServicesGetServiceProperties_564286;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the properties of a storage account’s Blob service, including properties for Storage Analytics and CORS (Cross-Origin Resource Sharing) rules.
  ## 
...
proc call*(call_564295: Call_BlobServicesGetServiceProperties_564286;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564296, "BlobServicesName", newJString(BlobServicesName))
...
var blobServicesGetServiceProperties* = Call_BlobServicesGetServiceProperties_564286(
    name: "blobServicesGetServiceProperties", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/{BlobServicesName}",
    validator: validate_BlobServicesGetServiceProperties_564287, base: "",
    url: url_BlobServicesGetServiceProperties_564288, schemes: {Scheme.Https})
type
  Call_BlobContainersLease_564312 = ref object of OpenApiRestCall_563556
proc url_BlobContainersLease_564314(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BlobContainersLease_564313(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
...
proc call*(call_564321: Call_BlobContainersLease_564312; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## The Lease Container operation establishes and manages a lock on a container for delete operations. The lock duration can be 15 to 60 seconds, or can be infinite.
  ## 
...
proc call*(call_564322: Call_BlobContainersLease_564312; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; containerName: string;
  ...
  add(path_564323, "containerName", newJString(containerName))
  if parameters != nil:
...
var blobContainersLease* = Call_BlobContainersLease_564312(
    ...
    validator: validate_BlobContainersLease_564313, base: "",
    url: url_BlobContainersLease_564314, schemes: {Scheme.Https})
export
  rest
