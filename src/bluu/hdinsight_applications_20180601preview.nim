...
type
  Call_ApplicationsListByCluster_593646 = ref object of OpenApiRestCall_593424
proc url_ApplicationsListByCluster_593648(protocol: Scheme; host: string;
...
proc validate_ApplicationsListByCluster_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593847: Call_ApplicationsListByCluster_593646; path: JsonNode;
...
proc call*(call_593918: Call_ApplicationsListByCluster_593646; clusterName: string;
...
var applicationsListByCluster* = Call_ApplicationsListByCluster_593646(
    ...
    validator: validate_ApplicationsListByCluster_593647, base: "",
    url: url_ApplicationsListByCluster_593648, schemes: {Scheme.Https})
type
