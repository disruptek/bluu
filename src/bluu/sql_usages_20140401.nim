...
type
  Call_DatabaseUsagesListByDatabase_563778 = ref object of OpenApiRestCall_563556
proc url_DatabaseUsagesListByDatabase_563780(protocol: Scheme; host: string;
...
proc validate_DatabaseUsagesListByDatabase_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563982: Call_DatabaseUsagesListByDatabase_563778; path: JsonNode;
...
proc call*(call_564053: Call_DatabaseUsagesListByDatabase_563778;
...
var databaseUsagesListByDatabase* = Call_DatabaseUsagesListByDatabase_563778(
    ...
    validator: validate_DatabaseUsagesListByDatabase_563779, base: "",
    url: url_DatabaseUsagesListByDatabase_563780, schemes: {Scheme.Https})
type
  Call_ServerUsagesListByServer_564095 = ref object of OpenApiRestCall_563556
proc url_ServerUsagesListByServer_564097(protocol: Scheme; host: string;
...
proc validate_ServerUsagesListByServer_564096(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564102: Call_ServerUsagesListByServer_564095; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns server usages.
  ## 
...
proc call*(call_564103: Call_ServerUsagesListByServer_564095; apiVersion: string;
...
var serverUsagesListByServer* = Call_ServerUsagesListByServer_564095(
    ...
    validator: validate_ServerUsagesListByServer_564096, base: "",
    url: url_ServerUsagesListByServer_564097, schemes: {Scheme.Https})
export
  rest
