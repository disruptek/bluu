...
type
  Call_AvailableEndpointServicesList_593630 = ref object of OpenApiRestCall_593408
proc url_AvailableEndpointServicesList_593632(protocol: Scheme; host: string;
...
proc validate_AvailableEndpointServicesList_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593830: Call_AvailableEndpointServicesList_593630; path: JsonNode;
...
proc call*(call_593901: Call_AvailableEndpointServicesList_593630;
...
var availableEndpointServicesList* = Call_AvailableEndpointServicesList_593630(
    ...
    validator: validate_AvailableEndpointServicesList_593631, base: "",
    url: url_AvailableEndpointServicesList_593632, schemes: {Scheme.Https})
export
  rest
