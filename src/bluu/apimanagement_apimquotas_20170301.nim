...
proc validate_QuotaByCounterKeysListByService_563779(path: JsonNode;
  ...
  var valid_563955 = path.getOrDefault("serviceName")
  valid_563955 = validateParameter(valid_563955, JString, required = true,
                                 default = nil)
  if valid_563955 != nil:
    section.add "serviceName", valid_563955
  var valid_563956 = path.getOrDefault("subscriptionId")
  valid_563956 = validateParameter(valid_563956, JString, required = true,
                                 default = nil)
  if valid_563956 != nil:
    section.add "subscriptionId", valid_563956
  var valid_563957 = path.getOrDefault("quotaCounterKey")
  valid_563957 = validateParameter(valid_563957, JString, required = true,
                                 default = nil)
  if valid_563957 != nil:
    section.add "quotaCounterKey", valid_563957
...
proc call*(call_563982: Call_QuotaByCounterKeysListByService_563778;
...
proc call*(call_564053: Call_QuotaByCounterKeysListByService_563778;
  ...
  add(path_564054, "serviceName", newJString(serviceName))
  add(query_564056, "api-version", newJString(apiVersion))
  add(path_564054, "subscriptionId", newJString(subscriptionId))
  add(path_564054, "quotaCounterKey", newJString(quotaCounterKey))
...
type
  Call_QuotaByCounterKeysUpdate_564095 = ref object of OpenApiRestCall_563556
proc url_QuotaByCounterKeysUpdate_564097(protocol: Scheme; host: string;
...
proc validate_QuotaByCounterKeysUpdate_564096(path: JsonNode; query: JsonNode;
  ...
  var valid_564117 = path.getOrDefault("quotaCounterKey")
  valid_564117 = validateParameter(valid_564117, JString, required = true,
                                 default = nil)
  if valid_564117 != nil:
    section.add "quotaCounterKey", valid_564117
...
proc call*(call_564121: Call_QuotaByCounterKeysUpdate_564095; path: JsonNode;
...
proc call*(call_564122: Call_QuotaByCounterKeysUpdate_564095; serviceName: string;
  ...
  add(path_564123, "quotaCounterKey", newJString(quotaCounterKey))
...
var quotaByCounterKeysUpdate* = Call_QuotaByCounterKeysUpdate_564095(
    name: "quotaByCounterKeysUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}",
    validator: validate_QuotaByCounterKeysUpdate_564096, base: "",
    url: url_QuotaByCounterKeysUpdate_564097, schemes: {Scheme.Https})
type
  Call_QuotaByPeriodKeysGet_564126 = ref object of OpenApiRestCall_563556
proc url_QuotaByPeriodKeysGet_564128(protocol: Scheme; host: string; base: string;
...
proc validate_QuotaByPeriodKeysGet_564127(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564129 = path.getOrDefault("quotaPeriodKey")
  valid_564129 = validateParameter(valid_564129, JString, required = true,
                                 default = nil)
  if valid_564129 != nil:
    section.add "quotaPeriodKey", valid_564129
  ...
  var valid_564132 = path.getOrDefault("quotaCounterKey")
  valid_564132 = validateParameter(valid_564132, JString, required = true,
                                 default = nil)
  if valid_564132 != nil:
    section.add "quotaCounterKey", valid_564132
...
proc call*(call_564135: Call_QuotaByPeriodKeysGet_564126; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the value of the quota counter associated with the counter-key in the policy for the specific period in service instance.
  ## 
  ## Document describing how to configure the quota policies.
...
proc call*(call_564136: Call_QuotaByPeriodKeysGet_564126; quotaPeriodKey: string;
          serviceName: string; apiVersion: string; subscriptionId: string;
          quotaCounterKey: string; resourceGroupName: string): Recallable =
  ...
  add(path_564137, "quotaPeriodKey", newJString(quotaPeriodKey))
  ...
  add(path_564137, "quotaCounterKey", newJString(quotaCounterKey))
...
var quotaByPeriodKeysGet* = Call_QuotaByPeriodKeysGet_564126(
    ...
    validator: validate_QuotaByPeriodKeysGet_564127, base: "",
    url: url_QuotaByPeriodKeysGet_564128, schemes: {Scheme.Https})
type
  Call_QuotaByPeriodKeysUpdate_564139 = ref object of OpenApiRestCall_563556
proc url_QuotaByPeriodKeysUpdate_564141(protocol: Scheme; host: string; base: string;
...
proc validate_QuotaByPeriodKeysUpdate_564140(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `quotaPeriodKey` field"
  var valid_564142 = path.getOrDefault("quotaPeriodKey")
  valid_564142 = validateParameter(valid_564142, JString, required = true,
                                 default = nil)
  if valid_564142 != nil:
    section.add "quotaPeriodKey", valid_564142
  ...
  var valid_564145 = path.getOrDefault("quotaCounterKey")
  valid_564145 = validateParameter(valid_564145, JString, required = true,
                                 default = nil)
  if valid_564145 != nil:
    section.add "quotaCounterKey", valid_564145
...
proc call*(call_564149: Call_QuotaByPeriodKeysUpdate_564139; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing quota counter value in the specified service instance.
  ## 
...
proc call*(call_564150: Call_QuotaByPeriodKeysUpdate_564139;
  ...
  add(path_564151, "quotaPeriodKey", newJString(quotaPeriodKey))
  ...
  add(path_564151, "quotaCounterKey", newJString(quotaCounterKey))
...
var quotaByPeriodKeysUpdate* = Call_QuotaByPeriodKeysUpdate_564139(
    name: "quotaByPeriodKeysUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/{quotaPeriodKey}",
    validator: validate_QuotaByPeriodKeysUpdate_564140, base: "",
    url: url_QuotaByPeriodKeysUpdate_564141, schemes: {Scheme.Https})
export
  rest
