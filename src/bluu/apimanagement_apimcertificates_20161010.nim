...
type
  Call_CertificatesListByService_563777 = ref object of OpenApiRestCall_563555
proc url_CertificatesListByService_563779(protocol: Scheme; host: string;
...
proc validate_CertificatesListByService_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563975: Call_CertificatesListByService_563777; path: JsonNode;
...
proc call*(call_564046: Call_CertificatesListByService_563777; serviceName: string;
...
var certificatesListByService* = Call_CertificatesListByService_563777(
    ...
    validator: validate_CertificatesListByService_563778, base: "",
    url: url_CertificatesListByService_563779, schemes: {Scheme.Https})
type
  Call_CertificatesCreateOrUpdate_564109 = ref object of OpenApiRestCall_563555
proc url_CertificatesCreateOrUpdate_564111(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesCreateOrUpdate_564110(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564132 = path.getOrDefault("certificateId")
  valid_564132 = validateParameter(valid_564132, JString, required = true,
                                 default = nil)
  if valid_564132 != nil:
    section.add "certificateId", valid_564132
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564136: Call_CertificatesCreateOrUpdate_564109; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates the certificate being used for authentication with the backend.
  ## 
  ## How to secure back-end services using client certificate authentication in Azure API Management
...
proc call*(call_564137: Call_CertificatesCreateOrUpdate_564109;
  ...
  add(path_564138, "certificateId", newJString(certificateId))
  result = call_564137.call(path_564138, query_564139, nil, nil, body_564140)

var certificatesCreateOrUpdate* = Call_CertificatesCreateOrUpdate_564109(
    ...
    validator: validate_CertificatesCreateOrUpdate_564110, base: "",
    url: url_CertificatesCreateOrUpdate_564111, schemes: {Scheme.Https})
type
  Call_CertificatesGet_564088 = ref object of OpenApiRestCall_563555
proc url_CertificatesGet_564090(protocol: Scheme; host: string; base: string;
...
proc validate_CertificatesGet_564089(path: JsonNode; query: JsonNode;
  ...
  var valid_564103 = path.getOrDefault("certificateId")
  valid_564103 = validateParameter(valid_564103, JString, required = true,
                                 default = nil)
  if valid_564103 != nil:
    section.add "certificateId", valid_564103
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564105: Call_CertificatesGet_564088; path: JsonNode; query: JsonNode;
...
proc call*(call_564106: Call_CertificatesGet_564088; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564107, "certificateId", newJString(certificateId))
  result = call_564106.call(path_564107, query_564108, nil, nil, nil)

var certificatesGet* = Call_CertificatesGet_564088(name: "certificatesGet",
    ...
    validator: validate_CertificatesGet_564089, base: "", url: url_CertificatesGet_564090,
    schemes: {Scheme.Https})
type
  Call_CertificatesDelete_564141 = ref object of OpenApiRestCall_563555
proc url_CertificatesDelete_564143(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesDelete_564142(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_564147 = path.getOrDefault("certificateId")
  valid_564147 = validateParameter(valid_564147, JString, required = true,
                                 default = nil)
  if valid_564147 != nil:
    section.add "certificateId", valid_564147
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564150: Call_CertificatesDelete_564141; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific certificate.
  ## 
...
proc call*(call_564151: Call_CertificatesDelete_564141; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          certificateId: string): Recallable =
  ## certificatesDelete
  ## Deletes specific certificate.
  ...
  add(path_564152, "certificateId", newJString(certificateId))
  result = call_564151.call(path_564152, query_564153, nil, nil, nil)

var certificatesDelete* = Call_CertificatesDelete_564141(
    name: "certificatesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/certificates/{certificateId}",
    validator: validate_CertificatesDelete_564142, base: "",
    url: url_CertificatesDelete_564143, schemes: {Scheme.Https})
export
  rest
