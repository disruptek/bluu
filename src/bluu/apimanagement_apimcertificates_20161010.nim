...
type
  Call_CertificatesListByService_593646 = ref object of OpenApiRestCall_593424
proc url_CertificatesListByService_593648(protocol: Scheme; host: string;
...
proc validate_CertificatesListByService_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593842: Call_CertificatesListByService_593646; path: JsonNode;
...
proc call*(call_593913: Call_CertificatesListByService_593646;
...
var certificatesListByService* = Call_CertificatesListByService_593646(
    ...
    validator: validate_CertificatesListByService_593647, base: "",
    url: url_CertificatesListByService_593648, schemes: {Scheme.Https})
type
  Call_CertificatesCreateOrUpdate_593976 = ref object of OpenApiRestCall_593424
proc url_CertificatesCreateOrUpdate_593978(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesCreateOrUpdate_593977(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594003: Call_CertificatesCreateOrUpdate_593976; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates the certificate being used for authentication with the backend.
  ## 
  ## How to secure back-end services using client certificate authentication in Azure API Management
...
proc call*(call_594004: Call_CertificatesCreateOrUpdate_593976;
...
var certificatesCreateOrUpdate* = Call_CertificatesCreateOrUpdate_593976(
    ...
    validator: validate_CertificatesCreateOrUpdate_593977, base: "",
    url: url_CertificatesCreateOrUpdate_593978, schemes: {Scheme.Https})
type
  Call_CertificatesGet_593955 = ref object of OpenApiRestCall_593424
proc url_CertificatesGet_593957(protocol: Scheme; host: string; base: string;
...
proc validate_CertificatesGet_593956(path: JsonNode; query: JsonNode;
...
proc call*(call_593972: Call_CertificatesGet_593955; path: JsonNode; query: JsonNode;
...
proc call*(call_593973: Call_CertificatesGet_593955; resourceGroupName: string;
...
var certificatesGet* = Call_CertificatesGet_593955(name: "certificatesGet",
    ...
    validator: validate_CertificatesGet_593956, base: "", url: url_CertificatesGet_593957,
    schemes: {Scheme.Https})
type
  Call_CertificatesDelete_594008 = ref object of OpenApiRestCall_593424
proc url_CertificatesDelete_594010(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificatesDelete_594009(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594017: Call_CertificatesDelete_594008; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific certificate.
  ## 
...
proc call*(call_594018: Call_CertificatesDelete_594008; resourceGroupName: string;
          apiVersion: string; certificateId: string; subscriptionId: string;
          serviceName: string): Recallable =
  ## certificatesDelete
  ## Deletes specific certificate.
...
var certificatesDelete* = Call_CertificatesDelete_594008(
    name: "certificatesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/certificates/{certificateId}",
    validator: validate_CertificatesDelete_594009, base: "",
    url: url_CertificatesDelete_594010, schemes: {Scheme.Https})
export
  rest
