...
type
  Call_DpsCertificateList_594051 = ref object of OpenApiRestCall_593424
proc url_DpsCertificateList_594053(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DpsCertificateList_594052(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
...
proc call*(call_594058: Call_DpsCertificateList_594051; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the certificates tied to the provisioning service.
  ## 
...
proc call*(call_594059: Call_DpsCertificateList_594051; resourceGroupName: string;
          apiVersion: string; provisioningServiceName: string;
          subscriptionId: string): Recallable =
  ## dpsCertificateList
  ## Get all the certificates tied to the provisioning service.
...
var dpsCertificateList* = Call_DpsCertificateList_594051(
    ...
    validator: validate_DpsCertificateList_594052, base: "",
    url: url_DpsCertificateList_594053, schemes: {Scheme.Https})
type
