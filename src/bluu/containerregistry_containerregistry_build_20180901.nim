...
type
  Call_RegistriesGetBuildSourceUploadUrl_593659 = ref object of OpenApiRestCall_593437
proc url_RegistriesGetBuildSourceUploadUrl_593661(protocol: Scheme; host: string;
...
proc validate_RegistriesGetBuildSourceUploadUrl_593660(path: JsonNode;
  ...
  var valid_593836 = path.getOrDefault("registryName")
  valid_593836 = validateParameter(valid_593836, JString, required = true,
                                 default = nil)
  if valid_593836 != nil:
    section.add "registryName", valid_593836
...
proc call*(call_593860: Call_RegistriesGetBuildSourceUploadUrl_593659;
...
proc call*(call_593931: Call_RegistriesGetBuildSourceUploadUrl_593659;
  ...
  add(path_593932, "resourceGroupName", newJString(resourceGroupName))
  add(query_593934, "api-version", newJString(apiVersion))
  add(path_593932, "subscriptionId", newJString(subscriptionId))
  add(path_593932, "registryName", newJString(registryName))
  result = call_593931.call(path_593932, query_593934, nil, nil, nil)

var registriesGetBuildSourceUploadUrl* = Call_RegistriesGetBuildSourceUploadUrl_593659(
    ...
    validator: validate_RegistriesGetBuildSourceUploadUrl_593660, base: "/",
    url: url_RegistriesGetBuildSourceUploadUrl_593661, schemes: {Scheme.Https})
type
  Call_RunsList_593973 = ref object of OpenApiRestCall_593437
proc url_RunsList_593975(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RunsList_593974(path: JsonNode; query: JsonNode; header: JsonNode;
  ...
  var valid_593979 = path.getOrDefault("registryName")
  valid_593979 = validateParameter(valid_593979, JString, required = true,
                                 default = nil)
  if valid_593979 != nil:
    section.add "registryName", valid_593979
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_593983: Call_RunsList_593973; path: JsonNode; query: JsonNode;
...
proc call*(call_593984: Call_RunsList_593973; resourceGroupName: string;
  ...
  add(path_593985, "registryName", newJString(registryName))
  add(query_593986, "$filter", newJString(Filter))
  result = call_593984.call(path_593985, query_593986, nil, nil, nil)

var runsList* = Call_RunsList_593973(name: "runsList", meth: HttpMethod.HttpGet,
                                  ...
                                  validator: validate_RunsList_593974, base: "/",
                                  url: url_RunsList_593975,
                                  schemes: {Scheme.Https})
type
  Call_RunsGet_593987 = ref object of OpenApiRestCall_593437
proc url_RunsGet_593989(protocol: Scheme; host: string; base: string; route: string;
                       path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RunsGet_593988(path: JsonNode; query: JsonNode; header: JsonNode;
                            formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593992 = path.getOrDefault("registryName")
  valid_593992 = validateParameter(valid_593992, JString, required = true,
                                 default = nil)
  if valid_593992 != nil:
    section.add "registryName", valid_593992
  var valid_593993 = path.getOrDefault("runId")
  valid_593993 = validateParameter(valid_593993, JString, required = true,
                                 default = nil)
  if valid_593993 != nil:
    section.add "runId", valid_593993
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_593995: Call_RunsGet_593987; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the detailed information for a given run.
  ## 
...
proc call*(call_593996: Call_RunsGet_593987; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; registryName: string;
  ...
  add(path_593997, "registryName", newJString(registryName))
  add(path_593997, "runId", newJString(runId))
  result = call_593996.call(path_593997, query_593998, nil, nil, nil)

var runsGet* = Call_RunsGet_593987(name: "runsGet", meth: HttpMethod.HttpGet,
                                ...
                                validator: validate_RunsGet_593988, base: "/",
                                url: url_RunsGet_593989, schemes: {Scheme.Https})
type
  Call_RunsUpdate_593999 = ref object of OpenApiRestCall_593437
proc url_RunsUpdate_594001(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RunsUpdate_594000(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594005 = path.getOrDefault("runId")
  valid_594005 = validateParameter(valid_594005, JString, required = true,
                                 default = nil)
  if valid_594005 != nil:
    section.add "runId", valid_594005
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594008: Call_RunsUpdate_593999; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Patch the run properties.
  ## 
...
proc call*(call_594009: Call_RunsUpdate_593999; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; registryName: string;
  ...
  add(path_594010, "registryName", newJString(registryName))
  add(path_594010, "runId", newJString(runId))
  if runUpdateParameters != nil:
    body_594012 = runUpdateParameters
  result = call_594009.call(path_594010, query_594011, nil, nil, body_594012)

var runsUpdate* = Call_RunsUpdate_593999(name: "runsUpdate",
                                      meth: HttpMethod.HttpPatch,
                                      host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/runs/{runId}",
                                      validator: validate_RunsUpdate_594000,
                                      base: "/", url: url_RunsUpdate_594001,
                                      schemes: {Scheme.Https})
type
  Call_RunsCancel_594013 = ref object of OpenApiRestCall_593437
proc url_RunsCancel_594015(protocol: Scheme; host: string; base: string; route: string;
                          path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RunsCancel_594014(path: JsonNode; query: JsonNode; header: JsonNode;
                               formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594019 = path.getOrDefault("runId")
  valid_594019 = validateParameter(valid_594019, JString, required = true,
                                 default = nil)
  if valid_594019 != nil:
    section.add "runId", valid_594019
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594021: Call_RunsCancel_594013; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Cancel an existing run.
  ## 
...
proc call*(call_594022: Call_RunsCancel_594013; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; registryName: string;
          runId: string): Recallable =
  ## runsCancel
  ## Cancel an existing run.
  ...
  add(path_594023, "registryName", newJString(registryName))
  add(path_594023, "runId", newJString(runId))
  result = call_594022.call(path_594023, query_594024, nil, nil, nil)

var runsCancel* = Call_RunsCancel_594013(name: "runsCancel",
                                      ...
                                      validator: validate_RunsCancel_594014,
                                      base: "/", url: url_RunsCancel_594015,
                                      schemes: {Scheme.Https})
type
  Call_RunsGetLogSasUrl_594025 = ref object of OpenApiRestCall_593437
proc url_RunsGetLogSasUrl_594027(protocol: Scheme; host: string; base: string;
...
proc validate_RunsGetLogSasUrl_594026(path: JsonNode; query: JsonNode;
  ...
  var valid_594030 = path.getOrDefault("registryName")
  valid_594030 = validateParameter(valid_594030, JString, required = true,
                                 default = nil)
  if valid_594030 != nil:
    section.add "registryName", valid_594030
  var valid_594031 = path.getOrDefault("runId")
  valid_594031 = validateParameter(valid_594031, JString, required = true,
                                 default = nil)
  if valid_594031 != nil:
    section.add "runId", valid_594031
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594033: Call_RunsGetLogSasUrl_594025; path: JsonNode;
...
proc call*(call_594034: Call_RunsGetLogSasUrl_594025; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; registryName: string;
          runId: string): Recallable =
  ## runsGetLogSasUrl
  ## Gets a link to download the run logs.
  ...
  add(path_594035, "registryName", newJString(registryName))
  add(path_594035, "runId", newJString(runId))
  result = call_594034.call(path_594035, query_594036, nil, nil, nil)

var runsGetLogSasUrl* = Call_RunsGetLogSasUrl_594025(name: "runsGetLogSasUrl",
    ...
    validator: validate_RunsGetLogSasUrl_594026, base: "/",
    url: url_RunsGetLogSasUrl_594027, schemes: {Scheme.Https})
type
  Call_RegistriesScheduleRun_594037 = ref object of OpenApiRestCall_593437
proc url_RegistriesScheduleRun_594039(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RegistriesScheduleRun_594038(path: JsonNode; query: JsonNode;
...
proc call*(call_594045: Call_RegistriesScheduleRun_594037; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Schedules a new run based on the request parameters and add it to the run queue.
  ## 
...
proc call*(call_594046: Call_RegistriesScheduleRun_594037;
  ...
  if runRequest != nil:
    body_594049 = runRequest
  add(path_594047, "subscriptionId", newJString(subscriptionId))
  add(path_594047, "registryName", newJString(registryName))
  result = call_594046.call(path_594047, query_594048, nil, nil, body_594049)

var registriesScheduleRun* = Call_RegistriesScheduleRun_594037(
    ...
    validator: validate_RegistriesScheduleRun_594038, base: "/",
    url: url_RegistriesScheduleRun_594039, schemes: {Scheme.Https})
type
  Call_TasksList_594050 = ref object of OpenApiRestCall_593437
proc url_TasksList_594052(protocol: Scheme; host: string; base: string; route: string;
                         path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksList_594051(path: JsonNode; query: JsonNode; header: JsonNode;
                              formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594055 = path.getOrDefault("registryName")
  valid_594055 = validateParameter(valid_594055, JString, required = true,
                                 default = nil)
  if valid_594055 != nil:
    section.add "registryName", valid_594055
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594057: Call_TasksList_594050; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the tasks for a specified container registry.
  ## 
...
proc call*(call_594058: Call_TasksList_594050; resourceGroupName: string;
  ...
  add(path_594059, "registryName", newJString(registryName))
  result = call_594058.call(path_594059, query_594060, nil, nil, nil)

var tasksList* = Call_TasksList_594050(name: "tasksList", meth: HttpMethod.HttpGet,
                                    ...
                                    validator: validate_TasksList_594051,
                                    base: "/", url: url_TasksList_594052,
                                    schemes: {Scheme.Https})
type
  Call_TasksCreate_594073 = ref object of OpenApiRestCall_593437
proc url_TasksCreate_594075(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksCreate_594074(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594078 = path.getOrDefault("taskName")
  valid_594078 = validateParameter(valid_594078, JString, required = true,
                                 default = nil)
  if valid_594078 != nil:
    section.add "taskName", valid_594078
  var valid_594079 = path.getOrDefault("registryName")
  valid_594079 = validateParameter(valid_594079, JString, required = true,
                                 default = nil)
  if valid_594079 != nil:
    section.add "registryName", valid_594079
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594082: Call_TasksCreate_594073; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a task for a container registry with the specified parameters.
  ## 
...
proc call*(call_594083: Call_TasksCreate_594073; resourceGroupName: string;
  ...
  add(path_594084, "taskName", newJString(taskName))
  if taskCreateParameters != nil:
    body_594086 = taskCreateParameters
  add(path_594084, "registryName", newJString(registryName))
  result = call_594083.call(path_594084, query_594085, nil, nil, body_594086)

var tasksCreate* = Call_TasksCreate_594073(name: "tasksCreate",
                                        ...
                                        validator: validate_TasksCreate_594074,
                                        base: "/", url: url_TasksCreate_594075,
                                        schemes: {Scheme.Https})
type
  Call_TasksGet_594061 = ref object of OpenApiRestCall_593437
proc url_TasksGet_594063(protocol: Scheme; host: string; base: string; route: string;
                        path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksGet_594062(path: JsonNode; query: JsonNode; header: JsonNode;
                             formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594066 = path.getOrDefault("taskName")
  valid_594066 = validateParameter(valid_594066, JString, required = true,
                                 default = nil)
  if valid_594066 != nil:
    section.add "taskName", valid_594066
  var valid_594067 = path.getOrDefault("registryName")
  valid_594067 = validateParameter(valid_594067, JString, required = true,
                                 default = nil)
  if valid_594067 != nil:
    section.add "registryName", valid_594067
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594069: Call_TasksGet_594061; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the properties of a specified task.
  ## 
...
proc call*(call_594070: Call_TasksGet_594061; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; taskName: string;
          registryName: string): Recallable =
  ## tasksGet
  ## Get the properties of a specified task.
  ...
  add(path_594071, "taskName", newJString(taskName))
  add(path_594071, "registryName", newJString(registryName))
  result = call_594070.call(path_594071, query_594072, nil, nil, nil)

var tasksGet* = Call_TasksGet_594061(name: "tasksGet", meth: HttpMethod.HttpGet,
                                  host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/tasks/{taskName}",
                                  validator: validate_TasksGet_594062, base: "/",
                                  url: url_TasksGet_594063,
                                  schemes: {Scheme.Https})
type
  Call_TasksUpdate_594099 = ref object of OpenApiRestCall_593437
proc url_TasksUpdate_594101(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksUpdate_594100(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594104 = path.getOrDefault("taskName")
  valid_594104 = validateParameter(valid_594104, JString, required = true,
                                 default = nil)
  if valid_594104 != nil:
    section.add "taskName", valid_594104
  var valid_594105 = path.getOrDefault("registryName")
  valid_594105 = validateParameter(valid_594105, JString, required = true,
                                 default = nil)
  if valid_594105 != nil:
    section.add "registryName", valid_594105
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594108: Call_TasksUpdate_594099; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a task with the specified parameters.
  ## 
...
proc call*(call_594109: Call_TasksUpdate_594099; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; taskName: string;
  ...
  add(path_594110, "taskName", newJString(taskName))
  add(path_594110, "registryName", newJString(registryName))
  if taskUpdateParameters != nil:
    body_594112 = taskUpdateParameters
  result = call_594109.call(path_594110, query_594111, nil, nil, body_594112)

var tasksUpdate* = Call_TasksUpdate_594099(name: "tasksUpdate",
                                        meth: HttpMethod.HttpPatch,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/tasks/{taskName}",
                                        validator: validate_TasksUpdate_594100,
                                        base: "/", url: url_TasksUpdate_594101,
                                        schemes: {Scheme.Https})
type
  Call_TasksDelete_594087 = ref object of OpenApiRestCall_593437
proc url_TasksDelete_594089(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksDelete_594088(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594092 = path.getOrDefault("taskName")
  valid_594092 = validateParameter(valid_594092, JString, required = true,
                                 default = nil)
  if valid_594092 != nil:
    section.add "taskName", valid_594092
  var valid_594093 = path.getOrDefault("registryName")
  valid_594093 = validateParameter(valid_594093, JString, required = true,
                                 default = nil)
  if valid_594093 != nil:
    section.add "registryName", valid_594093
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594095: Call_TasksDelete_594087; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a specified task.
  ## 
...
proc call*(call_594096: Call_TasksDelete_594087; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; taskName: string;
          registryName: string): Recallable =
  ## tasksDelete
  ## Deletes a specified task.
  ...
  add(path_594097, "taskName", newJString(taskName))
  add(path_594097, "registryName", newJString(registryName))
  result = call_594096.call(path_594097, query_594098, nil, nil, nil)

var tasksDelete* = Call_TasksDelete_594087(name: "tasksDelete",
                                        meth: HttpMethod.HttpDelete,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/tasks/{taskName}",
                                        validator: validate_TasksDelete_594088,
                                        base: "/", url: url_TasksDelete_594089,
                                        schemes: {Scheme.Https})
type
  Call_TasksGetDetails_594113 = ref object of OpenApiRestCall_593437
proc url_TasksGetDetails_594115(protocol: Scheme; host: string; base: string;
                               route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_TasksGetDetails_594114(path: JsonNode; query: JsonNode;
                                    header: JsonNode; formData: JsonNode;
                                    body: JsonNode): JsonNode =
  ...
  var valid_594118 = path.getOrDefault("taskName")
  valid_594118 = validateParameter(valid_594118, JString, required = true,
                                 default = nil)
  if valid_594118 != nil:
    section.add "taskName", valid_594118
  var valid_594119 = path.getOrDefault("registryName")
  valid_594119 = validateParameter(valid_594119, JString, required = true,
                                 default = nil)
  if valid_594119 != nil:
    section.add "registryName", valid_594119
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The client API version.
...
proc call*(call_594121: Call_TasksGetDetails_594113; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns a task with extended information that includes all secrets.
  ## 
...
proc call*(call_594122: Call_TasksGetDetails_594113; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; taskName: string;
          registryName: string): Recallable =
  ## tasksGetDetails
  ## Returns a task with extended information that includes all secrets.
  ...
  add(path_594123, "taskName", newJString(taskName))
  add(path_594123, "registryName", newJString(registryName))
  result = call_594122.call(path_594123, query_594124, nil, nil, nil)

var tasksGetDetails* = Call_TasksGetDetails_594113(name: "tasksGetDetails",
    ...
    validator: validate_TasksGetDetails_594114, base: "/", url: url_TasksGetDetails_594115,
    schemes: {Scheme.Https})
export
  rest
