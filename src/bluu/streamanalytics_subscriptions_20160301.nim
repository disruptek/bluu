...
const
  macServiceName = "streamanalytics-subscriptions"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_SubscriptionsListQuotas_563777 = ref object of OpenApiRestCall_563555
proc url_SubscriptionsListQuotas_563779(protocol: Scheme; host: string; base: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.StreamAnalytics/locations/"),
...
proc validate_SubscriptionsListQuotas_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563979: Call_SubscriptionsListQuotas_563777; path: JsonNode;
...
proc call*(call_564050: Call_SubscriptionsListQuotas_563777; apiVersion: string;
          subscriptionId: string; location: string): Recallable =
  ## subscriptionsListQuotas
  ## Retrieves the subscription's current quota information in a particular region.
...
var subscriptionsListQuotas* = Call_SubscriptionsListQuotas_563777(
    name: "subscriptionsListQuotas", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.StreamAnalytics/locations/{location}/quotas",
    validator: validate_SubscriptionsListQuotas_563778, base: "",
    url: url_SubscriptionsListQuotas_563779, schemes: {Scheme.Https})
export
  rest
