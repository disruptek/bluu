...
type
  Call_PublicIPPrefixesListAll_573879 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesListAll_573881(protocol: Scheme; host: string; base: string;
...
proc validate_PublicIPPrefixesListAll_573880(path: JsonNode; query: JsonNode;
...
proc call*(call_574069: Call_PublicIPPrefixesListAll_573879; path: JsonNode;
...
proc call*(call_574140: Call_PublicIPPrefixesListAll_573879; apiVersion: string;
...
var publicIPPrefixesListAll* = Call_PublicIPPrefixesListAll_573879(
    ...
    validator: validate_PublicIPPrefixesListAll_573880, base: "",
    url: url_PublicIPPrefixesListAll_573881, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesList_574182 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesList_574184(protocol: Scheme; host: string; base: string;
...
proc validate_PublicIPPrefixesList_574183(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_574188: Call_PublicIPPrefixesList_574182; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all public IP prefixes in a resource group.
  ## 
...
proc call*(call_574189: Call_PublicIPPrefixesList_574182;
...
var publicIPPrefixesList* = Call_PublicIPPrefixesList_574182(
    ...
    validator: validate_PublicIPPrefixesList_574183, base: "",
    url: url_PublicIPPrefixesList_574184, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesCreateOrUpdate_574205 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesCreateOrUpdate_574207(protocol: Scheme; host: string;
...
proc validate_PublicIPPrefixesCreateOrUpdate_574206(path: JsonNode;
  ...
  var valid_574236 = path.getOrDefault("publicIpPrefixName")
  valid_574236 = validateParameter(valid_574236, JString, required = true,
                                 default = nil)
  if valid_574236 != nil:
    section.add "publicIpPrefixName", valid_574236
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_574239: Call_PublicIPPrefixesCreateOrUpdate_574205; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a static or dynamic public IP prefix.
  ## 
...
proc call*(call_574240: Call_PublicIPPrefixesCreateOrUpdate_574205;
  ...
  add(path_574241, "publicIpPrefixName", newJString(publicIpPrefixName))
  if parameters != nil:
    body_574243 = parameters
  result = call_574240.call(path_574241, query_574242, nil, nil, body_574243)

var publicIPPrefixesCreateOrUpdate* = Call_PublicIPPrefixesCreateOrUpdate_574205(
    ...
    validator: validate_PublicIPPrefixesCreateOrUpdate_574206, base: "",
    url: url_PublicIPPrefixesCreateOrUpdate_574207, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesGet_574192 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesGet_574194(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesGet_574193(path: JsonNode; query: JsonNode;
  ...
  var valid_574198 = path.getOrDefault("publicIpPrefixName")
  valid_574198 = validateParameter(valid_574198, JString, required = true,
                                 default = nil)
  if valid_574198 != nil:
    section.add "publicIpPrefixName", valid_574198
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_574201: Call_PublicIPPrefixesGet_574192; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified public IP prefix in a specified resource group.
  ## 
...
proc call*(call_574202: Call_PublicIPPrefixesGet_574192; resourceGroupName: string;
  ...
  add(path_574203, "publicIpPrefixName", newJString(publicIpPrefixName))
  result = call_574202.call(path_574203, query_574204, nil, nil, nil)

var publicIPPrefixesGet* = Call_PublicIPPrefixesGet_574192(
    name: "publicIPPrefixesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesGet_574193, base: "",
    url: url_PublicIPPrefixesGet_574194, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesUpdateTags_574255 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesUpdateTags_574257(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesUpdateTags_574256(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_574260 = path.getOrDefault("publicIpPrefixName")
  valid_574260 = validateParameter(valid_574260, JString, required = true,
                                 default = nil)
  if valid_574260 != nil:
    section.add "publicIpPrefixName", valid_574260
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_574263: Call_PublicIPPrefixesUpdateTags_574255; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates public IP prefix tags.
  ## 
...
proc call*(call_574264: Call_PublicIPPrefixesUpdateTags_574255;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          publicIpPrefixName: string; parameters: JsonNode): Recallable =
  ...
  add(path_574265, "publicIpPrefixName", newJString(publicIpPrefixName))
  if parameters != nil:
    body_574267 = parameters
  result = call_574264.call(path_574265, query_574266, nil, nil, body_574267)

var publicIPPrefixesUpdateTags* = Call_PublicIPPrefixesUpdateTags_574255(
    name: "publicIPPrefixesUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesUpdateTags_574256, base: "",
    url: url_PublicIPPrefixesUpdateTags_574257, schemes: {Scheme.Https})
type
  Call_PublicIPPrefixesDelete_574244 = ref object of OpenApiRestCall_573657
proc url_PublicIPPrefixesDelete_574246(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PublicIPPrefixesDelete_574245(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_574249 = path.getOrDefault("publicIpPrefixName")
  valid_574249 = validateParameter(valid_574249, JString, required = true,
                                 default = nil)
  if valid_574249 != nil:
    section.add "publicIpPrefixName", valid_574249
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_574251: Call_PublicIPPrefixesDelete_574244; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified public IP prefix.
  ## 
...
proc call*(call_574252: Call_PublicIPPrefixesDelete_574244;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_574253, "publicIpPrefixName", newJString(publicIpPrefixName))
  result = call_574252.call(path_574253, query_574254, nil, nil, nil)

var publicIPPrefixesDelete* = Call_PublicIPPrefixesDelete_574244(
    name: "publicIPPrefixesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIpPrefixName}",
    validator: validate_PublicIPPrefixesDelete_574245, base: "",
    url: url_PublicIPPrefixesDelete_574246, schemes: {Scheme.Https})
export
  rest
