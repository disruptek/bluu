...
type
  Call_ServerAdvisorsListByServer_567880 = ref object of OpenApiRestCall_567658
proc url_ServerAdvisorsListByServer_567882(protocol: Scheme; host: string;
...
proc validate_ServerAdvisorsListByServer_567881(path: JsonNode; query: JsonNode;
...
proc call*(call_568081: Call_ServerAdvisorsListByServer_567880; path: JsonNode;
...
proc call*(call_568152: Call_ServerAdvisorsListByServer_567880;
...
var serverAdvisorsListByServer* = Call_ServerAdvisorsListByServer_567880(
    ...
    validator: validate_ServerAdvisorsListByServer_567881, base: "",
    url: url_ServerAdvisorsListByServer_567882, schemes: {Scheme.Https})
type
  Call_ServerAdvisorsGet_568194 = ref object of OpenApiRestCall_567658
proc url_ServerAdvisorsGet_568196(protocol: Scheme; host: string; base: string;
...
proc validate_ServerAdvisorsGet_568195(path: JsonNode; query: JsonNode;
  ...
  var valid_568200 = path.getOrDefault("advisorName")
  valid_568200 = validateParameter(valid_568200, JString, required = true,
                                 default = nil)
  if valid_568200 != nil:
    section.add "advisorName", valid_568200
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568202: Call_ServerAdvisorsGet_568194; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a server advisor.
  ## 
...
proc call*(call_568203: Call_ServerAdvisorsGet_568194; resourceGroupName: string;
  ...
  add(path_568204, "advisorName", newJString(advisorName))
  result = call_568203.call(path_568204, query_568205, nil, nil, nil)

var serverAdvisorsGet* = Call_ServerAdvisorsGet_568194(name: "serverAdvisorsGet",
    ...
    validator: validate_ServerAdvisorsGet_568195, base: "",
    url: url_ServerAdvisorsGet_568196, schemes: {Scheme.Https})
type
  Call_ServerAdvisorsUpdate_568206 = ref object of OpenApiRestCall_567658
proc url_ServerAdvisorsUpdate_568208(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServerAdvisorsUpdate_568207(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568210 = path.getOrDefault("serverName")
  valid_568210 = validateParameter(valid_568210, JString, required = true,
                                 default = nil)
  if valid_568210 != nil:
    section.add "serverName", valid_568210
  var valid_568211 = path.getOrDefault("subscriptionId")
  valid_568211 = validateParameter(valid_568211, JString, required = true,
                                 default = nil)
  if valid_568211 != nil:
    section.add "subscriptionId", valid_568211
  var valid_568212 = path.getOrDefault("advisorName")
  valid_568212 = validateParameter(valid_568212, JString, required = true,
                                 default = nil)
  if valid_568212 != nil:
    section.add "advisorName", valid_568212
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568215: Call_ServerAdvisorsUpdate_568206; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a server advisor.
  ## 
...
proc call*(call_568216: Call_ServerAdvisorsUpdate_568206;
          resourceGroupName: string; apiVersion: string; serverName: string;
  ...
  add(path_568217, "advisorName", newJString(advisorName))
  if parameters != nil:
    body_568219 = parameters
  result = call_568216.call(path_568217, query_568218, nil, nil, body_568219)

var serverAdvisorsUpdate* = Call_ServerAdvisorsUpdate_568206(
    ...
    validator: validate_ServerAdvisorsUpdate_568207, base: "",
    url: url_ServerAdvisorsUpdate_568208, schemes: {Scheme.Https})
type
  Call_DatabaseAdvisorsListByDatabase_568220 = ref object of OpenApiRestCall_567658
proc url_DatabaseAdvisorsListByDatabase_568222(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseAdvisorsListByDatabase_568221(path: JsonNode;
...
proc call*(call_568228: Call_DatabaseAdvisorsListByDatabase_568220; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a list of database advisors.
  ## 
...
proc call*(call_568229: Call_DatabaseAdvisorsListByDatabase_568220;
          resourceGroupName: string; apiVersion: string; serverName: string;
...
var databaseAdvisorsListByDatabase* = Call_DatabaseAdvisorsListByDatabase_568220(
    ...
    validator: validate_DatabaseAdvisorsListByDatabase_568221, base: "",
    url: url_DatabaseAdvisorsListByDatabase_568222, schemes: {Scheme.Https})
type
  Call_DatabaseAdvisorsGet_568232 = ref object of OpenApiRestCall_567658
proc url_DatabaseAdvisorsGet_568234(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseAdvisorsGet_568233(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_568239 = path.getOrDefault("advisorName")
  valid_568239 = validateParameter(valid_568239, JString, required = true,
                                 default = nil)
  if valid_568239 != nil:
    section.add "advisorName", valid_568239
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568241: Call_DatabaseAdvisorsGet_568232; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a database advisor.
  ## 
...
proc call*(call_568242: Call_DatabaseAdvisorsGet_568232; resourceGroupName: string;
          apiVersion: string; serverName: string; subscriptionId: string;
  ...
  add(path_568243, "advisorName", newJString(advisorName))
  result = call_568242.call(path_568243, query_568244, nil, nil, nil)

var databaseAdvisorsGet* = Call_DatabaseAdvisorsGet_568232(
    ...
    validator: validate_DatabaseAdvisorsGet_568233, base: "",
    url: url_DatabaseAdvisorsGet_568234, schemes: {Scheme.Https})
type
  Call_DatabaseAdvisorsUpdate_568245 = ref object of OpenApiRestCall_567658
proc url_DatabaseAdvisorsUpdate_568247(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseAdvisorsUpdate_568246(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568252 = path.getOrDefault("advisorName")
  valid_568252 = validateParameter(valid_568252, JString, required = true,
                                 default = nil)
  if valid_568252 != nil:
    section.add "advisorName", valid_568252
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568255: Call_DatabaseAdvisorsUpdate_568245; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a database advisor.
  ## 
...
proc call*(call_568256: Call_DatabaseAdvisorsUpdate_568245;
          resourceGroupName: string; apiVersion: string; serverName: string;
  ...
  add(path_568257, "advisorName", newJString(advisorName))
  if parameters != nil:
    body_568259 = parameters
  result = call_568256.call(path_568257, query_568258, nil, nil, body_568259)

var databaseAdvisorsUpdate* = Call_DatabaseAdvisorsUpdate_568245(
    name: "databaseAdvisorsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/advisors/{advisorName}",
    validator: validate_DatabaseAdvisorsUpdate_568246, base: "",
    url: url_DatabaseAdvisorsUpdate_568247, schemes: {Scheme.Https})
type
  Call_DatabaseRecommendedActionsListByDatabaseAdvisor_568260 = ref object of OpenApiRestCall_567658
proc url_DatabaseRecommendedActionsListByDatabaseAdvisor_568262(protocol: Scheme;
...
proc validate_DatabaseRecommendedActionsListByDatabaseAdvisor_568261(
  ...
  var valid_568267 = path.getOrDefault("advisorName")
  valid_568267 = validateParameter(valid_568267, JString, required = true,
                                 default = nil)
  if valid_568267 != nil:
    section.add "advisorName", valid_568267
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568269: Call_DatabaseRecommendedActionsListByDatabaseAdvisor_568260;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_568270: Call_DatabaseRecommendedActionsListByDatabaseAdvisor_568260;
          resourceGroupName: string; apiVersion: string; serverName: string;
  ...
  add(path_568271, "advisorName", newJString(advisorName))
  result = call_568270.call(path_568271, query_568272, nil, nil, nil)

var databaseRecommendedActionsListByDatabaseAdvisor* = Call_DatabaseRecommendedActionsListByDatabaseAdvisor_568260(
    ...
    validator: validate_DatabaseRecommendedActionsListByDatabaseAdvisor_568261,
    base: "", url: url_DatabaseRecommendedActionsListByDatabaseAdvisor_568262,
    schemes: {Scheme.Https})
type
  Call_DatabaseRecommendedActionsGet_568273 = ref object of OpenApiRestCall_567658
proc url_DatabaseRecommendedActionsGet_568275(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseRecommendedActionsGet_568274(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568280 = path.getOrDefault("advisorName")
  valid_568280 = validateParameter(valid_568280, JString, required = true,
                                 default = nil)
  if valid_568280 != nil:
    section.add "advisorName", valid_568280
  var valid_568281 = path.getOrDefault("recommendedActionName")
  valid_568281 = validateParameter(valid_568281, JString, required = true,
                                 default = nil)
  if valid_568281 != nil:
    section.add "recommendedActionName", valid_568281
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568283: Call_DatabaseRecommendedActionsGet_568273; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a database recommended action.
  ## 
...
proc call*(call_568284: Call_DatabaseRecommendedActionsGet_568273;
          resourceGroupName: string; apiVersion: string; serverName: string;
          subscriptionId: string; databaseName: string; advisorName: string;
  ...
  add(path_568285, "serverName", newJString(serverName))
  add(path_568285, "subscriptionId", newJString(subscriptionId))
  add(path_568285, "databaseName", newJString(databaseName))
  add(path_568285, "advisorName", newJString(advisorName))
  add(path_568285, "recommendedActionName", newJString(recommendedActionName))
  result = call_568284.call(path_568285, query_568286, nil, nil, nil)

var databaseRecommendedActionsGet* = Call_DatabaseRecommendedActionsGet_568273(
    ...
    validator: validate_DatabaseRecommendedActionsGet_568274, base: "",
    url: url_DatabaseRecommendedActionsGet_568275, schemes: {Scheme.Https})
type
  Call_DatabaseRecommendedActionsUpdate_568287 = ref object of OpenApiRestCall_567658
proc url_DatabaseRecommendedActionsUpdate_568289(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_DatabaseRecommendedActionsUpdate_568288(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568291 = path.getOrDefault("serverName")
  valid_568291 = validateParameter(valid_568291, JString, required = true,
                                 default = nil)
  if valid_568291 != nil:
    section.add "serverName", valid_568291
  var valid_568292 = path.getOrDefault("subscriptionId")
  valid_568292 = validateParameter(valid_568292, JString, required = true,
                                 default = nil)
  if valid_568292 != nil:
    section.add "subscriptionId", valid_568292
  var valid_568293 = path.getOrDefault("databaseName")
  valid_568293 = validateParameter(valid_568293, JString, required = true,
                                 default = nil)
  if valid_568293 != nil:
    section.add "databaseName", valid_568293
  var valid_568294 = path.getOrDefault("advisorName")
  valid_568294 = validateParameter(valid_568294, JString, required = true,
                                 default = nil)
  if valid_568294 != nil:
    section.add "advisorName", valid_568294
  var valid_568295 = path.getOrDefault("recommendedActionName")
  valid_568295 = validateParameter(valid_568295, JString, required = true,
                                 default = nil)
  if valid_568295 != nil:
    section.add "recommendedActionName", valid_568295
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_568298: Call_DatabaseRecommendedActionsUpdate_568287;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Updates a database recommended action.
  ## 
...
proc call*(call_568299: Call_DatabaseRecommendedActionsUpdate_568287;
          resourceGroupName: string; apiVersion: string; serverName: string;
          subscriptionId: string; databaseName: string; advisorName: string;
  ...
  add(path_568300, "databaseName", newJString(databaseName))
  add(path_568300, "advisorName", newJString(advisorName))
  if parameters != nil:
    body_568302 = parameters
  add(path_568300, "recommendedActionName", newJString(recommendedActionName))
  result = call_568299.call(path_568300, query_568301, nil, nil, body_568302)

var databaseRecommendedActionsUpdate* = Call_DatabaseRecommendedActionsUpdate_568287(
    name: "databaseRecommendedActionsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/advisors/{advisorName}/recommendedActions/{recommendedActionName}",
    validator: validate_DatabaseRecommendedActionsUpdate_568288, base: "",
    url: url_DatabaseRecommendedActionsUpdate_568289, schemes: {Scheme.Https})
export
  rest
