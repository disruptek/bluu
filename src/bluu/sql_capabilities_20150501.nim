...
proc call*(call_593846: Call_CapabilitiesListByLocation_593646; path: JsonNode;
...
proc call*(call_593917: Call_CapabilitiesListByLocation_593646; apiVersion: string;
