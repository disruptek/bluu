...
proc call*(call_568079: Call_CapabilitiesListByLocation_567879; path: JsonNode;
...
proc call*(call_568150: Call_CapabilitiesListByLocation_567879; apiVersion: string;
