...
proc call*(call_563979: Call_CapabilitiesListByLocation_563777; path: JsonNode;
...
proc call*(call_564050: Call_CapabilitiesListByLocation_563777; apiVersion: string;
