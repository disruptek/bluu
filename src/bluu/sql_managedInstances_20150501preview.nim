...
type
  Call_ManagedInstancesListByResourceGroup_564091 = ref object of OpenApiRestCall_563555
proc url_ManagedInstancesListByResourceGroup_564093(protocol: Scheme; host: string;
...
proc validate_ManagedInstancesListByResourceGroup_564092(path: JsonNode;
...
proc call*(call_564097: Call_ManagedInstancesListByResourceGroup_564091;
...
proc call*(call_564098: Call_ManagedInstancesListByResourceGroup_564091;
...
var managedInstancesListByResourceGroup* = Call_ManagedInstancesListByResourceGroup_564091(
    ...
    validator: validate_ManagedInstancesListByResourceGroup_564092, base: "",
    url: url_ManagedInstancesListByResourceGroup_564093, schemes: {Scheme.Https})
type
  Call_ManagedInstancesCreateOrUpdate_564112 = ref object of OpenApiRestCall_563555
proc url_ManagedInstancesCreateOrUpdate_564114(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedInstancesCreateOrUpdate_564113(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564120: Call_ManagedInstancesCreateOrUpdate_564112; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a managed instance.
  ## 
...
proc call*(call_564121: Call_ManagedInstancesCreateOrUpdate_564112;
...
var managedInstancesCreateOrUpdate* = Call_ManagedInstancesCreateOrUpdate_564112(
    ...
    validator: validate_ManagedInstancesCreateOrUpdate_564113, base: "",
    url: url_ManagedInstancesCreateOrUpdate_564114, schemes: {Scheme.Https})
type
  Call_ManagedInstancesGet_564101 = ref object of OpenApiRestCall_563555
proc url_ManagedInstancesGet_564103(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedInstancesGet_564102(path: JsonNode; query: JsonNode;
  ...
  var valid_564106 = path.getOrDefault("managedInstanceName")
  valid_564106 = validateParameter(valid_564106, JString, required = true,
                                 default = nil)
  if valid_564106 != nil:
    section.add "managedInstanceName", valid_564106
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_564108: Call_ManagedInstancesGet_564101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets a managed instance.
  ## 
...
proc call*(call_564109: Call_ManagedInstancesGet_564101; apiVersion: string;
  ...
  add(path_564110, "managedInstanceName", newJString(managedInstanceName))
  result = call_564109.call(path_564110, query_564111, nil, nil, nil)

var managedInstancesGet* = Call_ManagedInstancesGet_564101(
    name: "managedInstancesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}",
    validator: validate_ManagedInstancesGet_564102, base: "",
    url: url_ManagedInstancesGet_564103, schemes: {Scheme.Https})
type
  Call_ManagedInstancesUpdate_564136 = ref object of OpenApiRestCall_563555
proc url_ManagedInstancesUpdate_564138(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedInstancesUpdate_564137(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564144: Call_ManagedInstancesUpdate_564136; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates a managed instance.
  ## 
...
proc call*(call_564145: Call_ManagedInstancesUpdate_564136; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          managedInstanceName: string; parameters: JsonNode): Recallable =
  ...
  add(path_564146, "managedInstanceName", newJString(managedInstanceName))
  if parameters != nil:
    body_564148 = parameters
  result = call_564145.call(path_564146, query_564147, nil, nil, body_564148)

var managedInstancesUpdate* = Call_ManagedInstancesUpdate_564136(
    name: "managedInstancesUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}",
    validator: validate_ManagedInstancesUpdate_564137, base: "",
    url: url_ManagedInstancesUpdate_564138, schemes: {Scheme.Https})
type
  Call_ManagedInstancesDelete_564125 = ref object of OpenApiRestCall_563555
proc url_ManagedInstancesDelete_564127(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ManagedInstancesDelete_564126(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564130 = path.getOrDefault("managedInstanceName")
  valid_564130 = validateParameter(valid_564130, JString, required = true,
                                 default = nil)
  if valid_564130 != nil:
    section.add "managedInstanceName", valid_564130
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_564132: Call_ManagedInstancesDelete_564125; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a managed instance.
  ## 
...
proc call*(call_564133: Call_ManagedInstancesDelete_564125; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          managedInstanceName: string): Recallable =
...
var managedInstancesDelete* = Call_ManagedInstancesDelete_564125(
    name: "managedInstancesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}",
    validator: validate_ManagedInstancesDelete_564126, base: "",
    url: url_ManagedInstancesDelete_564127, schemes: {Scheme.Https})
export
  rest
