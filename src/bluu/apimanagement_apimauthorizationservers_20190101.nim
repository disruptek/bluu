...
type
  Call_AuthorizationServerCreateOrUpdate_593967 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerCreateOrUpdate_593969(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerCreateOrUpdate_593968(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593998 = path.getOrDefault("authsid")
  valid_593998 = validateParameter(valid_593998, JString, required = true,
                                 default = nil)
  if valid_593998 != nil:
    section.add "authsid", valid_593998
...
proc call*(call_594004: Call_AuthorizationServerCreateOrUpdate_593967;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates new authorization server or updates an existing authorization server.
  ## 
...
proc call*(call_594005: Call_AuthorizationServerCreateOrUpdate_593967;
  ...
  add(path_594006, "authsid", newJString(authsid))
...
var authorizationServerCreateOrUpdate* = Call_AuthorizationServerCreateOrUpdate_593967(
    ...
    validator: validate_AuthorizationServerCreateOrUpdate_593968, base: "",
    url: url_AuthorizationServerCreateOrUpdate_593969, schemes: {Scheme.Https})
type
  Call_AuthorizationServerGetEntityTag_594022 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerGetEntityTag_594024(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerGetEntityTag_594023(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594026 = path.getOrDefault("authsid")
  valid_594026 = validateParameter(valid_594026, JString, required = true,
                                 default = nil)
  if valid_594026 != nil:
    section.add "authsid", valid_594026
...
proc call*(call_594030: Call_AuthorizationServerGetEntityTag_594022;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the authorizationServer specified by its identifier.
  ## 
...
proc call*(call_594031: Call_AuthorizationServerGetEntityTag_594022;
          resourceGroupName: string; apiVersion: string; authsid: string;
  ...
  add(path_594032, "authsid", newJString(authsid))
...
var authorizationServerGetEntityTag* = Call_AuthorizationServerGetEntityTag_594022(
    name: "authorizationServerGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerGetEntityTag_594023, base: "",
    url: url_AuthorizationServerGetEntityTag_594024, schemes: {Scheme.Https})
type
...
proc validate_AuthorizationServerGet_593956(path: JsonNode; query: JsonNode;
  ...
  var valid_593959 = path.getOrDefault("authsid")
  valid_593959 = validateParameter(valid_593959, JString, required = true,
                                 default = nil)
  if valid_593959 != nil:
    section.add "authsid", valid_593959
...
proc call*(call_593963: Call_AuthorizationServerGet_593955; path: JsonNode;
...
proc call*(call_593964: Call_AuthorizationServerGet_593955;
          resourceGroupName: string; apiVersion: string; authsid: string;
          subscriptionId: string; serviceName: string): Recallable =
  ...
  add(path_593965, "authsid", newJString(authsid))
...
type
  Call_AuthorizationServerUpdate_594034 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerUpdate_594036(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerUpdate_594035(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594038 = path.getOrDefault("authsid")
  valid_594038 = validateParameter(valid_594038, JString, required = true,
                                 default = nil)
  if valid_594038 != nil:
    section.add "authsid", valid_594038
...
proc call*(call_594044: Call_AuthorizationServerUpdate_594034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the authorization server specified by its identifier.
  ## 
...
proc call*(call_594045: Call_AuthorizationServerUpdate_594034;
          resourceGroupName: string; apiVersion: string; authsid: string;
          subscriptionId: string; parameters: JsonNode; serviceName: string): Recallable =
  ...
  add(path_594046, "authsid", newJString(authsid))
...
var authorizationServerUpdate* = Call_AuthorizationServerUpdate_594034(
    name: "authorizationServerUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerUpdate_594035, base: "",
    url: url_AuthorizationServerUpdate_594036, schemes: {Scheme.Https})
type
  Call_AuthorizationServerDelete_594009 = ref object of OpenApiRestCall_593424
proc url_AuthorizationServerDelete_594011(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_AuthorizationServerDelete_594010(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594013 = path.getOrDefault("authsid")
  valid_594013 = validateParameter(valid_594013, JString, required = true,
                                 default = nil)
  if valid_594013 != nil:
    section.add "authsid", valid_594013
...
proc call*(call_594018: Call_AuthorizationServerDelete_594009; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific authorization server instance.
  ## 
...
proc call*(call_594019: Call_AuthorizationServerDelete_594009;
          resourceGroupName: string; apiVersion: string; authsid: string;
          subscriptionId: string; serviceName: string): Recallable =
  ...
  add(path_594020, "authsid", newJString(authsid))
...
var authorizationServerDelete* = Call_AuthorizationServerDelete_594009(
    name: "authorizationServerDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationServers/{authsid}",
    validator: validate_AuthorizationServerDelete_594010, base: "",
    url: url_AuthorizationServerDelete_594011, schemes: {Scheme.Https})
export
  rest
