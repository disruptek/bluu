...
var virtualNetworkGatewaysGetLearnedRoutes* = Call_VirtualNetworkGatewaysGetLearnedRoutes_564342(
    ...
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564353 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564355(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564354(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_564360: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564353;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets pre-generated VPN profile for P2S client of the virtual network gateway in the specified resource group. The profile needs to be generated first using generateVpnProfile.
  ## 
...
proc call*(call_564361: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564353;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_564362, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564361.call(path_564362, query_564363, nil, nil, nil)

var virtualNetworkGatewaysGetVpnProfilePackageUrl* = Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564353(
    ...
    validator: validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564354,
    base: "", url: url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_564355,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysReset_564364 = ref object of OpenApiRestCall_563555
proc url_VirtualNetworkGatewaysReset_564366(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysReset_564365(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564369 = path.getOrDefault("virtualNetworkGatewayName")
  valid_564369 = validateParameter(valid_564369, JString, required = true,
                                 default = nil)
  if valid_564369 != nil:
    section.add "virtualNetworkGatewayName", valid_564369
  result.add "path", section
  ## parameters in `query` object:
  ##   gatewayVip: JString
  ...
  ##              : Client API version.
  section = newJObject()
  var valid_564370 = query.getOrDefault("gatewayVip")
  valid_564370 = validateParameter(valid_564370, JString, required = false,
                                 default = nil)
  if valid_564370 != nil:
    section.add "gatewayVip", valid_564370
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_564372: Call_VirtualNetworkGatewaysReset_564364; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resets the primary of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_564373: Call_VirtualNetworkGatewaysReset_564364;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(query_564375, "gatewayVip", newJString(gatewayVip))
  ...
  add(path_564374, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_564373.call(path_564374, query_564375, nil, nil, nil)

var virtualNetworkGatewaysReset* = Call_VirtualNetworkGatewaysReset_564364(
    ...
    validator: validate_VirtualNetworkGatewaysReset_564365, base: "",
    url: url_VirtualNetworkGatewaysReset_564366, schemes: {Scheme.Https})
export
  rest
