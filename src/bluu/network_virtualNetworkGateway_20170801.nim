...
var virtualNetworkGatewaysGetLearnedRoutes* = Call_VirtualNetworkGatewaysGetLearnedRoutes_568442(
    ...
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568453 = ref object of OpenApiRestCall_567657
proc url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568455(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568454(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_568460: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568453;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets pre-generated VPN profile for P2S client of the virtual network gateway in the specified resource group. The profile needs to be generated first using generateVpnProfile.
  ## 
...
proc call*(call_568461: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568453;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_568462, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_568461.call(path_568462, query_568463, nil, nil, nil)

var virtualNetworkGatewaysGetVpnProfilePackageUrl* = Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568453(
    ...
    validator: validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568454,
    base: "", url: url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_568455,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysReset_568464 = ref object of OpenApiRestCall_567657
proc url_VirtualNetworkGatewaysReset_568466(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysReset_568465(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568469 = path.getOrDefault("virtualNetworkGatewayName")
  valid_568469 = validateParameter(valid_568469, JString, required = true,
                                 default = nil)
  if valid_568469 != nil:
    section.add "virtualNetworkGatewayName", valid_568469
  result.add "path", section
  ## parameters in `query` object:
  ##   gatewayVip: JString
  ...
  ##              : Client API version.
  section = newJObject()
  var valid_568470 = query.getOrDefault("gatewayVip")
  valid_568470 = validateParameter(valid_568470, JString, required = false,
                                 default = nil)
  if valid_568470 != nil:
    section.add "gatewayVip", valid_568470
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_568472: Call_VirtualNetworkGatewaysReset_568464; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resets the primary of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_568473: Call_VirtualNetworkGatewaysReset_568464;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var virtualNetworkGatewaysReset* = Call_VirtualNetworkGatewaysReset_568464(
    ...
    validator: validate_VirtualNetworkGatewaysReset_568465, base: "",
    url: url_VirtualNetworkGatewaysReset_568466, schemes: {Scheme.Https})
export
  rest
