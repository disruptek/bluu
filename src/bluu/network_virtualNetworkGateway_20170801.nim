...
var virtualNetworkGatewaysGetLearnedRoutes* = Call_VirtualNetworkGatewaysGetLearnedRoutes_594209(
    ...
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594220 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594222(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594221(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_594227: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594220;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets pre-generated VPN profile for P2S client of the virtual network gateway in the specified resource group. The profile needs to be generated first using generateVpnProfile.
  ## 
...
proc call*(call_594228: Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594220;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          virtualNetworkGatewayName: string): Recallable =
  ...
  add(path_594229, "virtualNetworkGatewayName",
      newJString(virtualNetworkGatewayName))
  result = call_594228.call(path_594229, query_594230, nil, nil, nil)

var virtualNetworkGatewaysGetVpnProfilePackageUrl* = Call_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594220(
    ...
    validator: validate_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594221,
    base: "", url: url_VirtualNetworkGatewaysGetVpnProfilePackageUrl_594222,
    schemes: {Scheme.Https})
type
  Call_VirtualNetworkGatewaysReset_594231 = ref object of OpenApiRestCall_593424
proc url_VirtualNetworkGatewaysReset_594233(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VirtualNetworkGatewaysReset_594232(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594236 = path.getOrDefault("virtualNetworkGatewayName")
  valid_594236 = validateParameter(valid_594236, JString, required = true,
                                 default = nil)
  if valid_594236 != nil:
    section.add "virtualNetworkGatewayName", valid_594236
  result.add "path", section
  ## parameters in `query` object:
  ##   gatewayVip: JString
  ...
  ##              : Client API version.
  section = newJObject()
  var valid_594237 = query.getOrDefault("gatewayVip")
  valid_594237 = validateParameter(valid_594237, JString, required = false,
                                 default = nil)
  if valid_594237 != nil:
    section.add "gatewayVip", valid_594237
  assert query != nil,
        "query argument is necessary due to required `api-version` field"
...
proc call*(call_594239: Call_VirtualNetworkGatewaysReset_594231; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Resets the primary of the virtual network gateway in the specified resource group.
  ## 
...
proc call*(call_594240: Call_VirtualNetworkGatewaysReset_594231;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
...
var virtualNetworkGatewaysReset* = Call_VirtualNetworkGatewaysReset_594231(
    ...
    validator: validate_VirtualNetworkGatewaysReset_594232, base: "",
    url: url_VirtualNetworkGatewaysReset_594233, schemes: {Scheme.Https})
export
  rest
