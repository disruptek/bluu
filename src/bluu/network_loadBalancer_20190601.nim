...
type
  Call_LoadBalancerOutboundRulesList_594165 = ref object of OpenApiRestCall_593424
proc url_LoadBalancerOutboundRulesList_594167(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancerOutboundRulesList_594166(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594172: Call_LoadBalancerOutboundRulesList_594165; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the outbound rules in a load balancer.
  ## 
...
proc call*(call_594173: Call_LoadBalancerOutboundRulesList_594165;
          resourceGroupName: string; apiVersion: string; loadBalancerName: string;
          subscriptionId: string): Recallable =
...
var loadBalancerOutboundRulesList* = Call_LoadBalancerOutboundRulesList_594165(
    ...
    validator: validate_LoadBalancerOutboundRulesList_594166, base: "",
    url: url_LoadBalancerOutboundRulesList_594167, schemes: {Scheme.Https})
type
  Call_LoadBalancerOutboundRulesGet_594176 = ref object of OpenApiRestCall_593424
proc url_LoadBalancerOutboundRulesGet_594178(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancerOutboundRulesGet_594177(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594180 = path.getOrDefault("loadBalancerName")
  ...
  var valid_594182 = path.getOrDefault("outboundRuleName")
  valid_594182 = validateParameter(valid_594182, JString, required = true,
                                 default = nil)
  if valid_594182 != nil:
    section.add "outboundRuleName", valid_594182
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version.
...
proc call*(call_594184: Call_LoadBalancerOutboundRulesGet_594176; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified load balancer outbound rule.
  ## 
...
proc call*(call_594185: Call_LoadBalancerOutboundRulesGet_594176;
          resourceGroupName: string; apiVersion: string; loadBalancerName: string;
  ...
  add(path_594186, "outboundRuleName", newJString(outboundRuleName))
  result = call_594185.call(path_594186, query_594187, nil, nil, nil)

var loadBalancerOutboundRulesGet* = Call_LoadBalancerOutboundRulesGet_594176(
    ...
    validator: validate_LoadBalancerOutboundRulesGet_594177, base: "",
    url: url_LoadBalancerOutboundRulesGet_594178, schemes: {Scheme.Https})
type
  Call_LoadBalancerProbesList_594188 = ref object of OpenApiRestCall_593424
proc url_LoadBalancerProbesList_594190(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancerProbesList_594189(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594192 = path.getOrDefault("loadBalancerName")
  valid_594192 = validateParameter(valid_594192, JString, required = true,
                                 default = nil)
  if valid_594192 != nil:
    section.add "loadBalancerName", valid_594192
...
proc call*(call_594195: Call_LoadBalancerProbesList_594188; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the load balancer probes.
  ## 
...
proc call*(call_594196: Call_LoadBalancerProbesList_594188;
          resourceGroupName: string; apiVersion: string; loadBalancerName: string;
          subscriptionId: string): Recallable =
  ...
  add(path_594197, "loadBalancerName", newJString(loadBalancerName))
  add(path_594197, "subscriptionId", newJString(subscriptionId))
  result = call_594196.call(path_594197, query_594198, nil, nil, nil)

var loadBalancerProbesList* = Call_LoadBalancerProbesList_594188(
    ...
    validator: validate_LoadBalancerProbesList_594189, base: "",
    url: url_LoadBalancerProbesList_594190, schemes: {Scheme.Https})
type
  Call_LoadBalancerProbesGet_594199 = ref object of OpenApiRestCall_593424
proc url_LoadBalancerProbesGet_594201(protocol: Scheme; host: string; base: string;
                                     route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancerProbesGet_594200(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594203 = path.getOrDefault("probeName")
  valid_594203 = validateParameter(valid_594203, JString, required = true,
                                 default = nil)
  if valid_594203 != nil:
    section.add "probeName", valid_594203
  var valid_594204 = path.getOrDefault("loadBalancerName")
  valid_594204 = validateParameter(valid_594204, JString, required = true,
                                 default = nil)
  if valid_594204 != nil:
    section.add "loadBalancerName", valid_594204
...
proc call*(call_594207: Call_LoadBalancerProbesGet_594199; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets load balancer probe.
  ## 
...
proc call*(call_594208: Call_LoadBalancerProbesGet_594199;
  ...
  add(path_594209, "probeName", newJString(probeName))
  add(path_594209, "loadBalancerName", newJString(loadBalancerName))
  add(path_594209, "subscriptionId", newJString(subscriptionId))
  result = call_594208.call(path_594209, query_594210, nil, nil, nil)

var loadBalancerProbesGet* = Call_LoadBalancerProbesGet_594199(
    ...
    validator: validate_LoadBalancerProbesGet_594200, base: "",
    url: url_LoadBalancerProbesGet_594201, schemes: {Scheme.Https})
export
  rest
