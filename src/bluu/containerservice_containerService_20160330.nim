...
type
  Call_ContainerServicesList_563778 = ref object of OpenApiRestCall_563556
proc url_ContainerServicesList_563780(protocol: Scheme; host: string; base: string;
...
proc validate_ContainerServicesList_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563979: Call_ContainerServicesList_563778; path: JsonNode;
...
proc call*(call_564050: Call_ContainerServicesList_563778; apiVersion: string;
...
var containerServicesList* = Call_ContainerServicesList_563778(
    ...
    validator: validate_ContainerServicesList_563779, base: "",
    url: url_ContainerServicesList_563780, schemes: {Scheme.Https})
type
  Call_ContainerServicesListByResourceGroup_564092 = ref object of OpenApiRestCall_563556
proc url_ContainerServicesListByResourceGroup_564094(protocol: Scheme;
...
proc validate_ContainerServicesListByResourceGroup_564093(path: JsonNode;
...
proc call*(call_564098: Call_ContainerServicesListByResourceGroup_564092;
...
proc call*(call_564099: Call_ContainerServicesListByResourceGroup_564092;
...
var containerServicesListByResourceGroup* = Call_ContainerServicesListByResourceGroup_564092(
    ...
    validator: validate_ContainerServicesListByResourceGroup_564093, base: "",
    url: url_ContainerServicesListByResourceGroup_564094, schemes: {Scheme.Https})
type
  Call_ContainerServicesCreateOrUpdate_564113 = ref object of OpenApiRestCall_563556
proc url_ContainerServicesCreateOrUpdate_564115(protocol: Scheme; host: string;
...
proc validate_ContainerServicesCreateOrUpdate_564114(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564133 = path.getOrDefault("containerServiceName")
  valid_564133 = validateParameter(valid_564133, JString, required = true,
                                 default = nil)
  if valid_564133 != nil:
    section.add "containerServiceName", valid_564133
...
proc call*(call_564138: Call_ContainerServicesCreateOrUpdate_564113;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a container service with the specified configuration of orchestrator, masters, and agents.
  ## 
...
proc call*(call_564139: Call_ContainerServicesCreateOrUpdate_564113;
  ...
  add(path_564140, "containerServiceName", newJString(containerServiceName))
...
var containerServicesCreateOrUpdate* = Call_ContainerServicesCreateOrUpdate_564113(
    ...
    validator: validate_ContainerServicesCreateOrUpdate_564114, base: "",
    url: url_ContainerServicesCreateOrUpdate_564115, schemes: {Scheme.Https})
type
  Call_ContainerServicesGet_564102 = ref object of OpenApiRestCall_563556
proc url_ContainerServicesGet_564104(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerServicesGet_564103(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `containerServiceName` field"
  var valid_564105 = path.getOrDefault("containerServiceName")
  valid_564105 = validateParameter(valid_564105, JString, required = true,
                                 default = nil)
  if valid_564105 != nil:
    section.add "containerServiceName", valid_564105
...
proc call*(call_564109: Call_ContainerServicesGet_564102; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the properties of the specified container service in the specified subscription and resource group. The operation returns the properties including state, orchestrator, number of masters and agents, and FQDNs of masters and agents. 
  ## 
...
proc call*(call_564110: Call_ContainerServicesGet_564102; apiVersion: string;
  ...
  add(path_564111, "containerServiceName", newJString(containerServiceName))
...
var containerServicesGet* = Call_ContainerServicesGet_564102(
    name: "containerServicesGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/containerServices/{containerServiceName}",
    validator: validate_ContainerServicesGet_564103, base: "",
    url: url_ContainerServicesGet_564104, schemes: {Scheme.Https})
type
  Call_ContainerServicesDelete_564143 = ref object of OpenApiRestCall_563556
proc url_ContainerServicesDelete_564145(protocol: Scheme; host: string; base: string;
...
proc validate_ContainerServicesDelete_564144(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `containerServiceName` field"
  var valid_564146 = path.getOrDefault("containerServiceName")
  valid_564146 = validateParameter(valid_564146, JString, required = true,
                                 default = nil)
  if valid_564146 != nil:
    section.add "containerServiceName", valid_564146
...
proc call*(call_564150: Call_ContainerServicesDelete_564143; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified container service in the specified subscription and resource group. The operation does not delete other resources created as part of creating a container service, including storage accounts, VMs, and availability sets. All the other resources created with the container service are part of the same resource group and can be deleted individually.
  ## 
...
proc call*(call_564151: Call_ContainerServicesDelete_564143; apiVersion: string;
          containerServiceName: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
  ...
  add(path_564152, "containerServiceName", newJString(containerServiceName))
...
var containerServicesDelete* = Call_ContainerServicesDelete_564143(
    name: "containerServicesDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/containerServices/{containerServiceName}",
    validator: validate_ContainerServicesDelete_564144, base: "",
    url: url_ContainerServicesDelete_564145, schemes: {Scheme.Https})
export
  rest
