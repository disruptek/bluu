...
proc call*(call_563974: Call_EmailTemplateListByService_563777; path: JsonNode;
...
proc call*(call_564045: Call_EmailTemplateListByService_563777;
...
type
  Call_EmailTemplateCreateOrUpdate_564121 = ref object of OpenApiRestCall_563555
proc url_EmailTemplateCreateOrUpdate_564123(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EmailTemplateCreateOrUpdate_564122(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  assert path != nil,
        "path argument is necessary due to required `serviceName` field"
  var valid_564141 = path.getOrDefault("serviceName")
  valid_564141 = validateParameter(valid_564141, JString, required = true,
                                 default = nil)
  if valid_564141 != nil:
    section.add "serviceName", valid_564141
...
proc call*(call_564148: Call_EmailTemplateCreateOrUpdate_564121; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an Email Template.
  ## 
...
proc call*(call_564149: Call_EmailTemplateCreateOrUpdate_564121;
          serviceName: string; apiVersion: string; subscriptionId: string;
...
var emailTemplateCreateOrUpdate* = Call_EmailTemplateCreateOrUpdate_564121(
    ...
    validator: validate_EmailTemplateCreateOrUpdate_564122, base: "",
    url: url_EmailTemplateCreateOrUpdate_564123, schemes: {Scheme.Https})
type
  Call_EmailTemplateGetEntityTag_564166 = ref object of OpenApiRestCall_563555
proc url_EmailTemplateGetEntityTag_564168(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EmailTemplateGetEntityTag_564167(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564172 = path.getOrDefault("templateName")
  valid_564172 = validateParameter(valid_564172, JString, required = true, default = newJString(
      "applicationApprovedNotificationMessage"))
  if valid_564172 != nil:
    section.add "templateName", valid_564172
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564174: Call_EmailTemplateGetEntityTag_564166; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the email template specified by its identifier.
  ## 
...
proc call*(call_564175: Call_EmailTemplateGetEntityTag_564166; serviceName: string;
  ...
  add(path_564176, "templateName", newJString(templateName))
  result = call_564175.call(path_564176, query_564177, nil, nil, nil)

var emailTemplateGetEntityTag* = Call_EmailTemplateGetEntityTag_564166(
    name: "emailTemplateGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/templates/{templateName}",
    validator: validate_EmailTemplateGetEntityTag_564167, base: "",
    url: url_EmailTemplateGetEntityTag_564168, schemes: {Scheme.Https})
type
  Call_EmailTemplateGet_564087 = ref object of OpenApiRestCall_563555
proc url_EmailTemplateGet_564089(protocol: Scheme; host: string; base: string;
...
proc validate_EmailTemplateGet_564088(path: JsonNode; query: JsonNode;
  ...
  var valid_564115 = path.getOrDefault("templateName")
  valid_564115 = validateParameter(valid_564115, JString, required = true, default = newJString(
      "applicationApprovedNotificationMessage"))
  if valid_564115 != nil:
    section.add "templateName", valid_564115
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564117: Call_EmailTemplateGet_564087; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the email template specified by its identifier.
  ## 
...
proc call*(call_564118: Call_EmailTemplateGet_564087; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          templateName: string = "applicationApprovedNotificationMessage"): Recallable =
  ## emailTemplateGet
  ## Gets the details of the email template specified by its identifier.
  ...
  add(path_564119, "templateName", newJString(templateName))
  result = call_564118.call(path_564119, query_564120, nil, nil, nil)

var emailTemplateGet* = Call_EmailTemplateGet_564087(name: "emailTemplateGet",
    ...
    validator: validate_EmailTemplateGet_564088, base: "",
    url: url_EmailTemplateGet_564089, schemes: {Scheme.Https})
type
  Call_EmailTemplateUpdate_564178 = ref object of OpenApiRestCall_563555
proc url_EmailTemplateUpdate_564180(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EmailTemplateUpdate_564179(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564184 = path.getOrDefault("templateName")
  valid_564184 = validateParameter(valid_564184, JString, required = true, default = newJString(
      "applicationApprovedNotificationMessage"))
  if valid_564184 != nil:
    section.add "templateName", valid_564184
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564187: Call_EmailTemplateUpdate_564178; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific Email Template.
  ## 
...
proc call*(call_564188: Call_EmailTemplateUpdate_564178; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          parameters: JsonNode;
          templateName: string = "applicationApprovedNotificationMessage"): Recallable =
  ## emailTemplateUpdate
  ...
  add(path_564189, "templateName", newJString(templateName))
  if parameters != nil:
    body_564191 = parameters
  result = call_564188.call(path_564189, query_564190, nil, nil, body_564191)

var emailTemplateUpdate* = Call_EmailTemplateUpdate_564178(
    name: "emailTemplateUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/templates/{templateName}",
    validator: validate_EmailTemplateUpdate_564179, base: "",
    url: url_EmailTemplateUpdate_564180, schemes: {Scheme.Https})
type
...
proc validate_EmailTemplateDelete_564154(path: JsonNode; query: JsonNode;
  ...
  var valid_564159 = path.getOrDefault("templateName")
  valid_564159 = validateParameter(valid_564159, JString, required = true, default = newJString(
      "applicationApprovedNotificationMessage"))
  if valid_564159 != nil:
    section.add "templateName", valid_564159
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564162: Call_EmailTemplateDelete_564153; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Reset the Email Template to default template provided by the API Management service instance.
  ## 
...
proc call*(call_564163: Call_EmailTemplateDelete_564153; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          templateName: string = "applicationApprovedNotificationMessage"): Recallable =
  ## emailTemplateDelete
  ## Reset the Email Template to default template provided by the API Management service instance.
  ...
  add(path_564164, "templateName", newJString(templateName))
...
var emailTemplateDelete* = Call_EmailTemplateDelete_564153(
    ...
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/templates/{templateName}",
    validator: validate_EmailTemplateDelete_564154, base: "",
    url: url_EmailTemplateDelete_564155, schemes: {Scheme.Https})
export
  rest
