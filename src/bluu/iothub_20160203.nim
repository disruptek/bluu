...
type
  Call_IotHubResourceListBySubscription_563777 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceListBySubscription_563779(protocol: Scheme; host: string;
...
proc validate_IotHubResourceListBySubscription_563778(path: JsonNode;
...
proc call*(call_563978: Call_IotHubResourceListBySubscription_563777;
...
proc call*(call_564049: Call_IotHubResourceListBySubscription_563777;
...
var iotHubResourceListBySubscription* = Call_IotHubResourceListBySubscription_563777(
    ...
    validator: validate_IotHubResourceListBySubscription_563778, base: "",
    url: url_IotHubResourceListBySubscription_563779, schemes: {Scheme.Https})
type
  Call_IotHubResourceCheckNameAvailability_564091 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceCheckNameAvailability_564093(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceCheckNameAvailability_564092(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564097: Call_IotHubResourceCheckNameAvailability_564091;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Check if an IoT hub name is available.
  ## 
...
proc call*(call_564098: Call_IotHubResourceCheckNameAvailability_564091;
  ...
  if operationInputs != nil:
    body_564101 = operationInputs
  result = call_564098.call(path_564099, query_564100, nil, nil, body_564101)

var iotHubResourceCheckNameAvailability* = Call_IotHubResourceCheckNameAvailability_564091(
    ...
    validator: validate_IotHubResourceCheckNameAvailability_564092, base: "",
    url: url_IotHubResourceCheckNameAvailability_564093, schemes: {Scheme.Https})
type
  Call_IotHubResourceListByResourceGroup_564102 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceListByResourceGroup_564104(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListByResourceGroup_564103(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564108: Call_IotHubResourceListByResourceGroup_564102;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get all the IoT hubs in a resource group.
  ## 
...
proc call*(call_564109: Call_IotHubResourceListByResourceGroup_564102;
...
var iotHubResourceListByResourceGroup* = Call_IotHubResourceListByResourceGroup_564102(
    ...
    validator: validate_IotHubResourceListByResourceGroup_564103, base: "",
    url: url_IotHubResourceListByResourceGroup_564104, schemes: {Scheme.Https})
type
  Call_IotHubResourceCreateOrUpdate_564123 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceCreateOrUpdate_564125(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceCreateOrUpdate_564124(path: JsonNode; query: JsonNode;
...
proc call*(call_564131: Call_IotHubResourceCreateOrUpdate_564123; path: JsonNode;
...
proc call*(call_564132: Call_IotHubResourceCreateOrUpdate_564123;
  ...
  add(path_564133, "resourceName", newJString(resourceName))
  if iotHubDescription != nil:
    body_564135 = iotHubDescription
  result = call_564132.call(path_564133, query_564134, nil, nil, body_564135)

var iotHubResourceCreateOrUpdate* = Call_IotHubResourceCreateOrUpdate_564123(
    ...
    validator: validate_IotHubResourceCreateOrUpdate_564124, base: "",
    url: url_IotHubResourceCreateOrUpdate_564125, schemes: {Scheme.Https})
type
  Call_IotHubResourceGet_564112 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGet_564114(protocol: Scheme; host: string; base: string;
...
proc validate_IotHubResourceGet_564113(path: JsonNode; query: JsonNode;
...
proc call*(call_564119: Call_IotHubResourceGet_564112; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the non-security related metadata of an IoT hub.
  ## 
...
proc call*(call_564120: Call_IotHubResourceGet_564112; apiVersion: string;
...
var iotHubResourceGet* = Call_IotHubResourceGet_564112(name: "iotHubResourceGet",
    ...
    validator: validate_IotHubResourceGet_564113, base: "",
    url: url_IotHubResourceGet_564114, schemes: {Scheme.Https})
type
  Call_IotHubResourceDelete_564136 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceDelete_564138(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceDelete_564137(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Delete an IoT hub.
  ## 
  var section: JsonNode
...
proc call*(call_564143: Call_IotHubResourceDelete_564136; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete an IoT hub.
  ## 
...
proc call*(call_564144: Call_IotHubResourceDelete_564136; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564145, "resourceName", newJString(resourceName))
  result = call_564144.call(path_564145, query_564146, nil, nil, nil)

var iotHubResourceDelete* = Call_IotHubResourceDelete_564136(
    name: "iotHubResourceDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}",
    validator: validate_IotHubResourceDelete_564137, base: "",
    url: url_IotHubResourceDelete_564138, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetKeysForKeyName_564147 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetKeysForKeyName_564149(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetKeysForKeyName_564148(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564150 = path.getOrDefault("keyName")
  valid_564150 = validateParameter(valid_564150, JString, required = true,
                                 default = nil)
  if valid_564150 != nil:
    section.add "keyName", valid_564150
  ...
  var valid_564153 = path.getOrDefault("resourceName")
  valid_564153 = validateParameter(valid_564153, JString, required = true,
                                 default = nil)
  if valid_564153 != nil:
    section.add "resourceName", valid_564153
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564155: Call_IotHubResourceGetKeysForKeyName_564147;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a shared access policy by name from an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-security.
  ## 
...
proc call*(call_564156: Call_IotHubResourceGetKeysForKeyName_564147;
...
var iotHubResourceGetKeysForKeyName* = Call_IotHubResourceGetKeysForKeyName_564147(
    ...
    validator: validate_IotHubResourceGetKeysForKeyName_564148, base: "",
    url: url_IotHubResourceGetKeysForKeyName_564149, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetStats_564159 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetStats_564161(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetStats_564160(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564166: Call_IotHubResourceGetStats_564159; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the statistics from an IoT hub.
  ## 
...
proc call*(call_564167: Call_IotHubResourceGetStats_564159; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var iotHubResourceGetStats* = Call_IotHubResourceGetStats_564159(
    ...
    validator: validate_IotHubResourceGetStats_564160, base: "",
    url: url_IotHubResourceGetStats_564161, schemes: {Scheme.Https})
type
  Call_IotHubResourceListEventHubConsumerGroups_564170 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceListEventHubConsumerGroups_564172(protocol: Scheme;
...
proc validate_IotHubResourceListEventHubConsumerGroups_564171(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564173 = path.getOrDefault("eventHubEndpointName")
  valid_564173 = validateParameter(valid_564173, JString, required = true,
                                 default = nil)
  if valid_564173 != nil:
    section.add "eventHubEndpointName", valid_564173
  ...
  var valid_564176 = path.getOrDefault("resourceName")
  valid_564176 = validateParameter(valid_564176, JString, required = true,
                                 default = nil)
  if valid_564176 != nil:
    section.add "resourceName", valid_564176
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564178: Call_IotHubResourceListEventHubConsumerGroups_564170;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a list of the consumer groups in the Event Hub-compatible device-to-cloud endpoint in an IoT hub.
  ## 
...
proc call*(call_564179: Call_IotHubResourceListEventHubConsumerGroups_564170;
  ...
  add(path_564180, "eventHubEndpointName", newJString(eventHubEndpointName))
...
var iotHubResourceListEventHubConsumerGroups* = Call_IotHubResourceListEventHubConsumerGroups_564170(
    ...
    validator: validate_IotHubResourceListEventHubConsumerGroups_564171, base: "",
    url: url_IotHubResourceListEventHubConsumerGroups_564172,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceCreateEventHubConsumerGroup_564195 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceCreateEventHubConsumerGroup_564197(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceCreateEventHubConsumerGroup_564196(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564198 = path.getOrDefault("eventHubEndpointName")
  valid_564198 = validateParameter(valid_564198, JString, required = true,
                                 default = nil)
  if valid_564198 != nil:
    section.add "eventHubEndpointName", valid_564198
...
proc call*(call_564204: Call_IotHubResourceCreateEventHubConsumerGroup_564195;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Add a consumer group to an Event Hub-compatible endpoint in an IoT hub.
  ## 
...
proc call*(call_564205: Call_IotHubResourceCreateEventHubConsumerGroup_564195;
  ...
  add(path_564206, "eventHubEndpointName", newJString(eventHubEndpointName))
...
var iotHubResourceCreateEventHubConsumerGroup* = Call_IotHubResourceCreateEventHubConsumerGroup_564195(
    ...
    validator: validate_IotHubResourceCreateEventHubConsumerGroup_564196,
    base: "", url: url_IotHubResourceCreateEventHubConsumerGroup_564197,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceGetEventHubConsumerGroup_564182 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetEventHubConsumerGroup_564184(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetEventHubConsumerGroup_564183(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564185 = path.getOrDefault("eventHubEndpointName")
  valid_564185 = validateParameter(valid_564185, JString, required = true,
                                 default = nil)
  if valid_564185 != nil:
    section.add "eventHubEndpointName", valid_564185
...
proc call*(call_564191: Call_IotHubResourceGetEventHubConsumerGroup_564182;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Get a consumer group from the Event Hub-compatible device-to-cloud endpoint for an IoT hub.
  ## 
...
proc call*(call_564192: Call_IotHubResourceGetEventHubConsumerGroup_564182;
          eventHubEndpointName: string; apiVersion: string; name: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564193, "eventHubEndpointName", newJString(eventHubEndpointName))
...
var iotHubResourceGetEventHubConsumerGroup* = Call_IotHubResourceGetEventHubConsumerGroup_564182(
    name: "iotHubResourceGetEventHubConsumerGroup", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{resourceName}/eventHubEndpoints/{eventHubEndpointName}/ConsumerGroups/{name}",
    validator: validate_IotHubResourceGetEventHubConsumerGroup_564183, base: "",
    url: url_IotHubResourceGetEventHubConsumerGroup_564184,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceDeleteEventHubConsumerGroup_564208 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceDeleteEventHubConsumerGroup_564210(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceDeleteEventHubConsumerGroup_564209(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `eventHubEndpointName` field"
  var valid_564211 = path.getOrDefault("eventHubEndpointName")
  valid_564211 = validateParameter(valid_564211, JString, required = true,
                                 default = nil)
  if valid_564211 != nil:
    section.add "eventHubEndpointName", valid_564211
...
proc call*(call_564217: Call_IotHubResourceDeleteEventHubConsumerGroup_564208;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Delete a consumer group from an Event Hub-compatible endpoint in an IoT hub.
  ## 
...
proc call*(call_564218: Call_IotHubResourceDeleteEventHubConsumerGroup_564208;
          eventHubEndpointName: string; apiVersion: string; name: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564219, "eventHubEndpointName", newJString(eventHubEndpointName))
...
var iotHubResourceDeleteEventHubConsumerGroup* = Call_IotHubResourceDeleteEventHubConsumerGroup_564208(
    ...
    validator: validate_IotHubResourceDeleteEventHubConsumerGroup_564209,
    base: "", url: url_IotHubResourceDeleteEventHubConsumerGroup_564210,
    schemes: {Scheme.Https})
type
  Call_IotHubResourceExportDevices_564221 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceExportDevices_564223(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceExportDevices_564222(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564229: Call_IotHubResourceExportDevices_564221; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Exports all the device identities in the IoT hub identity registry to an Azure Storage blob container. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities.
  ## 
...
proc call*(call_564230: Call_IotHubResourceExportDevices_564221;
  ...
  if exportDevicesParameters != nil:
    body_564233 = exportDevicesParameters
...
var iotHubResourceExportDevices* = Call_IotHubResourceExportDevices_564221(
    ...
    validator: validate_IotHubResourceExportDevices_564222, base: "",
    url: url_IotHubResourceExportDevices_564223, schemes: {Scheme.Https})
type
  Call_IotHubResourceImportDevices_564234 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceImportDevices_564236(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceImportDevices_564235(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564242: Call_IotHubResourceImportDevices_564234; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Import, update, or delete device identities in the IoT hub identity registry from a blob. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry#import-and-export-device-identities.
  ## 
...
proc call*(call_564243: Call_IotHubResourceImportDevices_564234;
  ...
  if importDevicesParameters != nil:
    body_564246 = importDevicesParameters
...
var iotHubResourceImportDevices* = Call_IotHubResourceImportDevices_564234(
    ...
    validator: validate_IotHubResourceImportDevices_564235, base: "",
    url: url_IotHubResourceImportDevices_564236, schemes: {Scheme.Https})
type
  Call_IotHubResourceListJobs_564247 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceListJobs_564249(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListJobs_564248(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564254: Call_IotHubResourceListJobs_564247; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get a list of all the jobs in an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry.
  ## 
...
proc call*(call_564255: Call_IotHubResourceListJobs_564247; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var iotHubResourceListJobs* = Call_IotHubResourceListJobs_564247(
    ...
    validator: validate_IotHubResourceListJobs_564248, base: "",
    url: url_IotHubResourceListJobs_564249, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetJob_564258 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetJob_564260(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetJob_564259(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564261 = path.getOrDefault("jobId")
  valid_564261 = validateParameter(valid_564261, JString, required = true,
                                 default = nil)
  if valid_564261 != nil:
    section.add "jobId", valid_564261
...
proc call*(call_564266: Call_IotHubResourceGetJob_564258; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the details of a job from an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-identity-registry.
  ## 
...
proc call*(call_564267: Call_IotHubResourceGetJob_564258; jobId: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
  ...
  add(path_564268, "jobId", newJString(jobId))
...
var iotHubResourceGetJob* = Call_IotHubResourceGetJob_564258(
    ...
    validator: validate_IotHubResourceGetJob_564259, base: "",
    url: url_IotHubResourceGetJob_564260, schemes: {Scheme.Https})
type
  Call_IotHubResourceListKeys_564270 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceListKeys_564272(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceListKeys_564271(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564277: Call_IotHubResourceListKeys_564270; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the security metadata for an IoT hub. For more information, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-security.
  ## 
...
proc call*(call_564278: Call_IotHubResourceListKeys_564270; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ...
  add(path_564279, "resourceName", newJString(resourceName))
  result = call_564278.call(path_564279, query_564280, nil, nil, nil)

var iotHubResourceListKeys* = Call_IotHubResourceListKeys_564270(
    ...
    validator: validate_IotHubResourceListKeys_564271, base: "",
    url: url_IotHubResourceListKeys_564272, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetQuotaMetrics_564281 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetQuotaMetrics_564283(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetQuotaMetrics_564282(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564286 = path.getOrDefault("resourceName")
  valid_564286 = validateParameter(valid_564286, JString, required = true,
                                 default = nil)
  if valid_564286 != nil:
    section.add "resourceName", valid_564286
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The version of the API.
...
proc call*(call_564288: Call_IotHubResourceGetQuotaMetrics_564281; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the quota metrics for an IoT hub.
  ## 
...
proc call*(call_564289: Call_IotHubResourceGetQuotaMetrics_564281;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          resourceName: string): Recallable =
  ...
  add(path_564290, "resourceName", newJString(resourceName))
  result = call_564289.call(path_564290, query_564291, nil, nil, nil)

var iotHubResourceGetQuotaMetrics* = Call_IotHubResourceGetQuotaMetrics_564281(
    ...
    validator: validate_IotHubResourceGetQuotaMetrics_564282, base: "",
    url: url_IotHubResourceGetQuotaMetrics_564283, schemes: {Scheme.Https})
type
  Call_IotHubResourceGetValidSkus_564292 = ref object of OpenApiRestCall_563555
proc url_IotHubResourceGetValidSkus_564294(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_IotHubResourceGetValidSkus_564293(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564299: Call_IotHubResourceGetValidSkus_564292; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the list of valid SKUs for an IoT hub.
  ## 
...
proc call*(call_564300: Call_IotHubResourceGetValidSkus_564292; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
...
var iotHubResourceGetValidSkus* = Call_IotHubResourceGetValidSkus_564292(
    ...
    validator: validate_IotHubResourceGetValidSkus_564293, base: "",
    url: url_IotHubResourceGetValidSkus_564294, schemes: {Scheme.Https})
export
  rest
