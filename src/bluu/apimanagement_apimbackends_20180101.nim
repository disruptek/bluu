...
proc call*(call_564136: Call_BackendCreateOrUpdate_564109; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or Updates a backend.
  ## 
...
proc call*(call_564137: Call_BackendCreateOrUpdate_564109; serviceName: string;
  ...
  add(path_564138, "backendid", newJString(backendid))
...
type
  Call_BackendGetEntityTag_564154 = ref object of OpenApiRestCall_563555
proc url_BackendGetEntityTag_564156(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BackendGetEntityTag_564155(path: JsonNode; query: JsonNode;
...
proc call*(call_564162: Call_BackendGetEntityTag_564154; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the backend specified by its identifier.
  ## 
...
proc call*(call_564163: Call_BackendGetEntityTag_564154; serviceName: string;
          apiVersion: string; backendid: string; subscriptionId: string;
  ...
  add(path_564164, "backendid", newJString(backendid))
...
var backendGetEntityTag* = Call_BackendGetEntityTag_564154(
    name: "backendGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/backends/{backendid}",
    validator: validate_BackendGetEntityTag_564155, base: "",
    url: url_BackendGetEntityTag_564156, schemes: {Scheme.Https})
type
...
type
  Call_BackendUpdate_564166 = ref object of OpenApiRestCall_563555
proc url_BackendUpdate_564168(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BackendUpdate_564167(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564176: Call_BackendUpdate_564166; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an existing backend.
  ## 
...
proc call*(call_564177: Call_BackendUpdate_564166; serviceName: string;
          apiVersion: string; backendid: string; subscriptionId: string;
          resourceGroupName: string; parameters: JsonNode): Recallable =
  ## backendUpdate
  ## Updates an existing backend.
  ...
  add(path_564178, "backendid", newJString(backendid))
...
var backendUpdate* = Call_BackendUpdate_564166(name: "backendUpdate",
    ...
    validator: validate_BackendUpdate_564167, base: "", url: url_BackendUpdate_564168,
    schemes: {Scheme.Https})
type
  Call_BackendDelete_564141 = ref object of OpenApiRestCall_563555
proc url_BackendDelete_564143(protocol: Scheme; host: string; base: string;
                             route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BackendDelete_564142(path: JsonNode; query: JsonNode; header: JsonNode;
                                  formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564150: Call_BackendDelete_564141; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified backend.
  ## 
...
proc call*(call_564151: Call_BackendDelete_564141; serviceName: string;
          apiVersion: string; backendid: string; subscriptionId: string;
          resourceGroupName: string): Recallable =
  ## backendDelete
  ## Deletes the specified backend.
  ...
  add(path_564152, "backendid", newJString(backendid))
...
var backendDelete* = Call_BackendDelete_564141(name: "backendDelete",
    ...
    validator: validate_BackendDelete_564142, base: "", url: url_BackendDelete_564143,
    schemes: {Scheme.Https})
type
  Call_BackendReconnect_564181 = ref object of OpenApiRestCall_563555
proc url_BackendReconnect_564183(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_BackendReconnect_564182(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
...
proc call*(call_564190: Call_BackendReconnect_564181; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Notifies the APIM proxy to create a new connection to the backend after the specified timeout. If no timeout was specified, timeout of 2 minutes is used.
  ## 
...
proc call*(call_564191: Call_BackendReconnect_564181; serviceName: string;
          apiVersion: string; backendid: string; subscriptionId: string;
  ...
  add(path_564192, "backendid", newJString(backendid))
...
var backendReconnect* = Call_BackendReconnect_564181(name: "backendReconnect",
    ...
    validator: validate_BackendReconnect_564182, base: "",
    url: url_BackendReconnect_564183, schemes: {Scheme.Https})
export
  rest
