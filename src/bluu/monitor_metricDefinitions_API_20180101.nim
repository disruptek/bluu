...
proc validate_MetricDefinitionsList_567865(path: JsonNode; query: JsonNode;
  ...
  var valid_568041 = query.getOrDefault("metricnamespace")
  valid_568041 = validateParameter(valid_568041, JString, required = false,
                                 default = nil)
  if valid_568041 != nil:
    section.add "metricnamespace", valid_568041
...
proc call*(call_568064: Call_MetricDefinitionsList_567864; path: JsonNode;
...
proc call*(call_568135: Call_MetricDefinitionsList_567864; apiVersion: string;
  ...
  add(query_568138, "metricnamespace", newJString(metricnamespace))
