...
type
  Call_ApiVersionSetListByService_593646 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetListByService_593648(protocol: Scheme; host: string;
...
proc validate_ApiVersionSetListByService_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593842: Call_ApiVersionSetListByService_593646; path: JsonNode;
...
proc call*(call_593913: Call_ApiVersionSetListByService_593646;
...
var apiVersionSetListByService* = Call_ApiVersionSetListByService_593646(
    ...
    validator: validate_ApiVersionSetListByService_593647, base: "",
    url: url_ApiVersionSetListByService_593648, schemes: {Scheme.Https})
type
  Call_ApiVersionSetCreateOrUpdate_593967 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetCreateOrUpdate_593969(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetCreateOrUpdate_593968(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593999 = path.getOrDefault("versionSetId")
  valid_593999 = validateParameter(valid_593999, JString, required = true,
                                 default = nil)
  if valid_593999 != nil:
    section.add "versionSetId", valid_593999
...
proc call*(call_594004: Call_ApiVersionSetCreateOrUpdate_593967; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or Updates a Api Version Set.
  ## 
...
proc call*(call_594005: Call_ApiVersionSetCreateOrUpdate_593967;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594006, "versionSetId", newJString(versionSetId))
  if parameters != nil:
...
var apiVersionSetCreateOrUpdate* = Call_ApiVersionSetCreateOrUpdate_593967(
    ...
    validator: validate_ApiVersionSetCreateOrUpdate_593968, base: "",
    url: url_ApiVersionSetCreateOrUpdate_593969, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGetEntityTag_594022 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetGetEntityTag_594024(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetGetEntityTag_594023(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594027 = path.getOrDefault("versionSetId")
  valid_594027 = validateParameter(valid_594027, JString, required = true,
                                 default = nil)
  if valid_594027 != nil:
    section.add "versionSetId", valid_594027
...
proc call*(call_594030: Call_ApiVersionSetGetEntityTag_594022; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_594031: Call_ApiVersionSetGetEntityTag_594022;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
  ...
  add(path_594032, "versionSetId", newJString(versionSetId))
  add(path_594032, "serviceName", newJString(serviceName))
  result = call_594031.call(path_594032, query_594033, nil, nil, nil)

var apiVersionSetGetEntityTag* = Call_ApiVersionSetGetEntityTag_594022(
    name: "apiVersionSetGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetGetEntityTag_594023, base: "",
    url: url_ApiVersionSetGetEntityTag_594024, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGet_593955 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetGet_593957(protocol: Scheme; host: string; base: string;
...
proc validate_ApiVersionSetGet_593956(path: JsonNode; query: JsonNode;
  ...
  var valid_593960 = path.getOrDefault("versionSetId")
  valid_593960 = validateParameter(valid_593960, JString, required = true,
                                 default = nil)
  if valid_593960 != nil:
    section.add "versionSetId", valid_593960
...
proc call*(call_593963: Call_ApiVersionSetGet_593955; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_593964: Call_ApiVersionSetGet_593955; resourceGroupName: string;
  ...
  add(path_593965, "versionSetId", newJString(versionSetId))
  add(path_593965, "serviceName", newJString(serviceName))
  result = call_593964.call(path_593965, query_593966, nil, nil, nil)

var apiVersionSetGet* = Call_ApiVersionSetGet_593955(name: "apiVersionSetGet",
    ...
    validator: validate_ApiVersionSetGet_593956, base: "",
    url: url_ApiVersionSetGet_593957, schemes: {Scheme.Https})
type
  Call_ApiVersionSetUpdate_594034 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetUpdate_594036(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetUpdate_594035(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594039 = path.getOrDefault("versionSetId")
  valid_594039 = validateParameter(valid_594039, JString, required = true,
                                 default = nil)
  if valid_594039 != nil:
    section.add "versionSetId", valid_594039
...
proc call*(call_594044: Call_ApiVersionSetUpdate_594034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the Api VersionSet specified by its identifier.
  ## 
...
proc call*(call_594045: Call_ApiVersionSetUpdate_594034; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; versionSetId: string;
  ...
  add(path_594046, "versionSetId", newJString(versionSetId))
  if parameters != nil:
...
var apiVersionSetUpdate* = Call_ApiVersionSetUpdate_594034(
    name: "apiVersionSetUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetUpdate_594035, base: "",
    url: url_ApiVersionSetUpdate_594036, schemes: {Scheme.Https})
type
  Call_ApiVersionSetDelete_594009 = ref object of OpenApiRestCall_593424
proc url_ApiVersionSetDelete_594011(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetDelete_594010(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594014 = path.getOrDefault("versionSetId")
  valid_594014 = validateParameter(valid_594014, JString, required = true,
                                 default = nil)
  if valid_594014 != nil:
    section.add "versionSetId", valid_594014
...
proc call*(call_594018: Call_ApiVersionSetDelete_594009; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific Api Version Set.
  ## 
...
proc call*(call_594019: Call_ApiVersionSetDelete_594009; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; versionSetId: string;
          serviceName: string): Recallable =
  ## apiVersionSetDelete
  ## Deletes specific Api Version Set.
  ...
  add(path_594020, "versionSetId", newJString(versionSetId))
  add(path_594020, "serviceName", newJString(serviceName))
  result = call_594019.call(path_594020, query_594021, nil, nil, nil)

var apiVersionSetDelete* = Call_ApiVersionSetDelete_594009(
    name: "apiVersionSetDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetDelete_594010, base: "",
    url: url_ApiVersionSetDelete_594011, schemes: {Scheme.Https})
export
  rest
