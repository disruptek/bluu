...
const
  macServiceName = "apimanagement-apimapiversionsets"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_ApiVersionSetListByService_563777 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetListByService_563779(protocol: Scheme; host: string;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.ApiManagement/service/"),
               ...
               (kind: ConstantSegment, value: "/apiVersionSets")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_ApiVersionSetListByService_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563975: Call_ApiVersionSetListByService_563777; path: JsonNode;
...
proc call*(call_564046: Call_ApiVersionSetListByService_563777;
...
var apiVersionSetListByService* = Call_ApiVersionSetListByService_563777(
    name: "apiVersionSetListByService", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets",
    validator: validate_ApiVersionSetListByService_563778, base: "",
    url: url_ApiVersionSetListByService_563779, schemes: {Scheme.Https})
type
  Call_ApiVersionSetCreateOrUpdate_564100 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetCreateOrUpdate_564102(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetCreateOrUpdate_564101(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564133 = path.getOrDefault("versionSetId")
  valid_564133 = validateParameter(valid_564133, JString, required = true,
                                 default = nil)
  if valid_564133 != nil:
    section.add "versionSetId", valid_564133
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564137: Call_ApiVersionSetCreateOrUpdate_564100; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or Updates a Api Version Set.
  ## 
...
proc call*(call_564138: Call_ApiVersionSetCreateOrUpdate_564100;
          serviceName: string; apiVersion: string; subscriptionId: string;
          resourceGroupName: string; parameters: JsonNode; versionSetId: string): Recallable =
  ...
  add(path_564139, "versionSetId", newJString(versionSetId))
  result = call_564138.call(path_564139, query_564140, nil, nil, body_564141)

var apiVersionSetCreateOrUpdate* = Call_ApiVersionSetCreateOrUpdate_564100(
    name: "apiVersionSetCreateOrUpdate", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetCreateOrUpdate_564101, base: "",
    url: url_ApiVersionSetCreateOrUpdate_564102, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGetEntityTag_564155 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetGetEntityTag_564157(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetGetEntityTag_564156(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564161 = path.getOrDefault("versionSetId")
  valid_564161 = validateParameter(valid_564161, JString, required = true,
                                 default = nil)
  if valid_564161 != nil:
    section.add "versionSetId", valid_564161
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564163: Call_ApiVersionSetGetEntityTag_564155; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_564164: Call_ApiVersionSetGetEntityTag_564155; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          versionSetId: string): Recallable =
  ...
  add(path_564165, "versionSetId", newJString(versionSetId))
  result = call_564164.call(path_564165, query_564166, nil, nil, nil)

var apiVersionSetGetEntityTag* = Call_ApiVersionSetGetEntityTag_564155(
    name: "apiVersionSetGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetGetEntityTag_564156, base: "",
    url: url_ApiVersionSetGetEntityTag_564157, schemes: {Scheme.Https})
type
  Call_ApiVersionSetGet_564088 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetGet_564090(protocol: Scheme; host: string; base: string;
...
proc validate_ApiVersionSetGet_564089(path: JsonNode; query: JsonNode;
  ...
  var valid_564094 = path.getOrDefault("versionSetId")
  valid_564094 = validateParameter(valid_564094, JString, required = true,
                                 default = nil)
  if valid_564094 != nil:
    section.add "versionSetId", valid_564094
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564096: Call_ApiVersionSetGet_564088; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the details of the Api Version Set specified by its identifier.
  ## 
...
proc call*(call_564097: Call_ApiVersionSetGet_564088; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          versionSetId: string): Recallable =
  ## apiVersionSetGet
  ## Gets the details of the Api Version Set specified by its identifier.
  ...
  add(path_564098, "versionSetId", newJString(versionSetId))
  result = call_564097.call(path_564098, query_564099, nil, nil, nil)

var apiVersionSetGet* = Call_ApiVersionSetGet_564088(name: "apiVersionSetGet",
    meth: HttpMethod.HttpGet, host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetGet_564089, base: "",
    url: url_ApiVersionSetGet_564090, schemes: {Scheme.Https})
type
  Call_ApiVersionSetUpdate_564167 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetUpdate_564169(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetUpdate_564168(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564173 = path.getOrDefault("versionSetId")
  valid_564173 = validateParameter(valid_564173, JString, required = true,
                                 default = nil)
  if valid_564173 != nil:
    section.add "versionSetId", valid_564173
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564177: Call_ApiVersionSetUpdate_564167; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the details of the Api VersionSet specified by its identifier.
  ## 
...
proc call*(call_564178: Call_ApiVersionSetUpdate_564167; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          parameters: JsonNode; versionSetId: string): Recallable =
  ## apiVersionSetUpdate
  ## Updates the details of the Api VersionSet specified by its identifier.
  ##   serviceName: string (required)
  ##              : The name of the API Management service.
  ...
  add(path_564179, "versionSetId", newJString(versionSetId))
  result = call_564178.call(path_564179, query_564180, nil, nil, body_564181)

var apiVersionSetUpdate* = Call_ApiVersionSetUpdate_564167(
    name: "apiVersionSetUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetUpdate_564168, base: "",
    url: url_ApiVersionSetUpdate_564169, schemes: {Scheme.Https})
type
  Call_ApiVersionSetDelete_564142 = ref object of OpenApiRestCall_563555
proc url_ApiVersionSetDelete_564144(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ApiVersionSetDelete_564143(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564148 = path.getOrDefault("versionSetId")
  valid_564148 = validateParameter(valid_564148, JString, required = true,
                                 default = nil)
  if valid_564148 != nil:
    section.add "versionSetId", valid_564148
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Version of the API to be used with the client request.
...
proc call*(call_564151: Call_ApiVersionSetDelete_564142; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific Api Version Set.
  ## 
...
proc call*(call_564152: Call_ApiVersionSetDelete_564142; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          versionSetId: string): Recallable =
  ## apiVersionSetDelete
  ## Deletes specific Api Version Set.
  ...
  add(path_564153, "versionSetId", newJString(versionSetId))
  result = call_564152.call(path_564153, query_564154, nil, nil, nil)

var apiVersionSetDelete* = Call_ApiVersionSetDelete_564142(
    name: "apiVersionSetDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}",
    validator: validate_ApiVersionSetDelete_564143, base: "",
    url: url_ApiVersionSetDelete_564144, schemes: {Scheme.Https})
export
  rest
