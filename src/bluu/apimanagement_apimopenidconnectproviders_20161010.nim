...
type
  Call_OpenIdConnectProvidersListByService_563777 = ref object of OpenApiRestCall_563555
proc url_OpenIdConnectProvidersListByService_563779(protocol: Scheme; host: string;
...
proc validate_OpenIdConnectProvidersListByService_563778(path: JsonNode;
...
proc call*(call_563975: Call_OpenIdConnectProvidersListByService_563777;
...
proc call*(call_564046: Call_OpenIdConnectProvidersListByService_563777;
...
var openIdConnectProvidersListByService* = Call_OpenIdConnectProvidersListByService_563777(
    ...
    validator: validate_OpenIdConnectProvidersListByService_563778, base: "",
    url: url_OpenIdConnectProvidersListByService_563779, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProvidersCreateOrUpdate_564109 = ref object of OpenApiRestCall_563555
proc url_OpenIdConnectProvidersCreateOrUpdate_564111(protocol: Scheme;
...
proc validate_OpenIdConnectProvidersCreateOrUpdate_564110(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564140 = path.getOrDefault("opid")
  valid_564140 = validateParameter(valid_564140, JString, required = true,
                                 default = nil)
  if valid_564140 != nil:
    section.add "opid", valid_564140
...
proc call*(call_564145: Call_OpenIdConnectProvidersCreateOrUpdate_564109;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates the OpenID Connect Provider.
  ## 
...
proc call*(call_564146: Call_OpenIdConnectProvidersCreateOrUpdate_564109;
  ...
  add(path_564147, "opid", newJString(opid))
...
var openIdConnectProvidersCreateOrUpdate* = Call_OpenIdConnectProvidersCreateOrUpdate_564109(
    ...
    validator: validate_OpenIdConnectProvidersCreateOrUpdate_564110, base: "",
    url: url_OpenIdConnectProvidersCreateOrUpdate_564111, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProvidersGet_564088 = ref object of OpenApiRestCall_563555
proc url_OpenIdConnectProvidersGet_564090(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProvidersGet_564089(path: JsonNode; query: JsonNode;
...
proc call*(call_564105: Call_OpenIdConnectProvidersGet_564088; path: JsonNode;
...
proc call*(call_564106: Call_OpenIdConnectProvidersGet_564088; serviceName: string;
...
var openIdConnectProvidersGet* = Call_OpenIdConnectProvidersGet_564088(
    name: "openIdConnectProvidersGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProvidersGet_564089, base: "",
    url: url_OpenIdConnectProvidersGet_564090, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProvidersUpdate_564163 = ref object of OpenApiRestCall_563555
proc url_OpenIdConnectProvidersUpdate_564165(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProvidersUpdate_564164(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564167 = path.getOrDefault("opid")
  valid_564167 = validateParameter(valid_564167, JString, required = true,
                                 default = nil)
  if valid_564167 != nil:
    section.add "opid", valid_564167
...
proc call*(call_564173: Call_OpenIdConnectProvidersUpdate_564163; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific OpenID Connect Provider.
  ## 
...
proc call*(call_564174: Call_OpenIdConnectProvidersUpdate_564163;
          serviceName: string; apiVersion: string; opid: string;
          subscriptionId: string; resourceGroupName: string; parameters: JsonNode): Recallable =
  ...
  add(path_564175, "opid", newJString(opid))
...
var openIdConnectProvidersUpdate* = Call_OpenIdConnectProvidersUpdate_564163(
    name: "openIdConnectProvidersUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProvidersUpdate_564164, base: "",
    url: url_OpenIdConnectProvidersUpdate_564165, schemes: {Scheme.Https})
type
  Call_OpenIdConnectProvidersDelete_564150 = ref object of OpenApiRestCall_563555
proc url_OpenIdConnectProvidersDelete_564152(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OpenIdConnectProvidersDelete_564151(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564154 = path.getOrDefault("opid")
  valid_564154 = validateParameter(valid_564154, JString, required = true,
                                 default = nil)
  if valid_564154 != nil:
    section.add "opid", valid_564154
...
proc call*(call_564159: Call_OpenIdConnectProvidersDelete_564150; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific OpenID Connect Provider of the API Management service instance.
  ## 
...
proc call*(call_564160: Call_OpenIdConnectProvidersDelete_564150;
          serviceName: string; apiVersion: string; opid: string;
  ...
  add(path_564161, "opid", newJString(opid))
...
var openIdConnectProvidersDelete* = Call_OpenIdConnectProvidersDelete_564150(
    name: "openIdConnectProvidersDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}",
    validator: validate_OpenIdConnectProvidersDelete_564151, base: "",
    url: url_OpenIdConnectProvidersDelete_564152, schemes: {Scheme.Https})
export
  rest
