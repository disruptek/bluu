...
type
  Call_RestorableDroppedManagedDatabasesListByInstance_563761 = ref object of OpenApiRestCall_563539
proc url_RestorableDroppedManagedDatabasesListByInstance_563763(protocol: Scheme;
...
proc validate_RestorableDroppedManagedDatabasesListByInstance_563762(
...
proc call*(call_563964: Call_RestorableDroppedManagedDatabasesListByInstance_563761;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_564035: Call_RestorableDroppedManagedDatabasesListByInstance_563761;
...
var restorableDroppedManagedDatabasesListByInstance* = Call_RestorableDroppedManagedDatabasesListByInstance_563761(
    ...
    validator: validate_RestorableDroppedManagedDatabasesListByInstance_563762,
    base: "", url: url_RestorableDroppedManagedDatabasesListByInstance_563763,
    schemes: {Scheme.Https})
type
  Call_RestorableDroppedManagedDatabasesGet_564077 = ref object of OpenApiRestCall_563539
proc url_RestorableDroppedManagedDatabasesGet_564079(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RestorableDroppedManagedDatabasesGet_564078(path: JsonNode;
  ...
  var valid_564080 = path.getOrDefault("restorableDroppedDatabaseId")
  valid_564080 = validateParameter(valid_564080, JString, required = true,
                                 default = nil)
  if valid_564080 != nil:
    section.add "restorableDroppedDatabaseId", valid_564080
...
proc call*(call_564085: Call_RestorableDroppedManagedDatabasesGet_564077;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a restorable dropped managed database.
  ## 
...
proc call*(call_564086: Call_RestorableDroppedManagedDatabasesGet_564077;
  ...
  add(path_564087, "restorableDroppedDatabaseId",
...
var restorableDroppedManagedDatabasesGet* = Call_RestorableDroppedManagedDatabasesGet_564077(
    ...
    validator: validate_RestorableDroppedManagedDatabasesGet_564078, base: "",
    url: url_RestorableDroppedManagedDatabasesGet_564079, schemes: {Scheme.Https})
export
  rest
