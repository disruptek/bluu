...
const
  macServiceName = "hdinsight-capabilities"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_LocationGetCapabilities_563777 = ref object of OpenApiRestCall_563555
proc url_LocationGetCapabilities_563779(protocol: Scheme; host: string; base: string;
...
proc validate_LocationGetCapabilities_563778(path: JsonNode; query: JsonNode;
...
proc call*(call_563979: Call_LocationGetCapabilities_563777; path: JsonNode;
...
proc call*(call_564050: Call_LocationGetCapabilities_563777; apiVersion: string;
...
var locationGetCapabilities* = Call_LocationGetCapabilities_563777(
    name: "locationGetCapabilities", meth: HttpMethod.HttpGet,
    ...
    validator: validate_LocationGetCapabilities_563778, base: "",
    url: url_LocationGetCapabilities_563779, schemes: {Scheme.Https})
export
  rest
