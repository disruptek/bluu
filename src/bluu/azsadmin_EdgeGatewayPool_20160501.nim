...
type
  Call_EdgeGatewayPoolsList_574679 = ref object of OpenApiRestCall_574457
proc url_EdgeGatewayPoolsList_574681(protocol: Scheme; host: string; base: string;
...
proc validate_EdgeGatewayPoolsList_574680(path: JsonNode; query: JsonNode;
...
proc call*(call_574886: Call_EdgeGatewayPoolsList_574679; path: JsonNode;
...
proc call*(call_574957: Call_EdgeGatewayPoolsList_574679;
...
var edgeGatewayPoolsList* = Call_EdgeGatewayPoolsList_574679(
    ...
    validator: validate_EdgeGatewayPoolsList_574680, base: "",
    url: url_EdgeGatewayPoolsList_574681, schemes: {Scheme.Https})
type
  Call_EdgeGatewayPoolsGet_574999 = ref object of OpenApiRestCall_574457
proc url_EdgeGatewayPoolsGet_575001(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_EdgeGatewayPoolsGet_575000(path: JsonNode; query: JsonNode;
  ...
  var valid_575012 = path.getOrDefault("edgeGatewayPool")
  valid_575012 = validateParameter(valid_575012, JString, required = true,
                                 default = nil)
  if valid_575012 != nil:
    section.add "edgeGatewayPool", valid_575012
...
proc call*(call_575016: Call_EdgeGatewayPoolsGet_574999; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Returns the requested edge gateway pool object.
  ## 
...
proc call*(call_575017: Call_EdgeGatewayPoolsGet_574999; resourceGroupName: string;
  ...
  add(path_575018, "edgeGatewayPool", newJString(edgeGatewayPool))
...
var edgeGatewayPoolsGet* = Call_EdgeGatewayPoolsGet_574999(
    ...
    validator: validate_EdgeGatewayPoolsGet_575000, base: "",
    url: url_EdgeGatewayPoolsGet_575001, schemes: {Scheme.Https})
export
  rest
