...
type
  Call_ContainerExecuteCommand_594034 = ref object of OpenApiRestCall_593425
proc url_ContainerExecuteCommand_594036(protocol: Scheme; host: string; base: string;
                                       route: string; path: JsonNode;
                                       query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ContainerExecuteCommand_594035(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594043: Call_ContainerExecuteCommand_594034; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Executes a command for a specific container instance in a specified resource group and container group.
  ## 
...
proc call*(call_594044: Call_ContainerExecuteCommand_594034;
...
var containerExecuteCommand* = Call_ContainerExecuteCommand_594034(
    ...
    validator: validate_ContainerExecuteCommand_594035, base: "",
    url: url_ContainerExecuteCommand_594036, schemes: {Scheme.Https})
type
  Call_ContainerListLogs_594048 = ref object of OpenApiRestCall_593425
proc url_ContainerListLogs_594050(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerListLogs_594049(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
...
proc call*(call_594057: Call_ContainerListLogs_594048; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the logs for a specified container instance in a specified resource group and container group.
  ## 
...
proc call*(call_594058: Call_ContainerListLogs_594048; resourceGroupName: string;
...
var containerListLogs* = Call_ContainerListLogs_594048(name: "containerListLogs",
    ...
    validator: validate_ContainerListLogs_594049, base: "",
    url: url_ContainerListLogs_594050, schemes: {Scheme.Https})
type
  Call_ContainerGroupsRestart_594061 = ref object of OpenApiRestCall_593425
proc url_ContainerGroupsRestart_594063(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerGroupsRestart_594062(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594066 = path.getOrDefault("containerGroupName")
  valid_594066 = validateParameter(valid_594066, JString, required = true,
                                 default = nil)
  if valid_594066 != nil:
    section.add "containerGroupName", valid_594066
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_594068: Call_ContainerGroupsRestart_594061; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Restarts all containers in a container group in place. If container image has updates, new image will be downloaded.
  ## 
...
proc call*(call_594069: Call_ContainerGroupsRestart_594061;
          resourceGroupName: string; apiVersion: string; subscriptionId: string;
          containerGroupName: string): Recallable =
  ...
  add(path_594070, "containerGroupName", newJString(containerGroupName))
  result = call_594069.call(path_594070, query_594071, nil, nil, nil)

var containerGroupsRestart* = Call_ContainerGroupsRestart_594061(
    ...
    validator: validate_ContainerGroupsRestart_594062, base: "",
    url: url_ContainerGroupsRestart_594063, schemes: {Scheme.Https})
type
  Call_ContainerGroupsStop_594072 = ref object of OpenApiRestCall_593425
proc url_ContainerGroupsStop_594074(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ContainerGroupsStop_594073(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594077 = path.getOrDefault("containerGroupName")
  valid_594077 = validateParameter(valid_594077, JString, required = true,
                                 default = nil)
  if valid_594077 != nil:
    section.add "containerGroupName", valid_594077
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client API version
...
proc call*(call_594079: Call_ContainerGroupsStop_594072; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Stops all containers in a container group. Compute resources will be deallocated and billing will stop.
  ## 
...
proc call*(call_594080: Call_ContainerGroupsStop_594072; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; containerGroupName: string): Recallable =
  ## containerGroupsStop
  ## Stops all containers in a container group. Compute resources will be deallocated and billing will stop.
  ##   resourceGroupName: string (required)
  ...
  add(path_594081, "containerGroupName", newJString(containerGroupName))
  result = call_594080.call(path_594081, query_594082, nil, nil, nil)

var containerGroupsStop* = Call_ContainerGroupsStop_594072(
    ...
    validator: validate_ContainerGroupsStop_594073, base: "",
    url: url_ContainerGroupsStop_594074, schemes: {Scheme.Https})
export
  rest
