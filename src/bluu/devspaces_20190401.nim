...
proc call*(call_564182: Call_ControllersListConnectionDetails_564173;
          apiVersion: string; name: string; subscriptionId: string;
          listConnectionDetailsParameters: JsonNode; resourceGroupName: string): Recallable =
  ...
  if listConnectionDetailsParameters != nil:
    body_564185 = listConnectionDetailsParameters
...
type
  Call_ContainerHostMappingsGetContainerHostMapping_564186 = ref object of OpenApiRestCall_563555
proc url_ContainerHostMappingsGetContainerHostMapping_564188(protocol: Scheme;
...
proc validate_ContainerHostMappingsGetContainerHostMapping_564187(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  var section: JsonNode
  result = newJObject()
  ## parameters in `path` object:
...
proc call*(call_564194: Call_ContainerHostMappingsGetContainerHostMapping_564186;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
...
proc call*(call_564195: Call_ContainerHostMappingsGetContainerHostMapping_564186;
  ...
  if containerHostMapping != nil:
    body_564198 = containerHostMapping
  add(path_564196, "subscriptionId", newJString(subscriptionId))
  add(path_564196, "location", newJString(location))
...
var containerHostMappingsGetContainerHostMapping* = Call_ContainerHostMappingsGetContainerHostMapping_564186(
    ...
    validator: validate_ContainerHostMappingsGetContainerHostMapping_564187,
    base: "", url: url_ContainerHostMappingsGetContainerHostMapping_564188,
    schemes: {Scheme.Https})
export
  rest
