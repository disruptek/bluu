...
proc call*(call_594049: Call_ControllersListConnectionDetails_594040;
  ...
  if listConnectionDetailsParameters != nil:
    body_594052 = listConnectionDetailsParameters
...
type
  Call_ContainerHostMappingsGetContainerHostMapping_594053 = ref object of OpenApiRestCall_593424
proc url_ContainerHostMappingsGetContainerHostMapping_594055(protocol: Scheme;
...
proc validate_ContainerHostMappingsGetContainerHostMapping_594054(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  var section: JsonNode
  result = newJObject()
  ## parameters in `path` object:
...
proc call*(call_594061: Call_ContainerHostMappingsGetContainerHostMapping_594053;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
...
proc call*(call_594062: Call_ContainerHostMappingsGetContainerHostMapping_594053;
  ...
  if containerHostMapping != nil:
    body_594065 = containerHostMapping
  add(path_594063, "location", newJString(location))
  result = call_594062.call(path_594063, query_594064, nil, nil, body_594065)

var containerHostMappingsGetContainerHostMapping* = Call_ContainerHostMappingsGetContainerHostMapping_594053(
    ...
    validator: validate_ContainerHostMappingsGetContainerHostMapping_594054,
    base: "", url: url_ContainerHostMappingsGetContainerHostMapping_594055,
    schemes: {Scheme.Https})
export
  rest
