...
type
  Call_ScriptActionsListPersistedScripts_593979 = ref object of OpenApiRestCall_593424
proc url_ScriptActionsListPersistedScripts_593981(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ScriptActionsListPersistedScripts_593980(path: JsonNode;
...
proc call*(call_593986: Call_ScriptActionsListPersistedScripts_593979;
...
proc call*(call_593987: Call_ScriptActionsListPersistedScripts_593979;
          clusterName: string; resourceGroupName: string; apiVersion: string;
...
var scriptActionsListPersistedScripts* = Call_ScriptActionsListPersistedScripts_593979(
    ...
    validator: validate_ScriptActionsListPersistedScripts_593980, base: "",
    url: url_ScriptActionsListPersistedScripts_593981, schemes: {Scheme.Https})
type
...
type
  Call_ScriptExecutionHistoryList_594002 = ref object of OpenApiRestCall_593424
proc url_ScriptExecutionHistoryList_594004(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ScriptExecutionHistoryList_594003(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594009: Call_ScriptExecutionHistoryList_594002; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all scripts' execution history for the specified cluster.
  ## 
...
proc call*(call_594010: Call_ScriptExecutionHistoryList_594002;
          clusterName: string; resourceGroupName: string; apiVersion: string;
          subscriptionId: string): Recallable =
...
var scriptExecutionHistoryList* = Call_ScriptExecutionHistoryList_594002(
    ...
    validator: validate_ScriptExecutionHistoryList_594003, base: "",
    url: url_ScriptExecutionHistoryList_594004, schemes: {Scheme.Https})
type
