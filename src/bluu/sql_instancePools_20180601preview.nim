...
type
  Call_InstancePoolsList_593646 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsList_593648(protocol: Scheme; host: string; base: string;
...
proc validate_InstancePoolsList_593647(path: JsonNode; query: JsonNode;
...
proc call*(call_593845: Call_InstancePoolsList_593646; path: JsonNode;
...
proc call*(call_593916: Call_InstancePoolsList_593646; apiVersion: string;
...
var instancePoolsList* = Call_InstancePoolsList_593646(name: "instancePoolsList",
    ...
    validator: validate_InstancePoolsList_593647, base: "",
    url: url_InstancePoolsList_593648, schemes: {Scheme.Https})
type
  Call_InstancePoolsListByResourceGroup_593958 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsListByResourceGroup_593960(protocol: Scheme; host: string;
...
proc validate_InstancePoolsListByResourceGroup_593959(path: JsonNode;
...
proc call*(call_593964: Call_InstancePoolsListByResourceGroup_593958;
...
proc call*(call_593965: Call_InstancePoolsListByResourceGroup_593958;
...
var instancePoolsListByResourceGroup* = Call_InstancePoolsListByResourceGroup_593958(
    ...
    validator: validate_InstancePoolsListByResourceGroup_593959, base: "",
    url: url_InstancePoolsListByResourceGroup_593960, schemes: {Scheme.Https})
type
  Call_InstancePoolsCreateOrUpdate_593979 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsCreateOrUpdate_593981(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InstancePoolsCreateOrUpdate_593980(path: JsonNode; query: JsonNode;
  ...
  var valid_593984 = path.getOrDefault("instancePoolName")
  valid_593984 = validateParameter(valid_593984, JString, required = true,
                                 default = nil)
  if valid_593984 != nil:
    section.add "instancePoolName", valid_593984
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593987: Call_InstancePoolsCreateOrUpdate_593979; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates an instance pool.
  ## 
...
proc call*(call_593988: Call_InstancePoolsCreateOrUpdate_593979;
  ...
  add(path_593989, "instancePoolName", newJString(instancePoolName))
  result = call_593988.call(path_593989, query_593990, nil, nil, body_593991)

var instancePoolsCreateOrUpdate* = Call_InstancePoolsCreateOrUpdate_593979(
    ...
    validator: validate_InstancePoolsCreateOrUpdate_593980, base: "",
    url: url_InstancePoolsCreateOrUpdate_593981, schemes: {Scheme.Https})
type
  Call_InstancePoolsGet_593968 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsGet_593970(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InstancePoolsGet_593969(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_593973 = path.getOrDefault("instancePoolName")
  valid_593973 = validateParameter(valid_593973, JString, required = true,
                                 default = nil)
  if valid_593973 != nil:
    section.add "instancePoolName", valid_593973
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593975: Call_InstancePoolsGet_593968; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets an instance pool.
  ## 
...
proc call*(call_593976: Call_InstancePoolsGet_593968; resourceGroupName: string;
  ...
  add(path_593977, "instancePoolName", newJString(instancePoolName))
  result = call_593976.call(path_593977, query_593978, nil, nil, nil)

var instancePoolsGet* = Call_InstancePoolsGet_593968(name: "instancePoolsGet",
    ...
    validator: validate_InstancePoolsGet_593969, base: "",
    url: url_InstancePoolsGet_593970, schemes: {Scheme.Https})
type
  Call_InstancePoolsUpdate_594003 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsUpdate_594005(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InstancePoolsUpdate_594004(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_594008 = path.getOrDefault("instancePoolName")
  valid_594008 = validateParameter(valid_594008, JString, required = true,
                                 default = nil)
  if valid_594008 != nil:
    section.add "instancePoolName", valid_594008
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_594011: Call_InstancePoolsUpdate_594003; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates an instance pool.
  ## 
...
proc call*(call_594012: Call_InstancePoolsUpdate_594003; resourceGroupName: string;
  ...
  add(path_594013, "instancePoolName", newJString(instancePoolName))
  result = call_594012.call(path_594013, query_594014, nil, nil, body_594015)

var instancePoolsUpdate* = Call_InstancePoolsUpdate_594003(
    name: "instancePoolsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/instancePools/{instancePoolName}",
    validator: validate_InstancePoolsUpdate_594004, base: "",
    url: url_InstancePoolsUpdate_594005, schemes: {Scheme.Https})
type
  Call_InstancePoolsDelete_593992 = ref object of OpenApiRestCall_593424
proc url_InstancePoolsDelete_593994(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_InstancePoolsDelete_593993(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_593997 = path.getOrDefault("instancePoolName")
  valid_593997 = validateParameter(valid_593997, JString, required = true,
                                 default = nil)
  if valid_593997 != nil:
    section.add "instancePoolName", valid_593997
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : The API version to use for the request.
...
proc call*(call_593999: Call_InstancePoolsDelete_593992; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes an instance pool
  ## 
...
proc call*(call_594000: Call_InstancePoolsDelete_593992; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; instancePoolName: string): Recallable =
  ## instancePoolsDelete
  ## Deletes an instance pool
  ##   resourceGroupName: string (required)
  ...
  add(path_594001, "instancePoolName", newJString(instancePoolName))
  result = call_594000.call(path_594001, query_594002, nil, nil, nil)

var instancePoolsDelete* = Call_InstancePoolsDelete_593992(
    name: "instancePoolsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/instancePools/{instancePoolName}",
    validator: validate_InstancePoolsDelete_593993, base: "",
    url: url_InstancePoolsDelete_593994, schemes: {Scheme.Https})
export
  rest
