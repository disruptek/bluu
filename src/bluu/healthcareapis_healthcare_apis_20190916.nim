...
proc call*(call_564096: Call_ServicesCheckNameAvailability_564076; path: JsonNode;
...
proc call*(call_564097: Call_ServicesCheckNameAvailability_564076;
          apiVersion: string; subscriptionId: string;
          checkNameAvailabilityInputs: JsonNode): Recallable =
  ...
  if checkNameAvailabilityInputs != nil:
    body_564100 = checkNameAvailabilityInputs
...
type
  Call_OperationResultsGet_564101 = ref object of OpenApiRestCall_563556
proc url_OperationResultsGet_564103(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_OperationResultsGet_564102(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_564104 = path.getOrDefault("operationResultId")
  valid_564104 = validateParameter(valid_564104, JString, required = true,
                                 default = nil)
  if valid_564104 != nil:
    section.add "operationResultId", valid_564104
  var valid_564105 = path.getOrDefault("locationName")
  valid_564105 = validateParameter(valid_564105, JString, required = true,
                                 default = nil)
  if valid_564105 != nil:
    section.add "locationName", valid_564105
...
proc call*(call_564108: Call_OperationResultsGet_564101; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the operation result for a long running operation.
  ## 
...
proc call*(call_564109: Call_OperationResultsGet_564101; operationResultId: string;
  ...
  add(path_564110, "operationResultId", newJString(operationResultId))
  add(query_564111, "api-version", newJString(apiVersion))
  add(path_564110, "locationName", newJString(locationName))
  add(path_564110, "subscriptionId", newJString(subscriptionId))
  result = call_564109.call(path_564110, query_564111, nil, nil, nil)

var operationResultsGet* = Call_OperationResultsGet_564101(
    ...
    validator: validate_OperationResultsGet_564102, base: "",
    url: url_OperationResultsGet_564103, schemes: {Scheme.Https})
type
  Call_ServicesList_564112 = ref object of OpenApiRestCall_563556
proc url_ServicesList_564114(protocol: Scheme; host: string; base: string;
                            route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesList_564113(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_564117: Call_ServicesList_564112; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the service instances in a subscription.
  ## 
...
proc call*(call_564118: Call_ServicesList_564112; apiVersion: string;
...
var servicesList* = Call_ServicesList_564112(name: "servicesList",
    ...
    validator: validate_ServicesList_564113, base: "", url: url_ServicesList_564114,
    schemes: {Scheme.Https})
type
  Call_ServicesListByResourceGroup_564121 = ref object of OpenApiRestCall_563556
proc url_ServicesListByResourceGroup_564123(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesListByResourceGroup_564122(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564127: Call_ServicesListByResourceGroup_564121; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get all the service instances in a resource group.
  ## 
...
proc call*(call_564128: Call_ServicesListByResourceGroup_564121;
...
var servicesListByResourceGroup* = Call_ServicesListByResourceGroup_564121(
    ...
    validator: validate_ServicesListByResourceGroup_564122, base: "",
    url: url_ServicesListByResourceGroup_564123, schemes: {Scheme.Https})
type
  Call_ServicesCreateOrUpdate_564142 = ref object of OpenApiRestCall_563556
proc url_ServicesCreateOrUpdate_564144(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesCreateOrUpdate_564143(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564150: Call_ServicesCreateOrUpdate_564142; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Create or update the metadata of a service instance.
  ## 
...
proc call*(call_564151: Call_ServicesCreateOrUpdate_564142; apiVersion: string;
          subscriptionId: string; resourceGroupName: string;
          serviceDescription: JsonNode; resourceName: string): Recallable =
...
var servicesCreateOrUpdate* = Call_ServicesCreateOrUpdate_564142(
    ...
    validator: validate_ServicesCreateOrUpdate_564143, base: "",
    url: url_ServicesCreateOrUpdate_564144, schemes: {Scheme.Https})
type
  Call_ServicesGet_564131 = ref object of OpenApiRestCall_563556
proc url_ServicesGet_564133(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesGet_564132(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564138: Call_ServicesGet_564131; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get the metadata of a service instance.
  ## 
...
proc call*(call_564139: Call_ServicesGet_564131; apiVersion: string;
...
var servicesGet* = Call_ServicesGet_564131(name: "servicesGet",
                                        meth: HttpMethod.HttpGet,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/services/{resourceName}",
                                        validator: validate_ServicesGet_564132,
                                        base: "", url: url_ServicesGet_564133,
                                        schemes: {Scheme.Https})
type
  Call_ServicesUpdate_564166 = ref object of OpenApiRestCall_563556
proc url_ServicesUpdate_564168(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesUpdate_564167(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_564174: Call_ServicesUpdate_564166; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update the metadata of a service instance.
  ## 
...
proc call*(call_564175: Call_ServicesUpdate_564166; apiVersion: string;
          subscriptionId: string; servicePatchDescription: JsonNode;
  ...
  if servicePatchDescription != nil:
    body_564178 = servicePatchDescription
...
var servicesUpdate* = Call_ServicesUpdate_564166(name: "servicesUpdate",
    ...
    validator: validate_ServicesUpdate_564167, base: "", url: url_ServicesUpdate_564168,
    schemes: {Scheme.Https})
type
  Call_ServicesDelete_564155 = ref object of OpenApiRestCall_563556
proc url_ServicesDelete_564157(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ServicesDelete_564156(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
...
proc call*(call_564162: Call_ServicesDelete_564155; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a service instance.
  ## 
...
proc call*(call_564163: Call_ServicesDelete_564155; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; resourceName: string): Recallable =
  ## servicesDelete
  ## Delete a service instance.
  ##   apiVersion: string (required)
...
var servicesDelete* = Call_ServicesDelete_564155(name: "servicesDelete",
    ...
    validator: validate_ServicesDelete_564156, base: "", url: url_ServicesDelete_564157,
    schemes: {Scheme.Https})
export
  rest
