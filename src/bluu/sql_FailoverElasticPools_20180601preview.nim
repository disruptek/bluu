...
type
  Call_ElasticPoolsFailover_593630 = ref object of OpenApiRestCall_593408
proc url_ElasticPoolsFailover_593632(protocol: Scheme; host: string; base: string;
...
proc validate_ElasticPoolsFailover_593631(path: JsonNode; query: JsonNode;
  ...
  var valid_593807 = path.getOrDefault("elasticPoolName")
  valid_593807 = validateParameter(valid_593807, JString, required = true,
                                 default = nil)
  if valid_593807 != nil:
    section.add "elasticPoolName", valid_593807
...
proc call*(call_593832: Call_ElasticPoolsFailover_593630; path: JsonNode;
...
proc call*(call_593903: Call_ElasticPoolsFailover_593630;
...
var elasticPoolsFailover* = Call_ElasticPoolsFailover_593630(
    ...
    validator: validate_ElasticPoolsFailover_593631, base: "",
    url: url_ElasticPoolsFailover_593632, schemes: {Scheme.Https})
export
  rest
