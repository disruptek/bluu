...
type
  Call_LoadBalancersListAll_567863 = ref object of OpenApiRestCall_567641
proc url_LoadBalancersListAll_567865(protocol: Scheme; host: string; base: string;
...
proc validate_LoadBalancersListAll_567864(path: JsonNode; query: JsonNode;
...
proc call*(call_568062: Call_LoadBalancersListAll_567863; path: JsonNode;
...
proc call*(call_568133: Call_LoadBalancersListAll_567863; apiVersion: string;
...
var loadBalancersListAll* = Call_LoadBalancersListAll_567863(
    ...
    validator: validate_LoadBalancersListAll_567864, base: "",
    url: url_LoadBalancersListAll_567865, schemes: {Scheme.Https})
type
  Call_LoadBalancersList_568175 = ref object of OpenApiRestCall_567641
proc url_LoadBalancersList_568177(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancersList_568176(path: JsonNode; query: JsonNode;
...
proc call*(call_568181: Call_LoadBalancersList_568175; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets all the load balancers in a resource group.
  ## 
...
proc call*(call_568182: Call_LoadBalancersList_568175; resourceGroupName: string;
...
var loadBalancersList* = Call_LoadBalancersList_568175(name: "loadBalancersList",
    ...
    validator: validate_LoadBalancersList_568176, base: "",
    url: url_LoadBalancersList_568177, schemes: {Scheme.Https})
type
  Call_LoadBalancersCreateOrUpdate_568198 = ref object of OpenApiRestCall_567641
proc url_LoadBalancersCreateOrUpdate_568200(protocol: Scheme; host: string;
...
proc validate_LoadBalancersCreateOrUpdate_568199(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568219 = path.getOrDefault("loadBalancerName")
  valid_568219 = validateParameter(valid_568219, JString, required = true,
                                 default = nil)
  if valid_568219 != nil:
    section.add "loadBalancerName", valid_568219
...
proc call*(call_568223: Call_LoadBalancersCreateOrUpdate_568198; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a load balancer.
  ## 
...
proc call*(call_568224: Call_LoadBalancersCreateOrUpdate_568198;
  ...
  add(path_568225, "loadBalancerName", newJString(loadBalancerName))
...
var loadBalancersCreateOrUpdate* = Call_LoadBalancersCreateOrUpdate_568198(
    ...
    validator: validate_LoadBalancersCreateOrUpdate_568199, base: "",
    url: url_LoadBalancersCreateOrUpdate_568200, schemes: {Scheme.Https})
type
  Call_LoadBalancersGet_568185 = ref object of OpenApiRestCall_567641
proc url_LoadBalancersGet_568187(protocol: Scheme; host: string; base: string;
                                route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancersGet_568186(path: JsonNode; query: JsonNode;
                                     header: JsonNode; formData: JsonNode;
                                     body: JsonNode): JsonNode =
  ...
  var valid_568190 = path.getOrDefault("loadBalancerName")
  valid_568190 = validateParameter(valid_568190, JString, required = true,
                                 default = nil)
  if valid_568190 != nil:
    section.add "loadBalancerName", valid_568190
...
proc call*(call_568194: Call_LoadBalancersGet_568185; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the specified load balancer.
  ## 
...
proc call*(call_568195: Call_LoadBalancersGet_568185; resourceGroupName: string;
  ...
  add(path_568196, "loadBalancerName", newJString(loadBalancerName))
  add(path_568196, "subscriptionId", newJString(subscriptionId))
  result = call_568195.call(path_568196, query_568197, nil, nil, nil)

var loadBalancersGet* = Call_LoadBalancersGet_568185(name: "loadBalancersGet",
    ...
    validator: validate_LoadBalancersGet_568186, base: "",
    url: url_LoadBalancersGet_568187, schemes: {Scheme.Https})
type
  Call_LoadBalancersDelete_568228 = ref object of OpenApiRestCall_567641
proc url_LoadBalancersDelete_568230(protocol: Scheme; host: string; base: string;
                                   route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_LoadBalancersDelete_568229(path: JsonNode; query: JsonNode;
                                        header: JsonNode; formData: JsonNode;
                                        body: JsonNode): JsonNode =
  ...
  var valid_568232 = path.getOrDefault("loadBalancerName")
  valid_568232 = validateParameter(valid_568232, JString, required = true,
                                 default = nil)
  if valid_568232 != nil:
    section.add "loadBalancerName", valid_568232
...
proc call*(call_568235: Call_LoadBalancersDelete_568228; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes the specified load balancer.
  ## 
...
proc call*(call_568236: Call_LoadBalancersDelete_568228; resourceGroupName: string;
  ...
  add(path_568237, "loadBalancerName", newJString(loadBalancerName))
  add(path_568237, "subscriptionId", newJString(subscriptionId))
  result = call_568236.call(path_568237, query_568238, nil, nil, nil)

var loadBalancersDelete* = Call_LoadBalancersDelete_568228(
    name: "loadBalancersDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}",
    validator: validate_LoadBalancersDelete_568229, base: "",
    url: url_LoadBalancersDelete_568230, schemes: {Scheme.Https})
export
  rest
