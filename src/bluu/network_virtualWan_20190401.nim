...
type
  Call_VpnSitesListByResourceGroup_594436 = ref object of OpenApiRestCall_593437
proc url_VpnSitesListByResourceGroup_594438(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesListByResourceGroup_594437(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594442: Call_VpnSitesListByResourceGroup_594436; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the vpnSites in a resource group.
  ## 
...
proc call*(call_594443: Call_VpnSitesListByResourceGroup_594436;
          resourceGroupName: string; apiVersion: string; subscriptionId: string): Recallable =
...
var vpnSitesListByResourceGroup* = Call_VpnSitesListByResourceGroup_594436(
    ...
    validator: validate_VpnSitesListByResourceGroup_594437, base: "",
    url: url_VpnSitesListByResourceGroup_594438, schemes: {Scheme.Https})
type
  Call_VpnSitesCreateOrUpdate_594457 = ref object of OpenApiRestCall_593437
proc url_VpnSitesCreateOrUpdate_594459(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesCreateOrUpdate_594458(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594461 = path.getOrDefault("vpnSiteName")
  valid_594461 = validateParameter(valid_594461, JString, required = true,
                                 default = nil)
  if valid_594461 != nil:
    section.add "vpnSiteName", valid_594461
...
proc call*(call_594465: Call_VpnSitesCreateOrUpdate_594457; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a VpnSite resource if it doesn't exist else updates the existing VpnSite.
  ## 
...
proc call*(call_594466: Call_VpnSitesCreateOrUpdate_594457;
...
var vpnSitesCreateOrUpdate* = Call_VpnSitesCreateOrUpdate_594457(
    ...
    validator: validate_VpnSitesCreateOrUpdate_594458, base: "",
    url: url_VpnSitesCreateOrUpdate_594459, schemes: {Scheme.Https})
type
  Call_VpnSitesGet_594446 = ref object of OpenApiRestCall_593437
proc url_VpnSitesGet_594448(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesGet_594447(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594450 = path.getOrDefault("vpnSiteName")
  valid_594450 = validateParameter(valid_594450, JString, required = true,
                                 default = nil)
  if valid_594450 != nil:
    section.add "vpnSiteName", valid_594450
...
proc call*(call_594453: Call_VpnSitesGet_594446; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the details of a VPN site.
  ## 
...
proc call*(call_594454: Call_VpnSitesGet_594446; resourceGroupName: string;
  ...
  add(path_594455, "vpnSiteName", newJString(vpnSiteName))
  add(path_594455, "subscriptionId", newJString(subscriptionId))
  result = call_594454.call(path_594455, query_594456, nil, nil, nil)

var vpnSitesGet* = Call_VpnSitesGet_594446(name: "vpnSitesGet",
                                        meth: HttpMethod.HttpGet,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}",
                                        validator: validate_VpnSitesGet_594447,
                                        base: "", url: url_VpnSitesGet_594448,
                                        schemes: {Scheme.Https})
type
  Call_VpnSitesUpdateTags_594481 = ref object of OpenApiRestCall_593437
proc url_VpnSitesUpdateTags_594483(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesUpdateTags_594482(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_594485 = path.getOrDefault("vpnSiteName")
  valid_594485 = validateParameter(valid_594485, JString, required = true,
                                 default = nil)
  if valid_594485 != nil:
    section.add "vpnSiteName", valid_594485
...
proc call*(call_594489: Call_VpnSitesUpdateTags_594481; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates VpnSite tags.
  ## 
...
proc call*(call_594490: Call_VpnSitesUpdateTags_594481; resourceGroupName: string;
  ...
  add(path_594491, "vpnSiteName", newJString(vpnSiteName))
  add(path_594491, "subscriptionId", newJString(subscriptionId))
  if VpnSiteParameters != nil:
    body_594493 = VpnSiteParameters
  result = call_594490.call(path_594491, query_594492, nil, nil, body_594493)

var vpnSitesUpdateTags* = Call_VpnSitesUpdateTags_594481(
    name: "vpnSitesUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}",
    validator: validate_VpnSitesUpdateTags_594482, base: "",
    url: url_VpnSitesUpdateTags_594483, schemes: {Scheme.Https})
type
  Call_VpnSitesDelete_594470 = ref object of OpenApiRestCall_593437
proc url_VpnSitesDelete_594472(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesDelete_594471(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Deletes a VpnSite.
  ## 
  ...
  var valid_594474 = path.getOrDefault("vpnSiteName")
  valid_594474 = validateParameter(valid_594474, JString, required = true,
                                 default = nil)
  if valid_594474 != nil:
    section.add "vpnSiteName", valid_594474
...
proc call*(call_594477: Call_VpnSitesDelete_594470; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a VpnSite.
  ## 
...
proc call*(call_594478: Call_VpnSitesDelete_594470; resourceGroupName: string;
          apiVersion: string; vpnSiteName: string; subscriptionId: string): Recallable =
  ## vpnSitesDelete
  ## Deletes a VpnSite.
  ##   resourceGroupName: string (required)
...
var vpnSitesDelete* = Call_VpnSitesDelete_594470(name: "vpnSitesDelete",
    ...
    validator: validate_VpnSitesDelete_594471, base: "", url: url_VpnSitesDelete_594472,
    schemes: {Scheme.Https})
export
  rest
