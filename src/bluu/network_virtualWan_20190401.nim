...
type
  Call_VpnSitesListByResourceGroup_568665 = ref object of OpenApiRestCall_567666
proc url_VpnSitesListByResourceGroup_568667(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesListByResourceGroup_568666(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_568671: Call_VpnSitesListByResourceGroup_568665; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Lists all the vpnSites in a resource group.
  ## 
...
proc call*(call_568672: Call_VpnSitesListByResourceGroup_568665;
          resourceGroupName: string; apiVersion: string; subscriptionId: string): Recallable =
...
var vpnSitesListByResourceGroup* = Call_VpnSitesListByResourceGroup_568665(
    ...
    validator: validate_VpnSitesListByResourceGroup_568666, base: "",
    url: url_VpnSitesListByResourceGroup_568667, schemes: {Scheme.Https})
type
  Call_VpnSitesCreateOrUpdate_568686 = ref object of OpenApiRestCall_567666
proc url_VpnSitesCreateOrUpdate_568688(protocol: Scheme; host: string; base: string;
                                      route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesCreateOrUpdate_568687(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568690 = path.getOrDefault("vpnSiteName")
  valid_568690 = validateParameter(valid_568690, JString, required = true,
                                 default = nil)
  if valid_568690 != nil:
    section.add "vpnSiteName", valid_568690
...
proc call*(call_568694: Call_VpnSitesCreateOrUpdate_568686; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates a VpnSite resource if it doesn't exist else updates the existing VpnSite.
  ## 
...
proc call*(call_568695: Call_VpnSitesCreateOrUpdate_568686;
...
var vpnSitesCreateOrUpdate* = Call_VpnSitesCreateOrUpdate_568686(
    ...
    validator: validate_VpnSitesCreateOrUpdate_568687, base: "",
    url: url_VpnSitesCreateOrUpdate_568688, schemes: {Scheme.Https})
type
  Call_VpnSitesGet_568675 = ref object of OpenApiRestCall_567666
proc url_VpnSitesGet_568677(protocol: Scheme; host: string; base: string;
                           route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesGet_568676(path: JsonNode; query: JsonNode; header: JsonNode;
                                formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_568679 = path.getOrDefault("vpnSiteName")
  valid_568679 = validateParameter(valid_568679, JString, required = true,
                                 default = nil)
  if valid_568679 != nil:
    section.add "vpnSiteName", valid_568679
...
proc call*(call_568682: Call_VpnSitesGet_568675; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieves the details of a VPN site.
  ## 
...
proc call*(call_568683: Call_VpnSitesGet_568675; resourceGroupName: string;
  ...
  add(path_568684, "vpnSiteName", newJString(vpnSiteName))
  add(path_568684, "subscriptionId", newJString(subscriptionId))
  result = call_568683.call(path_568684, query_568685, nil, nil, nil)

var vpnSitesGet* = Call_VpnSitesGet_568675(name: "vpnSitesGet",
                                        meth: HttpMethod.HttpGet,
                                        host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}",
                                        validator: validate_VpnSitesGet_568676,
                                        base: "", url: url_VpnSitesGet_568677,
                                        schemes: {Scheme.Https})
type
  Call_VpnSitesUpdateTags_568710 = ref object of OpenApiRestCall_567666
proc url_VpnSitesUpdateTags_568712(protocol: Scheme; host: string; base: string;
                                  route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesUpdateTags_568711(path: JsonNode; query: JsonNode;
                                       header: JsonNode; formData: JsonNode;
                                       body: JsonNode): JsonNode =
  ...
  var valid_568714 = path.getOrDefault("vpnSiteName")
  valid_568714 = validateParameter(valid_568714, JString, required = true,
                                 default = nil)
  if valid_568714 != nil:
    section.add "vpnSiteName", valid_568714
...
proc call*(call_568718: Call_VpnSitesUpdateTags_568710; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates VpnSite tags.
  ## 
...
proc call*(call_568719: Call_VpnSitesUpdateTags_568710; resourceGroupName: string;
  ...
  var body_568722 = newJObject()
  add(path_568720, "resourceGroupName", newJString(resourceGroupName))
  add(query_568721, "api-version", newJString(apiVersion))
  add(path_568720, "vpnSiteName", newJString(vpnSiteName))
  add(path_568720, "subscriptionId", newJString(subscriptionId))
  if VpnSiteParameters != nil:
    body_568722 = VpnSiteParameters
  result = call_568719.call(path_568720, query_568721, nil, nil, body_568722)

var vpnSitesUpdateTags* = Call_VpnSitesUpdateTags_568710(
    name: "vpnSitesUpdateTags", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}",
    validator: validate_VpnSitesUpdateTags_568711, base: "",
    url: url_VpnSitesUpdateTags_568712, schemes: {Scheme.Https})
type
  Call_VpnSitesDelete_568699 = ref object of OpenApiRestCall_567666
proc url_VpnSitesDelete_568701(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_VpnSitesDelete_568700(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ## Deletes a VpnSite.
  ## 
  ...
  var valid_568703 = path.getOrDefault("vpnSiteName")
  valid_568703 = validateParameter(valid_568703, JString, required = true,
                                 default = nil)
  if valid_568703 != nil:
    section.add "vpnSiteName", valid_568703
...
proc call*(call_568706: Call_VpnSitesDelete_568699; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes a VpnSite.
  ## 
...
proc call*(call_568707: Call_VpnSitesDelete_568699; resourceGroupName: string;
          apiVersion: string; vpnSiteName: string; subscriptionId: string): Recallable =
  ## vpnSitesDelete
  ## Deletes a VpnSite.
  ##   resourceGroupName: string (required)
...
var vpnSitesDelete* = Call_VpnSitesDelete_568699(name: "vpnSitesDelete",
    ...
    validator: validate_VpnSitesDelete_568700, base: "", url: url_VpnSitesDelete_568701,
    schemes: {Scheme.Https})
export
  rest
