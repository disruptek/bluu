...
type
  Call_PricingsList_593646 = ref object of OpenApiRestCall_593424
proc url_PricingsList_593648(protocol: Scheme; host: string; base: string;
...
proc validate_PricingsList_593647(path: JsonNode; query: JsonNode; header: JsonNode;
...
proc call*(call_593836: Call_PricingsList_593646; path: JsonNode; query: JsonNode;
...
proc call*(call_593907: Call_PricingsList_593646; apiVersion: string;
...
var pricingsList* = Call_PricingsList_593646(name: "pricingsList",
    ...
    validator: validate_PricingsList_593647, base: "", url: url_PricingsList_593648,
    schemes: {Scheme.Https})
type
  Call_PricingsUpdateSubscriptionPricing_593968 = ref object of OpenApiRestCall_593424
proc url_PricingsUpdateSubscriptionPricing_593970(protocol: Scheme; host: string;
...
proc validate_PricingsUpdateSubscriptionPricing_593969(path: JsonNode;
  ...
  var valid_593972 = path.getOrDefault("pricingName")
  valid_593972 = validateParameter(valid_593972, JString, required = true,
                                 default = nil)
  if valid_593972 != nil:
    section.add "pricingName", valid_593972
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : API version for the operation
...
proc call*(call_593975: Call_PricingsUpdateSubscriptionPricing_593968;
...
proc call*(call_593976: Call_PricingsUpdateSubscriptionPricing_593968;
  ...
  add(path_593977, "pricingName", newJString(pricingName))
  result = call_593976.call(path_593977, query_593978, nil, nil, body_593979)

var pricingsUpdateSubscriptionPricing* = Call_PricingsUpdateSubscriptionPricing_593968(
    ...
    validator: validate_PricingsUpdateSubscriptionPricing_593969, base: "",
    url: url_PricingsUpdateSubscriptionPricing_593970, schemes: {Scheme.Https})
type
  Call_PricingsGetSubscriptionPricing_593949 = ref object of OpenApiRestCall_593424
proc url_PricingsGetSubscriptionPricing_593951(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PricingsGetSubscriptionPricing_593950(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_593962 = path.getOrDefault("pricingName")
  valid_593962 = validateParameter(valid_593962, JString, required = true,
                                 default = nil)
  if valid_593962 != nil:
    section.add "pricingName", valid_593962
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : API version for the operation
...
proc call*(call_593964: Call_PricingsGetSubscriptionPricing_593949; path: JsonNode;
...
proc call*(call_593965: Call_PricingsGetSubscriptionPricing_593949;
  ...
  add(path_593966, "pricingName", newJString(pricingName))
  result = call_593965.call(path_593966, query_593967, nil, nil, nil)

var pricingsGetSubscriptionPricing* = Call_PricingsGetSubscriptionPricing_593949(
    name: "pricingsGetSubscriptionPricing", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.Security/pricings/{pricingName}",
    validator: validate_PricingsGetSubscriptionPricing_593950, base: "",
    url: url_PricingsGetSubscriptionPricing_593951, schemes: {Scheme.Https})
type
  Call_PricingsListByResourceGroup_593980 = ref object of OpenApiRestCall_593424
proc url_PricingsListByResourceGroup_593982(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PricingsListByResourceGroup_593981(path: JsonNode; query: JsonNode;
...
proc call*(call_593986: Call_PricingsListByResourceGroup_593980; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Security pricing configurations in the resource group
  ## 
...
proc call*(call_593987: Call_PricingsListByResourceGroup_593980;
...
var pricingsListByResourceGroup* = Call_PricingsListByResourceGroup_593980(
    ...
    validator: validate_PricingsListByResourceGroup_593981, base: "",
    url: url_PricingsListByResourceGroup_593982, schemes: {Scheme.Https})
type
  Call_PricingsCreateOrUpdateResourceGroupPricing_594001 = ref object of OpenApiRestCall_593424
proc url_PricingsCreateOrUpdateResourceGroupPricing_594003(protocol: Scheme;
...
proc validate_PricingsCreateOrUpdateResourceGroupPricing_594002(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_594006 = path.getOrDefault("pricingName")
  valid_594006 = validateParameter(valid_594006, JString, required = true,
                                 default = nil)
  if valid_594006 != nil:
    section.add "pricingName", valid_594006
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : API version for the operation
...
proc call*(call_594009: Call_PricingsCreateOrUpdateResourceGroupPricing_594001;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Security pricing configuration in the resource group
  ## 
...
proc call*(call_594010: Call_PricingsCreateOrUpdateResourceGroupPricing_594001;
...
var pricingsCreateOrUpdateResourceGroupPricing* = Call_PricingsCreateOrUpdateResourceGroupPricing_594001(
    ...
    validator: validate_PricingsCreateOrUpdateResourceGroupPricing_594002,
    base: "", url: url_PricingsCreateOrUpdateResourceGroupPricing_594003,
    schemes: {Scheme.Https})
type
  Call_PricingsGetResourceGroupPricing_593990 = ref object of OpenApiRestCall_593424
proc url_PricingsGetResourceGroupPricing_593992(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PricingsGetResourceGroupPricing_593991(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ## Security pricing configuration in the resource group
  ## 
  var section: JsonNode
  ...
  var valid_593995 = path.getOrDefault("pricingName")
  valid_593995 = validateParameter(valid_593995, JString, required = true,
                                 default = nil)
  if valid_593995 != nil:
    section.add "pricingName", valid_593995
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : API version for the operation
...
proc call*(call_593997: Call_PricingsGetResourceGroupPricing_593990;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Security pricing configuration in the resource group
  ## 
...
proc call*(call_593998: Call_PricingsGetResourceGroupPricing_593990;
  ...
  add(path_593999, "pricingName", newJString(pricingName))
  result = call_593998.call(path_593999, query_594000, nil, nil, nil)

var pricingsGetResourceGroupPricing* = Call_PricingsGetResourceGroupPricing_593990(
    name: "pricingsGetResourceGroupPricing", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/pricings/{pricingName}",
    validator: validate_PricingsGetResourceGroupPricing_593991, base: "",
    url: url_PricingsGetResourceGroupPricing_593992, schemes: {Scheme.Https})
export
  rest
