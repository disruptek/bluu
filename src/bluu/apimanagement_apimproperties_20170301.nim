...
proc call*(call_564135: Call_PropertyCreateOrUpdate_564109; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Creates or updates a property.
  ## 
...
proc call*(call_564136: Call_PropertyCreateOrUpdate_564109; serviceName: string;
  ...
  add(path_564137, "propId", newJString(propId))
...
type
  Call_PropertyGetEntityTag_564153 = ref object of OpenApiRestCall_563555
proc url_PropertyGetEntityTag_564155(protocol: Scheme; host: string; base: string;
                                    route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PropertyGetEntityTag_564154(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  var valid_564158 = path.getOrDefault("propId")
  valid_564158 = validateParameter(valid_564158, JString, required = true,
                                 default = nil)
  if valid_564158 != nil:
    section.add "propId", valid_564158
...
proc call*(call_564161: Call_PropertyGetEntityTag_564153; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Gets the entity state (Etag) version of the property specified by its identifier.
  ## 
...
proc call*(call_564162: Call_PropertyGetEntityTag_564153; serviceName: string;
          apiVersion: string; subscriptionId: string; propId: string;
  ...
  add(path_564163, "propId", newJString(propId))
...
var propertyGetEntityTag* = Call_PropertyGetEntityTag_564153(
    name: "propertyGetEntityTag", meth: HttpMethod.HttpHead,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/properties/{propId}",
    validator: validate_PropertyGetEntityTag_564154, base: "",
    url: url_PropertyGetEntityTag_564155, schemes: {Scheme.Https})
type
...
type
  Call_PropertyUpdate_564165 = ref object of OpenApiRestCall_563555
proc url_PropertyUpdate_564167(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PropertyUpdate_564166(path: JsonNode; query: JsonNode;
  ...
  var valid_564170 = path.getOrDefault("propId")
  valid_564170 = validateParameter(valid_564170, JString, required = true,
                                 default = nil)
  if valid_564170 != nil:
    section.add "propId", valid_564170
...
proc call*(call_564175: Call_PropertyUpdate_564165; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific property.
  ## 
...
proc call*(call_564176: Call_PropertyUpdate_564165; serviceName: string;
          apiVersion: string; subscriptionId: string; propId: string;
          resourceGroupName: string; parameters: JsonNode): Recallable =
  ## propertyUpdate
  ## Updates the specific property.
  ...
  add(path_564177, "propId", newJString(propId))
...
var propertyUpdate* = Call_PropertyUpdate_564165(name: "propertyUpdate",
    ...
    validator: validate_PropertyUpdate_564166, base: "", url: url_PropertyUpdate_564167,
    schemes: {Scheme.Https})
type
  Call_PropertyDelete_564140 = ref object of OpenApiRestCall_563555
proc url_PropertyDelete_564142(protocol: Scheme; host: string; base: string;
                              route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_PropertyDelete_564141(path: JsonNode; query: JsonNode;
                                   header: JsonNode; formData: JsonNode;
                                   body: JsonNode): JsonNode =
  ...
  var valid_564145 = path.getOrDefault("propId")
  valid_564145 = validateParameter(valid_564145, JString, required = true,
                                 default = nil)
  if valid_564145 != nil:
    section.add "propId", valid_564145
...
proc call*(call_564149: Call_PropertyDelete_564140; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Deletes specific property from the API Management service instance.
  ## 
...
proc call*(call_564150: Call_PropertyDelete_564140; serviceName: string;
          apiVersion: string; subscriptionId: string; propId: string;
          resourceGroupName: string): Recallable =
  ## propertyDelete
  ## Deletes specific property from the API Management service instance.
  ...
  add(path_564151, "propId", newJString(propId))
...
var propertyDelete* = Call_PropertyDelete_564140(name: "propertyDelete",
    ...
    validator: validate_PropertyDelete_564141, base: "", url: url_PropertyDelete_564142,
    schemes: {Scheme.Https})
export
  rest
