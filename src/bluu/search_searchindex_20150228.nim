...
type
  Call_DocumentsCount_567863 = ref object of OpenApiRestCall_567641
proc url_DocumentsCount_567865(protocol: Scheme; host: string; base: string;
...
proc validate_DocumentsCount_567864(path: JsonNode; query: JsonNode;
...
proc call*(call_568048: Call_DocumentsCount_567863; path: JsonNode; query: JsonNode;
...
proc call*(call_568119: Call_DocumentsCount_567863; apiVersion: string): Recallable =
  ## documentsCount
  ## Queries the number of documents in the Azure Search index.
  ## https://msdn.microsoft.com/library/azure/dn798924.aspx
...
var documentsCount* = Call_DocumentsCount_567863(name: "documentsCount",
    meth: HttpMethod.HttpGet, host: "azure.local", route: "/docs/$count",
    validator: validate_DocumentsCount_567864, base: "", url: url_DocumentsCount_567865,
