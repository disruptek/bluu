...
type
  Call_DocumentsCount_593630 = ref object of OpenApiRestCall_593408
proc url_DocumentsCount_593632(protocol: Scheme; host: string; base: string;
...
proc validate_DocumentsCount_593631(path: JsonNode; query: JsonNode;
...
proc call*(call_593815: Call_DocumentsCount_593630; path: JsonNode; query: JsonNode;
...
proc call*(call_593886: Call_DocumentsCount_593630; apiVersion: string): Recallable =
  ## documentsCount
  ## Queries the number of documents in the Azure Search index.
  ## https://msdn.microsoft.com/library/azure/dn798924.aspx
...
var documentsCount* = Call_DocumentsCount_593630(name: "documentsCount",
    meth: HttpMethod.HttpGet, host: "azure.local", route: "/docs/$count",
    validator: validate_DocumentsCount_593631, base: "", url: url_DocumentsCount_593632,
