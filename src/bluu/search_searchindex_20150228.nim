...
type
  Call_DocumentsCount_563761 = ref object of OpenApiRestCall_563539
proc url_DocumentsCount_563763(protocol: Scheme; host: string; base: string;
...
proc validate_DocumentsCount_563762(path: JsonNode; query: JsonNode;
...
proc call*(call_563948: Call_DocumentsCount_563761; path: JsonNode; query: JsonNode;
...
proc call*(call_564019: Call_DocumentsCount_563761; apiVersion: string): Recallable =
  ## documentsCount
  ## Queries the number of documents in the Azure Search index.
  ## https://msdn.microsoft.com/library/azure/dn798924.aspx
...
var documentsCount* = Call_DocumentsCount_563761(name: "documentsCount",
    meth: HttpMethod.HttpGet, host: "azure.local", route: "/docs/$count",
    validator: validate_DocumentsCount_563762, base: "", url: url_DocumentsCount_563763,
