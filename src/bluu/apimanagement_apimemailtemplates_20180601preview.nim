...
proc call*(call_564189: Call_EmailTemplateUpdate_564180; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific Email Template.
  ## 
...
proc call*(call_564190: Call_EmailTemplateUpdate_564180; serviceName: string;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          parameters: JsonNode;
          templateName: string = "applicationApprovedNotificationMessage"): Recallable =
  ## emailTemplateUpdate
  ...
  add(path_564191, "templateName", newJString(templateName))
  if parameters != nil:
