...
proc call*(call_594056: Call_EmailTemplateUpdate_594047; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updates the specific Email Template.
  ## 
...
proc call*(call_594057: Call_EmailTemplateUpdate_594047; resourceGroupName: string;
  ...
  add(path_594058, "templateName", newJString(templateName))
  if parameters != nil:
