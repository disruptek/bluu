...
type
  Call_CertificateListByAutomationAccount_596679 = ref object of OpenApiRestCall_596457
proc url_CertificateListByAutomationAccount_596681(protocol: Scheme; host: string;
...
proc validate_CertificateListByAutomationAccount_596680(path: JsonNode;
...
proc call*(call_596871: Call_CertificateListByAutomationAccount_596679;
...
proc call*(call_596942: Call_CertificateListByAutomationAccount_596679;
...
var certificateListByAutomationAccount* = Call_CertificateListByAutomationAccount_596679(
    ...
    validator: validate_CertificateListByAutomationAccount_596680, base: "",
    url: url_CertificateListByAutomationAccount_596681, schemes: {Scheme.Https})
type
  Call_CertificateCreateOrUpdate_596996 = ref object of OpenApiRestCall_596457
proc url_CertificateCreateOrUpdate_596998(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateCreateOrUpdate_596997(path: JsonNode; query: JsonNode;
  ...
  var valid_597028 = path.getOrDefault("certificateName")
  valid_597028 = validateParameter(valid_597028, JString, required = true,
                                 default = nil)
  if valid_597028 != nil:
    section.add "certificateName", valid_597028
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_597031: Call_CertificateCreateOrUpdate_596996; path: JsonNode;
...
proc call*(call_597032: Call_CertificateCreateOrUpdate_596996;
          automationAccountName: string; resourceGroupName: string;
  ...
  add(path_597033, "certificateName", newJString(certificateName))
  if parameters != nil:
    body_597035 = parameters
  result = call_597032.call(path_597033, query_597034, nil, nil, body_597035)

var certificateCreateOrUpdate* = Call_CertificateCreateOrUpdate_596996(
    ...
    validator: validate_CertificateCreateOrUpdate_596997, base: "",
    url: url_CertificateCreateOrUpdate_596998, schemes: {Scheme.Https})
type
  Call_CertificateGet_596984 = ref object of OpenApiRestCall_596457
proc url_CertificateGet_596986(protocol: Scheme; host: string; base: string;
...
proc validate_CertificateGet_596985(path: JsonNode; query: JsonNode;
  ...
  var valid_596990 = path.getOrDefault("certificateName")
  valid_596990 = validateParameter(valid_596990, JString, required = true,
                                 default = nil)
  if valid_596990 != nil:
    section.add "certificateName", valid_596990
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_596992: Call_CertificateGet_596984; path: JsonNode; query: JsonNode;
...
proc call*(call_596993: Call_CertificateGet_596984; automationAccountName: string;
  ...
  add(path_596994, "certificateName", newJString(certificateName))
  result = call_596993.call(path_596994, query_596995, nil, nil, nil)

var certificateGet* = Call_CertificateGet_596984(name: "certificateGet",
    ...
    validator: validate_CertificateGet_596985, base: "", url: url_CertificateGet_596986,
    schemes: {Scheme.Https})
type
  Call_CertificateUpdate_597048 = ref object of OpenApiRestCall_596457
proc url_CertificateUpdate_597050(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateUpdate_597049(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_597054 = path.getOrDefault("certificateName")
  valid_597054 = validateParameter(valid_597054, JString, required = true,
                                 default = nil)
  if valid_597054 != nil:
    section.add "certificateName", valid_597054
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_597057: Call_CertificateUpdate_597048; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a certificate.
  ## 
  ## http://aka.ms/azureautomationsdk/certificateoperations
...
proc call*(call_597058: Call_CertificateUpdate_597048;
          automationAccountName: string; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; certificateName: string;
          parameters: JsonNode): Recallable =
  ## certificateUpdate
  ...
  add(path_597059, "certificateName", newJString(certificateName))
  if parameters != nil:
    body_597061 = parameters
  result = call_597058.call(path_597059, query_597060, nil, nil, body_597061)

var certificateUpdate* = Call_CertificateUpdate_597048(name: "certificateUpdate",
    ...
    validator: validate_CertificateUpdate_597049, base: "",
    url: url_CertificateUpdate_597050, schemes: {Scheme.Https})
type
  Call_CertificateDelete_597036 = ref object of OpenApiRestCall_596457
proc url_CertificateDelete_597038(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateDelete_597037(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_597042 = path.getOrDefault("certificateName")
  valid_597042 = validateParameter(valid_597042, JString, required = true,
                                 default = nil)
  if valid_597042 != nil:
    section.add "certificateName", valid_597042
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_597044: Call_CertificateDelete_597036; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete the certificate.
  ## 
  ## http://aka.ms/azureautomationsdk/certificateoperations
...
proc call*(call_597045: Call_CertificateDelete_597036;
          automationAccountName: string; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; certificateName: string): Recallable =
  ## certificateDelete
  ## Delete the certificate.
  ## http://aka.ms/azureautomationsdk/certificateoperations
  ##   automationAccountName: string (required)
  ...
  add(path_597046, "certificateName", newJString(certificateName))
  result = call_597045.call(path_597046, query_597047, nil, nil, nil)

var certificateDelete* = Call_CertificateDelete_597036(name: "certificateDelete",
    ...
    validator: validate_CertificateDelete_597037, base: "",
    url: url_CertificateDelete_597038, schemes: {Scheme.Https})
export
  rest
