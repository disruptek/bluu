...
type
  Call_CertificateListByAutomationAccount_593646 = ref object of OpenApiRestCall_593424
proc url_CertificateListByAutomationAccount_593648(protocol: Scheme; host: string;
...
proc validate_CertificateListByAutomationAccount_593647(path: JsonNode;
...
proc call*(call_593838: Call_CertificateListByAutomationAccount_593646;
...
proc call*(call_593909: Call_CertificateListByAutomationAccount_593646;
...
var certificateListByAutomationAccount* = Call_CertificateListByAutomationAccount_593646(
    ...
    validator: validate_CertificateListByAutomationAccount_593647, base: "",
    url: url_CertificateListByAutomationAccount_593648, schemes: {Scheme.Https})
type
  Call_CertificateCreateOrUpdate_593963 = ref object of OpenApiRestCall_593424
proc url_CertificateCreateOrUpdate_593965(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateCreateOrUpdate_593964(path: JsonNode; query: JsonNode;
  ...
  var valid_593995 = path.getOrDefault("certificateName")
  valid_593995 = validateParameter(valid_593995, JString, required = true,
                                 default = nil)
  if valid_593995 != nil:
    section.add "certificateName", valid_593995
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_593998: Call_CertificateCreateOrUpdate_593963; path: JsonNode;
...
proc call*(call_593999: Call_CertificateCreateOrUpdate_593963;
          automationAccountName: string; resourceGroupName: string;
  ...
  add(path_594000, "certificateName", newJString(certificateName))
  if parameters != nil:
    body_594002 = parameters
  result = call_593999.call(path_594000, query_594001, nil, nil, body_594002)

var certificateCreateOrUpdate* = Call_CertificateCreateOrUpdate_593963(
    ...
    validator: validate_CertificateCreateOrUpdate_593964, base: "",
    url: url_CertificateCreateOrUpdate_593965, schemes: {Scheme.Https})
type
  Call_CertificateGet_593951 = ref object of OpenApiRestCall_593424
proc url_CertificateGet_593953(protocol: Scheme; host: string; base: string;
...
proc validate_CertificateGet_593952(path: JsonNode; query: JsonNode;
  ...
  var valid_593957 = path.getOrDefault("certificateName")
  valid_593957 = validateParameter(valid_593957, JString, required = true,
                                 default = nil)
  if valid_593957 != nil:
    section.add "certificateName", valid_593957
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_593959: Call_CertificateGet_593951; path: JsonNode; query: JsonNode;
...
proc call*(call_593960: Call_CertificateGet_593951; automationAccountName: string;
  ...
  add(path_593961, "certificateName", newJString(certificateName))
  result = call_593960.call(path_593961, query_593962, nil, nil, nil)

var certificateGet* = Call_CertificateGet_593951(name: "certificateGet",
    ...
    validator: validate_CertificateGet_593952, base: "", url: url_CertificateGet_593953,
    schemes: {Scheme.Https})
type
  Call_CertificateUpdate_594015 = ref object of OpenApiRestCall_593424
proc url_CertificateUpdate_594017(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateUpdate_594016(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594021 = path.getOrDefault("certificateName")
  valid_594021 = validateParameter(valid_594021, JString, required = true,
                                 default = nil)
  if valid_594021 != nil:
    section.add "certificateName", valid_594021
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594024: Call_CertificateUpdate_594015; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Update a certificate.
  ## 
  ## http://aka.ms/azureautomationsdk/certificateoperations
...
proc call*(call_594025: Call_CertificateUpdate_594015;
          automationAccountName: string; resourceGroupName: string;
          apiVersion: string; subscriptionId: string; certificateName: string;
          parameters: JsonNode): Recallable =
  ## certificateUpdate
  ...
  add(path_594026, "certificateName", newJString(certificateName))
  if parameters != nil:
    body_594028 = parameters
  result = call_594025.call(path_594026, query_594027, nil, nil, body_594028)

var certificateUpdate* = Call_CertificateUpdate_594015(name: "certificateUpdate",
    ...
    validator: validate_CertificateUpdate_594016, base: "",
    url: url_CertificateUpdate_594017, schemes: {Scheme.Https})
type
  Call_CertificateDelete_594003 = ref object of OpenApiRestCall_593424
proc url_CertificateDelete_594005(protocol: Scheme; host: string; base: string;
                                 route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_CertificateDelete_594004(path: JsonNode; query: JsonNode;
                                      header: JsonNode; formData: JsonNode;
                                      body: JsonNode): JsonNode =
  ...
  var valid_594009 = path.getOrDefault("certificateName")
  valid_594009 = validateParameter(valid_594009, JString, required = true,
                                 default = nil)
  if valid_594009 != nil:
    section.add "certificateName", valid_594009
  result.add "path", section
  ## parameters in `query` object:
  ##   api-version: JString (required)
  ##              : Client Api Version.
...
proc call*(call_594011: Call_CertificateDelete_594003; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete the certificate.
  ## 
  ## http://aka.ms/azureautomationsdk/certificateoperations
...
proc call*(call_594012: Call_CertificateDelete_594003;
          automationAccountName: string; resourceGroupName: string;
  ...
  add(path_594013, "certificateName", newJString(certificateName))
  result = call_594012.call(path_594013, query_594014, nil, nil, nil)

var certificateDelete* = Call_CertificateDelete_594003(name: "certificateDelete",
    ...
    validator: validate_CertificateDelete_594004, base: "",
    url: url_CertificateDelete_594005, schemes: {Scheme.Https})
export
  rest
