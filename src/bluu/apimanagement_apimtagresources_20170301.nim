...
type
  Call_TagResourceListByService_593647 = ref object of OpenApiRestCall_593425
proc url_TagResourceListByService_593649(protocol: Scheme; host: string;
...
proc validate_TagResourceListByService_593648(path: JsonNode; query: JsonNode;
...
proc call*(call_593843: Call_TagResourceListByService_593647; path: JsonNode;
...
proc call*(call_593914: Call_TagResourceListByService_593647;
...
var tagResourceListByService* = Call_TagResourceListByService_593647(
    ...
    validator: validate_TagResourceListByService_593648, base: "",
    url: url_TagResourceListByService_593649, schemes: {Scheme.Https})
export
  rest
