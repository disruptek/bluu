...
type
  Call_TagResourceListByService_563778 = ref object of OpenApiRestCall_563556
proc url_TagResourceListByService_563780(protocol: Scheme; host: string;
...
proc validate_TagResourceListByService_563779(path: JsonNode; query: JsonNode;
...
proc call*(call_563976: Call_TagResourceListByService_563778; path: JsonNode;
...
proc call*(call_564047: Call_TagResourceListByService_563778; serviceName: string;
...
var tagResourceListByService* = Call_TagResourceListByService_563778(
    ...
    validator: validate_TagResourceListByService_563779, base: "",
    url: url_TagResourceListByService_563780, schemes: {Scheme.Https})
export
  rest
