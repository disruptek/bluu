...
type
  Call_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593646 = ref object of OpenApiRestCall_593424
proc url_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593648(
...
proc validate_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593647(
...
proc call*(call_593848: Call_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593646;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_593919: Call_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593646;
...
var managedDatabaseSecurityAlertPoliciesListByDatabase* = Call_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593646(
    ...
    validator: validate_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593647,
    base: "", url: url_ManagedDatabaseSecurityAlertPoliciesListByDatabase_593648,
    schemes: {Scheme.Https})
type
  Call_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593987 = ref object of OpenApiRestCall_593424
proc url_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593989(
    protocol: Scheme; host: string; base: string; route: string; path: JsonNode;
    query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
...
proc validate_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593988(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
    body: JsonNode): JsonNode =
...
proc call*(call_593997: Call_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593987;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Creates or updates a database's security alert policy.
  ## 
...
proc call*(call_593998: Call_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593987;
          resourceGroupName: string; apiVersion: string;
...
var managedDatabaseSecurityAlertPoliciesCreateOrUpdate* = Call_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593987(
    ...
    validator: validate_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593988,
    base: "", url: url_ManagedDatabaseSecurityAlertPoliciesCreateOrUpdate_593989,
    schemes: {Scheme.Https})
type
  Call_ManagedDatabaseSecurityAlertPoliciesGet_593961 = ref object of OpenApiRestCall_593424
proc url_ManagedDatabaseSecurityAlertPoliciesGet_593963(protocol: Scheme;
...
proc validate_ManagedDatabaseSecurityAlertPoliciesGet_593962(path: JsonNode;
...
proc call*(call_593983: Call_ManagedDatabaseSecurityAlertPoliciesGet_593961;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets a managed database's security alert policy.
  ## 
...
proc call*(call_593984: Call_ManagedDatabaseSecurityAlertPoliciesGet_593961;
          resourceGroupName: string; apiVersion: string;
          managedInstanceName: string; subscriptionId: string; databaseName: string;
...
var managedDatabaseSecurityAlertPoliciesGet* = Call_ManagedDatabaseSecurityAlertPoliciesGet_593961(
    ...
    validator: validate_ManagedDatabaseSecurityAlertPoliciesGet_593962, base: "",
    url: url_ManagedDatabaseSecurityAlertPoliciesGet_593963,
    schemes: {Scheme.Https})
export
  rest
