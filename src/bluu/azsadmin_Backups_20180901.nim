...
proc validate_BackupsRestore_593971(path: JsonNode; query: JsonNode;
  ...
  var valid_593992 = path.getOrDefault("backup")
  valid_593992 = validateParameter(valid_593992, JString, required = true,
                                 default = nil)
  if valid_593992 != nil:
    section.add "backup", valid_593992
...
proc call*(call_593996: Call_BackupsRestore_593970; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Restore a backup.
  ## 
...
proc call*(call_593997: Call_BackupsRestore_593970; resourceGroupName: string;
