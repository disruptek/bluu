...
proc validate_BackupsRestore_583004(path: JsonNode; query: JsonNode;
  ...
  var valid_583025 = path.getOrDefault("backup")
  valid_583025 = validateParameter(valid_583025, JString, required = true,
                                 default = nil)
  if valid_583025 != nil:
    section.add "backup", valid_583025
...
proc call*(call_583029: Call_BackupsRestore_583003; path: JsonNode; query: JsonNode;
          header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Restore a backup.
  ## 
  let valid = call_583029.validator(path, query, header, formData, body)
  let scheme = call_583029.pickScheme
  if scheme.isNone:
    raise newException(IOError, "unable to find a supported scheme")
  let url = call_583029.url(scheme.get, call_583029.host, call_583029.base,
                         call_583029.route, valid.getOrDefault("path"),
                         valid.getOrDefault("query"))
  result = hook(call_583029, url, valid)

proc call*(call_583030: Call_BackupsRestore_583003; resourceGroupName: string;
          restoreOptions: JsonNode; subscriptionId: string; backup: string;
  ...
  ##   location: string (required)
  ##           : Name of the backup location.
  var path_583031 = newJObject()
  var query_583032 = newJObject()
  var body_583033 = newJObject()
  add(path_583031, "resourceGroupName", newJString(resourceGroupName))
  if restoreOptions != nil:
    body_583033 = restoreOptions
  add(query_583032, "api-version", newJString(apiVersion))
  add(path_583031, "subscriptionId", newJString(subscriptionId))
  add(path_583031, "backup", newJString(backup))
  add(path_583031, "location", newJString(location))
  result = call_583030.call(path_583031, query_583032, nil, nil, body_583033)
