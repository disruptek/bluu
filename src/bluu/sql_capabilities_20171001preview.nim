...
proc validate_CapabilitiesListByLocation_593647(path: JsonNode; query: JsonNode;
  ...
  var valid_593837 = query.getOrDefault("include")
  valid_593837 = validateParameter(valid_593837, JString, required = false,
                                 default = newJString("supportedEditions"))
  if valid_593837 != nil:
    section.add "include", valid_593837
...
proc call*(call_593860: Call_CapabilitiesListByLocation_593646; path: JsonNode;
...
proc call*(call_593931: Call_CapabilitiesListByLocation_593646; apiVersion: string;
  ...
  add(path_593932, "subscriptionId", newJString(subscriptionId))
  add(query_593934, "include", newJString(`include`))
  add(path_593932, "locationName", newJString(locationName))
