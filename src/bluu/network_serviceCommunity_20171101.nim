...
proc call*(call_568062: Call_BgpServiceCommunitiesList_567863; path: JsonNode;
...
proc call*(call_568133: Call_BgpServiceCommunitiesList_567863; apiVersion: string;
