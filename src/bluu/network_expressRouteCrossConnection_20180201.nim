...
proc call*(call_563978: Call_ExpressRouteCrossConnectionsList_563777;
...
proc call*(call_564049: Call_ExpressRouteCrossConnectionsList_563777;
...
type
  Call_ExpressRouteCrossConnectionsListByResourceGroup_564091 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCrossConnectionsListByResourceGroup_564093(protocol: Scheme;
...
proc validate_ExpressRouteCrossConnectionsListByResourceGroup_564092(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_564097: Call_ExpressRouteCrossConnectionsListByResourceGroup_564091;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves all the ExpressRouteCrossConnections in a resource group.
  ## 
...
proc call*(call_564098: Call_ExpressRouteCrossConnectionsListByResourceGroup_564091;
...
var expressRouteCrossConnectionsListByResourceGroup* = Call_ExpressRouteCrossConnectionsListByResourceGroup_564091(
    ...
    validator: validate_ExpressRouteCrossConnectionsListByResourceGroup_564092,
    base: "", url: url_ExpressRouteCrossConnectionsListByResourceGroup_564093,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsCreateOrUpdate_564112 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCrossConnectionsCreateOrUpdate_564114(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsCreateOrUpdate_564113(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564137: Call_ExpressRouteCrossConnectionsCreateOrUpdate_564112;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_564138: Call_ExpressRouteCrossConnectionsCreateOrUpdate_564112;
...
var expressRouteCrossConnectionsCreateOrUpdate* = Call_ExpressRouteCrossConnectionsCreateOrUpdate_564112(
    ...
    validator: validate_ExpressRouteCrossConnectionsCreateOrUpdate_564113,
    base: "", url: url_ExpressRouteCrossConnectionsCreateOrUpdate_564114,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsGet_564101 = ref object of OpenApiRestCall_563555
proc url_ExpressRouteCrossConnectionsGet_564103(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsGet_564102(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `crossConnectionName` field"
  var valid_564104 = path.getOrDefault("crossConnectionName")
  valid_564104 = validateParameter(valid_564104, JString, required = true,
                                 default = nil)
  if valid_564104 != nil:
    section.add "crossConnectionName", valid_564104
...
proc call*(call_564108: Call_ExpressRouteCrossConnectionsGet_564101;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets details about the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_564109: Call_ExpressRouteCrossConnectionsGet_564101;
          apiVersion: string; crossConnectionName: string; subscriptionId: string;
  ...
  add(path_564110, "crossConnectionName", newJString(crossConnectionName))
...
var expressRouteCrossConnectionsGet* = Call_ExpressRouteCrossConnectionsGet_564101(
    name: "expressRouteCrossConnectionsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}",
    validator: validate_ExpressRouteCrossConnectionsGet_564102, base: "",
    url: url_ExpressRouteCrossConnectionsGet_564103, schemes: {Scheme.Https})
type
