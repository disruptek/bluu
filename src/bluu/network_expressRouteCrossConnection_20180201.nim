...
proc call*(call_568078: Call_ExpressRouteCrossConnectionsList_567879;
...
proc call*(call_568149: Call_ExpressRouteCrossConnectionsList_567879;
...
type
  Call_ExpressRouteCrossConnectionsListByResourceGroup_568191 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCrossConnectionsListByResourceGroup_568193(protocol: Scheme;
...
proc validate_ExpressRouteCrossConnectionsListByResourceGroup_568192(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_568197: Call_ExpressRouteCrossConnectionsListByResourceGroup_568191;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves all the ExpressRouteCrossConnections in a resource group.
  ## 
...
proc call*(call_568198: Call_ExpressRouteCrossConnectionsListByResourceGroup_568191;
...
var expressRouteCrossConnectionsListByResourceGroup* = Call_ExpressRouteCrossConnectionsListByResourceGroup_568191(
    ...
    validator: validate_ExpressRouteCrossConnectionsListByResourceGroup_568192,
    base: "", url: url_ExpressRouteCrossConnectionsListByResourceGroup_568193,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsCreateOrUpdate_568212 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCrossConnectionsCreateOrUpdate_568214(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsCreateOrUpdate_568213(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_568237: Call_ExpressRouteCrossConnectionsCreateOrUpdate_568212;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_568238: Call_ExpressRouteCrossConnectionsCreateOrUpdate_568212;
...
var expressRouteCrossConnectionsCreateOrUpdate* = Call_ExpressRouteCrossConnectionsCreateOrUpdate_568212(
    ...
    validator: validate_ExpressRouteCrossConnectionsCreateOrUpdate_568213,
    base: "", url: url_ExpressRouteCrossConnectionsCreateOrUpdate_568214,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsGet_568201 = ref object of OpenApiRestCall_567657
proc url_ExpressRouteCrossConnectionsGet_568203(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsGet_568202(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `crossConnectionName` field"
  var valid_568204 = path.getOrDefault("crossConnectionName")
  valid_568204 = validateParameter(valid_568204, JString, required = true,
                                 default = nil)
  if valid_568204 != nil:
    section.add "crossConnectionName", valid_568204
...
proc call*(call_568208: Call_ExpressRouteCrossConnectionsGet_568201;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets details about the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_568209: Call_ExpressRouteCrossConnectionsGet_568201;
          crossConnectionName: string; resourceGroupName: string;
          apiVersion: string; subscriptionId: string): Recallable =
  ...
  add(path_568210, "crossConnectionName", newJString(crossConnectionName))
...
var expressRouteCrossConnectionsGet* = Call_ExpressRouteCrossConnectionsGet_568201(
    name: "expressRouteCrossConnectionsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}",
    validator: validate_ExpressRouteCrossConnectionsGet_568202, base: "",
    url: url_ExpressRouteCrossConnectionsGet_568203, schemes: {Scheme.Https})
type
