...
proc call*(call_593845: Call_ExpressRouteCrossConnectionsList_593646;
...
proc call*(call_593916: Call_ExpressRouteCrossConnectionsList_593646;
...
type
  Call_ExpressRouteCrossConnectionsListByResourceGroup_593958 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCrossConnectionsListByResourceGroup_593960(protocol: Scheme;
...
proc validate_ExpressRouteCrossConnectionsListByResourceGroup_593959(
    path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
...
proc call*(call_593964: Call_ExpressRouteCrossConnectionsListByResourceGroup_593958;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Retrieves all the ExpressRouteCrossConnections in a resource group.
  ## 
...
proc call*(call_593965: Call_ExpressRouteCrossConnectionsListByResourceGroup_593958;
...
var expressRouteCrossConnectionsListByResourceGroup* = Call_ExpressRouteCrossConnectionsListByResourceGroup_593958(
    ...
    validator: validate_ExpressRouteCrossConnectionsListByResourceGroup_593959,
    base: "", url: url_ExpressRouteCrossConnectionsListByResourceGroup_593960,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsCreateOrUpdate_593979 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCrossConnectionsCreateOrUpdate_593981(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsCreateOrUpdate_593980(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_594004: Call_ExpressRouteCrossConnectionsCreateOrUpdate_593979;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Update the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_594005: Call_ExpressRouteCrossConnectionsCreateOrUpdate_593979;
...
var expressRouteCrossConnectionsCreateOrUpdate* = Call_ExpressRouteCrossConnectionsCreateOrUpdate_593979(
    ...
    validator: validate_ExpressRouteCrossConnectionsCreateOrUpdate_593980,
    base: "", url: url_ExpressRouteCrossConnectionsCreateOrUpdate_593981,
    schemes: {Scheme.Https})
type
  Call_ExpressRouteCrossConnectionsGet_593968 = ref object of OpenApiRestCall_593424
proc url_ExpressRouteCrossConnectionsGet_593970(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_ExpressRouteCrossConnectionsGet_593969(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
  ...
  section = newJObject()
  assert path != nil, "path argument is necessary due to required `crossConnectionName` field"
  var valid_593971 = path.getOrDefault("crossConnectionName")
  valid_593971 = validateParameter(valid_593971, JString, required = true,
                                 default = nil)
  if valid_593971 != nil:
    section.add "crossConnectionName", valid_593971
...
proc call*(call_593975: Call_ExpressRouteCrossConnectionsGet_593968;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Gets details about the specified ExpressRouteCrossConnection.
  ## 
...
proc call*(call_593976: Call_ExpressRouteCrossConnectionsGet_593968;
          crossConnectionName: string; resourceGroupName: string;
          apiVersion: string; subscriptionId: string): Recallable =
  ...
  add(path_593977, "crossConnectionName", newJString(crossConnectionName))
...
var expressRouteCrossConnectionsGet* = Call_ExpressRouteCrossConnectionsGet_593968(
    name: "expressRouteCrossConnectionsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}",
    validator: validate_ExpressRouteCrossConnectionsGet_593969, base: "",
    url: url_ExpressRouteCrossConnectionsGet_593970, schemes: {Scheme.Https})
type
