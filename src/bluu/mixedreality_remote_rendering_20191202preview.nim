...
const
  macServiceName = "mixedreality-remote-rendering"
method hook(call: OpenApiRestCall; url: Uri; input: JsonNode): Recallable {.base.}
type
  Call_RemoteRenderingAccountsListBySubscription_563777 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsListBySubscription_563779(protocol: Scheme;
  ...
  const
    segments = @[(kind: ConstantSegment, value: "/subscriptions/"),
        ...
        value: "/providers/Microsoft.MixedReality/remoteRenderingAccounts")]
  var hydrated = hydratePath(path, segments)
  if hydrated.isNone:
    raise newException(ValueError, "unable to fully hydrate path")
  result.path = base & hydrated.get

proc validate_RemoteRenderingAccountsListBySubscription_563778(path: JsonNode;
...
proc call*(call_563969: Call_RemoteRenderingAccountsListBySubscription_563777;
...
proc call*(call_564040: Call_RemoteRenderingAccountsListBySubscription_563777;
...
var remoteRenderingAccountsListBySubscription* = Call_RemoteRenderingAccountsListBySubscription_563777(
    name: "remoteRenderingAccountsListBySubscription", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/providers/Microsoft.MixedReality/remoteRenderingAccounts",
    validator: validate_RemoteRenderingAccountsListBySubscription_563778,
    base: "", url: url_RemoteRenderingAccountsListBySubscription_563779,
    schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsListByResourceGroup_564082 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsListByResourceGroup_564084(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsListByResourceGroup_564083(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564088: Call_RemoteRenderingAccountsListByResourceGroup_564082;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## List Resources by Resource Group
  ## 
...
proc call*(call_564089: Call_RemoteRenderingAccountsListByResourceGroup_564082;
...
var remoteRenderingAccountsListByResourceGroup* = Call_RemoteRenderingAccountsListByResourceGroup_564082(
    name: "remoteRenderingAccountsListByResourceGroup", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts",
    validator: validate_RemoteRenderingAccountsListByResourceGroup_564083,
    base: "", url: url_RemoteRenderingAccountsListByResourceGroup_564084,
    schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsCreate_564103 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsCreate_564105(protocol: Scheme; host: string;
...
proc validate_RemoteRenderingAccountsCreate_564104(path: JsonNode; query: JsonNode;
  ...
  ##   remoteRenderingAccount: JObject (required)
...
proc call*(call_564120: Call_RemoteRenderingAccountsCreate_564103; path: JsonNode;
...
proc call*(call_564121: Call_RemoteRenderingAccountsCreate_564103;
          apiVersion: string; remoteRenderingAccount: JsonNode;
  ...
  if remoteRenderingAccount != nil:
    body_564124 = remoteRenderingAccount
...
var remoteRenderingAccountsCreate* = Call_RemoteRenderingAccountsCreate_564103(
    name: "remoteRenderingAccountsCreate", meth: HttpMethod.HttpPut,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}",
    validator: validate_RemoteRenderingAccountsCreate_564104, base: "",
    url: url_RemoteRenderingAccountsCreate_564105, schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsGet_564092 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsGet_564094(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsGet_564093(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564099: Call_RemoteRenderingAccountsGet_564092; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Retrieve a Remote Rendering Account.
  ## 
...
proc call*(call_564100: Call_RemoteRenderingAccountsGet_564092; apiVersion: string;
          subscriptionId: string; resourceGroupName: string; accountName: string): Recallable =
...
var remoteRenderingAccountsGet* = Call_RemoteRenderingAccountsGet_564092(
    name: "remoteRenderingAccountsGet", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}",
    validator: validate_RemoteRenderingAccountsGet_564093, base: "",
    url: url_RemoteRenderingAccountsGet_564094, schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsUpdate_564136 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsUpdate_564138(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsUpdate_564137(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564144: Call_RemoteRenderingAccountsUpdate_564136; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Updating a Remote Rendering Account
  ## 
...
proc call*(call_564145: Call_RemoteRenderingAccountsUpdate_564136;
          apiVersion: string; remoteRenderingAccount: JsonNode;
          subscriptionId: string; resourceGroupName: string; accountName: string): Recallable =
  ...
  if remoteRenderingAccount != nil:
    body_564148 = remoteRenderingAccount
...
var remoteRenderingAccountsUpdate* = Call_RemoteRenderingAccountsUpdate_564136(
    name: "remoteRenderingAccountsUpdate", meth: HttpMethod.HttpPatch,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}",
    validator: validate_RemoteRenderingAccountsUpdate_564137, base: "",
    url: url_RemoteRenderingAccountsUpdate_564138, schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsDelete_564125 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsDelete_564127(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsDelete_564126(path: JsonNode; query: JsonNode;
    header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564132: Call_RemoteRenderingAccountsDelete_564125; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Delete a Remote Rendering Account.
  ## 
...
proc call*(call_564133: Call_RemoteRenderingAccountsDelete_564125;
...
var remoteRenderingAccountsDelete* = Call_RemoteRenderingAccountsDelete_564125(
    name: "remoteRenderingAccountsDelete", meth: HttpMethod.HttpDelete,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}",
    validator: validate_RemoteRenderingAccountsDelete_564126, base: "",
    url: url_RemoteRenderingAccountsDelete_564127, schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsRegenerateKeys_564160 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsRegenerateKeys_564162(protocol: Scheme;
    host: string; base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsRegenerateKeys_564161(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564168: Call_RemoteRenderingAccountsRegenerateKeys_564160;
          path: JsonNode; query: JsonNode; header: JsonNode; formData: JsonNode;
          body: JsonNode): Recallable =
  ## Regenerate specified Key of a Remote Rendering Account
  ## 
...
proc call*(call_564169: Call_RemoteRenderingAccountsRegenerateKeys_564160;
...
var remoteRenderingAccountsRegenerateKeys* = Call_RemoteRenderingAccountsRegenerateKeys_564160(
    name: "remoteRenderingAccountsRegenerateKeys", meth: HttpMethod.HttpPost,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}/keys",
    validator: validate_RemoteRenderingAccountsRegenerateKeys_564161, base: "",
    url: url_RemoteRenderingAccountsRegenerateKeys_564162, schemes: {Scheme.Https})
type
  Call_RemoteRenderingAccountsGetKeys_564149 = ref object of OpenApiRestCall_563555
proc url_RemoteRenderingAccountsGetKeys_564151(protocol: Scheme; host: string;
    base: string; route: string; path: JsonNode; query: JsonNode): Uri =
  result.scheme = $protocol
  result.hostname = host
  result.query = $queryString(query)
...
proc validate_RemoteRenderingAccountsGetKeys_564150(path: JsonNode;
    query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): JsonNode =
...
proc call*(call_564156: Call_RemoteRenderingAccountsGetKeys_564149; path: JsonNode;
          query: JsonNode; header: JsonNode; formData: JsonNode; body: JsonNode): Recallable =
  ## Get Both of the 2 Keys of a Remote Rendering Account
  ## 
...
proc call*(call_564157: Call_RemoteRenderingAccountsGetKeys_564149;
          apiVersion: string; subscriptionId: string; resourceGroupName: string;
          accountName: string): Recallable =
...
var remoteRenderingAccountsGetKeys* = Call_RemoteRenderingAccountsGetKeys_564149(
    name: "remoteRenderingAccountsGetKeys", meth: HttpMethod.HttpGet,
    host: "management.azure.com", route: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/remoteRenderingAccounts/{accountName}/keys",
    validator: validate_RemoteRenderingAccountsGetKeys_564150, base: "",
    url: url_RemoteRenderingAccountsGetKeys_564151, schemes: {Scheme.Https})
export
  rest
